export type NumericProperty =
  ...
  | "itemManagerIndex"
  | "lastBuffRequestType"
  | "lastGlobalCounterDay"
  | "lastImageCacheClear"
  | "lastRssUpdate"
  | "previousUpdateRevision"
  | "relaySkillButtonCount"
  ...
  | "bartenderTurnsUsed"
  | "basementMallPrices"
  | "batmanFundsAvailable"
  | "batmanBonusInitialFunds"
  | "batmanTimeLeft"
  | "bearSwagger"
  | "beeCounter"
  | "birdformCold"
  ...
  | "electricKoolAidEaten"
  | "encountersUntilDMTChoice"
  | "essenceOfAnnoyanceCost"
  | "essenceOfBearCost"
  ...
  | "guideToSafariCost"
  | "guyMadeOfBeesCount"
  | "guzzlrBronzeDeliveries"
  | "guzzlrDeliveryProgress"
  | "guzzlrGoldDeliveries"
  | "guzzlrPlatinumDeliveries"
  | "haciendaLayout"
  ...
  | "lastTr4pz0rQuest"
  | "lastVioletFogMap"
  | "lastWartDinseyDefeated"
  | "lastWuTangDefeated"
  | "lastYearbookCameraAscension"
  | "lastZapperWand"
  | "lawOfAveragesCost"
  | "libramSummons"
  | "lightsOutAutomation"
  ...
  | "manaBurningTrigger"
  | "manorDrawerCount"
  | "manualOfNumberologyCost"
  | "mapToKokomoCost"
  | "masksUnlocked"
  | "maximizerMRUSize"
  | "maximizerCombinationLimit"
  | "maximizerEquipmentLevel"
  ...
  | "yearbookCameraAscensions"
  | "yearbookCameraUpgrades"
  | "zeppelinProtestors"
  | "zombiePoints"
  | "_absintheDrops"
  | "_abstractionDropsCrown"
  | "_aguaDrops"
  | "_xenomorphCharge"
  ...
  | "_grimBrotherCharge"
  | "_grimFairyTaleDrops"
  | "_grimFairyTaleDropsCrown"
  | "_grimoireConfiscatorSummons"
  ...
  | "_newYouQuestSharpensDone"
  | "_newYouQuestSharpensToDo"
  | "_nightmareFuelCharges"
  | "_noobSkillCount"
  | "_nuclearStockpileUsed"
  | "_oilExtracted"
  | "_optimisticCandleDropsCrown"
  | "_oreDropsCrown"
  | "_otoscopeUsed"
  | "_pantsgivingBanish"
  | "_pantsgivingCount"
  | "_pantsgivingCrumbs"
  | "_pantsgivingFullness"
  | "_pasteDrops"
  | "_peteJukeboxFixed"
  | "_peteJumpedShark"
  | "_petePeeledOut"
  ...
  | "_reflexHammerUsed"
  | "_resolutionAdv"
  | "_resolutionRareSummons"
  | "_riftletAdv"
  | "_rogueProgramCharge"
  | "_romanticFightsLeft"
  | "_saberForceMonsterCount"
  | "_saberForceUses"
  | "_saberMod"
  | "_saltGrainsConsumed"
  | "_sandwormCharge"
  ...
  | "_sourceTerminalDuplicateUses"
  | "_sourceTerminalEnhanceUses"
  | "_sourceTerminalExtrudes"
  | "_sourceTerminalPortscanUses"
  | "_spaceFurDropsCrown"
  | "_spacegatePlanetIndex"
  | "_spacegateTurnsLeft"
  ...
  | "_turkeyMyst"
  | "_turkeyMoxie"
  | "_unaccompaniedMinerUsed"
  | "_unconsciousCollectiveCharge"
  | "_universeCalculated"
  | "_universeImploded"
  | "_usedReplicaBatoomerang"
  | "_vampyreCloakeFormUses"
...
export type BooleanProperty =
  ...
  | "relayMaintainsMana"
  | "relayOverridesImages"
  | "relayRunsAfterAdventureScript"
  | "relayRunsBeforeBattleScript"
  | "relayRunsBeforePVPScript"
  | "relayScriptButtonFirst"
  | "relayTextualizesEffects"
  | "relayTrimsZapList"
  | "relayUsesInlineLinks"
  | "relayUsesIntegratedChat"
  | "relayWarnOnRecoverFailure"
  ...
  | "_svnRepoFileFetched"
  | "_svnUpdated"
  | "antagonisticSnowmanKitAvailable"
  | "arcadeGameHints"
  | "armoryUnlocked"
  | "autoCraft"
  | "autoQuest"
  ...
  | "badMoonEncounter47"
  | "badMoonEncounter48"
  | "barrelShrineUnlocked"
  | "bigBrotherRescued"
  | "blackBartsBootyAvailable"
  | "bondAdv"
  | "bondBeach"
  | "bondBeat"
  | "bondBooze"
  ...
  | "doghouseBoarded"
  | "dontStopForCounters"
  | "drippingHallUnlocked"
  | "drippyShieldUnlocked"
  | "edUsedLash"
  | "eldritchFissureAvailable"
  | "eldritchHorrorAvailable"
  | "essenceOfAnnoyanceAvailable"
  | "essenceOfBearAvailable"
  | "expressCardUsed"
  ...
  | "hermitHax0red"
  | "holidayHalsBookAvailable"
  | "horseryAvailable"
  | "hotAirportAlways"
  | "implementGlitchItem"
  | "itemBoughtPerAscension637"
  | "itemBoughtPerAscension8266"
  | "itemBoughtPerCharacter6423"
  | "itemBoughtPerCharacter6428"
  | "itemBoughtPerCharacter6429"
  | "kingLiberated"
  | "lastPirateInsult1"
  | "lastPirateInsult2"
  | "lastPirateInsult3"
  ...
  | "manualOfNumberologyAvailable"
  | "mappingMonsters"
  | "mapToAnemoneMinePurchased"
  | "mapToKokomoAvailable"
  ...
  | "maximizerCreateOnHand"
  | "maximizerCurrentMallPrices"
  | "maximizerFoldables"
  | "maximizerIncludeAll"
  | "maximizerNoAdventures"
  | "middleChamberUnlock"
  | "moonTuned"
  ...
  | "rememberDesktopSize"
  | "restUsingChateau"
  | "restUsingCampAwayTent"
  | "requireBoxServants"
  | "requireSewerTestItems"
  | "safePickpocket"
  | "schoolOfHardKnocksDiplomaAvailable"
  | "serverAddsCustomCombat"
  | "SHAWARMAInitiativeUnlocked"
  | "showGainsPerUnit"
  | "showIgnoringStorePrices"
  | "showNoSummonOnly"
  | "showTurnFreeOnly"
  | "sleazeAirportAlways"
  | "snojoAvailable"
  ...
  | "styxPixieVisited"
  | "suppressInappropriateNags"
  | "suppressPotentialMalware"
  | "suppressPowerPixellation"
  | "telegraphOfficeAvailable"
  | "telescopeLookedHigh"
  | "timeTowerAvailable"
  | "trackLightsOut"
  | "uneffectWithHotTub"
  | "universalSeasoningActive"
  | "universalSeasoningAvailable"
  ...
  | "_affirmationCookieEaten"
  | "_affirmationHateUsed"
  | "_akgyxothUsed"
  | "_alienAnimalMilkUsed"
  | "_alienPlantPodUsed"
  | "_allYearSucker"
  | "_aprilShower"
  | "_armyToddlerCast"
  ...
  | "_coldOne"
  | "_communismUsed"
  | "_confusingLEDClockUsed"
  | "_controlPanelUsed"
  | "_corruptedStardustUsed"
  ...
  | "_dailyDungeonMalwareUsed"
  | "_darkChocolateHeart"
  | "_daycareFights"
  | "_daycareNap"
  | "_daycareSpa"
  | "_daycareToday"
  | "_defectiveTokenChecked"
  | "_defectiveTokenUsed"
  | "_dinseyGarbageDisposed"
  | "_discoKnife"
  | "_distentionPillUsed"
  | "_dnaHybrid"
  | "_drippingHallDoor1"
  ...
  | "_envyfishEggUsed"
  | "_essentialTofuUsed"
  | "_etchedHourglassUsed"
  | "_eternalCarBatteryUsed"
  | "_everfullGlassUsed"
  | "_eyeAndATwistUsed"
  | "_fancyChessSetUsed"
  | "_falloutShelterSpaUsed"
  | "_fancyHotDogEaten"
  | "_farmerItemsCollected"
  | "_favoriteBirdVisited"
  | "_firedJokestersGun"
  | "_fireStartingKitUsed"
  | "_fireworkUsed"
  | "_fishyPipeUsed"
  | "_floundryItemCreated"
  | "_floundryItemUsed"
  | "_freePillKeeperUsed"
  | "_frToday"
  | "_fudgeSporkUsed"
  | "_garbageItemChanged"
  | "_gingerBiggerAlligators"
  | "_gingerbreadCityToday"
  | "_gingerbreadClockAdvanced"
  | "_gingerbreadClockVisited"
  | "_gingerbreadColumnDestroyed"
  | "_gingerbreadMobHitUsed"
  | "_glennGoldenDiceUsed"
  | "_glitchItemImplemented"
  | "_gnollEyeUsed"
  | "_grimBuff"
  | "_guildManualUsed"
  | "_guzzlrQuestAbandoned"
  | "_hardKnocksDiplomaUsed"
  | "_hippyMeatCollected"
  | "_hobbyHorseUsed"
  | "_holidayFunUsed"
  | "_holoWristCrystal"
  ...
  | "_iceHotelRoomsRaided"
  | "_iceSculptureUsed"
  | "_incredibleSelfEsteemCast"
  | "_infernoDiscoVisited"
  | "_internetDailyDungeonMalwareBought"
  | "_internetGallonOfMilkBought"
  | "_internetPlusOneBought"
  | "_internetPrintScreenButtonBought"
  | "_internetViralVideoBought"
  | "_interviewIsabella"
  ...
  | "_kgbRightDrawerUsed"
  | "_kolConSixPackUsed"
  | "_kolhsCutButNotDried"
  | "_kolhsIsskayLikeAnAshtray"
  | "_kolhsPoeticallyLicenced"
  | "_kolhsSchoolSpirited"
  | "_latteBanishUsed"
  | "_latteCopyUsed"
  | "_latteDrinkUsed"
  | "_legendaryBeat"
  ...
  | "_psychoJarFilled"
  | "_psychoJarUsed"
  | "_psychokineticHugUsed"
  | "_rainStickUsed"
  | "_redwoodRainStickUsed"
  | "_requestSandwichSucceeded"
  | "_rhinestonesAcquired"
  | "_seaJellyHarvested"
  | "_setOfJacksUsed"
  | "_sewingKitUsed"
  | "_sexChanged"
  ...
  | "_spinmasterLatheVisited"
  | "_spinningWheel"
  | "_spookyAirportToday"
  | "_stabonicScrollUsed"
  | "_steelyEyedSquintUsed"
  | "_stenchAirportToday"
  | "_stinkyCheeseBanisherUsed"
  | "_streamsCrossed"
  | "_stuffedPocketwatchUsed"
  | "_styxSprayUsed"
  | "_summonAnnoyanceUsed"
  | "_summonCarrotUsed"
  | "_summonResortPassUsed"
  | "_sweetToothUsed"
  ...
  | "_tryptophanDartUsed"
  | "_turtlePowerCast"
  | "_twelveNightEnergyUsed"
  | "_ultraMegaSourBallUsed"
  | "_universalSeasoningUsed"
  | "_victorSpoilsUsed"
  | "_villainLairCanLidUsed"
  | "_villainLairColorChoiceUsed"
  | "_villainLairDoorChoiceUsed"
  | "_villainLairFirecrackerUsed"
  | "_villainLairSymbologyChoiceUsed"
  | "_villainLairWebUsed"
  | "_vmaskBanisherUsed"
  | "_voraciTeaUsed"
  | "_volcanoItemRedeemed"
  | "_volcanoSuperduperheatedMetal"
  | "_voteToday"
  | "_VYKEACafeteriaRaided"
  | "_VYKEALoungeRaided"
  | "_walfordQuestStartedToday"
  | "_warbearBankUsed"
  | "_warbearBreakfastMachineUsed"
  | "_warbearGyrocopterUsed"
  | "_warbearSodaMachineUsed"
  | "_witchessBuff"
  | "_workshedItemUsed"
  | "_zombieClover"
  | "_preventScurvy"
