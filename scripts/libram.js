...
new ActionSource($skill(FreeKill_templateObject || (FreeKill_templateObject = FreeKill_taggedTemplateLiteral(["Gingerbread Mob Hit"]))), () => !get("_gingerbreadMobHitUsed") && have($skill(FreeKill_templateObject2 || (FreeKill_templateObject2 = FreeKill_taggedTemplateLiteral(["Gingerbread Mob Hit"])))) ? 1 : 0, Macro.skill($skill(FreeKill_templateObject3 || (FreeKill_templateObject3 = FreeKill_taggedTemplateLiteral(["Gingerbread Mob Hit"])))), {
  ...
  preparation: () => (0,external_kolmafia_namespaceObject.restoreMp)(30)
}), new ActionSource($item(FreeKill_templateObject7 || (FreeKill_templateObject7 = FreeKill_taggedTemplateLiteral(["replica bat-oomerang"]))), () => have($item(FreeKill_templateObject8 || (FreeKill_templateObject8 = FreeKill_taggedTemplateLiteral(["replica bat-oomerang"])))) ? 3 - get("_usedReplicaBatoomerang") : 0, Macro.item($item(FreeKill_templateObject9 || (FreeKill_templateObject9 = FreeKill_taggedTemplateLiteral(["replica bat-oomerang"]))))), new ActionSource($item(FreeKill_templateObject10 || (FreeKill_templateObject10 = FreeKill_taggedTemplateLiteral(["The Jokester's gun"]))), () => !get("_firedJokestersGun") && have($item(FreeKill_templateObject11 || (FreeKill_templateObject11 = FreeKill_taggedTemplateLiteral(["The Jokester's gun"])))) ? 1 : 0, Macro.skill($skill(FreeKill_templateObject12 || (FreeKill_templateObject12 = FreeKill_taggedTemplateLiteral(["Fire the Jokester's Gun"])))), {
  equipmentRequirements: () => new Requirement([], {
    forceEquip: $items(FreeKill_templateObject13 || (FreeKill_templateObject13 = FreeKill_taggedTemplateLiteral(["The Jokester's gun"])))
  })
}), new ActionSource($item(FreeKill_templateObject14 || (FreeKill_templateObject14 = FreeKill_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))), () => have($item(FreeKill_templateObject15 || (FreeKill_templateObject15 = FreeKill_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) ? 3 - get("_chestXRayUsed") : 0, Macro.skill($skill(FreeKill_templateObject16 || (FreeKill_templateObject16 = FreeKill_taggedTemplateLiteral(["Chest X-Ray"])))), {
  equipmentRequirements: () => new Requirement([], {
    forceEquip: $items(FreeKill_templateObject17 || (FreeKill_templateObject17 = FreeKill_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
  })
}), new ActionSource($skill(FreeKill_templateObject18 || (FreeKill_templateObject18 = FreeKill_taggedTemplateLiteral(["Asdon Martin: Missile Launcher"]))), () => !get("_missileLauncherUsed") && installed() ? 1 : 0, Macro.skill($skill(FreeKill_templateObject19 || (FreeKill_templateObject19 = FreeKill_taggedTemplateLiteral(["Asdon Martin: Missile Launcher"])))), {
  preparation: () => fillTo(100)
}), // Heavy Rains
new ActionSource($skill(FreeKill_templateObject20 || (FreeKill_templateObject20 = FreeKill_taggedTemplateLiteral(["Lightning Strike"]))), () => have($skill(FreeKill_templateObject21 || (FreeKill_templateObject21 = FreeKill_taggedTemplateLiteral(["Lightning Strike"])))) ? Math.floor((0,external_kolmafia_namespaceObject.myLightning)() / 20) : 0, Macro.skill($skill(FreeKill_templateObject22 || (FreeKill_templateObject22 = FreeKill_taggedTemplateLiteral(["Lightning Strike"]))))), // Expensive limited sources
new ActionSource($item(FreeKill_templateObject23 || (FreeKill_templateObject23 = FreeKill_taggedTemplateLiteral(["powdered madness"]))), () => 5 - get("_powderedMadnessUses"), Macro.item($item(FreeKill_templateObject24 || (FreeKill_templateObject24 = FreeKill_taggedTemplateLiteral(["powdered madness"])))), {
  preparation: () => (0,external_kolmafia_namespaceObject.retrieveItem)($item(FreeKill_templateObject25 || (FreeKill_templateObject25 = FreeKill_taggedTemplateLiteral(["powdered madness"])))),
  cost: () => ActionSource.defaultPriceFunction($item(FreeKill_templateObject26 || (FreeKill_templateObject26 = FreeKill_taggedTemplateLiteral(["powdered madness"]))))
}), new ActionSource($familiar(FreeKill_templateObject27 || (FreeKill_templateObject27 = FreeKill_taggedTemplateLiteral(["Puck Man"]))), () => have($familiar(FreeKill_templateObject28 || (FreeKill_templateObject28 = FreeKill_taggedTemplateLiteral(["Puck Man"])))) ? 20 - get("_powerPillUses") : 0, Macro.item($item(FreeKill_templateObject29 || (FreeKill_templateObject29 = FreeKill_taggedTemplateLiteral(["power pill"])))), {
  familiar: () => $familiar(FreeKill_templateObject30 || (FreeKill_templateObject30 = FreeKill_taggedTemplateLiteral(["Puck Man"]))),
  preparation: () => (0,external_kolmafia_namespaceObject.retrieveItem)($item(FreeKill_templateObject31 || (FreeKill_templateObject31 = FreeKill_taggedTemplateLiteral(["power pill"])))),
  cost: () => ActionSource.defaultPriceFunction($item(FreeKill_templateObject32 || (FreeKill_templateObject32 = FreeKill_taggedTemplateLiteral(["power pill"]))))
}), new ActionSource($familiar(FreeKill_templateObject33 || (FreeKill_templateObject33 = FreeKill_taggedTemplateLiteral(["Ms. Puck Man"]))), () => have($familiar(FreeKill_templateObject34 || (FreeKill_templateObject34 = FreeKill_taggedTemplateLiteral(["Ms. Puck Man"])))) ? 20 - get("_powerPillUses") : 0, Macro.item($item(FreeKill_templateObject35 || (FreeKill_templateObject35 = FreeKill_taggedTemplateLiteral(["power pill"])))), {
  familiar: () => $familiar(FreeKill_templateObject36 || (FreeKill_templateObject36 = FreeKill_taggedTemplateLiteral(["Ms. Puck Man"]))),
  preparation: () => (0,external_kolmafia_namespaceObject.retrieveItem)($item(FreeKill_templateObject37 || (FreeKill_templateObject37 = FreeKill_taggedTemplateLiteral(["power pill"])))),
  cost: () => ActionSource.defaultPriceFunction($item(FreeKill_templateObject38 || (FreeKill_templateObject38 = FreeKill_taggedTemplateLiteral(["power pill"]))))
}), // Expensive unlimited sources
new ActionSource($skill(FreeKill_templateObject39 || (FreeKill_templateObject39 = FreeKill_taggedTemplateLiteral(["Shocking Lick"]))), () => Infinity, Macro.skill($skill(FreeKill_templateObject40 || (FreeKill_templateObject40 = FreeKill_taggedTemplateLiteral(["Shocking Lick"])))), {
  preparation: () => {
    if (get("shockingLickCharges") === 0 && (0,external_kolmafia_namespaceObject.retrieveItem)($item(FreeKill_templateObject41 || (FreeKill_templateObject41 = FreeKill_taggedTemplateLiteral(["battery (9-Volt)"]))))) {
      (0,external_kolmafia_namespaceObject.use)($item(FreeKill_templateObject42 || (FreeKill_templateObject42 = FreeKill_taggedTemplateLiteral(["battery (9-Volt)"]))));
    }

    return get("shockingLickCharges") > 0;
  },
  cost: () => ActionSource.defaultPriceFunction($item(FreeKill_templateObject43 || (FreeKill_templateObject43 = FreeKill_taggedTemplateLiteral(["battery (AAA)"])))) * 4
})].concat(FreeKill_toConsumableArray($items(FreeKill_templateObject44 || (FreeKill_templateObject44 = FreeKill_taggedTemplateLiteral(["Daily Affirmation: Think Win-Lose, superduperheated metal"]))).map(item => new ActionSource(item, () => Infinity, Macro.item(item), {
