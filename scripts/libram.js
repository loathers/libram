...
__export(src_exports, {
  ...
  BloodCubicZirconia: function() {
    return BloodCubicZirconia_exports;
  },
  ...
  SkeletonOfCrimboPast: function() {
    return SkeletonOfCrimboPast_exports;
  },
  SlimeTube: function() {
    return SlimeTube;
  },
  ...
  adventureTargetToWeightedMap: function() {
    return adventureTargetToWeightedMap;
  },
  applyModes: function() {
    return applyModes;
  },
...
function arrayToCountedMap(array) {
  ...
  return array.forEach(function(item15) {
...
function maxBy(array, optimizer) {
  ...
  return typeof optimizer == "function" ? _toConsumableArray2(array).reduce(function(_ref6, other) {
    var value = _ref6.value, item15 = _ref6.item, otherValue = optimizer(other);
...
function getFoldGroup(item15) {
  ...
  var result = Object.entries((0, import_kolmafia4.getRelated)(item15, "fold")).sort(function(_ref, _ref2) {
...
function getZapGroup(item15) {
  return Object.keys((0, import_kolmafia4.getRelated)(item15, "zap")).map(function(i) {
    return import_kolmafia4.Item.get(i);
  });
}
var banishSource = function(banisher) {
  ...
  var item15 = (0, import_kolmafia4.toItem)(banisher);
  return $items(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["none, training scroll:  Snokebomb, tomayohawk-style reflex hammer"]))).includes(item15) ? (0, import_kolmafia4.toSkill)(banisher) : item15;
};
...
function canUse(item15) {
  ...
  return !(path3 !== import_kolmafia4.Path.get("Nuclear Autumn") && $items(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["Shrieking Weasel holo-record, Power-Guy 2000 holo-record, Lucky Strikes holo-record, EMD holo-record, Superdrifter holo-record, The Pigs holo-record, Drunk Uncles holo-record"]))).includes(item15) || path3 === import_kolmafia4.Path.get("G-Lover") && !item15.name.toLowerCase().includes("g") || path3 === import_kolmafia4.Path.get("Bees Hate You") && item15.name.toLowerCase().includes("b"));
}
...
function findLeprechaunMultiplier(familiar10) {
  if (familiar10 === $familiar(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["Mutant Cactus Bud"]))))
    return (0, import_kolmafia4.numericModifier)(familiar10, "Leprechaun Effectiveness", 1, $item.none);
  if (familiar10 === $familiar(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["Reanimated Reanimator"])))) return 0;
...
function findFairyMultiplier(familiar10) {
  if (familiar10 === $familiar(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["Mutant Fire Ant"]))))
    return (0, import_kolmafia4.numericModifier)(familiar10, "Fairy Effectiveness", 1, $item.none);
  if (familiar10 === $familiar(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["Reanimated Reanimator"])))) return 0;
  var itemBonus = (0, import_kolmafia4.numericModifier)(familiar10, "Item Drop", 1, $item.none);
  return itemBonus === 0 ? 0 : familiar10 === $familiar(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["Jill-of-All-Trades"]))) ? 1.5 : Math.pow(Math.sqrt(itemBonus + 55 / 4 + 3) - Math.sqrt(55) / 2, 2);
}
...
function directlyUse(item15) {
  return (0, import_kolmafia4.visitUrl)("inv_use.php?which=3&whichitem=".concat(item15.id, "&pwd"));
}
...
function setCombatFlags() {
  ...
  })), ["action=Update", "am=1", "ajax=1", "pwd"]).join("&"), !0)));
}
...
function totalFamiliarWeight() {
  ...
  return clamp(clamp((0, import_kolmafia4.familiarWeight)(familiar10), have($effect(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["Fidoxene"])))) ? 20 : 0, 1 / 0) + familiar10.soupWeight + (considerAdjustment ? (0, import_kolmafia4.weightAdjustment)() : 0) + (familiar10.feasted ? 10 : 0), 1, 1 / 0);
}
...
var modeableCommands = ["backupcamera", "umbrella", "snowsuit", "edpiece", "retrocape", "parka", "jillcandle"], modeableItems = {
  backupcamera: $item(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral2(["backup camera"]))),
  ...
  retrocape: $item(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral2(["unwrapped knock-off retro superhero cape"]))),
...
function canEquipItemCount() {
  ...
  }) || (cachedStats = stats, cachedCanEquipItemCount = import_kolmafia6.Item.all().filter(function(item15) {
    return (0, import_kolmafia6.canEquip)(item15);
  ...
  if (outfitName) {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
        ...
        (0, import_kolmafia6.equippedItem)(slot) !== item15 && (0, import_kolmafia6.availableAmount)(item15) > 0 && (0, import_kolmafia6.equip)(slot, item15);
      }
    } catch (err) {
      _iterator3.e(err);
    } finally {
...
function maximizeCached(objectives) {
  var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, fullOptions = mergeMaximizeOptions(defaultMaximizeOptions, options), forceEquip = fullOptions.forceEquip, preventEquip = fullOptions.preventEquip, bonusEquip = fullOptions.bonusEquip, onlySlot = fullOptions.onlySlot, preventSlot = fullOptions.preventSlot, forceUpdate = fullOptions.forceUpdate, objective = _toConsumableArray5(new Set([].concat(_toConsumableArray5(objectives.sort()), _toConsumableArray5(forceEquip.map(function(item15) {
    ...
    var _ref11 = _slicedToArray4(_ref10, 2), item15 = _ref11[0], bonus = _ref11[1];
  ...
  }).sort()), [have($effect(_templateObject502 || (_templateObject502 = _taggedTemplateLiteral2(["Offhand Remarkable"])))), options.updateOnLocationChange && (0, import_kolmafia6.myLocation)()]).join("; "), cacheEntry = checkCache(cacheKey, fullOptions);
...
_defineProperty5(ActionSource, "defaultPriceFunction", function(item15) {
  return getAcquirePrice(item15) > 0 ? getAcquirePrice(item15) : 1 / 0;
});
...
function installed() {
  return (0, import_kolmafia8.getWorkshed)() === $item(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral3(["Asdon Martin keyfob (on ring)"])));
}
function have2() {
...
function fillTo(targetUnits) {
  ...
  for (; (0, import_kolmafia8.getFuel)() < targetUnits; ) {
    ...
    else if ((0, import_kolmafia8.npcPrice)($item(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral3(["wad of dough"])))) === 0 && (0, import_kolmafia8.npcPrice)($item(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral3(["all-purpose flower"])))) > 0) {
    ...
    } else (0, import_kolmafia8.retrieveItem)(count, bestFuel);
...
var scrapbookChargesLastUpdated = get("_lastCombatStarted"), asdonMartinSource = new ActionSource($skill(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral4(["Asdon Martin: Spring-Loaded Front Bumper"]))), function() {
  ...
  }, Macro.skill($skill(_templateObject510 || (_templateObject510 = _taggedTemplateLiteral4(["Snokebomb"])))), {
    preparation: function() {
  ...
  new ActionSource($item(_templateObject134 || (_templateObject134 = _taggedTemplateLiteral4(["latte lovers member's mug"]))), function() {
    return have($item(_templateObject144 || (_templateObject144 = _taggedTemplateLiteral4(["latte lovers member's mug"])))) && !get("_latteBanishUsed") ? 1 : 0;
  }, Macro.skill($skill(_templateObject154 || (_templateObject154 = _taggedTemplateLiteral4(["Throw Latte on Opponent"])))), {
    equipmentRequirements: function() {
      return new Requirement([], {
        forceEquip: $items(_templateObject164 || (_templateObject164 = _taggedTemplateLiteral4(["latte lovers member's mug"])))
      });
    }
  }),
  ...
  new ActionSource($item(_templateObject303 || (_templateObject303 = _taggedTemplateLiteral4(["stinky cheese eye"]))), function() {
    return getFoldGroup($item(_templateObject314 || (_templateObject314 = _taggedTemplateLiteral4(["stinky cheese eye"])))).some(function(item15) {
      return have(item15);
  ...
  return new ActionSource(item15, function() {
    ...
    preparation: function() {
      return (0, import_kolmafia9.retrieveItem)(item15);
    },
    cost: function() {
...
var freeKillSources = [
  ...
  new ActionSource($skill(_templateObject415 || (_templateObject415 = _taggedTemplateLiteral5(["Shattering Punch"]))), function() {
    return have($skill(_templateObject511 || (_templateObject511 = _taggedTemplateLiteral5(["Shattering Punch"])))) ? 3 - get("_shatteringPunchUsed") : 0;
  ...
  new ActionSource($item(_templateObject105 || (_templateObject105 = _taggedTemplateLiteral5(["The Jokester's gun"]))), function() {
    ...
    equipmentRequirements: function() {
      return new Requirement([], {
        forceEquip: $items(_templateObject145 || (_templateObject145 = _taggedTemplateLiteral5(["The Jokester's gun"])))
      });
    }
  }),
  new ActionSource($item(_templateObject155 || (_templateObject155 = _taggedTemplateLiteral5(["Lil' Doctor\u2122 bag"]))), function() {
    return have($item(_templateObject165 || (_templateObject165 = _taggedTemplateLiteral5(["Lil' Doctor\u2122 bag"])))) ? 3 - get("_chestXRayUsed") : 0;
  }, Macro.skill($skill(_templateObject175 || (_templateObject175 = _taggedTemplateLiteral5(["Chest X-Ray"])))), {
    equipmentRequirements: function() {
      return new Requirement([], {
        forceEquip: $items(_templateObject185 || (_templateObject185 = _taggedTemplateLiteral5(["Lil' Doctor\u2122 bag"])))
      });
    }
  }),
...
var familiar = $familiar(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral6(["Frumious Bandersnatch"])));
function have3() {
...
var familiar2 = $familiar(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral7(["Pair of Stomping Boots"])));
function have4() {
...
var everythingLooksGreen = function() {
  ...
  return function() {
    return otherClause() && !have($effect(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral8(["Everything Looks Green"])))) ? 1 : 0;
  };
}, freeRunSources = [
  ...
  new ActionSource($item(_templateObject218 || (_templateObject218 = _taggedTemplateLiteral8(["spring shoes"]))), everythingLooksGreen(function() {
    ...
    equipmentRequirements: function() {
      return new Requirement([], {
        forceEquip: $items(_templateObject512 || (_templateObject512 = _taggedTemplateLiteral8(["spring shoes"])))
      });
    }
  }),
  // Free limited sources
  new ActionSource($familiar(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral8(["Frumious Bandersnatch"]))), function() {
  ...
  new ActionSource($item(_templateObject136 || (_templateObject136 = _taggedTemplateLiteral8(["navel ring of navel gazing"]))), function() {
    return have($item(_templateObject146 || (_templateObject146 = _taggedTemplateLiteral8(["navel ring of navel gazing"])))) ? Math.max(0, 3 - get("_navelRunaways")) : 0;
  }, Macro.step("runaway"), {
    equipmentRequirements: function() {
      return new Requirement([], {
        forceEquip: $items(_templateObject156 || (_templateObject156 = _taggedTemplateLiteral8(["navel ring of navel gazing"])))
      });
    }
  }),
  new ActionSource($item(_templateObject166 || (_templateObject166 = _taggedTemplateLiteral8(["Greatest American Pants"]))), function() {
    return have($item(_templateObject176 || (_templateObject176 = _taggedTemplateLiteral8(["Greatest American Pants"])))) ? Math.max(0, 3 - get("_navelRunaways")) : 0;
  }, Macro.step("runaway"), {
    equipmentRequirements: function() {
      return new Requirement([], {
        forceEquip: $items(_templateObject186 || (_templateObject186 = _taggedTemplateLiteral8(["Greatest American Pants"])))
      });
    }
  }),
...
var familiar3 = $familiar(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral9(["Comma Chameleon"])));
function have5() {
...
function transform(fam) {
  ...
  return !(equipment === $item.none || !have(equipment) || ((0, import_kolmafia14.visitUrl)("inv_equip.php?which=2&action=equip&whichitem=".concat((0, import_kolmafia14.toInt)(equipment), "&pwd")), (0, import_kolmafia14.visitUrl)("charpane.php"), currentFamiliar() !== fam));
}
...
var stickers = {
  unicorn: $item(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral10(["scratch 'n' sniff unicorn sticker"]))),
  ...
  dragon: $item(_templateObject513 || (_templateObject513 = _taggedTemplateLiteral10(["scratch 'n' sniff dragon sticker"]))),
...
function setStickers() {
  ...
  for (var start = currentStickers(), i = 0; i <= 2; i++) {
    ...
    if (sticker) {
      ...
      start[i] !== item15 && ((0, import_kolmafia15.visitUrl)("bedazzle.php?action=peel&slot=".concat(i + 1, "&pwd")), (0, import_kolmafia15.visitUrl)("bedazzle.php?action=stick&slot=".concat(i + 1, "&sticker=").concat(item15.id, "&pwd")));
    }
  }
  return currentStickers();
}
...
var sheet = $item(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral11(["Spooky Putty sheet"])));
function have7() {
...
var ridingFamiliars = [{
  familiar: $familiar(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral12(["Puck Man"]))),
  ...
  familiar: $familiar(_templateObject514 || (_templateObject514 = _taggedTemplateLiteral12(["Grimstone Golem"]))),
  ...
  familiar: $familiar(_templateObject710 || (_templateObject710 = _taggedTemplateLiteral12(["Knob Goblin Organ Grinder"]))),
  drops: 30,
  probability: 1
}, {
  ...
  drops: $items(_templateObject147 || (_templateObject147 = _taggedTemplateLiteral12(["hoarded candy wad"]))),
  probability: 0.5,
  dropPredicate: function() {
    return get("_hoardedCandyDropsCrown") < 3;
  }
}, {
  familiar: $familiar(_templateObject157 || (_templateObject157 = _taggedTemplateLiteral12(["Warbear Drone"]))),
  drops: $items(_templateObject167 || (_templateObject167 = _taggedTemplateLiteral12(["warbear whosit"]))),
  probability: 1 / 4.5
}, {
  familiar: $familiar(_templateObject177 || (_templateObject177 = _taggedTemplateLiteral12(["Li'l Xenomorph"]))),
  ...
  familiar: $familiar(_templateObject255 || (_templateObject255 = _taggedTemplateLiteral12(["Adventurous Spelunker"]))),
  ...
  drops: $items(_templateObject503 || (_templateObject503 = _taggedTemplateLiteral12(["candy cane, eggnog, fruitcake, gingerbread bugbear"]))),
  probability: 0.3
}, {
  familiar: $familiar(_templateObject515 || (_templateObject515 = _taggedTemplateLiteral12(["Stocking Mimic"]))),
  ...
  familiar: $familiar(_templateObject712 || (_templateObject712 = _taggedTemplateLiteral12(["Casagnova Gnome"]))),
  drops: 0,
  probability: 0
}, {
  ...
  familiar: $familiar(_templateObject792 || (_templateObject792 = _taggedTemplateLiteral12(["Obtuse Angel"]))),
  drops: 0,
  probability: 0
}, {
...
function validTeaPartyHat(item15, characters) {
  return (0, import_kolmafia18.toSlot)(item15) !== $slot(_templateObject321 || (_templateObject321 = _taggedTemplateLiteral13(["hat"]))) || !(0, import_kolmafia18.canEquip)(item15) ? !1 : characters <= 5 ? item15.nameLength <= 5 : characters >= 30 ? item15.nameLength >= 30 : characters === item15.nameLength;
}
...
function findTeaPartyHats(effect2) {
  ...
  if (!characters)
    throw new Error("Invalid Mad Tea Party effect ".concat(effect2));
  return import_kolmafia18.Item.all().filter(function(item15) {
...
function haveTeaPartyHat(effect2) {
  ...
  if (!characters)
    throw new Error("Invalid Mad Tea Party effect ".concat(effect2));
  return import_kolmafia18.Item.all().find(function(item15) {
...
function tryTeaPartyBuff(effect2) {
  ...
  if (!characters)
    throw new Error("Invalid Mad Tea Party effect ".concat(effect2));
  if (!haveTeaPartyHat(effect2) || (ensureEffect($effect(_templateObject420 || (_templateObject420 = _taggedTemplateLiteral13(["Down the Rabbit Hole"])))), !have($effect(_templateObject516 || (_templateObject516 = _taggedTemplateLiteral13(["Down the Rabbit Hole"]))))))
    return !1;
...
var bodyParts = {
  ...
  kgnee: $item(_templateObject517 || (_templateObject517 = _taggedTemplateLiteral16(["gnomish housemaid's kgnee"]))),
...
function get2(name, subject) {
  ...
  if (isMultiStringModifier(name))
    return subject === void 0 ? (0, import_kolmafia22.stringsModifier)(name) : (0, import_kolmafia22.stringsModifier)(subject, name);
}
...
function parseModifiers(pref) {
  ...
  return parseModifierString((0, import_kolmafia22.getProperty)(pref), parsers);
}
...
var ConspiracyQuest = /* @__PURE__ */ function() {
  ...
  forceEquip: [$item(_templateObject519 || (_templateObject519 = _taggedTemplateLiteral18(["gore bucket"])))]
  ...
  forceEquip: [$item(_templateObject713 || (_templateObject713 = _taggedTemplateLiteral18(["encrypted micro-cassette recorder"])))]
...
function hybridize() {
  ...
  var tonicPotion = getTonic(currentSyringe), expectedEffect = (0, import_kolmafia27.toEffect)((0, import_kolmafia27.stringModifier)(tonicPotion, "Effect"));
...
function installed3() {
  return (0, import_kolmafia32.getWorkshed)() === $item(_templateObject524 || (_templateObject524 = _taggedTemplateLiteral25(["portable Mayo Clinic"])));
}
function have20() {
...
var LOCATIONS = Object.freeze($locations(_templateObject150 || (_templateObject150 = _taggedTemplateLiteral26(["Gingerbread Civic Center, Gingerbread Train Station, Gingerbread Industrial Zone, Gingerbread Upscale Retail District, Gingerbread Sewers"]))));
function availableLocations() {
  return LOCATIONS.filter(function(l) {
    return (0, import_kolmafia33.canAdventure)(l);
  });
}
var NOONS = /* @__PURE__ */ new Map([[$location(_templateObject249 || (_templateObject249 = _taggedTemplateLiteral26(["Gingerbread Train Station"]))), 1204], [$location(_templateObject339 || (_templateObject339 = _taggedTemplateLiteral26(["Gingerbread Civic Center"]))), 1202], [$location(_templateObject438 || (_templateObject438 = _taggedTemplateLiteral26(["Gingerbread Industrial Zone"]))), 1206], [$location(_templateObject525 || (_templateObject525 = _taggedTemplateLiteral26(["Gingerbread Upscale Retail District"]))), 1208]]), MIDNIGHTS = /* @__PURE__ */ new Map([[$location(_templateObject620 || (_templateObject620 = _taggedTemplateLiteral26(["Gingerbread Train Station"]))), 1205], [$location(_templateObject718 || (_templateObject718 = _taggedTemplateLiteral26(["Gingerbread Civic Center"]))), 1203], [$location(_templateObject816 || (_templateObject816 = _taggedTemplateLiteral26(["Gingerbread Industrial Zone"]))), 1207], [$location(_templateObject914 || (_templateObject914 = _taggedTemplateLiteral26(["Gingerbread Upscale Retail District"]))), 1209]]);
...
var item = $item(_templateObject151 || (_templateObject151 = _taggedTemplateLiteral27(["Source terminal"])));
function have21() {
...
var Buffs = {
  ...
  Critical: $effect(_templateObject526 || (_templateObject526 = _taggedTemplateLiteral27(["critical.enh"]))),
  Damage: $effect(_templateObject621 || (_templateObject621 = _taggedTemplateLiteral27(["damage.enh"]))),
  Substats: $effect(_templateObject719 || (_templateObject719 = _taggedTemplateLiteral27(["substats.enh"])))
};
...
var Skills = {
  ...
  Duplicate: $skill(_templateObject1510 || (_templateObject1510 = _taggedTemplateLiteral27(["Duplicate"]))),
  /** Causes government agent/Source Agent wanderer next turn once per combat and three times per day */
  Portscan: $skill(_templateObject1610 || (_templateObject1610 = _taggedTemplateLiteral27(["Portscan"]))),
  /** Increase Max MP by 100% and recover 1000 MP once per combat with a 30 turn cooldown */
  Turbo: $skill(_templateObject1710 || (_templateObject1710 = _taggedTemplateLiteral27(["Turbo"])))
};
...
function isCurrentSkill(skills4) {
  var currentSkills = getSkills(), skillsArray = Array.isArray(skills4) ? skills4.slice(0, 2) : [skills4];
...
var item2 = $item(_templateObject160 || (_templateObject160 = _taggedTemplateLiteral28(["Witchess Set"])));
function have22() {
...
var pantogram = $item(_templateObject161 || (_templateObject161 = _taggedTemplateLiteral29(["portable pantogram"]))), pants = $item(_templateObject251 || (_templateObject251 = _taggedTemplateLiteral29(["pantogram pants"])));
function have24() {
...
var familiar6 = $familiar(_templateObject170 || (_templateObject170 = _taggedTemplateLiteral30(["Robortender"])));
function have25() {
...
var phylumDrops = /* @__PURE__ */ new Map([
  ...
  [$phylum(_templateObject528 || (_templateObject528 = _taggedTemplateLiteral30(["Demon"]))), $item(_templateObject625 || (_templateObject625 = _taggedTemplateLiteral30(["bottle of novelty hot sauce"])))],
  [$phylum(_templateObject721 || (_templateObject721 = _taggedTemplateLiteral30(["Elemental"]))), $item(_templateObject819 || (_templateObject819 = _taggedTemplateLiteral30(["elemental sugarcube"])))],
...
function hazardEquipment(hazards2) {
  var hazardEquipment2 = {
    "toxic atmosphere": $item(_templateObject171 || (_templateObject171 = _taggedTemplateLiteral31(["filter helmet"]))),
    ...
    "high winds": $item(_templateObject529 || (_templateObject529 = _taggedTemplateLiteral31(["high-friction boots"])))
  };
...
function getHazardEquipment() {
  ...
  return equipment.forEach(function(equip7) {
    var num = equip7.id - 9404;
  ...
  }), equipment.forEach(function(equip7) {
    if ((0, import_kolmafia40.availableAmount)(equip7) !== 1)
      return !1;
  }), !0;
}
...
function haveLovEnamorang() {
  return have($item(_templateObject180 || (_templateObject180 = _taggedTemplateLiteral32(["LOV Enamorang"]))));
}
...
// src/resources/2018/BoxingDaycare.ts
...
function daydream() {
  return canDaydream() ? (0, import_kolmafia42.cliExecute)("daycare item") : !1;
}
...
function visitSpa(target) {
  if (!canVisitSpa()) return !1;
  if (target instanceof import_kolmafia42.Stat) {
    var _command = target === import_kolmafia42.Stat.none ? "regen" : target.toString().toLowerCase().slice(0, 3);
    return (0, import_kolmafia42.cliExecute)("daycare ".concat(_command));
  }
  var targetString = target instanceof import_kolmafia42.Effect ? target.name : target, command = SPA_PACKAGE_COMMANDS[Object.entries(SPA_PACKAGES).findIndex(function(entry) {
    return entry.includes(targetString);
  })];
  return command ? (0, import_kolmafia42.cliExecute)("daycare ".concat(command)) : !1;
}
var visit = function() {
  return (0, import_kolmafia42.visitUrl)("place.php?whichplace=town_wrong&action=townwrong_boxingdaycare");
}, visitDaycare = function() {
  visit(), (0, import_kolmafia42.runChoice)(3);
};
function hireInstructor() {
  ...
  try {
    visitDaycare();
    var item15 = get("daycareInstructorItem"), quantity = get("daycareInstructorItemQuantity");
    if (!item15 || !quantity) return !1;
    var initial = get("daycareInstructors");
    return shouldHire(item15, quantity) ? ((0, import_kolmafia42.retrieveItem)(item15, quantity), (!(0, import_kolmafia42.handlingChoice)() || (0, import_kolmafia42.lastChoice)() !== 1336) && visitDaycare(), (0, import_kolmafia42.runChoice)(3), initial === get("daycareInstructors")) : !1;
  } finally {
    (0, import_kolmafia42.visitUrl)("main.php");
  }
}
function rerollInstructor() {
  ...
  try {
    ...
    return get("daycareInstructorItem") ? ((0, import_kolmafia42.runChoice)(7), initial === get("daycareInstructorItem")) : !1;
  } finally {
    (0, import_kolmafia42.visitUrl)("main.php");
  }
}
...
function recruit() {
  if (!have28() || (0, import_kolmafia42.myMeat)() < recruitCost()) return !1;
  var initial = get("daycareToddlers");
  return visitDaycare(), (0, import_kolmafia42.runChoice)(1), (0, import_kolmafia42.visitUrl)("main.php"), initial === get("daycareToddlers");
}
function scavenge() {
  return have28() ? (0, import_kolmafia42.cliExecute)("daycare scavenge") : !1;
}
...
var INGREDIENTS = {
  ...
  belgian: {
    ...
    location: $location(_templateObject530 || (_templateObject530 = _taggedTemplateLiteral33(["Whitey's Grove"])))
  },
  chalk: {
    modifier: {
      "Cold Damage": 25
  ...
  "bug-thistle": {
    ...
    location: $location(_templateObject724 || (_templateObject724 = _taggedTemplateLiteral33(["The Bugbear Pen"])))
  },
  butternut: {
    modifier: {
      "Spell Damage": 10
  ...
  cocoa: {
    ...
    location: $location(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral33(["The Icy Peak"])))
  },
  diet: {
    modifier: {
      Initiative: 50
    },
    location: $location(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral33(["The Cola Wars Battlefield"])))
  },
  dwarf: {
    modifier: {
      Muscle: 30
    },
    location: $location(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral33(["Itznotyerzitz Mine"])))
  },
  dyspepsi: {
    modifier: {
      Initiative: 25
    },
    location: $location(_templateObject1813 || (_templateObject1813 = _taggedTemplateLiteral33(["Cola Wars Battlefield (Dyspepsi Uniform)"])))
  },
  filth: {
    modifier: {
      "Damage Reduction": 20
  ...
  guarna: {
    ...
    location: $location(_templateObject2511 || (_templateObject2511 = _taggedTemplateLiteral33(["The Bat Hole Entrance"])))
  },
  gunpowder: {
    modifier: {
      "Weapon Damage": 50
  ...
  teeth: {
    ...
    location: $location(_templateObject505 || (_templateObject505 = _taggedTemplateLiteral33(["The VERY Unquiet Garves"])))
  },
  vitamin: {
    modifier: {
      "Familiar Experience": 3
    },
    location: $location(_templateObject5111 || (_templateObject5111 = _taggedTemplateLiteral33(["The Dark Elbow of the Woods"])))
  },
  flour: {
    modifier: {
      "Sleaze Resistance": 3
...
function fill() {
  ...
  }) ? !1 : (0, import_kolmafia44.cliExecute)("latte refill ".concat(ingredients.join(" ")));
}
...
function currentIngredients() {
  return (0, import_kolmafia44.getProperty)("latteIngredients").split(",");
}
...
var item3 = $item(_templateObject190 || (_templateObject190 = _taggedTemplateLiteral34(["SongBoom\u2122 BoomBox"])));
function have30() {
  return have(item3);
}
var keywords = {
...
function setSong(newSong) {
  if (song() !== newSong) {
    ...
    return (0, import_kolmafia45.cliExecute)("boombox ".concat(newSong ? keywords[newSong] : "none")), !0;
  } else
    return !1;
}
...
function have31() {
  return have(import_kolmafia46.Item.get("Beach Comb"));
}
function available3() {
  return have31() || have(import_kolmafia46.Item.get("driftwood beach comb"));
}
var headBuffs = [$effect(_templateObject191 || (_templateObject191 = _taggedTemplateLiteral35(["Hot-Headed"]))), $effect(_templateObject280 || (_templateObject280 = _taggedTemplateLiteral35(["Cold as Nice"]))), $effect(_templateObject351 || (_templateObject351 = _taggedTemplateLiteral35(["A Brush with Grossness"]))), $effect(_templateObject450 || (_templateObject450 = _taggedTemplateLiteral35(["Does It Have a Skull In There??"]))), $effect(_templateObject531 || (_templateObject531 = _taggedTemplateLiteral35(["Oiled, Slick"]))), $effect(_templateObject627 || (_templateObject627 = _taggedTemplateLiteral35(["Lack of Body-Building"]))), $effect(_templateObject725 || (_templateObject725 = _taggedTemplateLiteral35(["We're All Made of Starfish"]))), $effect(_templateObject821 || (_templateObject821 = _taggedTemplateLiteral35(["Pomp & Circumsands"]))), $effect(_templateObject919 || (_templateObject919 = _taggedTemplateLiteral35(["Resting Beach Face"]))), $effect(_templateObject1018 || (_templateObject1018 = _taggedTemplateLiteral35(["Do I Know You From Somewhere?"]))), $effect(_templateObject1117 || (_templateObject1117 = _taggedTemplateLiteral35(["You Learned Something Maybe!"])))], head = {
  ...
  SPOOKY: $effect(_templateObject1514 || (_templateObject1514 = _taggedTemplateLiteral35(["Does It Have a Skull In There??"]))),
  ...
  if (!(!available3() || !tiles.length)) {
    for (var _i = 0, _tiles = tiles; _i < _tiles.length; _i++) {
      ...
      if (canComb(tile)) {
        ...
        (0, import_kolmafia46.cliExecute)("beach wander ".concat(minute)), (0, import_kolmafia46.cliExecute)("beach comb ".concat(row, " ").concat(column));
      }
    }
    (0, import_kolmafia46.handlingChoice)() && (0, import_kolmafia46.runChoice)(5);
  }
}
function headAvailable(target) {
  var effect2 = target instanceof import_kolmafia46.Effect ? target : head[target], headNumber = 1 + headBuffs.indexOf(effect2);
  return (0, import_kolmafia46.getProperty)("beachHeadsUnlocked").split(",").includes(headNumber.toString()) && !(0, import_kolmafia46.getProperty)("_beachHeadsUsed").split(",").includes(headNumber.toString());
}
function tryHead(target) {
  var effect2 = target instanceof import_kolmafia46.Effect ? target : head[target];
  return !headBuffs.includes(effect2) || !headAvailable(target) ? !1 : ((0, import_kolmafia46.cliExecute)(effect2.default), have(effect2));
}
...
function gaze() {
  canGaze() && (0, import_kolmafia47.visitUrl)("place.php?whichplace=campaway&action=campaway_sky");
}
function getGazeBuff() {
  var daycountToCheck = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, import_kolmafia47.daycount)(), buffSign = signIdToName((daycountToCheck + (0, import_kolmafia47.myPath)().id) % 9 + 1), effectName = [];
  return buffSign === (0, import_kolmafia47.mySign)() && effectName.push("Big"), effectName.push("Smile of the", buffSign), import_kolmafia47.Effect.get(effectName.join(" "));
}
function blowSmoke(messages) {
  var times = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, smoke = $item(_templateObject200 || (_templateObject200 = _taggedTemplateLiteral36(["campfire smoke"])));
  (0, import_kolmafia47.retrieveItem)(smoke, times);
  for (var i = 0; i < times; i++)
    withChoice(1394, "1&message=".concat(random(messages)), function() {
      (0, import_kolmafia47.use)(smoke);
    });
}
...
var familiar7 = $familiar(_templateObject201 || (_templateObject201 = _taggedTemplateLiteral37(["Pocket Professor"])));
function have33() {
...
function totalAvailableLectures() {
  var weight = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : totalFamiliarWeight(familiar7), includeChip = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : (0, import_kolmafia48.haveEquipped)($item(_templateObject281 || (_templateObject281 = _taggedTemplateLiteral37(["Pocket Professor memory chip"]))));
...
function currentlyAvailableLectures() {
  var weight = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : totalFamiliarWeight(familiar7), includeChip = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : (0, import_kolmafia48.haveEquipped)($item(_templateObject359 || (_templateObject359 = _taggedTemplateLiteral37(["Pocket Professor memory chip"]))));
...
function have34() {
  return (0, import_kolmafia49.haveFamiliar)(familiar8);
}
function getTrackedPhylum() {
  return get("redSnapperPhylum");
}
function trackPhylum(phylum) {
  var currentFamiliar3 = (0, import_kolmafia49.myFamiliar)();
  try {
    (0, import_kolmafia49.useFamiliar)(familiar8), (0, import_kolmafia49.cliExecute)("snapper ".concat(phylum));
  } finally {
    (0, import_kolmafia49.useFamiliar)(currentFamiliar3);
  }
}
...
var passive = $skill(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral38(["Comprehensive Cartography"])));
function have35() {
  return have(passive);
}
function mapMonster(location, monster) {
  if (!have35() || get("_monstersMapped") >= 3 || !(0, import_kolmafia50.canAdventure)(location) || ((0, import_kolmafia50.useSkill)($skill(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral38(["Map the Monsters"])))), !get("mappingMonsters"))) return !1;
  for (var turns2 = (0, import_kolmafia50.myTurncount)(); (0, import_kolmafia50.currentRound)() < 1; ) {
    if ((0, import_kolmafia50.myTurncount)() > turns2)
      throw new Error("Map the Monsters unsuccessful?");
    if ((0, import_kolmafia50.visitUrl)((0, import_kolmafia50.toUrl)(location)), (0, import_kolmafia50.handlingChoice)() && (0, import_kolmafia50.lastChoice)() === 1435)
      return (0, import_kolmafia50.runChoice)(1, "heyscriptswhatsupwinkwink=".concat(monster.id)), !0;
    (0, import_kolmafia50.runChoice)(-1, !1);
  }
  return !1;
}
...
var item4 = $item(_templateObject299 || (_templateObject299 = _taggedTemplateLiteral39(["Guzzlr tablet"])));
function have36() {
  return have(item4);
}
function useTabletWithChoice(option) {
  withChoice(1412, option, function() {
    return (0, import_kolmafia51.use)(1, item4);
  });
}
...
function abandon() {
  return canAbandon() ? ((0, import_kolmafia51.visitUrl)("inventory.php?tap=guzzlr", !1), (0, import_kolmafia51.runChoice)(1), (0, import_kolmafia51.runChoice)(5), !0) : !1;
}
...
var Cocktails = $items(_templateObject2100 || (_templateObject2100 = _taggedTemplateLiteral39(["Buttery Boy, Steamboat, Ghiaccio Colada, Nog-on-the-Cob, Sourfinger"])));
function havePlatinumBooze() {
  return Cocktails.some(function(cock) {
    return (0, import_kolmafia51.itemAmount)(cock) > 0;
  });
}
function haveBooze() {
  var booze = getBooze();
...
function set2(hero, mode) {
  return have37() ? currentHero() === hero && currentMode() === mode ? !0 : ((0, import_kolmafia52.cliExecute)("retrocape ".concat(hero, " ").concat(mode)), currentHero() === hero && currentMode() === mode) : !1;
}
...
function have38() {
  return (0, import_kolmafia53.availableAmount)(orb) > 0;
}
...
var getLastPondered = function() {
  return "".concat((0, import_kolmafia53.myTotalTurnsSpent)(), ";").concat((0, import_kolmafia53.totalTurnsPlayed)(), ";").concat(get("lastAdventure"));
}, lastPondered = "";
function ponder() {
  return have38() ? (lastPondered !== getLastPondered() && (canVisitUrl() ? (logger_default.debug("Now pondering Crystal Ball."), (0, import_kolmafia53.visitUrl)("inventory.php?ponder=1", !1), lastPondered = getLastPondered()) : logger_default.debug("Failed to ponder Crystall Ball.")), getPrediction()) : /* @__PURE__ */ new Map();
}
...
var buffs = $effects(_templateObject2102 || (_templateObject2102 = _taggedTemplateLiteral41(["Spectacle Moustache, Toiletbrush Moustache, Barbell Moustache, Grizzly Beard, Surrealist's Moustache, Musician's Musician's Moustache, Gull-Wing Moustache, Space Warlord's Beard, Pointy Wizard Beard, Cowboy Stache, Friendly Chops"])));
function hasBuff() {
...
function buffCycle() {
  var playerclass = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, import_kolmafia54.myClass)(), cycle2 = tuple(import_kolmafia54.Effect.none, import_kolmafia54.Effect.none, import_kolmafia54.Effect.none, import_kolmafia54.Effect.none, import_kolmafia54.Effect.none, import_kolmafia54.Effect.none, import_kolmafia54.Effect.none, import_kolmafia54.Effect.none, import_kolmafia54.Effect.none, import_kolmafia54.Effect.none, import_kolmafia54.Effect.none);
...
function nextBuff() {
  var currentBuff = (0, import_kolmafia54.toEffect)(get("lastBeardBuff").toFixed(0)), cycle2 = buffCycle(), index = cycle2.indexOf(currentBuff), newIndex = (1 + index) % 11;
...
var item6 = import_kolmafia55.Item.get("autumn-aton");
function available4() {
  return (0, import_kolmafia55.availableAmount)(item6) > 0;
}
function have40() {
  return get("hasAutumnaton") || available4();
}
function checkLocations(html) {
  return (0, import_kolmafia55.xpath)(html, '//select[@name="heythereprogrammer"]//option[position()>1]/@value').map(function(id) {
    return (0, import_kolmafia55.toLocation)(Number(id));
  });
}
...
function sendTo(target) {
  ...
  upgrade2 && (0, import_kolmafia55.availableChoiceOptions)()[1] && (0, import_kolmafia55.runChoice)(1);
  var locationsAvailable = checkLocations(pageHtml), location = target instanceof import_kolmafia55.Location ? target : Array.isArray(target) ? target.find(function(l) {
    return validateLocation(locationsAvailable, l);
  }) : target(locationsAvailable);
  return !location || !validateLocation(locationsAvailable, location) ? null : ((0, import_kolmafia55.handlingChoice)() || directlyUse(item6), (0, import_kolmafia55.runChoice)(2, "heythereprogrammer=".concat(location.id)), (0, import_kolmafia55.handlingChoice)() && (0, import_kolmafia55.visitUrl)("main.php"), location);
}
function upgrade() {
  directlyUse(item6);
  var canUpgrade = (0, import_kolmafia55.availableChoiceOptions)()[1] !== void 0;
  return canUpgrade && (0, import_kolmafia55.runChoice)(1), (0, import_kolmafia55.visitUrl)("main.php"), canUpgrade;
}
function availableLocations2() {
  if (!available4()) return [];
  var pageHtml = directlyUse(item6);
  return (0, import_kolmafia55.visitUrl)("main.php"), checkLocations(pageHtml);
}
...
function turnsLeft() {
  return get("autumnatonQuestTurn") - (0, import_kolmafia55.totalTurnsPlayed)();
}
function legs() {
...
var difficulties = ["low", "mid", "high"], UNIQUES = {
  ...
  indoor: {
    ...
    mid: {
      index: 3,
      item: $item(_templateObject537 || (_templateObject537 = _taggedTemplateLiteral42(["autumn-spice donut"])))
    },
    high: {
      index: 7,
  ...
  underground: {
    low: {
      index: 1,
      item: $item(_templateObject728 || (_templateObject728 = _taggedTemplateLiteral42(["autumn sweater-weather sweater"])))
    },
    mid: {
      index: 5,
...
function monstersReminisced() {
  return parseLocketProperty().map(function(id) {
    return (0, import_kolmafia56.toMonster)(id);
  });
}
function reminisce(monster) {
  if (!have41() || reminiscesLeft() === 0 || !(0, import_kolmafia56.getLocketMonsters)()[monster.name])
    return !1;
  (0, import_kolmafia56.cliExecute)("reminisce ".concat(monster));
  for (var _len = arguments.length, combatParams = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++)
    combatParams[_key - 1] = arguments[_key];
  return import_kolmafia56.runCombat.apply(void 0, combatParams), monstersReminisced().includes(monster);
}
...
var item7 = $item(_templateObject379 || (_templateObject379 = _taggedTemplateLiteral44(["designer sweatpants"]))), skills2 = {
  SweatFlick: $skill(_templateObject2104 || (_templateObject2104 = _taggedTemplateLiteral44(["Sweat Flick"]))),
  SweatSpray: $skill(_templateObject380 || (_templateObject380 = _taggedTemplateLiteral44(["Sweat Spray"]))),
  SweatFlood: $skill(_templateObject459 || (_templateObject459 = _taggedTemplateLiteral44(["Sweat Flood"]))),
  SipSomeSweat: $skill(_templateObject538 || (_templateObject538 = _taggedTemplateLiteral44(["Sip Some Sweat"]))),
  SweatSip: $skill(_templateObject631 || (_templateObject631 = _taggedTemplateLiteral44(["Sweat Sip"]))),
  DrenchYourselfInSweat: $skill(_templateObject729 || (_templateObject729 = _taggedTemplateLiteral44(["Drench Yourself in Sweat"]))),
...
function have42() {
  return (0, import_kolmafia57.availableAmount)(item7) > 0;
}
function sweat() {
  return get("sweat");
}
...
function sweatCost(skill) {
  ...
  return (_sweatSkillCost$get = sweatSkillCost.get(skill)) !== null && _sweatSkillCost$get !== void 0 ? _sweatSkillCost$get : 1 / 0;
}
...
function useSkill3(skill) {
  ...
  var sweatAmt = sweat(), result = (0, import_kolmafia57.useSkill)(1, skill) && sweatAmt !== sweat();
  return result || refresh(), result;
}
...
var goose = $familiar(_templateObject381 || (_templateObject381 = _taggedTemplateLiteral45(["Grey Goose"])));
function have43() {
  return have(goose);
}
function currentExperience() {
  var postAscensionBaseExperience = have($familiar(_templateObject2105 || (_templateObject2105 = _taggedTemplateLiteral45(["Shorter-Order Cook"])))) && !get("gooseReprocessed") ? 81 + (have($item(_templateObject388 || (_templateObject388 = _taggedTemplateLiteral45(["blue plate"])))) ? 19 : 0) : 0;
...
function expectedExperience() {
  var weight = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : currentWeight();
  return Math.pow(Math.max(weight - 5, 0), (0, import_kolmafia58.myClass)().id === 27 ? 2 : 3);
}
...
function fightsUntil(target) {
  ...
  return diff <= 0 ? 0 : Math.ceil(diff / (1 + bonusExperience + (have($skill(_templateObject460 || (_templateObject460 = _taggedTemplateLiteral45(["Testudinal Teachings"])))) ? 1 / 6 : 0)));
}
...
function have44() {
  return (0, import_kolmafia59.availableAmount)(cleaver) > 0;
}
...
var item8 = $item(_templateObject389 || (_templateObject389 = _taggedTemplateLiteral46(["model train set"])));
function installed4() {
  return (0, import_kolmafia60.getWorkshed)() === item8;
}
function have45() {
...
}({}), trainsetEffects = /* @__PURE__ */ new Map([[Station.TOWER_FIZZY, import_kolmafia60.Effect.get("Carbonated")], [Station.TOWER_FROZEN, import_kolmafia60.Effect.get("Frozen")], [Station.SPOOKY_GRAVEYARD, import_kolmafia60.Effect.get("Shivering Spine")], [Station.TOWER_SEWAGE, import_kolmafia60.Effect.get("Hot Soupy Garbage")], [Station.OIL_BRIDGE, import_kolmafia60.Effect.get("Burningly Oiled")], [Station.OIL_REFINERY, import_kolmafia60.Effect.get("Spookily Greasy")], [Station.WATER_BRIDGE, import_kolmafia60.Effect.get("Troubled Waters")], [Station.PRAWN_SILO, import_kolmafia60.Effect.get("Craving Prawns")]]), trainsetEffectsDoubled = /* @__PURE__ */ new Map([[Station.TOWER_FIZZY, import_kolmafia60.Effect.get("Double Carbonated")], [Station.TOWER_FROZEN, import_kolmafia60.Effect.get("Double Frozen")], [Station.SPOOKY_GRAVEYARD, import_kolmafia60.Effect.get("Doubly Shivering Spine")], [Station.TOWER_SEWAGE, import_kolmafia60.Effect.get("Double Hot Soupy Garbage")], [Station.OIL_BRIDGE, import_kolmafia60.Effect.get("Doubly Burningly Oiled")], [Station.OIL_REFINERY, import_kolmafia60.Effect.get("Doubly Spookily Greasy")], [Station.WATER_BRIDGE, import_kolmafia60.Effect.get("Doubly Troubled Waters")], [Station.PRAWN_SILO, import_kolmafia60.Effect.get("Doubly Craving Prawns")]]);
...
function setConfiguration(configuration) {
  ...
  (0, import_kolmafia60.visitUrl)("campground.php?action=workshed"), (0, import_kolmafia60.runChoice)(1, "forceoption=0".concat(configuration.map(function(station, index) {
    return "&slot[".concat(index, "]=").concat(stationToInt(station));
  }).join(""))), (0, import_kolmafia60.visitUrl)("main.php");
...
function have46() {
  return have($item(_templateObject390 || (_templateObject390 = _taggedTemplateLiteral47(["tiny stillsuit"]))));
}
function distillateAdventures() {
  if (!have46()) return 0;
  var sweat2 = get("familiarSweat");
  return Math.round(sweat2 ** 0.4);
}
function drinkDistillate() {
  return !have46() || get("familiarSweat") <= 0 ? !1 : (0, import_kolmafia61.cliExecute)("drink stillsuit distillate");
}
var distillateModifiers = function(pref) {
  return parseModifiers(pref);
};
function nextDistillateModifiers() {
  return (0, import_kolmafia61.visitUrl)("inventory.php?action=distill&pwd"), distillateModifiers("nextDistillateMods");
}
function currentDistillateModifiers() {
  return distillateModifiers("currentDistillateMods");
}
function distillateModifier(modifier) {
  (0, import_kolmafia61.visitUrl)("inventory.php?action=distill&pwd");
  var value = (0, import_kolmafia61.splitModifiers)(get("currentDistillateMods"))[modifier];
...
function bestFamiliar(modifier) {
  return maxBy(import_kolmafia61.Familiar.all().filter(have), function(familiar10) {
...
var item9 = $item(_templateObject398 || (_templateObject398 = _taggedTemplateLiteral49(["A Guide to Burning Leaves"]))), burnFor = /* @__PURE__ */ new Map([[$monster(_templateObject2107 || (_templateObject2107 = _taggedTemplateLiteral49(["flaming leaflet"]))), 11], [$item(_templateObject399 || (_templateObject399 = _taggedTemplateLiteral49(["autumnic bomb"]))), 37], [$item(_templateObject461 || (_templateObject461 = _taggedTemplateLiteral49(["impromptu torch"]))), 42], [$item(_templateObject539 || (_templateObject539 = _taggedTemplateLiteral49(["flaming fig leaf"]))), 43], [$item(_templateObject634 || (_templateObject634 = _taggedTemplateLiteral49(["smoldering drape"]))), 44], [$item(_templateObject730 || (_templateObject730 = _taggedTemplateLiteral49(["distilled resin"]))), 50], [$item(_templateObject827 || (_templateObject827 = _taggedTemplateLiteral49(["autumnal aegis"]))), 66], [$item(_templateObject924 || (_templateObject924 = _taggedTemplateLiteral49(["lit leaf lasso"]))), 69], [$item(_templateObject1020 || (_templateObject1020 = _taggedTemplateLiteral49(["forest canopy bed"]))), 74], [$item(_templateObject1119 || (_templateObject1119 = _taggedTemplateLiteral49(["autumnic balm"]))), 99], [$monster(_templateObject1218 || (_templateObject1218 = _taggedTemplateLiteral49(["flaming monstera"]))), 111], [$item(_templateObject1317 || (_templateObject1317 = _taggedTemplateLiteral49(["day shortener"]))), 222], [$monster(_templateObject1415 || (_templateObject1415 = _taggedTemplateLiteral49(["leaviathan"]))), 666], [$item(_templateObject1515 || (_templateObject1515 = _taggedTemplateLiteral49(["coping juice"]))), 1111], [$item(_templateObject1615 || (_templateObject1615 = _taggedTemplateLiteral49(["smoldering leafcutter ant egg"]))), 6666], [$item(_templateObject1715 || (_templateObject1715 = _taggedTemplateLiteral49(["super-heated leaf"]))), 11111]]);
function have48() {
  return haveInCampground(item9);
}
function numberOfLeaves() {
  return (0, import_kolmafia63.itemAmount)($item(_templateObject1815 || (_templateObject1815 = _taggedTemplateLiteral49(["inflammable leaf"]))));
}
function burnSpecialLeaves(leaves) {
  var lea = burnFor.get(leaves);
  return lea === void 0 || lea > numberOfLeaves() ? !1 : (0, import_kolmafia63.cliExecute)("leaves ".concat(leaves));
}
function burnLeaves(leaves) {
  return leaves > numberOfLeaves() ? !1 : (0, import_kolmafia63.cliExecute)("leaves ".concat(leaves));
}
function visitLeaves() {
  (0, import_kolmafia63.cliExecute)("leaves");
}
function jumpInFire() {
  return get("_leavesJumped") || get("_leavesBurned") === 0 ? !1 : (visitLeaves(), (0, import_kolmafia63.runChoice)(2), get("_leavesJumped"));
}
...
var cincho = $item(_templateObject400 || (_templateObject400 = _taggedTemplateLiteral50(["Cincho de Mayo"])));
function have49() {
  return have(cincho);
}
...
function totalAvailableCinch() {
  var remainingRests = Math.max(0, (0, import_kolmafia64.totalFreeRests)() - get("timesRested"));
...
var skills3 = {
  ...
  FiestaExit: $skill(_templateObject466 || (_templateObject466 = _taggedTemplateLiteral50(["Cincho: Fiesta Exit"]))),
  ProjectilePi\u00F1ata: $skill(_templateObject540 || (_templateObject540 = _taggedTemplateLiteral50(["Cincho: Projectile Pi\xF1ata"]))),
  PartyFoul: $skill(_templateObject635 || (_templateObject635 = _taggedTemplateLiteral50(["Cincho: Party Foul"]))),
  ConfettiExtrava: $skill(_templateObject731 || (_templateObject731 = _taggedTemplateLiteral50(["Cincho: Confetti Extravaganza"])))
};
...
var item10 = $item(_templateObject401 || (_templateObject401 = _taggedTemplateLiteral51(["closed-circuit pay phone"])));
function have50() {
  return have(item10);
}
function rufusTarget() {
  ...
  switch (get("rufusQuestType")) {
    case "entity":
      return import_kolmafia65.Monster.get(target);
    case "artifact":
    case "items":
      return import_kolmafia65.Item.get(target);
    default:
      return null;
  }
}
var INGRESS_RIFTS = {
  ...
  mclargehuge: $location(_templateObject467 || (_templateObject467 = _taggedTemplateLiteral51(["Shadow Rift (Mt. McLargeHuge)"]))),
  beanstalk: $location(_templateObject541 || (_templateObject541 = _taggedTemplateLiteral51(["Shadow Rift (Somewhere Over the Beanstalk)"]))),
  manor3: $location(_templateObject636 || (_templateObject636 = _taggedTemplateLiteral51(["Shadow Rift (Spookyraven Manor Third Floor)"]))),
  "8bit": $location(_templateObject734 || (_templateObject734 = _taggedTemplateLiteral51(["Shadow Rift (The 8-Bit Realm)"]))),
  ...
  woods: $location(_templateObject1021 || (_templateObject1021 = _taggedTemplateLiteral51(["Shadow Rift (The Distant Woods)"]))),
  hiddencity: $location(_templateObject1120 || (_templateObject1120 = _taggedTemplateLiteral51(["Shadow Rift (The Hidden City)"]))),
  cemetery: $location(_templateObject1219 || (_templateObject1219 = _taggedTemplateLiteral51(["Shadow Rift (The Misspelled Cemetary)"]))),
  plains: $location(_templateObject1318 || (_templateObject1318 = _taggedTemplateLiteral51(["Shadow Rift (The Nearby Plains)"]))),
  town_right: $location(_templateObject1416 || (_templateObject1416 = _taggedTemplateLiteral51(["Shadow Rift (The Right Side of the Tracks)"])))
};
...
function chooseRift(options) {
  var filterFunction = function(l) {
    var _options$monsters, _options$drops, _options$otherFilter, _options$otherFilter2, monsters = (0, import_kolmafia65.getMonsters)(l);
    return options.canAdventure && !(0, import_kolmafia65.canAdventure)(l) || (_options$monsters = options.monsters) !== null && _options$monsters !== void 0 && _options$monsters.some(function(m) {
      ...
      return !monsters.some(function(m) {
        return i.name in (0, import_kolmafia65.itemDrops)(m);
      });
...
function chooseQuest(chooser) {
  return get("questRufus") !== "unstarted" || !have50() ? !1 : (withChoice(1497, "", function() {
    var _get2, _get22, _get3;
    directlyUse(item10), (0, import_kolmafia65.runChoice)(chooser({
      artifact: (_get2 = get("rufusDesiredArtifact")) !== null && _get2 !== void 0 ? _get2 : $item.none,
      entity: (_get22 = get("rufusDesiredEntity")) !== null && _get22 !== void 0 ? _get22 : $monster.none,
      items: (_get3 = get("rufusDesiredItems")) !== null && _get3 !== void 0 ? _get3 : $item.none
    }));
...
function submitQuest() {
  return questStep("questRufus") === 1 ? (withChoice(1498, 1, function() {
    return (0, import_kolmafia65.use)(item10);
...
var item11 = $item(_templateObject408 || (_templateObject408 = _taggedTemplateLiteral52(["cursed monkey's paw"])));
function have51() {
  return have(item11);
}
function wishes() {
...
function wishableItems() {
  ...
  return new Set(import_kolmafia66.Location.all().filter(function(l) {
    var _filters$location, _filters$location2;
    return (0, import_kolmafia66.canAdventure)(l) && ((_filters$location = (_filters$location2 = filters.location) === null || _filters$location2 === void 0 ? void 0 : _filters$location2.call(filters, l)) !== null && _filters$location !== void 0 ? _filters$location : !0);
  }).flatMap(function(l) {
    return (0, import_kolmafia66.getMonsters)(l).filter(function(m) {
      ...
      return (0, import_kolmafia66.itemDropsArray)(m).filter(function(_ref) {
...
function unwishableEffects() {
  var names = import_kolmafia66.Effect.all().filter(function(e) {
  ...
  return names.filter(function(_ref3) {
    ...
    var name = _ref5.name;
    return (0, import_kolmafia66.toEffect)(name);
  });
}
...
function isWishable(wish) {
  return wish instanceof import_kolmafia66.Item ? wishableItems().has(wish) : wish.attributes.includes("nohookah") ? !1 : wish.name.match(/[.,']/) ? !getUnwishableEffects().includes(wish) : !0;
}
function wishFor(wish) {
  if (wishes() <= 0) return !1;
  if (wish instanceof import_kolmafia66.Effect) return (0, import_kolmafia66.monkeyPaw)(wish);
  var locations = import_kolmafia66.Location.all().filter(function(l) {
    return (0, import_kolmafia66.canAdventure)(l) && (0, import_kolmafia66.getMonsters)(l).some(function(m) {
      return m.copyable && (0, import_kolmafia66.itemDropsArray)(m).some(function(_ref6) {
        var drop = _ref6.drop;
        return drop === wish;
      });
    });
  ...
  try {
    locations.length && ((0, import_kolmafia66.cliExecute)("checkpoint"), (0, import_kolmafia66.prepareForAdventure)(locations[0]));
    var result = (0, import_kolmafia66.monkeyPaw)(wish);
    ...
    locations.length && (0, import_kolmafia66.cliExecute)("outfit checkpoint");
  }
}
...
var helmet2 = $item(_templateObject409 || (_templateObject409 = _taggedTemplateLiteral53(["Apriling band helmet"])));
function have52() {
  return have(helmet2);
}
var MARCHING_SONGS = Object.freeze(["Apriling Band Patrol Beat", "Apriling Band Battle Cadence", "Apriling Band Celebration Bop"]), MARCHING_SONG_EFFECTS = Object.freeze(MARCHING_SONGS.map(function(song2) {
  return (0, import_kolmafia67.toEffect)(song2);
  ...
  return (0, import_kolmafia67.toItem)(instrument);
})), visitConduct = function() {
  return (0, import_kolmafia67.visitUrl)("inventory.php?pwd&action=apriling");
};
...
var joinSection = makeConductFunction(import_kolmafia67.Item, canJoinSection, INSTRUMENTS, 4);
function canChangeSong() {
  return have52() && get("nextAprilBandTurn") <= (0, import_kolmafia67.totalTurnsPlayed)();
}
var changeSong = makeConductFunction(import_kolmafia67.Effect, canChangeSong, MARCHING_SONGS, 1);
function conduct(result) {
  return result instanceof import_kolmafia67.Item || arrayContains(result, INSTRUMENTS) ? joinSection(result) : changeSong(result);
}
function play(instrument) {
  var acquire = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, item15 = instrument instanceof import_kolmafia67.Item ? instrument : import_kolmafia67.Item.get(instrument);
  if (!canPlay(instrument, acquire)) return !1;
  acquire && !have(item15) && joinSection(item15);
  var currentUsesRemaining = item15.dailyusesleft;
  return (0, import_kolmafia67.visitUrl)("inventory.php?pwd=".concat((0, import_kolmafia67.myHash)(), "&iid=").concat(item15.id, "&action=aprilplay"), !1), item15.dailyusesleft !== currentUsesRemaining;
}
function canPlay(instrument) {
  var acquire = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
  if (!have52()) return !1;
  var item15 = instrument instanceof import_kolmafia67.Item ? instrument : import_kolmafia67.Item.get(instrument);
  return !(!have(item15) && (!acquire || !canJoinSection()) || item15.dailyusesleft <= 0);
}
...
var familiar9 = $familiar(_templateObject468 || (_templateObject468 = _taggedTemplateLiteral54(["Chest Mimic"])));
function have53() {
...
function differentiate(monster) {
  ...
  if (!monsters.includes(monster))
    return (0, import_kolmafia68.visitUrl)("main.php"), !1;
  (0, import_kolmafia68.runChoice)(1, "mid=".concat(monster.id));
  for (var _len = arguments.length, combatParams = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++)
    combatParams[_key - 1] = arguments[_key];
  return import_kolmafia68.runCombat.apply(void 0, combatParams), !0;
}
function eggMonsters() {
  return new Map(multiSplit("mimicEggMonsters", ",", ":", [import_kolmafia68.toMonster, Number]));
}
function differentiableQuantity(monster) {
  var _eggMonsters$get;
  return have($item(_templateObject469 || (_templateObject469 = _taggedTemplateLiteral54(["mimic egg"])))) && (_eggMonsters$get = eggMonsters().get(monster)) !== null && _eggMonsters$get !== void 0 ? _eggMonsters$get : 0;
}
...
function have54() {
  return have($item(_templateObject470 || (_templateObject470 = _taggedTemplateLiteral55(["Mayam Calendar"]))));
}
...
var RESONANCES = Object.freeze({
  ...
  "sword yam2 eyepatch explosion": $item(_templateObject544 || (_templateObject544 = _taggedTemplateLiteral55(["yam cannon"]))),
  "fur lightning eyepatch yam4": $item(_templateObject637 || (_templateObject637 = _taggedTemplateLiteral55(["tiny yam cannon"]))),
  "yam1 lightning yam3 clock": $item(_templateObject735 || (_templateObject735 = _taggedTemplateLiteral55(["yam battery"]))),
  ...
  "yam1 meat eyepatch yam4": $item(_templateObject1022 || (_templateObject1022 = _taggedTemplateLiteral55(["yamtility belt"]))),
  "chair yam2 yam3 clock": $effect(_templateObject1121 || (_templateObject1121 = _taggedTemplateLiteral55(["Caught Yam-Handed"]))),
  "yam1 yam2 cheese clock": $effect(_templateObject1220 || (_templateObject1220 = _taggedTemplateLiteral55(["Memories of Cheesier Age"])))
...
var item12 = $item(_templateObject476 || (_templateObject476 = _taggedTemplateLiteral56(["tearaway pants"])));
function have55() {
  return have(item12);
}
...
function unlockGuild() {
  ...
  if (!have55()) return !1;
  try {
    (0, import_kolmafia70.cliExecute)("checkpoint"), (0, import_kolmafia70.equip)($slot(_templateObject3104 || (_templateObject3104 = _taggedTemplateLiteral56(["pants"]))), item12), (0, import_kolmafia70.visitUrl)("guild.php?place=challenge");
  } finally {
    (0, import_kolmafia70.cliExecute)("outfit checkpoint");
  }
...
function cauldronsRemaining() {
  return have56() ? $skill(_templateObject478 || (_templateObject478 = _taggedTemplateLiteral57(["Summon Cauldron of Bats"]))).dailylimit : 0;
}
function flapChance() {
...
function jumpBridge() {
  ...
  if (get("chasmBridgeProgress") === 30 || questStep("questL09Topping") >= 1)
    return !0;
  var back = (0, import_kolmafia71.equippedItem)($slot(_templateObject545 || (_templateObject545 = _taggedTemplateLiteral57(["back"]))));
  return (0, import_kolmafia71.equip)($item(_templateObject638 || (_templateObject638 = _taggedTemplateLiteral57(["bat wings"])))), (0, import_kolmafia71.visitUrl)("place.php?whichplace=orc_chasm&action=bridge_jump"), (0, import_kolmafia71.visitUrl)("place.php?whichplace=highlands&action=highlands_dude"), (0, import_kolmafia71.equip)(back), questStep("questL09Topping") >= 2;
}
...
var item13 = $item(_templateObject479 || (_templateObject479 = _taggedTemplateLiteral58(["Everfull Dart Holster"])));
function have57() {
  return have(item13);
}
...
var item14 = $item(_templateObject480 || (_templateObject480 = _taggedTemplateLiteral59(["TakerSpace letter of Marque"])));
function installed5() {
  return (0, import_kolmafia72.getWorkshed)() === item14;
}
function have58() {
  return installed5() || have(item14);
}
var RESOURCES = ["Spice", "Rum", "Anchor", "Mast", "Silk", "Gold"], RECIPES = /* @__PURE__ */ new Map([[$item(_templateObject2122 || (_templateObject2122 = _taggedTemplateLiteral59(["deft pirate hook"]))), [0, 0, 1, 1, 0, 1]], [$item(_templateObject3106 || (_templateObject3106 = _taggedTemplateLiteral59(["iron tricorn hat"]))), [0, 0, 2, 1, 0, 0]], [$item(_templateObject481 || (_templateObject481 = _taggedTemplateLiteral59(["jolly roger flag"]))), [0, 1, 0, 1, 1, 0]], [$item(_templateObject546 || (_templateObject546 = _taggedTemplateLiteral59(["sleeping profane parrot"]))), [15, 3, 0, 0, 2, 1]], [$item(_templateObject639 || (_templateObject639 = _taggedTemplateLiteral59(["pirrrate's currrse"]))), [2, 2, 0, 0, 0, 0]], [$item(_templateObject736 || (_templateObject736 = _taggedTemplateLiteral59(["tankard of spiced rum"]))), [1, 2, 0, 0, 0, 0]], [$item(_templateObject830 || (_templateObject830 = _taggedTemplateLiteral59(["packaged luxury garment"]))), [0, 0, 0, 0, 3, 2]], [$item(_templateObject927 || (_templateObject927 = _taggedTemplateLiteral59(["harpoon"]))), [0, 0, 0, 2, 0, 0]], [$item(_templateObject1023 || (_templateObject1023 = _taggedTemplateLiteral59(["chili powder cutlass"]))), [5, 0, 1, 0, 0, 0]], [$item(_templateObject1122 || (_templateObject1122 = _taggedTemplateLiteral59(["cursed Aztec tamale"]))), [2, 0, 0, 0, 0, 0]], [$item(_templateObject1221 || (_templateObject1221 = _taggedTemplateLiteral59(["jolly roger tattoo kit"]))), [0, 6, 1, 1, 0, 6]], [$item(_templateObject1319 || (_templateObject1319 = _taggedTemplateLiteral59(["golden pet rock"]))), [0, 0, 0, 0, 0, 7]], [$item(_templateObject1417 || (_templateObject1417 = _taggedTemplateLiteral59(["groggles"]))), [0, 6, 0, 0, 0, 0]], [$item(_templateObject1516 || (_templateObject1516 = _taggedTemplateLiteral59(["pirate dinghy"]))), [0, 0, 1, 1, 1, 0]], [$item(_templateObject1616 || (_templateObject1616 = _taggedTemplateLiteral59(["anchor bomb"]))), [0, 1, 3, 1, 0, 1]], [$item(_templateObject1716 || (_templateObject1716 = _taggedTemplateLiteral59(["silky pirate drawers"]))), [0, 0, 0, 0, 2, 0]], [$item(_templateObject1816 || (_templateObject1816 = _taggedTemplateLiteral59(["spices"]))), [1, 0, 0, 0, 0, 0]]]);
function allRecipes() {
...
function collect() {
  return !installed5() || get("_takerSpaceSuppliesDelivered") ? !1 : ((0, import_kolmafia72.visitUrl)("campground.php?action=workshed", !1), get("_takerSpaceSuppliesDelivered"));
}
...
function haveEnoughFor(item15) {
  var amount2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, recipe = recipeFor(item15);
...
function make(item15) {
  var amount2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1;
  return canMake(item15, amount2) && (0, import_kolmafia72.create)(item15, amount2);
}

// src/resources/2025/CrepeParachute.ts
...
function have59() {
  return have($item(_templateObject486 || (_templateObject486 = _taggedTemplateLiteral60(["crepe paper parachute cape"]))));
}
var visitParachute = function() {
  return (0, import_kolmafia73.visitUrl)("inventory.php?action=parachute&pwd");
};
function checkMonsters(html) {
  return (0, import_kolmafia73.xpath)(html, "//select[@name='monid']//option[position()>1]/@value").map(function(id) {
    return (0, import_kolmafia73.toMonster)(Number(id));
  });
}
...
function fight(target) {
  ...
  (!(0, import_kolmafia73.handlingChoice)() || (0, import_kolmafia73.lastChoice)() !== 1543) && visitParachute(), (0, import_kolmafia73.runChoice)(1, "monid=".concat(monster.id));
  for (var _len = arguments.length, combatParams = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++)
    combatParams[_key - 1] = arguments[_key];
  return import_kolmafia73.runCombat.apply(void 0, combatParams), !0;
}

// src/resources/2025/ToyCupidBow.ts
...
function have60() {
  return have($item(_templateObject487 || (_templateObject487 = _taggedTemplateLiteral61(["toy Cupid bow"]))));
}
...
function turnsLeft2() {
  ...
  return familiarsToday().includes(familiar10) ? 1 / 0 : currentFamiliar2() !== familiar10 ? 5 : clamp(5 - get("cupidBowFights"), 1, 5);
}

// src/resources/2025/Leprecondo.ts
...
function have61() {
  return have($item(_templateObject488 || (_templateObject488 = _taggedTemplateLiteral62(["Leprecondo"]))));
}
var NEEDS = Object.freeze(["exercise", "mental stimulation", "dumb entertainment", "food", "booze", "sleep"]), FURNITURE_PIECES = Object.freeze(["empty", "buckets of concrete", "thrift store oil painting", "boxes of old comic books", "second-hand hot plate", "beer cooler", "free mattress", "gigantic chess set", "UltraDance karaoke machine", "cupcake treadmill", "beer pong table", "padded weight bench", "internet-connected laptop", "sous vide laboratory", "programmable blender", "sensory deprivation tank", "fruit-smashing robot", "ManCave\u2122 sports bar set", "couch and flatscreen", "kegerator", "fine upholstered dining set", "whiskeybed", "high-end home workout system", "complete classics library", "ultimate retro game console", "Omnipot", "fully-stocked wet bar", "four-poster bed"]), Furniture = Object.freeze({
  ...
  "beer pong table": {
    ...
    exercise: $item(_templateObject489 || (_templateObject489 = _taggedTemplateLiteral62(["table tennis ball"])))
  },
  "boxes of old comic books": {
    "dumb entertainment": {
      effect: $effect(_templateObject547 || (_templateObject547 = _taggedTemplateLiteral62(["Wasting Time"]))),
      duration: 10
    }
  },
  "buckets of concrete": {
  ...
  "complete classics library": {
    "mental stimulation": $item(_templateObject737 || (_templateObject737 = _taggedTemplateLiteral62(["leprechaun antidepressant pill"])))
  },
  ...
  "cupcake treadmill": {
    exercise: {
      effect: $effect(_templateObject1024 || (_templateObject1024 = _taggedTemplateLiteral62(["Your Days Are Numbed"]))),
      duration: 10
    },
    food: $item(_templateObject1123 || (_templateObject1123 = _taggedTemplateLiteral62(["standard-issue cupcake"])))
  },
  "fine upholstered dining set": {
    food: $items(_templateObject1222 || (_templateObject1222 = _taggedTemplateLiteral62(["boring spaghetti, delicious noodles, goat cheese pizza, sausage pizza, spicy bean burrito, spicy noodles"]))),
    sleep: {
      effect: $effect(_templateObject1320 || (_templateObject1320 = _taggedTemplateLiteral62(["Sur La Table"]))),
      duration: 10
    }
  },
  empty: {},
  "four-poster bed": {
    sleep: {
      effect: $effect(_templateObject1418 || (_templateObject1418 = _taggedTemplateLiteral62(["Spacious Night's Sleep"]))),
      duration: 10
    }
  },
  "free mattress": {
    sleep: {
      effect: $effect(_templateObject1517 || (_templateObject1517 = _taggedTemplateLiteral62(["Good Night's Sleep"]))),
      duration: 10
    }
  },
  "fruit-smashing robot": {
    "dumb entertainment": {
      effect: $effect(_templateObject1617 || (_templateObject1617 = _taggedTemplateLiteral62(["You Might Have Gotten Wet"]))),
      duration: 10
    },
    food: $items(_templateObject1717 || (_templateObject1717 = _taggedTemplateLiteral62(["cherry, cranberries, grapefruit, grapes, kiwi, kumquat, lemon, lime, orange, papaya, raspberry, strawberry, tangerine"])))
  },
  "fully-stocked wet bar": {
    booze: $items(_templateObject1817 || (_templateObject1817 = _taggedTemplateLiteral62(["Divine sidecar, prussian cathouse sidecar, tangarita sidecar"])))
  },
  "gigantic chess set": {
    exercise: {
      effect: $effect(_templateObject1914 || (_templateObject1914 = _taggedTemplateLiteral62(["Work Out Smarter, Not Harder"]))),
      duration: 10
    },
    "mental stimulation": {
  ...
  "internet-connected laptop": {
    "dumb entertainment": {
      effect: $effect(_templateObject2216 || (_templateObject2216 = _taggedTemplateLiteral62(["Wasting Time"]))),
      duration: 10
    },
    "mental stimulation": $item(_templateObject2315 || (_templateObject2315 = _taggedTemplateLiteral62(["crafting plans"])))
  },
  kegerator: {
    booze: $item(_templateObject2414 || (_templateObject2414 = _taggedTemplateLiteral62(["pint of Leprechaun Stout"]))),
    food: $items(_templateObject2512 || (_templateObject2512 = _taggedTemplateLiteral62(["bean burrito, plain pizza, spicy mushroom quesadilla, tofu casserole, Trollhouse cookies"])))
  },
  "ManCave\u2122 sports bar set": {
    booze: $items(_templateObject2612 || (_templateObject2612 = _taggedTemplateLiteral62(["melted Jell-o shot, shot of blackberry schnapps, shot of nepenthe schnapps, shot of peach schnapps, shot of pear schnapps, shot of rotgut"]))),
    "dumb entertainment": $item(_templateObject2712 || (_templateObject2712 = _taggedTemplateLiteral62(["bar dart"])))
  },
  Omnipot: {
    food: $items(_templateObject2810 || (_templateObject2810 = _taggedTemplateLiteral62(["Heck ramen, incredible mini-pizza, small beer brat, tiny burrito, tiny peach pie, savoy truffle, white chocolate chip brownies"])))
  },
  "padded weight bench": {
    exercise: {
      effect: $effect(_templateObject2910 || (_templateObject2910 = _taggedTemplateLiteral62(["Gym Bros"]))),
      duration: 10
    },
    sleep: {
      effect: $effect(_templateObject3010 || (_templateObject3010 = _taggedTemplateLiteral62(["Tired Muscles"]))),
      duration: 10
    }
  },
  "programmable blender": {
    booze: $items(_templateObject3114 || (_templateObject3114 = _taggedTemplateLiteral62(["eggnog, extra-spicy bloody mary, grog, white lightning"]))),
    "mental stimulation": {
      effect: $effect(_templateObject3213 || (_templateObject3213 = _taggedTemplateLiteral62(["Counter Intelligence"]))),
      duration: 10
    }
  },
  "second-hand hot plate": {
    food: $items(_templateObject3312 || (_templateObject3312 = _taggedTemplateLiteral62(["bean burrito, chorizo taco, plain pizza, spicy mushroom quesadilla, tofu casserole, Trollhouse cookies"])))
  },
  "sensory deprivation tank": {
    "mental stimulation": {
      effect: $effect(_templateObject3411 || (_templateObject3411 = _taggedTemplateLiteral62(["Alone with Your Thoughts"]))),
      duration: 10
    },
    sleep: {
      effect: $effect(_templateObject3510 || (_templateObject3510 = _taggedTemplateLiteral62(["Quiet Night's Sleep"]))),
      duration: 10
    }
  },
  "sous vide laboratory": {
    food: $items(_templateObject3610 || (_templateObject3610 = _taggedTemplateLiteral62(["tiny burrito, black forest ham, fishy fish, ham steak, Knoll stir-fry, spooky stir-fry"]))),
    "mental stimulation": {
      effect: $effect(_templateObject3710 || (_templateObject3710 = _taggedTemplateLiteral62(["Counter Intelligence"]))),
      duration: 10
    }
  },
  "thrift store oil painting": {
    "mental stimulation": {
      effect: $effect(_templateObject3810 || (_templateObject3810 = _taggedTemplateLiteral62(["Well Stimulated"]))),
      duration: 10
    }
  },
  "ultimate retro game console": {
    "dumb entertainment": $item(_templateObject3910 || (_templateObject3910 = _taggedTemplateLiteral62(["phosphor traces"])))
  },
  "UltraDance karaoke machine": {
    "dumb entertainment": {
      effect: $effect(_templateObject4010 || (_templateObject4010 = _taggedTemplateLiteral62(["Your Days Are Numbed"]))),
      duration: 10
    },
    exercise: {
      effect: $effect(_templateObject4113 || (_templateObject4113 = _taggedTemplateLiteral62(["Vicarious Sweat"]))),
      duration: 10
    }
  },
  whiskeybed: {
    booze: $items(_templateObject4212 || (_templateObject4212 = _taggedTemplateLiteral62(["Divine sidecar, lumbering jack, old-fashioned, whiskey and cola, whiskey and soda, whiskey bittersweet, whiskey sour"]))),
    sleep: {
      effect: $effect(_templateObject4311 || (_templateObject4311 = _taggedTemplateLiteral62(["Moist Night's Sleep"]))),
      duration: 10
    }
  }
});
...
function lastNeedChange() {
  return (0, import_kolmafia75.turnsPlayed)() - get("leprecondoLastNeedChange");
}
...
function setFurniture() {
  if (rearrangesRemaining() < 0) return !1;
  ...
  }) || new Set(nonemptyFurniture).size !== nonemptyFurniture.length ? !1 : (directlyUse($item(_templateObject4410 || (_templateObject4410 = _taggedTemplateLiteral62(["Leprecondo"])))), (0, import_kolmafia75.runChoice)(1, furniture.map(function(piece, index) {
...
function furnitureBonuses() {
  ...
  return furniture.reduce(function(acc, piece) {
    return _objectSpread8(_objectSpread8({}, Furniture[piece]), acc);
  }, {});
}

// src/resources/evergreen/Raffle.ts
var Raffle_exports = {};
...
function getRafflePrize(place, page) {
  var _descId$, descId = new RegExp("".concat(place, " Prize:</td><td><img class=hand onclick='descitem\\((\\d+)\\)")).exec(page);
  return (0, import_kolmafia76.descToItem)((_descId$ = descId == null ? void 0 : descId[1]) !== null && _descId$ !== void 0 ? _descId$ : "");
}
function getRafflePrizes() {
  var page = (0, import_kolmafia76.visitUrl)("raffle.php");
  return tuple(getRafflePrize("First", page), getRafflePrize("Second", page));
}
function currentTickets() {
  var _exec$1$replace, _exec, page = (0, import_kolmafia76.visitUrl)("raffle.php");
  return page.includes("You haven't bought any tickets for today's raffle.") ? 0 : Number((_exec$1$replace = (_exec = /You have purchased ([\d,]+) tickets for today's raffle/.exec(page)) === null || _exec === void 0 ? void 0 : _exec[1].replace(/,/g, "")) !== null && _exec$1$replace !== void 0 ? _exec$1$replace : 0);
}
function buyTicketsUpTo(quantity) {
  var current2 = currentTickets(), needed = Math.max(0, quantity - current2);
  (0, import_kolmafia76.cliExecute)("raffle ".concat(needed, " ").concat((0, import_kolmafia76.canInteract)() ? "inventory" : "storage"));
}

// src/resources/2025/CyberRealm.ts
...
var ZONE_3_ITEMS_ARRAY = [
  ...
  $item(_templateObject548 || (_templateObject548 = _taggedTemplateLiteral63(["dedigitizer schematic: hashing vise"]))),
  $item(_templateObject641 || (_templateObject641 = _taggedTemplateLiteral63(["dedigitizer schematic: geofencing rapier"]))),
  $item(_templateObject738 || (_templateObject738 = _taggedTemplateLiteral63(["dedigitizer schematic: STATS+++ rom chip"]))),
...
function zone3Rewards() {
  return ZONE_3_ITEMS_ARRAY[(0, import_kolmafia77.gamedayToInt)() % 8];
}

// src/resources/2025/PeridotOfPeril.ts
...
var peridot = $item(_templateObject496 || (_templateObject496 = _taggedTemplateLiteral64(["Peridot of Peril"])));
function have63() {
  return have(peridot);
}
function zonesToday() {
  return get("_perilLocations").split(",").filter(Boolean).map(function(id) {
    return (0, import_kolmafia78.toLocation)(Number(id));
  });
}
function periledToday(location) {
...
// src/resources/2025/PrismaticBeret.ts
...
function getEffectivePower(item15) {
  ...
  switch ((0, import_kolmafia79.toSlot)(item15)) {
    ...
    case $slot(_templateObject644 || (_templateObject644 = _taggedTemplateLiteral65(["pants"]))):
      return (0, import_kolmafia79.getPower)(item15) * (1 + (have($skill(_templateObject739 || (_templateObject739 = _taggedTemplateLiteral65(["Tao of the Terrapin"])))) ? 1 : 0) + (hammerTime ? 3 : 0));
    default:
      return 0;
  }
}
function sumEquipmentPower() {
  var overrideEquipment = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {
    hat: (0, import_kolmafia79.equippedItem)($slot(_templateObject835 || (_templateObject835 = _taggedTemplateLiteral65(["hat"])))),
    pants: (0, import_kolmafia79.equippedItem)($slot(_templateObject929 || (_templateObject929 = _taggedTemplateLiteral65(["pants"])))),
    shirt: (0, import_kolmafia79.equippedItem)($slot(_templateObject1025 || (_templateObject1025 = _taggedTemplateLiteral65(["shirt"])))),
    hammerTime: have($effect(_templateObject1124 || (_templateObject1124 = _taggedTemplateLiteral65(["Hammertime"]))))
  };
  return getEffectivePower(overrideEquipment.hat, overrideEquipment.hammerTime) + getEffectivePower(overrideEquipment.pants, overrideEquipment.hammerTime) + getEffectivePower(overrideEquipment.shirt, overrideEquipment.hammerTime);
}
...
function findOptimalOutfitPower(effectValuer) {
  var _ref8 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref8$buyItems = _ref8.buyItems, buyItems = _ref8$buyItems === void 0 ? !0 : _ref8$buyItems, _ref8$uselessEffects = _ref8.uselessEffects, uselessEffects = _ref8$uselessEffects === void 0 ? [] : _ref8$uselessEffects, _ref8$hammerTime = _ref8.hammerTime, hammerTime = _ref8$hammerTime === void 0 ? have($effect(_templateObject1718 || (_templateObject1718 = _taggedTemplateLiteral65(["Hammertime"])))) : _ref8$hammerTime, buskUses = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : get("_beretBuskingUses"), uselessEffectSet = new Set(uselessEffects), powersums = availablePowersums({
    buyItems: buyItems,
...
var validateItems = function(arr, maxPower) {
  var map = /* @__PURE__ */ new Map(), _iterator = _createForOfIteratorHelper8(arr), _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      var it = _step.value, power = getEffectivePower(it);
      if (!(power > maxPower)) {
        var existing = map.get(power);
        (!existing || !have(existing) && (have(it) || (0, import_kolmafia79.npcPrice)(it) < (0, import_kolmafia79.npcPrice)(existing))) && map.set(power, it);
      }
    }
  } catch (err) {
    _iterator.e(err);
...
function findOutfit(power, buyItems) {
  var _getUseableClothes2 = getUseableClothes(buyItems), useableHats = _getUseableClothes2.useableHats, useablePants = _getUseableClothes2.useablePants, useableShirts = _getUseableClothes2.useableShirts, hats = validateItems(useableHats, power), pantses = validateItems(useablePants, power), shirts = validateItems(useableShirts, power), outfits = hats.flatMap(function(hat) {
    return shirts.flatMap(function(shirt) {
      return pantses.flatMap(function(pants2) {
        return sumEquipmentPower({
          hat: hat,
          pants: pants2,
          shirt: shirt,
          hammerTime: have($effect(_templateObject1818 || (_templateObject1818 = _taggedTemplateLiteral65(["Hammertime"]))))
        }) === power ? {
          hat: hat,
          pants: pants2,
          shirt: shirt
  ...
  var outfit2 = maxBy(outfits, outfitPrice, !0);
  if (logger_default.debug("Chose outfit ".concat(outfit2.hat, " ").concat(outfit2.shirt, " ").concat(outfit2.pants)), outfitPrice(outfit2) > (0, import_kolmafia79.myMeat)()) return null;
  var _iterator2 = _createForOfIteratorHelper8(relevantSlots), _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
      var slot = _step2.value, item15 = outfit2[slot];
      if (item15 !== import_kolmafia79.Item.none && !have(item15) && !(0, import_kolmafia79.buy)(item15))
        return logger_default.debug("Failed to purchase ".concat(item15)), null;
    }
  } catch (err) {
    _iterator2.e(err);
  } finally {
...
function buskAt(power) {
  var buyItems = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
  if (!have64()) return !1;
  var initialUses = get("_beretBuskingUses");
  if (initialUses >= 5) return !1;
  var outfit2 = findOutfit(power, buyItems);
  if (!outfit2) return !1;
  var initialEquips = $slots(_templateObject1915 || (_templateObject1915 = _taggedTemplateLiteral65(["hat, shirt, pants"]))).map(function(slot) {
  ...
  try {
    ...
    $slots(_templateObject2713 || (_templateObject2713 = _taggedTemplateLiteral65(["hat, shirt, pants"]))).forEach(function(slot, index) {
      return (0, import_kolmafia79.equip)(slot, initialEquips[index]);
    }), initialFamiliar !== $familiar(_templateObject2811 || (_templateObject2811 = _taggedTemplateLiteral65(["Mad Hatrack"]))) && (0, import_kolmafia79.myFamiliar)() === $familiar(_templateObject2911 || (_templateObject2911 = _taggedTemplateLiteral65(["Mad Hatrack"]))) && unequip($slot(_templateObject3011 || (_templateObject3011 = _taggedTemplateLiteral65(["familiar"])))), (0, import_kolmafia79.useFamiliar)(initialFamiliar), (0, import_kolmafia79.equip)($slot(_templateObject3116 || (_templateObject3116 = _taggedTemplateLiteral65(["familiar"]))), initialFamequip);
  }
}
function buskFor(effectValuer) {
  var _ref13 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref13$buyItems = _ref13.buyItems, buyItems = _ref13$buyItems === void 0 ? !0 : _ref13$buyItems, _ref13$uselessEffects = _ref13.uselessEffects, uselessEffects = _ref13$uselessEffects === void 0 ? [] : _ref13$uselessEffects, outfitPower = findOptimalOutfitPower(effectValuer, {
    buyItems: buyItems,
...
// src/resources/2025/BloodCubicZirconia.ts
var BloodCubicZirconia_exports = {};
__export(BloodCubicZirconia_exports, {
  availableCasts: function() {
    return availableCasts2;
  },
  castDownTo: function() {
    return castDownTo;
  },
...
function castDownTo(skill, statFloor) {
  if (!have65() || !COSTS.get(skill)) return !1;
  for (var casts = availableCasts2(skill, statFloor); casts; ) {
    if (!(0, import_kolmafia80.useSkill)(skill, casts)) return !1;
    casts = availableCasts2(skill, statFloor);
  }
  return !0;
}

// src/resources/2025/SkeletonOfCrimboPast.ts
var SkeletonOfCrimboPast_exports = {};
__export(SkeletonOfCrimboPast_exports, {
  CANE_BONUS: function() {
    return CANE_BONUS;
  },
  expectedBones: function() {
...
var summonSkill = $skill(_templateObject501 || (_templateObject501 = _taggedTemplateLiteral68(["Summon Candy Heart"]))), libramChance = 1 / 6, libramExpected = /* @__PURE__ */ new Map([[$item(_templateObject2132 || (_templateObject2132 = _taggedTemplateLiteral68(["green candy heart"]))), libramChance], [$item(_templateObject3119 || (_templateObject3119 = _taggedTemplateLiteral68(["lavender candy heart"]))), libramChance], [$item(_templateObject4102 || (_templateObject4102 = _taggedTemplateLiteral68(["orange candy heart"]))), libramChance], [$item(_templateObject554 || (_templateObject554 = _taggedTemplateLiteral68(["pink candy heart"]))), libramChance], [$item(_templateObject647 || (_templateObject647 = _taggedTemplateLiteral68(["white candy heart"]))), libramChance], [$item(_templateObject744 || (_templateObject744 = _taggedTemplateLiteral68(["yellow candy heart"]))), libramChance]]);
function have67() {
...
var summonSkill2 = $skill(_templateObject506 || (_templateObject506 = _taggedTemplateLiteral69(["Summon Party Favor"])));
function have68() {
...
function expected2() {
  ...
  return /* @__PURE__ */ new Map([[$item(_templateObject2133 || (_templateObject2133 = _taggedTemplateLiteral69(["divine blowout"]))), commonChance2], [$item(_templateObject3120 || (_templateObject3120 = _taggedTemplateLiteral69(["divine can of silly string"]))), commonChance2], [$item(_templateObject4103 || (_templateObject4103 = _taggedTemplateLiteral69(["divine noisemaker"]))), commonChance2], [$item(_templateObject555 || (_templateObject555 = _taggedTemplateLiteral69(["divine champagne flute"]))), rareChance2], [$item(_templateObject648 || (_templateObject648 = _taggedTemplateLiteral69(["divine champagne popper"]))), rareChance2], [$item(_templateObject745 || (_templateObject745 = _taggedTemplateLiteral69(["divine cracker"]))), rareChance2]]);
}
...
var summonSkill3 = $skill(_templateObject507 || (_templateObject507 = _taggedTemplateLiteral70(["Summon Love Song"]))), libramChance2 = 1 / 6, libramExpected2 = /* @__PURE__ */ new Map([[$item(_templateObject2134 || (_templateObject2134 = _taggedTemplateLiteral70(["love song of disturbing obsession"]))), libramChance2], [$item(_templateObject3121 || (_templateObject3121 = _taggedTemplateLiteral70(["love song of icy revenge"]))), libramChance2], [$item(_templateObject4104 || (_templateObject4104 = _taggedTemplateLiteral70(["love song of naughty innuendo"]))), libramChance2], [$item(_templateObject556 || (_templateObject556 = _taggedTemplateLiteral70(["love song of smoldering passion"]))), libramChance2], [$item(_templateObject649 || (_templateObject649 = _taggedTemplateLiteral70(["love song of sugary cuteness"]))), libramChance2], [$item(_templateObject746 || (_templateObject746 = _taggedTemplateLiteral70(["love song of vague ambiguity"]))), libramChance2]]);
function have69() {
...
var summonSkill4 = $skill(_templateObject508 || (_templateObject508 = _taggedTemplateLiteral71(["Summon BRICKOs"])));
function have70() {
  return have(summonSkill4);
}
function expected4() {
  var eyeSummons = get("_brickoEyeSummons"), eyeChance = eyeSummons === 3 ? 0 : eyeSummons === 0 ? 0.5 : 1 / 3;
  return /* @__PURE__ */ new Map([[$item(_templateObject2135 || (_templateObject2135 = _taggedTemplateLiteral71(["BRICKO eye brick"]))), eyeChance], [$item(_templateObject3122 || (_templateObject3122 = _taggedTemplateLiteral71(["BRICKO brick"]))), 3 - eyeChance]]);
}
...
var summonSkill5 = $skill(_templateObject509 || (_templateObject509 = _taggedTemplateLiteral72(["Summon Dice"]))), libramChance3 = 1 / 6, libramExpected3 = /* @__PURE__ */ new Map([[$item(_templateObject2136 || (_templateObject2136 = _taggedTemplateLiteral72(["d4"]))), libramChance3], [$item(_templateObject3123 || (_templateObject3123 = _taggedTemplateLiteral72(["d6"]))), libramChance3], [$item(_templateObject4105 || (_templateObject4105 = _taggedTemplateLiteral72(["d8"]))), libramChance3], [$item(_templateObject557 || (_templateObject557 = _taggedTemplateLiteral72(["d10"]))), libramChance3], [$item(_templateObject650 || (_templateObject650 = _taggedTemplateLiteral72(["d12"]))), libramChance3], [$item(_templateObject747 || (_templateObject747 = _taggedTemplateLiteral72(["d20"]))), libramChance3]]);
function have71() {
...
var summonSkill6 = $skill(_templateObject558 || (_templateObject558 = _taggedTemplateLiteral73(["Summon Resolutions"]))), commonChance = 0.98 / 6, rareChance = 0.02 / 3, libramExpected4 = /* @__PURE__ */ new Map([[$item(_templateObject2137 || (_templateObject2137 = _taggedTemplateLiteral73(["resolution: be feistier"]))), commonChance], [$item(_templateObject3124 || (_templateObject3124 = _taggedTemplateLiteral73(["resolution: be happier"]))), commonChance], [$item(_templateObject4106 || (_templateObject4106 = _taggedTemplateLiteral73(["resolution: be sexier"]))), commonChance], [$item(_templateObject559 || (_templateObject559 = _taggedTemplateLiteral73(["resolution: be smarter"]))), commonChance], [$item(_templateObject651 || (_templateObject651 = _taggedTemplateLiteral73(["resolution: be stronger"]))), commonChance], [$item(_templateObject748 || (_templateObject748 = _taggedTemplateLiteral73(["resolution: be wealthier"]))), commonChance], [$item(_templateObject838 || (_templateObject838 = _taggedTemplateLiteral73(["resolution: be kinder"]))), rareChance], [$item(_templateObject933 || (_templateObject933 = _taggedTemplateLiteral73(["resolution: be luckier"]))), rareChance], [$item(_templateObject1028 || (_templateObject1028 = _taggedTemplateLiteral73(["resolution: be more adventurous"]))), rareChance]]);
function have72() {
...
var summonSkill7 = $skill(_templateObject560 || (_templateObject560 = _taggedTemplateLiteral74(["Summon Taffy"])));
function have73() {
...
function expected7() {
  ...
  return /* @__PURE__ */ new Map([[$item(_templateObject2138 || (_templateObject2138 = _taggedTemplateLiteral74(["pulled blue taffy"]))), commonChance2], [$item(_templateObject3125 || (_templateObject3125 = _taggedTemplateLiteral74(["pulled orange taffy"]))), commonChance2], [$item(_templateObject4107 || (_templateObject4107 = _taggedTemplateLiteral74(["pulled violet taffy"]))), commonChance2], [$item(_templateObject561 || (_templateObject561 = _taggedTemplateLiteral74(["pulled red taffy"]))), commonChance2], [$item(_templateObject654 || (_templateObject654 = _taggedTemplateLiteral74(["pulled indigo taffy"]))), rareChance2], [$item(_templateObject749 || (_templateObject749 = _taggedTemplateLiteral74(["pulled green taffy"]))), rareChance2], [$item(_templateObject839 || (_templateObject839 = _taggedTemplateLiteral74(["pulled yellow taffy"]))), yellowChance]]);
}

// src/resources/LibramSummon.ts
var _templateObject564, _templateObject2139, _templateObject3126, _templateObject4108, _templateObject565, _templateObject655, _templateObject750, _templateObject840, _templateObject934, _templateObject1029, _templateObject1127, _templateObject1226, _templateObject1324, _templateObject1422;
...
function expectedLibramSummon(summonSkill8) {
  switch (summonSkill8) {
    case $skill(_templateObject564 || (_templateObject564 = _taggedTemplateLiteral75(["Summon Candy Heart"]))):
      return expected();
    case $skill(_templateObject2139 || (_templateObject2139 = _taggedTemplateLiteral75(["Summon Party Favor"]))):
      return expected2();
    case $skill(_templateObject3126 || (_templateObject3126 = _taggedTemplateLiteral75(["Summon Love Song"]))):
      return expected3();
    case $skill(_templateObject4108 || (_templateObject4108 = _taggedTemplateLiteral75(["Summon BRICKOs"]))):
      return expected4();
    case $skill(_templateObject565 || (_templateObject565 = _taggedTemplateLiteral75(["Summon Dice"]))):
      return expected5();
    case $skill(_templateObject655 || (_templateObject655 = _taggedTemplateLiteral75(["Summon Resolutions"]))):
      return expected6();
    case $skill(_templateObject750 || (_templateObject750 = _taggedTemplateLiteral75(["Summon Taffy"]))):
      return expected7();
  }
...
function possibleLibramSummons() {
  ...
  return have67() && results.set($skill(_templateObject840 || (_templateObject840 = _taggedTemplateLiteral75(["Summon Candy Heart"]))), expected()), have68() && results.set($skill(_templateObject934 || (_templateObject934 = _taggedTemplateLiteral75(["Summon Party Favor"]))), expected2()), have69() && results.set($skill(_templateObject1029 || (_templateObject1029 = _taggedTemplateLiteral75(["Summon Love Song"]))), expected3()), have70() && results.set($skill(_templateObject1127 || (_templateObject1127 = _taggedTemplateLiteral75(["Summon BRICKOs"]))), expected4()), have71() && results.set($skill(_templateObject1226 || (_templateObject1226 = _taggedTemplateLiteral75(["Summon Dice"]))), expected5()), have72() && results.set($skill(_templateObject1324 || (_templateObject1324 = _taggedTemplateLiteral75(["Summon Resolutions"]))), expected6()), have73() && results.set($skill(_templateObject1422 || (_templateObject1422 = _taggedTemplateLiteral75(["Summon Taffy"]))), expected7()), results;
}
function bestLibramToCast() {
  var arr = Array.from(possibleLibramSummons().entries());
  return arr.length ? maxBy(arr, function(_ref) {
    var _ref2 = _slicedToArray21(_ref, 2), itemMap = _ref2[1];
    return sum(Array.from(itemMap.entries()), function(_ref3) {
      var _ref4 = _slicedToArray21(_ref3, 2), item15 = _ref4[0], weight = _ref4[1];
...
// src/ascend.ts
var _templateObject566, _templateObject2140, _templateObject3127, _templateObject4109, _templateObject567, _templateObject656, _templateObject751, _templateObject841, _templateObject935;
...
function _toConsumableArray21(r) {
  return _arrayWithoutHoles21(r) || _iterableToArray21(r) || _unsupportedIterableToArray34(r) || _nonIterableSpread21();
}
...
function permedSkills() {
  return new Map(Array.from(Object.entries((0, import_kolmafia82.getPermedSkills)())).map(function(_ref) {
    var _ref2 = _slicedToArray22(_ref, 2), skillName = _ref2[0], isHardcore = _ref2[1];
    return [(0, import_kolmafia82.toSkill)(skillName), isHardcore ? Lifestyle.hardcore : Lifestyle.softcore];
  }));
}
var AscendError = /* @__PURE__ */ function(_Error) {
  ...
  function AscensionPrepError2(cause, original) {
    var _this;
    return _classCallCheck11(this, AscensionPrepError2), isGarden(cause) ? (_this = _callSuper3(this, AscensionPrepError2, ["Unable to swap garden to ".concat(cause, "; garden is currently ").concat(original, ".")]), _defineProperty17(_assertThisInitialized3(_this), "cause", void 0)) : isEudora(cause) ? (_this = _callSuper3(this, AscensionPrepError2, ["Unable to swap eudora to ".concat(cause, "; eudora is currently ").concat(original, ".")]), _defineProperty17(_assertThisInitialized3(_this), "cause", void 0)) : isDesk(cause) ? (_this = _callSuper3(this, AscensionPrepError2, ["Unable to swap chateau desk to ".concat(cause, "; desk is currently ").concat(original, ".")]), _defineProperty17(_assertThisInitialized3(_this), "cause", void 0)) : isNightstand(cause) ? (_this = _callSuper3(this, AscensionPrepError2, ["Unable to swap chateau nightstand to ".concat(cause, "; nightstand is currently ").concat(original, ".")]), _defineProperty17(_assertThisInitialized3(_this), "cause", void 0)) : isCeiling(cause) ? (_this = _callSuper3(this, AscensionPrepError2, ["Unable to swap chateau ceiling to ".concat(cause, "; ceiling is currently ").concat(original, ".")]), _defineProperty17(_assertThisInitialized3(_this), "cause", void 0)) : (_this = _callSuper3(this, AscensionPrepError2, [cause]), _defineProperty17(_assertThisInitialized3(_this), "cause", void 0)), _this.cause = cause, _assertThisInitialized3(_this);
  }
...
function inputToMoonId(moon, playerClass) {
  ...
  var offset = function() {
    switch (playerClass.primestat) {
      case $stat(_templateObject566 || (_templateObject566 = _taggedTemplateLiteral76(["Muscle"]))):
        return 0;
      case $stat(_templateObject2140 || (_templateObject2140 = _taggedTemplateLiteral76(["Mysticality"]))):
        return 1;
      case $stat(_templateObject3127 || (_templateObject3127 = _taggedTemplateLiteral76(["Moxie"]))):
        return 2;
      default:
...
function isInValhalla() {
  var charPaneText = (0, import_kolmafia82.visitUrl)("charpane.php"), matches = charPaneText.match(/<img src="[^"]*\/otherimages\/inf_\w+\.gif">/);
  return matches !== null;
}
function ascend(options) {
  var _permOptions$permSkil, _permOptions$permSkil2, DEFAULT_OPTIONS = {
    ...
    consumable: $item(_templateObject4109 || (_templateObject4109 = _taggedTemplateLiteral76(["astral six-pack"]))),
    pet: $item(_templateObject567 || (_templateObject567 = _taggedTemplateLiteral76(["none"])))
  ...
  if (playerClass.path !== (path3.avatar ? path3 : import_kolmafia82.Path.none))
  ...
  if (!$items(_templateObject656 || (_templateObject656 = _taggedTemplateLiteral76(["none, astral six-pack, astral hot dog dinner, [10882]carton of astral energy drinks"]))).includes(consumable))
    throw new AscendError("Invalid astral consumable: ".concat(consumable));
  if (!$items(_templateObject751 || (_templateObject751 = _taggedTemplateLiteral76(["none, astral bludgeon, astral shield, astral chapeau, astral bracer, astral longbow, astral shorts, astral mace, astral trousers, astral ring, astral statuette, astral pistol, astral mask, astral pet sweater, astral shirt, astral belt"]))).includes(pet))
    throw new AscendError("Invalid astral pet: ".concat(pet));
  var unownedSkills = _toConsumableArray21((_permOptions$permSkil = permOptions == null ? void 0 : permOptions.permSkills.keys()) !== null && _permOptions$permSkil !== void 0 ? _permOptions$permSkil : []).filter(function(skill2) {
    return !(0, import_kolmafia82.haveSkill)(skill2);
  });
  ...
  var unpermableSkills = _toConsumableArray21((_permOptions$permSkil2 = permOptions == null ? void 0 : permOptions.permSkills.keys()) !== null && _permOptions$permSkil2 !== void 0 ? _permOptions$permSkil2 : []).filter(function(skill2) {
  ...
  if (isInValhalla() || (0, import_kolmafia82.visitUrl)("ascend.php?action=ascend&confirm=on&confirm2=on"), !isInValhalla())
    throw new AscendError("Failed to ascend--do you have a pending trade offer?");
  if ((0, import_kolmafia82.visitUrl)("afterlife.php?action=pearlygates"), consumable !== $item(_templateObject841 || (_templateObject841 = _taggedTemplateLiteral76(["none"]))) && (0, import_kolmafia82.visitUrl)("afterlife.php?action=buydeli&whichitem=".concat(consumable.id)), pet !== $item(_templateObject935 || (_templateObject935 = _taggedTemplateLiteral76(["none"]))) && (0, import_kolmafia82.visitUrl)("afterlife.php?action=buyarmory&whichitem=".concat(pet.id)), permOptions) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        var _currentPerms$get, _step$value = _slicedToArray22(_step.value, 2), skill = _step$value[0], prospectivePermLevel = _step$value[1], currentPermLevel = (_currentPerms$get = currentPerms.get(skill)) !== null && _currentPerms$get !== void 0 ? _currentPerms$get : Lifestyle.casual;
        if (prospectivePermLevel > currentPermLevel) {
          ...
          (0, import_kolmafia82.visitUrl)("afterlife.php?action=".concat(permText, "&whichskill=").concat(skill.id));
        }
      }
    } catch (err) {
      _iterator.e(err);
  ...
  (0, import_kolmafia82.visitUrl)("afterlife.php?action=ascend&confirmascend=1&whichsign=".concat(moonId, "&gender=").concat(kolGender, "&whichclass=").concat(playerClass.id, "&whichpath=").concat(path3.id, "&asctype=").concat(lifestyle, "&nopetok=1&noskillsok=1&lamepathok=1&lamesignok=1&pwd"), !0);
}
function prepareAscension() {
  ...
  if (throwOnFail = (_throwOnFail = throwOnFail) !== null && _throwOnFail !== void 0 ? _throwOnFail : !0, garden && !Object.getOwnPropertyNames((0, import_kolmafia82.getCampground)()).includes(garden)) {
    (0, import_kolmafia82.use)(import_kolmafia82.Item.get(garden));
    var gardenName = Object.getOwnPropertyNames((0, import_kolmafia82.getCampground)()).find(isGarden);
    if (gardenName !== garden && throwOnFail)
      throw new AscensionPrepError(garden, gardenName);
  }
  if (eudora && (0, import_kolmafia82.eudoraItem)().name !== eudora) {
    var eudoraNumber = 1 + eudorae.indexOf(eudora);
    if (!(0, import_kolmafia82.xpath)((0, import_kolmafia82.visitUrl)("account.php?tab=correspondence"), '//select[@name="whichpenpal"]/option/@value').includes(eudoraNumber.toString()) && throwOnFail)
      throw new AscensionPrepError("Unable to swap eudora to ".concat(eudora, " because you are not subscribed to it."));
    if ((0, import_kolmafia82.visitUrl)("account.php?actions[]=whichpenpal&whichpenpal=".concat(eudoraNumber, "&action=Update"), !0), (0, import_kolmafia82.eudoraItem)() !== import_kolmafia82.Item.get(eudora) && throwOnFail)
      throw new AscensionPrepError(eudora, (0, import_kolmafia82.eudoraItem)());
  }
...
var EntityDecoder = /* @__PURE__ */ function() {
  function EntityDecoder2(decodeTree, emitCodePoint, errors) {
    _classCallCheck12(this, EntityDecoder2), this.decodeTree = decodeTree, this.emitCodePoint = emitCodePoint, this.errors = errors, this.state = EntityDecoderState.EntityStart, this.consumed = 1, this.result = 0, this.treeIndex = 0, this.excess = 1, this.decodeMode = DecodingMode.Strict;
  }
  return _createClass12(EntityDecoder2, [{
    key: "startEntity",
    ...
    value: function(input, offset) {
      for (var decodeTree = this.decodeTree, current2 = decodeTree[this.treeIndex], valueLength = (current2 & BinTrieFlags.VALUE_LENGTH) >> 14; offset < input.length; ) {
        if (valueLength === 0 && current2 & BinTrieFlags.FLAG13) {
        ...
        var char = input.charCodeAt(offset);
        if (char === CharCodes.SEMI && valueLength !== 0 && current2 & BinTrieFlags.FLAG13)
        ...
        if (current2 = decodeTree[this.treeIndex], valueLength = (current2 & BinTrieFlags.VALUE_LENGTH) >> 14, valueLength !== 0) {
          if (char === CharCodes.SEMI)
            return this.emitNamedEntityData(this.treeIndex, valueLength, this.consumed + this.excess);
          this.decodeMode !== DecodingMode.Strict && !(current2 & BinTrieFlags.FLAG13) && (this.result = this.treeIndex, this.consumed += this.excess, this.excess = 0);
        }
        offset++, this.excess++;
      }
      return -1;
...
var clanIdCache = {}, toPlayerId = function(player) {
  return typeof player == "string" ? (0, import_kolmafia83.getPlayerId)(player) : player;
  ...
  function Clan2(id, name) {
    _classCallCheck13(this, Clan2), _defineProperty18(this, "id", void 0), _defineProperty18(this, "name", void 0), this.id = id, this.name = name;
  }
  return _createClass13(Clan2, [{
    key: "_check",
    value: function() {
      if (this.id !== (0, import_kolmafia83.getClanId)())
    ...
    key: "check",
    value: function() {
      return (0, import_kolmafia83.visitUrl)("clan_hall.php").includes("<b>".concat(this.name, "</b>"));
    }
    /**
    ...
    value: function() {
      this._check();
      var logs = (0, import_kolmafia83.visitUrl)("clan_log.php"), lastFax = logs.match(LOG_FAX_PATTERN);
      if (!lastFax) return null;
      var _lastFax = _slicedToArray23(lastFax, 4), monsterName = _lastFax[3];
      return monsterName ? import_kolmafia83.Monster.get(monsterName) : null;
    }
    /**
    ...
    value: function() {
      this._check();
      var page = (0, import_kolmafia83.visitUrl)("clan_whitelist.php");
      return (0, import_kolmafia83.xpath)(page, '//select[@name="level"]//option').map(function(option) {
        var validHtml = "<select>".concat(option, "</select>"), match = (0, import_kolmafia83.xpath)(validHtml, "//text()")[0].match(WHITELIST_DEGREE_PATTERN), id = (0, import_kolmafia83.xpath)(validHtml, "//@value")[0];
        if (!match || !id) return null;
        var _match = _slicedToArray23(match, 3), encodedName = _match[1], degree = _match[2];
        return {
    ...
    value: function(player, rankName) {
      ...
      if (!rank) return !1;
      var result = (0, import_kolmafia83.visitUrl)("clan_whitelist.php?action=add&pwd&addwho=".concat(playerId, "&level=").concat(rank.id, "&title=").concat(title));
    ...
    value: function(player) {
      this._check();
      var playerId = toPlayerId(player), result = (0, import_kolmafia83.visitUrl)("clan_whitelist.php?action=updatewl&pwd&who=".concat(playerId, "&remove=Remove"));
    ...
    value: function() {
      this._check();
      var page = (0, import_kolmafia83.visitUrl)("clan_stash.php"), _ref = page.match(/Your <b>Clan Coffer<\/b> contains ([\d,]+) Meat./) || ["0", "0"], _ref2 = _slicedToArray23(_ref, 2), meat = _ref2[1];
    ...
    value: function(amount2) {
      this._check();
      var result = (0, import_kolmafia83.visitUrl)("clan_stash.php?pwd&action=contribute&howmuch=".concat(amount2));
    ...
    value: function(items) {
      ...
      return map.forEach(function(quantity, item15) {
        var needed = Math.max(0, quantity - (0, import_kolmafia83.availableAmount)(item15));
        if (needed === 0)
          return map.set(item15, 0);
        var foldGroup = getFoldGroup(item15), _iterator = _createForOfIteratorHelper10(foldGroup), _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            for (var foldable = _step.value, quantityToFold = Math.min(needed, (0, import_kolmafia83.availableAmount)(foldable)), _i2 = 0; _i2 < quantityToFold; _i2++)
              (0, import_kolmafia83.cliExecute)("fold ".concat(item15.name)), needed--;
        ...
        (0, import_kolmafia83.refreshStash)();
        for (var _i = 0, _arr = [item15].concat(_toConsumableArray22(foldGroup)); _i < _arr.length; _i++) {
          var matchingItem = _arr[_i], quantityToTake = Math.min(needed, (0, import_kolmafia83.stashAmount)(matchingItem));
          if (quantityToTake !== 0) {
            if (!(0, import_kolmafia83.takeStash)(quantityToTake, matchingItem)) return;
            if (matchingItem === item15)
              needed -= quantityToTake;
            else
              for (var i = 0; i < quantityToTake; i++)
                (0, import_kolmafia83.cliExecute)("fold ".concat(matchingItem.name)), needed--;
          }
        }
    ...
    value: function(items) {
      ...
      return map.forEach(function(quantity, item15) {
        (0, import_kolmafia83.retrieveItem)(quantity, item15);
        var returned = Math.min(quantity, (0, import_kolmafia83.availableAmount)(item15));
        (0, import_kolmafia83.putStash)(returned, item15), map.set(item15, quantity - returned);
      }), Array.isArray(items) ? countedMapToArray(map) : map;
    }
    /**
    ...
    key: "_join",
    value: function(id) {
      var result = (0, import_kolmafia83.visitUrl)("showclan.php?recruiter=1&whichclan=".concat(id, "&pwd&whichclan=").concat(id, "&action=joinclan&apply=Apply+to+this+Clan&confirm=on"));
      ...
      try {
        ...
        if (map.size > 0) {
          ...
          map.forEach(function(quantity, item15) {
            ...
            remaining > 0 ? map.set(item15, remaining) : map.delete(item15);
    ...
    value: function(clanIdOrName) {
      ...
      if (typeof clanIdOrName == "string") {
        ...
        if (clanName === (0, import_kolmafia83.getClanName)().toLowerCase())
          return Clan2.get();
      ...
      } else if (clanId = clanIdOrName, clanId === (0, import_kolmafia83.getClanId)())
        return Clan2.get();
    ...
    key: "get",
    value: function() {
      return new Clan2((0, import_kolmafia83.getClanId)(), (0, import_kolmafia83.getClanName)());
    }
    /**
    ...
    key: "getWhitelisted",
    value: function() {
      var page = (0, import_kolmafia83.visitUrl)("clan_signup.php");
      return (0, import_kolmafia83.xpath)(page, '//select[@name="whichclan"]//option').map(function(option) {
        var validHtml = "<select>".concat(option, "</select>"), id = Number.parseInt((0, import_kolmafia83.xpath)(validHtml, "//@value")[0]), name = decodeHTML((0, import_kolmafia83.xpath)(validHtml, "//text()")[0]);
...
function rainMan(target) {
  canRainMan(target) && withChoice(970, "1&whichmonster=".concat(target.id), function() {
    return (0, import_kolmafia84.useSkill)($skill(_templateObject568 || (_templateObject568 = _taggedTemplateLiteral77(["Rain Man"]))));
  });
}
function canRainMan(target) {
  if (!have($skill(_templateObject2141 || (_templateObject2141 = _taggedTemplateLiteral77(["Rain Man"])))) || // having the skill implies you are in heavy rains path
  (0, import_kolmafia84.myRain)() < 50 || !target.copyable || target.id < 0)
    return !1;
  if ((0, import_kolmafia84.monsterFactoidsAvailable)(target, !1) > 0)
    return !0;
  var page = withChoice(970, 2, function() {
    return (0, import_kolmafia84.visitUrl)("runskillz.php?pwd&action=Skillz&whichskill=".concat($skill(_templateObject3128 || (_templateObject3128 = _taggedTemplateLiteral77(["Rain Man"]))).id, "&quantity=1"));
  });
  return page.indexOf("<option value=".concat(target.id, ">")) > 0;
}
var RAIN_MONSTER_WINDOW_BEGIN = "Rain Monster window begin", RAIN_MONSTER_WINDOW_END = "Rain Monster window end", wanderers = Object.freeze(import_kolmafia84.Monster.get(["giant isopod", "gourmet gourami", "freshwater bonefish", "alley catfish", "piranhadon", "giant tardigrade", "aquaconda", "storm cow"]));
function expectedWanderer(location) {
  var difficultyWaterLevel = location.difficultyLevel === "low" ? 1 : 2, environmentWaterLevel = location.environment === "underground" ? 4 : location.environment === "indoor" ? 2 : 1, waterLevel = (0, import_kolmafia84.numericModifier)(import_kolmafia84.Modifier.get("Water Level")) + difficultyWaterLevel + environmentWaterLevel;
  return waterLevel > 1 && waterLevel < 6 ? wanderers[waterLevel - 1] : waterLevel === 6 && location.environment === "underground" ? $monster(_templateObject4114 || (_templateObject4114 = _taggedTemplateLiteral77(["giant tardigrade"]))) : waterLevel === 6 && location.environment === "indoor" ? $monster(_templateObject569 || (_templateObject569 = _taggedTemplateLiteral77(["aquaconda"]))) : waterLevel === 6 && location.environment === "outdoor" ? $monster(_templateObject657 || (_templateObject657 = _taggedTemplateLiteral77(["storm cow"]))) : $monster(_templateObject754 || (_templateObject754 = _taggedTemplateLiteral77(["giant isopod"])));
}
...
var thralls = /* @__PURE__ */ new Map([[$stat(_templateObject570 || (_templateObject570 = _taggedTemplateLiteral78(["muscle"]))), $thrall(_templateObject2142 || (_templateObject2142 = _taggedTemplateLiteral78(["Elbow Macaroni"])))], [$stat(_templateObject3129 || (_templateObject3129 = _taggedTemplateLiteral78(["moxie"]))), $thrall(_templateObject4115 || (_templateObject4115 = _taggedTemplateLiteral78(["Penne Dreadful"])))]]), statCommunityServicePredictor = function(stat) {
  return function() {
    return 60 - Math.floor(1 / 30 * ((0, import_kolmafia85.myBuffedstat)(stat) - (0, import_kolmafia85.myBasestat)(thralls.get(stat) === (0, import_kolmafia85.myThrall)() && !have($effect(_templateObject571 || (_templateObject571 = _taggedTemplateLiteral78(["Expert Oiliness"])))) ? $stat(_templateObject658 || (_templateObject658 = _taggedTemplateLiteral78(["mysticality"]))) : stat)));
  };
}, visitCouncil = function() {
  return (0, import_kolmafia85.visitUrl)("council.php");
};
function hypotheticalModifier(modifier) {
  ...
  return (0, import_kolmafia85.numericModifier)(modifier) + sum(newEffects, function(effect2) {
    return (0, import_kolmafia85.numericModifier)(effect2, modifier);
  });
}
var CommunityService = /* @__PURE__ */ function() {
  function CommunityService2(id, stat, property, predictor, maximizeRequirements) {
    _classCallCheck14(this, CommunityService2), _defineProperty19(this, "choice", void 0), _defineProperty19(this, "stat", void 0), _defineProperty19(this, "property", void 0), _defineProperty19(this, "predictor", void 0), _defineProperty19(this, "maximizeRequirements", void 0), _defineProperty19(this, "timer", null), this.choice = id, this.stat = stat, this.property = property, this.predictor = predictor, this.maximizeRequirements = maximizeRequirements;
  }
  return _createClass14(CommunityService2, [{
    ...
    value: function() {
      ...
      (_this$timer = this.timer) !== null && _this$timer !== void 0 || (this.timer = {
        time: Date.now(),
        turns: (0, import_kolmafia85.myTurncount)()
      });
    }
  }, {
    key: "isDone",
    ...
    value: function() {
      ...
      var councilText = (0, import_kolmafia85.runChoice)(this.choice);
    ...
    value: function(prepare) {
      ...
      try {
        ...
        return (0, import_kolmafia85.print)("".concat(e), "red"), "failed";
      }
      var prediction = this.predictor(), council = visitCouncil(), turnCost = this._actualCost(council);
      return turnCost ? turnCost > Math.min(maxTurns, (0, import_kolmafia85.myAdventures)()) || !this.do() ? "failed" : (CommunityService2.log[this.property] = {
        predictedTurns: prediction + additionalTurns,
        turnCost: (0, import_kolmafia85.myTurncount)() - turns2,
    ...
    value: (
      ...
      function() {
        for (var colour = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "blue", logEntries = Object.entries(CommunityService2.log), _i = 0, _logEntries = logEntries; _i < _logEntries.length; _i++) {
          var _logEntries$_i = _slicedToArray24(_logEntries[_i], 2), testName = _logEntries$_i[0], testEntry = _logEntries$_i[1], type = testEntry.type, predictedTurns = testEntry.predictedTurns, turnCost = testEntry.turnCost, seconds = testEntry.seconds;
          type === "test" ? ((0, import_kolmafia85.print)("We predicted the ".concat(testName, " test would take ").concat(predictedTurns, " turns, ").concat(predictedTurns === turnCost ? "and" : "but", " it took ").concat(turnCost, " turns."), colour), (0, import_kolmafia85.print)("".concat(testName, " took ").concat(seconds.toFixed(1), " seconds."), colour)) : (predictedTurns === 0 && turnCost === 0 || (0, import_kolmafia85.print)("We predicted the task ".concat(testName, " would take ").concat(predictedTurns, " turns, ").concat(predictedTurns === turnCost ? "and" : "but", " it took ").concat(turnCost, " turns."), colour), (0, import_kolmafia85.print)("The task ".concat(testName, " took ").concat(seconds.toFixed(1), " seconds."), colour));
        }
        var totalTime = sum(logEntries, function(_ref3) {
          var _ref4 = _slicedToArray24(_ref3, 2), testEntry2 = _ref4[1];
          return testEntry2.seconds;
        });
        (0, import_kolmafia85.print)("All together, you have spent ".concat(totalTime.toFixed(1), " seconds during this Community Service run"), colour);
      }
    )
...
_defineProperty19(CommunityService, "taskTimers", /* @__PURE__ */ new Map());
_defineProperty19(CommunityService, "log", {});
_defineProperty19(CommunityService, "HP", new _CommunityService(1, "HP", "Donate Blood", function() {
  return 60 - Math.floor(((0, import_kolmafia85.myMaxhp)() - (0, import_kolmafia85.myBuffedstat)($stat(_templateObject755 || (_templateObject755 = _taggedTemplateLiteral78(["muscle"])))) - 3) / 30);
}, new Requirement(["HP"], {})));
_defineProperty19(CommunityService, "Muscle", new _CommunityService(2, "Muscle", "Feed The Children", statCommunityServicePredictor($stat(_templateObject845 || (_templateObject845 = _taggedTemplateLiteral78(["Muscle"])))), new Requirement(["Muscle"], {})));
_defineProperty19(CommunityService, "Mysticality", new _CommunityService(3, "Mysticality", "Build Playground Mazes", statCommunityServicePredictor($stat(_templateObject936 || (_templateObject936 = _taggedTemplateLiteral78(["Mysticality"])))), new Requirement(["Mysticality"], {})));
_defineProperty19(CommunityService, "Moxie", new _CommunityService(4, "Moxie", "Feed Conspirators", statCommunityServicePredictor($stat(_templateObject1030 || (_templateObject1030 = _taggedTemplateLiteral78(["Moxie"])))), new Requirement(["Moxie"], {})));
_defineProperty19(CommunityService, "FamiliarWeight", new _CommunityService(5, "Familiar Weight", "Breed More Collies", function() {
  for (var _len2 = arguments.length, effects = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++)
    effects[_key2] = arguments[_key2];
  return 60 - Math.floor((totalFamiliarWeight((0, import_kolmafia85.myFamiliar)(), !1) + hypotheticalModifier.apply(void 0, ["Familiar Weight"].concat(effects))) / 5);
}, new Requirement(["Familiar Weight"], {})));
_defineProperty19(CommunityService, "WeaponDamage", new _CommunityService(6, "Weapon Damage", "Reduce Gazelle Population", function() {
  for (var weaponPower = (0, import_kolmafia85.getPower)((0, import_kolmafia85.equippedItem)($slot(_templateObject1128 || (_templateObject1128 = _taggedTemplateLiteral78(["weapon"]))))), offhandPower = (0, import_kolmafia85.toSlot)((0, import_kolmafia85.equippedItem)($slot(_templateObject1227 || (_templateObject1227 = _taggedTemplateLiteral78(["off-hand"]))))) === $slot(_templateObject1325 || (_templateObject1325 = _taggedTemplateLiteral78(["weapon"]))) ? (0, import_kolmafia85.getPower)((0, import_kolmafia85.equippedItem)($slot(_templateObject1423 || (_templateObject1423 = _taggedTemplateLiteral78(["off-hand"]))))) : 0, familiarPower = (0, import_kolmafia85.toSlot)((0, import_kolmafia85.equippedItem)($slot(_templateObject1521 || (_templateObject1521 = _taggedTemplateLiteral78(["familiar"]))))) === $slot(_templateObject1621 || (_templateObject1621 = _taggedTemplateLiteral78(["weapon"]))) ? (0, import_kolmafia85.getPower)((0, import_kolmafia85.equippedItem)($slot(_templateObject1720 || (_templateObject1720 = _taggedTemplateLiteral78(["familiar"]))))) : 0, multiplier = have($effect(_templateObject1820 || (_templateObject1820 = _taggedTemplateLiteral78(["Bow-Legged Swagger"])))) ? 2 : 1, _len3 = arguments.length, effects = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++)
...
_defineProperty19(CommunityService, "SpellDamage", new _CommunityService(7, "Spell Damage", "Make Sausage", function() {
  for (var dragonfishDamage = (0, import_kolmafia85.myFamiliar)() === $familiar(_templateObject1917 || (_templateObject1917 = _taggedTemplateLiteral78(["Magic Dragonfish"]))) ? (0, import_kolmafia85.numericModifier)($familiar(_templateObject2017 || (_templateObject2017 = _taggedTemplateLiteral78(["Magic Dragonfish"]))), "Spell Damage Percent", totalFamiliarWeight(), $item.none) : 0, _len4 = arguments.length, effects = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++)
...
_defineProperty19(CommunityService, "Noncombat", new _CommunityService(8, "Non-Combat", "Be a Living Statue", function() {
  for (var _len5 = arguments.length, effects = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++)
    effects[_key5] = arguments[_key5];
  var noncombatRate = -1 * hypotheticalModifier.apply(void 0, ["Raw Combat Rate"].concat(effects)), currentFamiliarModifier = -1 * (0, import_kolmafia85.numericModifier)((0, import_kolmafia85.myFamiliar)(), "Raw Combat Rate", totalFamiliarWeight(), (0, import_kolmafia85.equippedItem)($slot(_templateObject2143 || (_templateObject2143 = _taggedTemplateLiteral78(["familiar"]))))), newFamiliarModifier = -1 * (0, import_kolmafia85.numericModifier)((0, import_kolmafia85.myFamiliar)(), "Raw Combat Rate", totalFamiliarWeight((0, import_kolmafia85.myFamiliar)(), !1) + hypotheticalModifier.apply(void 0, ["Familiar Weight"].concat(effects)), (0, import_kolmafia85.equippedItem)($slot(_templateObject2219 || (_templateObject2219 = _taggedTemplateLiteral78(["familiar"]))))), adjustedRate = noncombatRate - currentFamiliarModifier + newFamiliarModifier;
  return 60 - 3 * Math.floor(adjustedRate / 5);
}, new Requirement(["-Raw Combat Rate"], {})));
_defineProperty19(CommunityService, "BoozeDrop", new _CommunityService(9, "Item Drop", "Make Margaritas", function() {
  for (var mummingCostume = MummingTrunk_exports.currentCostumes().get((0, import_kolmafia85.myFamiliar)()), mummingBuff = mummingCostume && mummingCostume[0] === "Item Drop" ? mummingCostume[1] : 0, familiarItemDrop = (0, import_kolmafia85.numericModifier)((0, import_kolmafia85.myFamiliar)(), "Item Drop", totalFamiliarWeight(), (0, import_kolmafia85.equippedItem)($slot(_templateObject2318 || (_templateObject2318 = _taggedTemplateLiteral78(["familiar"]))))) + mummingBuff - (0, import_kolmafia85.numericModifier)((0, import_kolmafia85.equippedItem)($slot(_templateObject2417 || (_templateObject2417 = _taggedTemplateLiteral78(["familiar"])))), "Item Drop"), familiarBoozeDrop = (0, import_kolmafia85.numericModifier)((0, import_kolmafia85.myFamiliar)(), "Booze Drop", totalFamiliarWeight(), (0, import_kolmafia85.equippedItem)($slot(_templateObject2515 || (_templateObject2515 = _taggedTemplateLiteral78(["familiar"]))))) - (0, import_kolmafia85.numericModifier)((0, import_kolmafia85.equippedItem)($slot(_templateObject2615 || (_templateObject2615 = _taggedTemplateLiteral78(["familiar"])))), "Booze Drop"), multiplier = (0, import_kolmafia85.haveEquipped)($item(_templateObject2715 || (_templateObject2715 = _taggedTemplateLiteral78(["broken champagne bottle"])))) && get("garbageChampagneCharge") > 0 ? 0.5 : 1, _len6 = arguments.length, effects = new Array(_len6), _key6 = 0; _key6 < _len6; _key6++)
    effects[_key6] = arguments[_key6];
  return 60 - Math.floor(multiplier * (hypotheticalModifier.apply(void 0, ["Item Drop"].concat(effects)) - familiarItemDrop - (0, import_kolmafia85.numericModifier)((0, import_kolmafia85.myThrall)(), "Item Drop")) / 30 + 1e-3) - Math.floor((hypotheticalModifier.apply(void 0, ["Booze Drop"].concat(effects)) - familiarBoozeDrop) / 15 + 1e-3);
}, new Requirement(["Item Drop", "2 Booze Drop"], {
  preventEquip: $items(_templateObject2813 || (_templateObject2813 = _taggedTemplateLiteral78(["broken champagne bottle"])))
})));
_defineProperty19(CommunityService, "HotRes", new _CommunityService(10, "Hot Resistance", "Clean Steam Tunnels", function() {
  for (var currentFamiliarModifier = (0, import_kolmafia85.numericModifier)((0, import_kolmafia85.myFamiliar)(), "Hot Resistance", totalFamiliarWeight(), (0, import_kolmafia85.equippedItem)($slot(_templateObject2912 || (_templateObject2912 = _taggedTemplateLiteral78(["familiar"]))))), _len7 = arguments.length, effects = new Array(_len7), _key7 = 0; _key7 < _len7; _key7++)
    effects[_key7] = arguments[_key7];
  var newFamiliarModifier = (0, import_kolmafia85.numericModifier)((0, import_kolmafia85.myFamiliar)(), "Hot Resistance", totalFamiliarWeight((0, import_kolmafia85.myFamiliar)(), !1) + hypotheticalModifier.apply(void 0, ["Familiar Weight"].concat(effects)), (0, import_kolmafia85.equippedItem)($slot(_templateObject3012 || (_templateObject3012 = _taggedTemplateLiteral78(["familiar"])))));
...
_defineProperty19(CommunityService, "CoilWire", new _CommunityService(11, "Coil Wire", "Coil Wire", function() {
  return 60;
}, new Requirement([], {})));
_defineProperty19(CommunityService, "donate", function() {
  visitCouncil(), (0, import_kolmafia85.visitUrl)("choice.php?whichchoice=1089&option=30");
});
_defineProperty19(CommunityService, "path", $path(_templateObject3130 || (_templateObject3130 = _taggedTemplateLiteral78(["Community Service"]))));
...
function coolingTank() {
  (0, import_kolmafia86.visitUrl)("place.php?whichplace=falloutshelter&action=vault8");
}
function spa() {
  (0, import_kolmafia86.visitUrl)("place.php?whichplace=falloutshelter&action=vault3");
}
function chronoLab() {
  (0, import_kolmafia86.visitUrl)("place.php?whichplace=falloutshelter&action=vault5");
}
...
var Not = /* @__PURE__ */ _createClass15(function Not2(thing) {
  _classCallCheck15(this, Not2), _defineProperty20(this, "thing", void 0), this.thing = thing;
});
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      if (aggregatedList.length === 0)
        ...
        var last = aggregatedList[aggregatedList.length - 1], _last = _slicedToArray25(last, 1), lastItem = _last[0];
...
function knapsack(values, capacity) {
  ...
  var valuesInverted = values.map(function(_ref) {
    var _ref2 = _slicedToArray25(_ref, 4), thing = _ref2[0], value2 = _ref2[1], weight = _ref2[2], maximum2 = _ref2[3];
    ...
    var _ref4 = _slicedToArray25(_ref3, 4), weight = _ref4[2], maximum2 = _ref4[3];
    return weight < 0 && maximum2 !== void 0 ? -weight * maximum2 : 0;
  }), adjustedCapacity = capacity + capacityAdjustment;
  if (adjustedCapacity < 0)
    return [-1 / 0, []];
  for (var valuesSorted = _toConsumableArray23(valuesInverted).sort(function(x, y) {
    return x[2] - y[2];
  }), values01 = (_ref5 = []).concat.apply(_ref5, _toConsumableArray23(valuesSorted.map(function(_ref6) {
    var _ref7 = _slicedToArray25(_ref6, 4), thing = _ref7[0], value2 = _ref7[1], weight = _ref7[2], maximum2 = _ref7[3];
  ...
  var _bestSolution = bestSolution(memoizationTable, values01, values01.length - 1, adjustedCapacity), _bestSolution2 = _slicedToArray25(_bestSolution, 2), value = _bestSolution2[0], invertedSolution = _bestSolution2[1], aggregatedSolution = aggregate(invertedSolution), countMap = new Map(aggregatedSolution), valueAdjustment = 0, solution = aggregatedSolution.filter(function(_ref8) {
    var _ref9 = _slicedToArray25(_ref8, 1), thingOrNot2 = _ref9[0];
    return !(thingOrNot2 instanceof Not);
  }), _iterator2 = _createForOfIteratorHelper11(valuesSorted), _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
      var _step2$value = _slicedToArray25(_step2.value, 4), thingOrNot = _step2$value[0], _value = _step2$value[1], maximum = _step2$value[3];
...
function bestSolution(memoizationTable, values, currentIndex, remainingCapacity) {
  ...
  var _values$currentIndex = _slicedToArray25(values[currentIndex], 3), item15 = _values$currentIndex[0], value = _values$currentIndex[1], weight = _values$currentIndex[2], _bestSolution3 = bestSolution(memoizationTable, values, currentIndex - 1, remainingCapacity - weight), _bestSolution4 = _slicedToArray25(_bestSolution3, 2), valueIncludeRest = _bestSolution4[0], itemsInclude = _bestSolution4[1], valueInclude = valueIncludeRest + value, _bestSolution5 = bestSolution(memoizationTable, values, currentIndex - 1, remainingCapacity), _bestSolution6 = _slicedToArray25(_bestSolution5, 2), valueExclude = _bestSolution6[0], itemsExclude = _bestSolution6[1], result = valueInclude > valueExclude ? [valueInclude, [].concat(_toConsumableArray23(itemsInclude), [item15])] : [valueExclude, itemsExclude];
  return memoizationTable[currentIndex][remainingCapacity - 1] = result, result;
}

// src/diet/index.ts
var _templateObject575, _templateObject2144, _templateObject3131, _templateObject4116, _templateObject576, _templateObject659, _templateObject756, _templateObject846, _templateObject937, _templateObject1031, _templateObject1129, _templateObject1228, _templateObject1326, _templateObject1424, _templateObject1522, _templateObject1622, _templateObject1721, _templateObject1821, _templateObject1918, _templateObject2018, _templateObject2145, _templateObject2220, _templateObject2319, _templateObject2418, _templateObject2516, _templateObject2616, _templateObject2716, _templateObject2814, _templateObject2913, _templateObject3013, _templateObject3132, _templateObject3214, _templateObject3313, _templateObject3412, _templateObject3511, _templateObject3611, _templateObject3711, _templateObject3811, _templateObject3911, _templateObject4011, _templateObject4117, _templateObject4213, _templateObject4312, _templateObject4411, _templateObject4510, _templateObject4610, _templateObject4710, _templateObject4810, _templateObject4910, _templateObject5010, _templateObject5112, _templateObject5211, _templateObject5310, _templateObject5410, _templateObject5510, _templateObject5610, _templateObject577, _templateObject584, _templateObject594, _templateObject604, _templateObject6110, _templateObject6210, _templateObject6310, _templateObject6410, _templateObject6510, _templateObject664, _templateObject674, _templateObject684, _templateObject694, _templateObject704, _templateObject7110, _templateObject7210;
...
function _toConsumableArray24(r) {
  return _arrayWithoutHoles24(r) || _iterableToArray24(r) || _unsupportedIterableToArray38(r) || _nonIterableSpread24();
}
...
function isMonday() {
  return get2("Muscle Percent", $item(_templateObject575 || (_templateObject575 = _taggedTemplateLiteral80(["Tuesday's ruby"])))) > 0;
}
function seasoningAdventures(item15) {
  var _getRange = getRange(item15.adventures), _getRange2 = _slicedToArray26(_getRange, 2), min = _getRange2[0], max = _getRange2[1];
...
function _expectedAdventures(menuItem, modifiers) {
  ...
  var _getRange3 = getRange(item15.adventures), _getRange4 = _slicedToArray26(_getRange3, 2), min = _getRange4[0], max = _getRange4[1], interpolated = _toConsumableArray24(new Array(max - min + 1).keys()).map(function(n) {
    return n + min;
  }), forkMugMultiplier = menuItem.itemType() === "food" && (_item$notes = item15.notes) !== null && _item$notes !== void 0 && _item$notes.includes("SALAD") || menuItem.itemType() === "booze" && (_item$notes2 = item15.notes) !== null && _item$notes2 !== void 0 && _item$notes2.includes("BEER") ? 1.5 : 1.3, aioliAdventures = item15.fullness, garish = modifiers.garish && ((_item$notes3 = item15.notes) === null || _item$notes3 === void 0 ? void 0 : _item$notes3.includes("LASAGNA")) && !isMonday(), refinedPalate = modifiers.refinedPalate && ((_item$notes4 = item15.notes) === null || _item$notes4 === void 0 ? void 0 : _item$notes4.includes("WINE")), pinkyRing = modifiers.pinkyRing && ((_item$notes5 = item15.notes) === null || _item$notes5 === void 0 ? void 0 : _item$notes5.includes("WINE"));
  return sum(interpolated, function(baseAdventures) {
    var _item$notes6, _item$notes7, adventures = baseAdventures;
    return modifiers.forkMug && (adventures = Math.floor(adventures * forkMugMultiplier)), (_item$notes6 = item15.notes) !== null && _item$notes6 !== void 0 && _item$notes6.includes("SAUCY") && modifiers.saucemaven && (adventures += (0, import_kolmafia87.myPrimestat)() === $stat(_templateObject2144 || (_templateObject2144 = _taggedTemplateLiteral80(["Mysticality"]))) ? 5 : 3), garish && (adventures += 5), refinedPalate && (adventures = Math.floor(adventures * 1.25)), pinkyRing && (adventures = Math.round(adventures * 1.125)), (_item$notes7 = item15.notes) !== null && _item$notes7 !== void 0 && _item$notes7.includes("MARTINI") && modifiers.tuxedoShirt && (adventures += 2), menuItem.itemType() === "food" && modifiers.mayoflex && adventures++, menuItem.itemType() === "food" && modifiers.seasoning && (adventures += seasoningAdventures(item15)), menuItem.itemType() === "food" && modifiers.aioli && (adventures += aioliAdventures), menuItem.itemType() === "food" && modifiers.whetStone && adventures++, adventures;
  }) / interpolated.length;
}
var MenuItem = /* @__PURE__ */ function() {
  function MenuItem2(item15) {
    var _MenuItem$defaultOpti, options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    _classCallCheck16(this, MenuItem2), _defineProperty21(this, "item", void 0), _defineProperty21(this, "organ", void 0), _defineProperty21(this, "size", void 0), _defineProperty21(this, "maximum", void 0), _defineProperty21(this, "additionalValue", void 0), _defineProperty21(this, "effect", void 0), _defineProperty21(this, "priceOverride", void 0), _defineProperty21(this, "mayo", void 0), _defineProperty21(this, "data", void 0), _defineProperty21(this, "priceCached", void 0), _defineProperty21(this, "itemTypeCached", void 0);
    var _options = _objectSpread10(_objectSpread10({}, options), (_MenuItem$defaultOpti = MenuItem2.defaultOptions().get(item15)) !== null && _MenuItem$defaultOpti !== void 0 ? _MenuItem$defaultOpti : {}), size = _options.size, organ = _options.organ, maximum = _options.maximum, additionalValue = _options.additionalValue, effect2 = _options.effect, priceOverride = _options.priceOverride, mayo = _options.mayo, data = _options.data;
    if (this.item = item15, notNullish(maximum) && (this.maximum = maximum === "auto" ? item15.dailyusesleft : maximum), notNullish(additionalValue) && (this.additionalValue = additionalValue), notNullish(effect2) && (this.effect = effect2), notNullish(priceOverride) && (this.priceOverride = priceOverride), notNullish(mayo) && (this.mayo = mayo), notNullish(data) && (this.data = data), notNullish(organ))
      this.organ = organ;
    else {
      var typ = (0, import_kolmafia87.itemType)(this.item);
  ...
  return _createClass16(MenuItem2, [{
    ...
    key: "itemType",
    value: function() {
      return this.itemTypeCached || (this.itemTypeCached = (0, import_kolmafia87.itemType)(this.item)), this.itemTypeCached;
    }
  }], [{
    key: "defaultOptions",
    value: function() {
      return /* @__PURE__ */ new Map([[$item(_templateObject3131 || (_templateObject3131 = _taggedTemplateLiteral80(["distention pill"]))), {
        organ: "food",
        maximum: !have($item(_templateObject4116 || (_templateObject4116 = _taggedTemplateLiteral80(["distention pill"])))) || get("_distentionPillUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject576 || (_templateObject576 = _taggedTemplateLiteral80(["synthetic dog hair pill"]))), {
        organ: "booze",
        maximum: !have($item(_templateObject659 || (_templateObject659 = _taggedTemplateLiteral80(["synthetic dog hair pill"])))) || get("_syntheticDogHairPillUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject756 || (_templateObject756 = _taggedTemplateLiteral80(["cuppa Voraci tea"]))), {
        organ: "food",
        maximum: get("_voraciTeaUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject846 || (_templateObject846 = _taggedTemplateLiteral80(["cuppa Sobrie tea"]))), {
        organ: "booze",
        maximum: get("_sobrieTeaUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject937 || (_templateObject937 = _taggedTemplateLiteral80(["mojo filter"]))), {
        organ: "spleen item",
        maximum: 3 - get("currentMojoFilters"),
        size: -1
      }], [$item(_templateObject1031 || (_templateObject1031 = _taggedTemplateLiteral80(["spice melange"]))), {
        maximum: get("spiceMelangeUsed") ? 0 : 1
      }], [$item(_templateObject1129 || (_templateObject1129 = _taggedTemplateLiteral80(["Ultra Mega Sour Ball"]))), {
        maximum: get("_ultraMegaSourBallUsed") ? 0 : 1
      }], [$item(_templateObject1228 || (_templateObject1228 = _taggedTemplateLiteral80(["The Plumber's mushroom stew"]))), {
        maximum: get("_plumbersMushroomStewEaten") ? 0 : 1
      }], [$item(_templateObject1326 || (_templateObject1326 = _taggedTemplateLiteral80(["The Mad Liquor"]))), {
        maximum: get("_madLiquorDrunk") ? 0 : 1
      }], [$item(_templateObject1424 || (_templateObject1424 = _taggedTemplateLiteral80(["Doc Clock's thyme cocktail"]))), {
        maximum: get("_docClocksThymeCocktailDrunk") ? 0 : 1
      }], [$item(_templateObject1522 || (_templateObject1522 = _taggedTemplateLiteral80(["Mr. Burnsger"]))), {
        maximum: get("_mrBurnsgerEaten") ? 0 : 1
      }], [$item(_templateObject1622 || (_templateObject1622 = _taggedTemplateLiteral80(["Calzone of Legend"]))), {
        maximum: get("calzoneOfLegendEaten") ? 0 : 1
      }], [$item(_templateObject1721 || (_templateObject1721 = _taggedTemplateLiteral80(["Deep Dish of Legend"]))), {
        maximum: get("deepDishOfLegendEaten") ? 0 : 1
      }], [$item(_templateObject1821 || (_templateObject1821 = _taggedTemplateLiteral80(["Pizza of Legend"]))), {
        maximum: get("pizzaOfLegendEaten") ? 0 : 1
      }], [$item(_templateObject1918 || (_templateObject1918 = _taggedTemplateLiteral80(["jar of fermented pickle juice"]))), {
        maximum: get("_pickleJuiceDrunk") ? 0 : 1
      }], [$item(_templateObject2018 || (_templateObject2018 = _taggedTemplateLiteral80(["extra-greasy slider"]))), {
        maximum: get("_extraGreasySliderEaten") ? 0 : 1
      }], [$item(_templateObject2145 || (_templateObject2145 = _taggedTemplateLiteral80(["voodoo snuff"]))), {
        maximum: get("_voodooSnuffUsed") ? 0 : 1
      }], [$item(_templateObject2220 || (_templateObject2220 = _taggedTemplateLiteral80(["Ol' Scratch's salad fork"]))), {
        maximum: get("_saladForkUsed") ? 0 : 1
      }], [$item(_templateObject2319 || (_templateObject2319 = _taggedTemplateLiteral80(["Frosty's frosty mug"]))), {
        maximum: get("_frostyMugUsed") ? 0 : 1
      }], [$item(_templateObject2418 || (_templateObject2418 = _taggedTemplateLiteral80(["tin cup of mulligan stew"]))), {
        maximum: get("_mulliganStewEaten") ? 0 : 1
      }], [$item(_templateObject2516 || (_templateObject2516 = _taggedTemplateLiteral80(["Hodgman's blanket"]))), {
        maximum: get("_hodgmansBlanketDrunk") ? 0 : 1
      }]]);
    }
  }]);
}();
_defineProperty21(MenuItem, "defaultPriceFunction", function(item15) {
  return (0, import_kolmafia87.npcPrice)(item15) > 0 ? (0, import_kolmafia87.npcPrice)(item15) : (0, import_kolmafia87.mallPrice)(item15);
});
...
var DietPlanner = /* @__PURE__ */ function() {
  function DietPlanner2(mpa, menu) {
    var _this2 = this;
    var _this = this;
    _classCallCheck16(this, DietPlanner2), _defineProperty21(this, "mpa", void 0), _defineProperty21(this, "menu", void 0), _defineProperty21(this, "mayoLookup", void 0), _defineProperty21(this, "fork", void 0), _defineProperty21(this, "mug", void 0), _defineProperty21(this, "seasoning", void 0), _defineProperty21(this, "whetStone", void 0), _defineProperty21(this, "aioli", void 0), _defineProperty21(this, "spleenValue", 0), _defineProperty21(this, "baseDefaultModifiers", {
      forkMug: !1,
      seasoning: !1,
      whetStone: !1,
      aioli: !1,
      mayoflex: !1,
      refinedPalate: have($effect(_templateObject2616 || (_templateObject2616 = _taggedTemplateLiteral80(["Refined Palate"])))),
      garish: have($effect(_templateObject2716 || (_templateObject2716 = _taggedTemplateLiteral80(["Gar-ish"])))),
      saucemaven: have($skill(_templateObject2814 || (_templateObject2814 = _taggedTemplateLiteral80(["Saucemaven"])))),
      pinkyRing: have($item(_templateObject2913 || (_templateObject2913 = _taggedTemplateLiteral80(["mafia pinky ring"])))) && (0, import_kolmafia87.canEquip)($item(_templateObject3013 || (_templateObject3013 = _taggedTemplateLiteral80(["mafia pinky ring"])))),
      tuxedoShirt: have($item(_templateObject3132 || (_templateObject3132 = _taggedTemplateLiteral80(["tuxedo shirt"])))) && (0, import_kolmafia87.canEquip)($item(_templateObject3214 || (_templateObject3214 = _taggedTemplateLiteral80(["tuxedo shirt"]))))
    }), this.mpa = mpa;
    var fork = menu.find(function(item15) {
      return item15.item === $item(_templateObject3313 || (_templateObject3313 = _taggedTemplateLiteral80(["Ol' Scratch's salad fork"])));
    });
    fork && (this.fork = fork);
    var mug = menu.find(function(item15) {
      return item15.item === $item(_templateObject3412 || (_templateObject3412 = _taggedTemplateLiteral80(["Frosty's frosty mug"])));
    });
    mug && (this.mug = mug);
    var seasoning = menu.find(function(item15) {
      return item15.item === $item(_templateObject3511 || (_templateObject3511 = _taggedTemplateLiteral80(["Special Seasoning"])));
    });
    seasoning && (this.seasoning = seasoning);
    var whetStone = menu.find(function(item15) {
      return item15.item === $item(_templateObject3611 || (_templateObject3611 = _taggedTemplateLiteral80(["whet stone"])));
    });
    whetStone && (this.whetStone = whetStone);
    var aioli = menu.find(function(item15) {
      return item15.item === $item(_templateObject3711 || (_templateObject3711 = _taggedTemplateLiteral80(["mini kiwi aioli"])));
    });
    if (aioli && (this.aioli = aioli), this.mayoLookup = /* @__PURE__ */ new Map(), installed3())
      for (var _loop = function() {
        var mayo = _arr[_i], menuItem = menu.find(function(item15) {
          return item15.item === mayo;
        });
        menuItem && _this.mayoLookup.set(mayo, menuItem);
      }, _i = 0, _arr = [Mayo.flex, Mayo.zapine]; _i < _arr.length; _i++)
        _loop();
    this.menu = menu.filter(function(item15) {
      return item15.organ;
    }), menu.filter(function(item15) {
      return (0, import_kolmafia87.historicalPrice)(item15.item) === 0 || (0, import_kolmafia87.historicalAge)(item15.item) >= 1;
    }).length > 100 && ((0, import_kolmafia87.mallPrices)("food"), (0, import_kolmafia87.mallPrices)("booze"));
    var spleenItems = menu.filter(function(item15) {
      return (0, import_kolmafia87.itemType)(item15.item) === "spleen item";
    });
    if (spleenItems.sort(function(x, y) {
      ...
      var bestMarginalSpleenItem = spleenItems.find(function(spleenItem) {
        return spleenItem.maximum === void 0 || spleenItem.maximum * spleenItem.size >= (0, import_kolmafia87.spleenLimit)() - (0, import_kolmafia87.mySpleenUse)();
      });
  ...
  return _createClass16(DietPlanner2, [{
    ...
    value: function(menuItem, overrideModifiers) {
      ...
      var defaultModifiers = _objectSpread10(_objectSpread10({}, this.baseDefaultModifiers), {}, {
      ...
      var forkMug = menuItem.itemType() === "food" ? this.fork : menuItem.itemType() === "booze" ? this.mug : null, forkMugPrice = forkMug ? forkMug.price() : 1 / 0, baseCost = menuItem.price() + sum(helpers, function(item15) {
        return item15.price();
      }), valueRaw = _expectedAdventures(menuItem, defaultModifiers) * this.mpa - baseCost + ((_menuItem$additionalV = menuItem.additionalValue) !== null && _menuItem$additionalV !== void 0 ? _menuItem$additionalV : 0), valueForkMug = _expectedAdventures(menuItem, _objectSpread10(_objectSpread10({}, defaultModifiers), {}, {
        forkMug: !0
      })) * this.mpa - baseCost - forkMugPrice + ((_menuItem$additionalV2 = menuItem.additionalValue) !== null && _menuItem$additionalV2 !== void 0 ? _menuItem$additionalV2 : 0), valueSpleen = $items(_templateObject3811 || (_templateObject3811 = _taggedTemplateLiteral80(["jar of fermented pickle juice, extra-greasy slider"]))).includes(menuItem.item) ? 5 * this.spleenValue : 0;
    ...
    value: function(organ, capacity) {
      ...
      var overrideModifiers = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, submenu = this.menu.filter(function(menuItem) {
        return menuItem.organ === organ && (0, import_kolmafia87.myLevel)() >= menuItem.item.levelreq;
      }), knapsackValues = submenu.map(function(menuItem) {
        return [].concat(_toConsumableArray24(_this.consumptionHelpersAndValue(menuItem, overrideModifiers)), [menuItem.size, menuItem.maximum]);
      });
    ...
    value: function(organCapacities) {
      ...
      var _ref5, overrideModifiers = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, valuePlans = organCapacities.map(function(_ref) {
        var _ref2 = _slicedToArray26(_ref, 2), organ = _ref2[0], capacity = _ref2[1];
        return _this.planOrgan(organ, capacity, overrideModifiers);
      });
      return [sum(valuePlans, function(_ref3) {
        var _ref4 = _slicedToArray26(_ref3, 1), value = _ref4[0];
        return value;
      }), (_ref5 = []).concat.apply(_ref5, _toConsumableArray24(valuePlans.map(function(_ref6) {
        var _ref7 = _slicedToArray26(_ref6, 2), plan = _ref7[1];
        return plan;
      })))];
    }
    /**
    ...
    value: function(organCapacities, trialItems, overrideModifiers) {
      ...
      var _trialItems$ = _slicedToArray26(trialItems[0], 2), trialItem = _trialItems$[0], organSizes = _trialItems$[1];
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          var _step$value = _slicedToArray26(_step.value, 2), organ = _step$value[0], size = _step$value[1], current2 = organCapacitiesWithMap.get(organ);
          if (current2 === void 0)
            return this.planOrgansWithTrials(organCapacities, trialItems.slice(1), overrideModifiers);
      ...
      var organCapacitiesWith = _toConsumableArray24(organCapacitiesWithMap), isRefinedPalate = trialItem.item === $item(_templateObject3911 || (_templateObject3911 = _taggedTemplateLiteral80(["pocket wish"]))) && trialItem.effect === $effect(_templateObject4011 || (_templateObject4011 = _taggedTemplateLiteral80(["Refined Palate"]))) || trialItem.item === $item(_templateObject4117 || (_templateObject4117 = _taggedTemplateLiteral80(["toasted brie"]))), isGarish = trialItem.item === $item(_templateObject4213 || (_templateObject4213 = _taggedTemplateLiteral80(["pocket wish"]))) && trialItem.effect === $effect(_templateObject4312 || (_templateObject4312 = _taggedTemplateLiteral80(["Gar-ish"]))) || trialItem.item === $item(_templateObject4411 || (_templateObject4411 = _taggedTemplateLiteral80(["potion of the field gar"]))), _this$planOrgansWithT = this.planOrgansWithTrials(organCapacities, trialItems.slice(1), overrideModifiers), _this$planOrgansWithT2 = _slicedToArray26(_this$planOrgansWithT, 2), valueWithout = _this$planOrgansWithT2[0], planWithout = _this$planOrgansWithT2[1], _this$planOrgansWithT3 = this.planOrgansWithTrials(organCapacitiesWith, trialItems.slice(1), _objectSpread10(_objectSpread10(_objectSpread10({}, overrideModifiers), isRefinedPalate ? {
        refinedPalate: !0
      } : {}), isGarish ? {
        garish: !0
      } : {})), _this$planOrgansWithT4 = _slicedToArray26(_this$planOrgansWithT3, 2), valueWith = _this$planOrgansWithT4[0], planWith = _this$planOrgansWithT4[1], _this$consumptionHelp = this.consumptionHelpersAndValue(trialItem, {}), _this$consumptionHelp2 = _slicedToArray26(_this$consumptionHelp, 2), helpersAndItem = _this$consumptionHelp2[0], value = _this$consumptionHelp2[1];
      return valueWithout > valueWith + value ? [valueWithout, planWithout] : [valueWith + value, [].concat(_toConsumableArray24(planWith), [[helpersAndItem, 1]])];
    }
  }]);
}(), interactingItems = [[$item(_templateObject4510 || (_templateObject4510 = _taggedTemplateLiteral80(["spice melange"]))), [["food", -3], ["booze", -3]]], [$item(_templateObject4610 || (_templateObject4610 = _taggedTemplateLiteral80(["Ultra Mega Sour Ball"]))), [["food", -3], ["booze", -3]]], [$item(_templateObject4710 || (_templateObject4710 = _taggedTemplateLiteral80(["The Plumber's mushroom stew"]))), [["food", 3], ["booze", -1]]], [$item(_templateObject4810 || (_templateObject4810 = _taggedTemplateLiteral80(["The Mad Liquor"]))), [["food", -1], ["booze", 3]]], [$item(_templateObject4910 || (_templateObject4910 = _taggedTemplateLiteral80(["Doc Clock's thyme cocktail"]))), [["food", -2], ["booze", 4]]], [$item(_templateObject5010 || (_templateObject5010 = _taggedTemplateLiteral80(["Mr. Burnsger"]))), [["food", 4], ["booze", -2]]], [$effect(_templateObject5112 || (_templateObject5112 = _taggedTemplateLiteral80(["Refined Palate"]))), []], [$item(_templateObject5211 || (_templateObject5211 = _taggedTemplateLiteral80(["toasted brie"]))), [["food", 2]]], [$effect(_templateObject5310 || (_templateObject5310 = _taggedTemplateLiteral80(["Gar-ish"]))), []], [$item(_templateObject5410 || (_templateObject5410 = _taggedTemplateLiteral80(["potion of the field gar"]))), []]];
function planDiet(mpa, menu) {
  var organCapacities = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [["food", null], ["booze", null], ["spleen item", null]], resolvedOrganCapacities = organCapacities.map(function(_ref8) {
    var _ref9 = _slicedToArray26(_ref8, 2), organ = _ref9[0], size = _ref9[1];
    return [organ, size != null ? size : organ === "food" ? (0, import_kolmafia87.fullnessLimit)() - (0, import_kolmafia87.myFullness)() : organ === "booze" ? (0, import_kolmafia87.inebrietyLimit)() - (0, import_kolmafia87.myInebriety)() : organ === "spleen item" ? (0, import_kolmafia87.spleenLimit)() - (0, import_kolmafia87.mySpleenUse)() : 0];
  }), includedInteractingItems = menu.map(function(menuItem) {
    var interacting = interactingItems.find(function(_ref10) {
      var _ref11 = _slicedToArray26(_ref10, 1), itemOrEffect = _ref11[0];
      return menuItem.item === itemOrEffect || menuItem.item === $item(_templateObject5510 || (_templateObject5510 = _taggedTemplateLiteral80(["pocket wish"]))) && menuItem.effect === itemOrEffect;
    });
    if (interacting) {
      var _interacting = _slicedToArray26(interacting, 2), organSizes = _interacting[1];
    ...
    return !includedInteractingItems.some(function(_ref12) {
      var _ref13 = _slicedToArray26(_ref12, 1), interacting = _ref13[0];
    ...
    var _ref15 = _slicedToArray26(_ref14, 2), organ = _ref15[0], capacity = _ref15[1];
    return ["food", "booze"].includes(organ) && capacity >= 0;
  }), includedInteractingItems, {}), _dietPlanner$planOrga2 = _slicedToArray26(_dietPlanner$planOrga, 2), planFoodBooze = _dietPlanner$planOrga2[1], spleenCapacity = resolvedOrganCapacities.find(function(_ref16) {
    var _ref17 = _slicedToArray26(_ref16, 1), organ = _ref17[0];
    return organ === "spleen item";
  });
  if (spleenCapacity) {
    var additionalSpleen = sum(planFoodBooze, function(_ref18) {
      var _ref19 = _slicedToArray26(_ref18, 2), items = _ref19[0], number = _ref19[1];
      return items.some(function(menuItem) {
        return $items(_templateObject5610 || (_templateObject5610 = _taggedTemplateLiteral80(["jar of fermented pickle juice, extra-greasy slider"]))).includes(menuItem.item);
      }) ? 5 * number : 0;
    }), _spleenCapacity = _slicedToArray26(spleenCapacity, 2), availableSpleen = _spleenCapacity[1], _dietPlanner$planOrga3 = dietPlanner.planOrgan("spleen item", availableSpleen + additionalSpleen), _dietPlanner$planOrga4 = _slicedToArray26(_dietPlanner$planOrga3, 2), planSpleen = _dietPlanner$planOrga4[1];
    return [].concat(_toConsumableArray24(planFoodBooze), _toConsumableArray24(planSpleen));
  } else
    return planFoodBooze;
}
var DietEntry = /* @__PURE__ */ function() {
  function DietEntry2(menuItems, quantity) {
    _classCallCheck16(this, DietEntry2), _defineProperty21(this, "quantity", void 0), _defineProperty21(this, "menuItems", void 0), this.menuItems = Object.freeze(menuItems), this.quantity = quantity;
  }
    ...
    value: function(diet) {
      {
        ...
        var items = this.menuItems.map(function(m) {
          return m.item;
        }), targetItem = this.menuItems[this.menuItems.length - 1].item, fork = (0, import_kolmafia87.itemType)(targetItem) === "food" && items.includes($item(_templateObject577 || (_templateObject577 = _taggedTemplateLiteral80(["Ol' Scratch's salad fork"])))), mug = (0, import_kolmafia87.itemType)(targetItem) === "booze" && items.includes($item(_templateObject584 || (_templateObject584 = _taggedTemplateLiteral80(["Frosty's frosty mug"]))));
        return this.quantity * _expectedAdventures(this.menuItems[this.menuItems.length - 1], {
          forkMug: fork || mug,
          seasoning: items.includes($item(_templateObject594 || (_templateObject594 = _taggedTemplateLiteral80(["Special Seasoning"])))),
          whetStone: items.includes($item(_templateObject604 || (_templateObject604 = _taggedTemplateLiteral80(["whet stone"])))),
          aioli: items.includes($item(_templateObject6110 || (_templateObject6110 = _taggedTemplateLiteral80(["mini kiwi aioli"])))),
  ...
  function Diet2() {
    ...
    _classCallCheck16(this, Diet2), _defineProperty21(this, "entries", void 0), this.entries = entries;
  }
  return _createClass16(Diet2, [{
    ...
    get: function() {
      return this.entries.some(function(dietEntry) {
        return dietEntry.menuItems.some(function(trialItem) {
          return trialItem.item === $item(_templateObject6210 || (_templateObject6210 = _taggedTemplateLiteral80(["pocket wish"]))) && trialItem.effect === $effect(_templateObject6310 || (_templateObject6310 = _taggedTemplateLiteral80(["Refined Palate"]))) || trialItem.item === $item(_templateObject6410 || (_templateObject6410 = _taggedTemplateLiteral80(["toasted brie"])));
        });
      });
    }
  }, {
    ...
    get: function() {
      return this.entries.some(function(dietEntry) {
        return dietEntry.menuItems.some(function(trialItem) {
          return trialItem.item === $item(_templateObject6510 || (_templateObject6510 = _taggedTemplateLiteral80(["pocket wish"]))) && trialItem.effect === $effect(_templateObject664 || (_templateObject664 = _taggedTemplateLiteral80(["Gar-ish"]))) || trialItem.item === $item(_templateObject674 || (_templateObject674 = _taggedTemplateLiteral80(["potion of the field gar"])));
        });
      });
    }
  }, {
    key: "saucemaven",
    get: function() {
      return have($skill(_templateObject684 || (_templateObject684 = _taggedTemplateLiteral80(["Saucemaven"]))));
    }
  }, {
    key: "tuxedoShirt",
    get: function() {
      return have($item(_templateObject694 || (_templateObject694 = _taggedTemplateLiteral80(["tuxedo shirt"])))) && (0, import_kolmafia87.canEquip)($item(_templateObject704 || (_templateObject704 = _taggedTemplateLiteral80(["tuxedo shirt"]))));
    }
  }, {
    key: "pinkyRing",
    get: function() {
      return have($item(_templateObject7110 || (_templateObject7110 = _taggedTemplateLiteral80(["mafia pinky ring"])))) && (0, import_kolmafia87.canEquip)($item(_templateObject7210 || (_templateObject7210 = _taggedTemplateLiteral80(["mafia pinky ring"]))));
    }
  }, {
    key: "expectedAdventures",
    value: function() {
    ...
    key: "copy",
    value: function() {
      return new Diet2(_toConsumableArray24(this.entries));
    }
  }], [{
    key: "from",
    value: function(rawDiet) {
      var diet = rawDiet.map(function(item15) {
        var _item = _slicedToArray26(item15, 2), menuItems = _item[0], quantity = _item[1];
...
var Dungeon = /* @__PURE__ */ function() {
  function Dungeon2(name_, loot, openAction, closeAction, openCost, openImage, closedImage) {
    _classCallCheck17(this, Dungeon2), _defineProperty22(this, "name_", void 0), _defineProperty22(this, "loot", void 0), _defineProperty22(this, "openAction", void 0), _defineProperty22(this, "closeAction", void 0), _defineProperty22(this, "openCost", void 0), _defineProperty22(this, "openImage", void 0), _defineProperty22(this, "closedImage", void 0), this.name_ = name_, this.loot = loot, this.openAction = openAction, this.closeAction = closeAction, this.openCost = openCost, this.openImage = openImage, this.closedImage = closedImage;
  }
  return _createClass17(Dungeon2, [{
    key: "possibleLoot",
    get: function() {
      return _toConsumableArray25(this.loot);
    }
  }, {
    key: "name",
    get: function() {
    ...
    value: function(idOrname_) {
      ...
      var pageText = (0, import_kolmafia88.visitUrl)("clan_basement.php");
      if (!pageText.match(new RegExp(player.name, "i")))
        throw new Error("".concat(player.name, " cannot be distributed loot from ").concat((0, import_kolmafia88.getClanName)()));
      var itemname_s = (0, import_kolmafia88.xpath)(pageText, "//tr/td[2]/b/text()"), whichLoots = (0, import_kolmafia88.xpath)(pageText, '//form[@action="clan_basement.php"]//input[@type="hidden"][@name_="whichloot"]/@value');
      itemname_s.forEach(function(itemname_, index) {
        lootList.includes((0, import_kolmafia88.toItem)(itemname_)) && ((0, import_kolmafia88.visitUrl)("clan_basement.php?whichloot=".concat(whichLoots[index], "&recipient=").concat(player.id)), distributeAllOfAGivenItem || lootList.splice(lootList.indexOf((0, import_kolmafia88.toItem)(itemname_))));
      });
    }
    /**
     * Close this dungeon
    ...
    key: "close",
    value: function() {
      (0, import_kolmafia88.visitUrl)("clan_basement.php?action=".concat(this.closeAction, "&confirm=true"), !0);
      var pageText = (0, import_kolmafia88.visitUrl)("clan_basement.php");
    ...
    key: "open",
    value: function() {
      var paymentPolicy = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "Difference", pageText = (0, import_kolmafia88.visitUrl)("clan_basement.php");
      ...
      return (0, import_kolmafia88.visitUrl)("clan_basement.php?action=".concat(this.openAction), !0), (0, import_kolmafia88.visitUrl)("clan_basement.php").includes(this.openImage);
    }
    /**
    ...
    key: "findLoot",
    value: function() {
      var result = /* @__PURE__ */ new Map(), pageText = (0, import_kolmafia88.visitUrl)("clan_basement.php"), _iterator = _createForOfIteratorHelper13(this.loot), _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
...
function _toConsumableArray26(r) {
  return _arrayWithoutHoles26(r) || _iterableToArray26(r) || _unsupportedIterableToArray40(r) || _nonIterableSpread26();
}
...
function _slicedToArray27(r, e) {
  return _arrayWithHoles27(r) || _iterableToArrayLimit27(r, e) || _unsupportedIterableToArray40(r, e) || _nonIterableRest27();
}
...
var Mine = /* @__PURE__ */ function(Mine2) {
  ...
  return !(coord.length != 2 || coord[0] < 0 || coord[0] > 7 || coord[1] < 0 || coord[1] > 7);
};
function hasObjectDetection() {
  var mine = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Mine.ITZNOTYERZITZ;
  return mine === Mine.CRIMBONIUM && have($effect(_templateObject579 || (_templateObject579 = _taggedTemplateLiteral82(["Crimbonar"])))) ? !0 : (0, import_kolmafia89.haveEffect)($effect(_templateObject2147 || (_templateObject2147 = _taggedTemplateLiteral82(["Object Detection"])))) !== 0 || (0, import_kolmafia89.isWearingOutfit)("Dwarvish War Uniform");
}
function caveInCost(mine) {
  switch (mine) {
    ...
    case Mine.CRIMBONIUM:
      return (0, import_kolmafia89.myBuffedstat)($stat(_templateObject3134 || (_templateObject3134 = _taggedTemplateLiteral82(["muscle"])))) * 1.5;
    case Mine.KNOB:
      return (0, import_kolmafia89.myBuffedstat)($stat(_templateObject4118 || (_templateObject4118 = _taggedTemplateLiteral82(["muscle"])))) * 0.5;
    case Mine.ANEMONE:
      return (0, import_kolmafia89.myBuffedstat)($stat(_templateObject580 || (_templateObject580 = _taggedTemplateLiteral82(["muscle"])))) * 2.5;
    case Mine.VOLCANO:
      return damageTakenByElement(75, $element(_templateObject660 || (_templateObject660 = _taggedTemplateLiteral82(["hot"]))));
    default:
      return 0;
  }
}
var stateIndexToCoord = function(position) {
  var row = Math.floor(position / 6) + 1, col = position % 6 + 1, coord = [col, row];
  ...
  return row >= 5 && state[index] === "*" ? [coords] : state[index] !== "o" ? [] : [[-1, 0], [1, 0], [0, -1], [0, 1]].map(function(_ref) {
    var _ref2 = _slicedToArray27(_ref, 2), dy = _ref2[0], dx = _ref2[1], y = col + dy, x = row + dx;
...
function getAccessibleSparkles(mine) {
  ...
  return _toConsumableArray26(Array(state.length).fill(0)).flatMap(function(v, position) {
...
function findNewCavern(mine) {
  return (0, import_kolmafia89.visitUrl)("mining.php?mine=".concat(mine, "&reset=1&pwd"), !0);
}
function mineCoordinate(mine, _ref3) {
  var _ref4 = _slicedToArray27(_ref3, 2), col = _ref4[0], row = _ref4[1], page = (0, import_kolmafia89.visitUrl)("mining.php?mine=".concat(mine, "&which=").concat(col + 8 * row, "&pwd"), !0);
  return extractItems(page);
}
function visit2(mine) {
  return (0, import_kolmafia89.visitUrl)("mining.php?mine=".concat(mine));
}
...
function countFreeMines() {
  return (have($skill(_templateObject757 || (_templateObject757 = _taggedTemplateLiteral82(["Unaccompanied Miner"])))) ? 5 - get("_unaccompaniedMinerUsed") : 0) + (0, import_kolmafia89.haveEffect)($effect(_templateObject847 || (_templateObject847 = _taggedTemplateLiteral82(["Loded"]))));
}
...
function _toConsumableArray27(r) {
  return _arrayWithoutHoles27(r) || _iterableToArray27(r) || _unsupportedIterableToArray41(r) || _nonIterableSpread27();
}
...
var aprilShieldEffects = /* @__PURE__ */ new Map([[$skill(_templateObject581 || (_templateObject581 = _taggedTemplateLiteral83(["Empathy of the Newt"]))), $effect(_templateObject2148 || (_templateObject2148 = _taggedTemplateLiteral83(["Thoughtful Empathy"])))], [$skill(_templateObject3135 || (_templateObject3135 = _taggedTemplateLiteral83(["Sauce Contemplation"]))), $effect(_templateObject4119 || (_templateObject4119 = _taggedTemplateLiteral83(["Lubricating Sauce"])))], [$skill(_templateObject585 || (_templateObject585 = _taggedTemplateLiteral83(["Manicotti Meditation"]))), $effect(_templateObject661 || (_templateObject661 = _taggedTemplateLiteral83(["Tubes of Universal Meat"])))], [$skill(_templateObject758 || (_templateObject758 = _taggedTemplateLiteral83(["Seal Clubbing Frenzy"]))), $effect(_templateObject848 || (_templateObject848 = _taggedTemplateLiteral83(["Slippery as a Seal"])))], [$skill(_templateObject938 || (_templateObject938 = _taggedTemplateLiteral83(["Patience of the Tortoise"]))), $effect(_templateObject1032 || (_templateObject1032 = _taggedTemplateLiteral83(["Strength of the Tortoise"])))], [$skill(_templateObject1130 || (_templateObject1130 = _taggedTemplateLiteral83(["Disco Aerobics"]))), $effect(_templateObject1229 || (_templateObject1229 = _taggedTemplateLiteral83(["Disco over Matter"])))], [$skill(_templateObject1327 || (_templateObject1327 = _taggedTemplateLiteral83(["Moxie of the Mariachi"]))), $effect(_templateObject1425 || (_templateObject1425 = _taggedTemplateLiteral83(["Mariachi Moisture"])))]]), MpSource = /* @__PURE__ */ function() {
  function MpSource2() {
  ...
  function OscusSoda2() {
    return _classCallCheck18(this, OscusSoda2), _callSuper4(this, OscusSoda2, arguments);
  }
  return _inherits5(OscusSoda2, _MpSource), _createClass18(OscusSoda2, [{
    key: "available",
    value: function() {
      return have($item(_templateObject1523 || (_templateObject1523 = _taggedTemplateLiteral83(["Oscus's neverending soda"]))));
    }
  }, {
    key: "usesRemaining",
    value: function() {
    ...
    key: "execute",
    value: function() {
      (0, import_kolmafia90.use)($item(_templateObject1623 || (_templateObject1623 = _taggedTemplateLiteral83(["Oscus's neverending soda"]))));
    }
  }]);
}(MpSource);
_OscusSoda = OscusSoda;
_defineProperty23(OscusSoda, "instance", new _OscusSoda());
var MagicalSausages = /* @__PURE__ */ function(_MpSource2) {
  function MagicalSausages2() {
    return _classCallCheck18(this, MagicalSausages2), _callSuper4(this, MagicalSausages2, arguments);
  }
  return _inherits5(MagicalSausages2, _MpSource2), _createClass18(MagicalSausages2, [{
    key: "available",
    value: function() {
      return have($item(_templateObject1722 || (_templateObject1722 = _taggedTemplateLiteral83(["Kramco Sausage-o-Matic\u2122"]))));
    }
  }, {
    key: "usesRemaining",
    value: function() {
      var maxSausages = (0, import_kolmafia90.availableAmount)($item(_templateObject1822 || (_templateObject1822 = _taggedTemplateLiteral83(["magical sausage"])))) + (0, import_kolmafia90.availableAmount)($item(_templateObject1919 || (_templateObject1919 = _taggedTemplateLiteral83(["magical sausage casing"]))));
      return this.available() ? clamp(23 - get("_sausagesEaten"), 0, maxSausages) : 0;
    }
  }, {
    key: "availableMpMin",
    value: function() {
      return this.available() ? Math.min((0, import_kolmafia90.myMaxmp)(), 999) * this.usesRemaining() : 0;
    }
  }, {
    key: "execute",
    value: function() {
      var mpSpaceAvailable = (0, import_kolmafia90.myMaxmp)() - (0, import_kolmafia90.myMp)();
      if (!(mpSpaceAvailable < 700)) {
        var maxSausages = Math.min(this.usesRemaining(), Math.floor(((0, import_kolmafia90.myMaxmp)() - (0, import_kolmafia90.myMp)()) / Math.min((0, import_kolmafia90.myMaxmp)() - (0, import_kolmafia90.myMp)(), 999)));
        (0, import_kolmafia90.retrieveItem)(maxSausages, $item(_templateObject2019 || (_templateObject2019 = _taggedTemplateLiteral83(["magical sausage"])))), (0, import_kolmafia90.eat)(maxSausages, $item(_templateObject2149 || (_templateObject2149 = _taggedTemplateLiteral83(["magical sausage"]))));
      }
    }
  }]);
}(MpSource);
_MagicalSausages = MagicalSausages;
_defineProperty23(MagicalSausages, "instance", new _MagicalSausages());
var MoodElement = /* @__PURE__ */ function() {
  ...
  function SkillMoodElement2(skill, options) {
    var _aprilShieldEffects$g, _this;
    return _classCallCheck18(this, SkillMoodElement2), _this = _callSuper4(this, SkillMoodElement2), _defineProperty23(_this, "skill", void 0), _defineProperty23(_this, "effect", void 0), _defineProperty23(_this, "options", void 0), _this.skill = skill, _this.effect = options.requireAprilShield ? (_aprilShieldEffects$g = aprilShieldEffects.get(skill)) !== null && _aprilShieldEffects$g !== void 0 ? _aprilShieldEffects$g : $effect.none : (0, import_kolmafia90.toEffect)(skill), _this.options = options, _this;
  }
  return _inherits5(SkillMoodElement2, _MoodElement), _createClass18(SkillMoodElement2, [{
    key: "aprilShieldRestricted",
    get: function() {
      return !this.options.requireAprilShield && this.skill === $skill(_templateObject2221 || (_templateObject2221 = _taggedTemplateLiteral83(["Empathy of the Newt"])));
    }
  }, {
    key: "mpCostPerTurn",
    value: function() {
      var turns2 = (0, import_kolmafia90.turnsPerCast)(this.skill);
      return turns2 > 0 ? (0, import_kolmafia90.mpCost)(this.skill) / turns2 : 0;
    }
  }, {
    key: "turnIncrement",
    value: function() {
      return (0, import_kolmafia90.turnsPerCast)(this.skill);
    }
  }, {
    key: "execute",
    value: function(mood, ensureTurns) {
      ...
      var initialTurns = (0, import_kolmafia90.haveEffect)(this.effect), shieldSlot = import_kolmafia90.Slot.all().find(function(slot) {
        return (0, import_kolmafia90.equippedItem)(slot) === $item(_templateObject2320 || (_templateObject2320 = _taggedTemplateLiteral83(["April Shower Thoughts shield"])));
      }), initialOffhand = (0, import_kolmafia90.equippedItem)($slot(_templateObject2419 || (_templateObject2419 = _taggedTemplateLiteral83(["off-hand"])))), initialWeapon = (0, import_kolmafia90.equippedItem)($slot(_templateObject2517 || (_templateObject2517 = _taggedTemplateLiteral83(["weapon"]))));
      if (initialTurns >= ensureTurns) return !0;
      if (!(0, import_kolmafia90.haveSkill)(this.skill)) return !1;
      if (this.aprilShieldRestricted && shieldSlot && unequip($item(_templateObject2617 || (_templateObject2617 = _taggedTemplateLiteral83(["April Shower Thoughts shield"])))), mood.options.songSlots && isSong(this.skill) && !have(this.effect)) {
        ...
        try {
          var _loop = function() {
            ...
            if (!slot || slot.includes(_this2.effect))
              return (0, import_kolmafia90.cliExecute)("shrug ".concat(song2)), 1;
          };
      ...
      var oldRemainingCasts = -1, remainingCasts = Math.ceil((ensureTurns - (0, import_kolmafia90.haveEffect)(this.effect)) / (0, import_kolmafia90.turnsPerCast)(this.skill));
      try {
        for (; remainingCasts > 0 && oldRemainingCasts !== remainingCasts; ) {
          if (this.options.requireAprilShield && !shieldSlot && ((0, import_kolmafia90.weaponHands)(initialWeapon) > 1 && unequip(initialWeapon), !(0, import_kolmafia90.equip)($item(_templateObject2717 || (_templateObject2717 = _taggedTemplateLiteral83(["April Shower Thoughts shield"]))))))
            return !1;
          var maxCasts = 0;
          if ((0, import_kolmafia90.hpCost)(this.skill) > 0)
            maxCasts = Math.max(0, Math.floor(((0, import_kolmafia90.myHp)() - 1) / (0, import_kolmafia90.hpCost)(this.skill)));
          else {
            var cost = (0, import_kolmafia90.mpCost)(this.skill);
            if (maxCasts = Math.floor(Math.min(mood.availableMp(), (0, import_kolmafia90.myMp)()) / cost), maxCasts < remainingCasts) {
              var bestMp = Math.min(remainingCasts * cost, (0, import_kolmafia90.myMaxmp)());
              mood.moreMp(bestMp), maxCasts = Math.floor(Math.min(mood.availableMp(), (0, import_kolmafia90.myMp)()) / cost);
            }
          }
          var casts = clamp(remainingCasts, 0, Math.min(100, maxCasts));
          (0, import_kolmafia90.useSkill)(casts, this.skill), oldRemainingCasts = remainingCasts, remainingCasts = Math.ceil((ensureTurns - (0, import_kolmafia90.haveEffect)(this.effect)) / (0, import_kolmafia90.turnsPerCast)(this.skill));
        }
        return (0, import_kolmafia90.haveEffect)(this.effect) >= ensureTurns;
      } finally {
        shieldSlot && (0, import_kolmafia90.equip)($item(_templateObject2815 || (_templateObject2815 = _taggedTemplateLiteral83(["April Shower Thoughts shield"]))), shieldSlot), initialOffhand !== (0, import_kolmafia90.equippedItem)($slot(_templateObject2914 || (_templateObject2914 = _taggedTemplateLiteral83(["off-hand"])))) && (0, import_kolmafia90.equip)(initialOffhand, $slot(_templateObject3014 || (_templateObject3014 = _taggedTemplateLiteral83(["off-hand"])))), initialWeapon !== (0, import_kolmafia90.equippedItem)($slot(_templateObject3136 || (_templateObject3136 = _taggedTemplateLiteral83(["weapon"])))) && (0, import_kolmafia90.equip)(initialWeapon, $slot(_templateObject3215 || (_templateObject3215 = _taggedTemplateLiteral83(["weapon"]))));
      }
    }
  }]);
  ...
  function PotionMoodElement2(potion, maxPricePerTurn) {
    var _this3;
    return _classCallCheck18(this, PotionMoodElement2), _this3 = _callSuper4(this, PotionMoodElement2), _defineProperty23(_this3, "potion", void 0), _defineProperty23(_this3, "maxPricePerTurn", void 0), _this3.potion = potion, _this3.maxPricePerTurn = maxPricePerTurn, _this3;
  }
  return _inherits5(PotionMoodElement2, _MoodElement2), _createClass18(PotionMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
      var effect2 = (0, import_kolmafia90.effectModifier)(this.potion, "Effect"), effectTurns = (0, import_kolmafia90.haveEffect)(effect2), turnsPerUse = (0, import_kolmafia90.numericModifier)(this.potion, "Effect Duration");
      if ((0, import_kolmafia90.mallPrice)(this.potion) > this.maxPricePerTurn * turnsPerUse)
        return !1;
      if (effectTurns < ensureTurns) {
        var uses = Math.floor((ensureTurns - effectTurns) / turnsPerUse), quantityToBuy = clamp(uses - (0, import_kolmafia90.availableAmount)(this.potion), 0, 100);
        (0, import_kolmafia90.buy)(quantityToBuy, this.potion, Math.floor(this.maxPricePerTurn * turnsPerUse));
        var quantityToUse = clamp(uses, 0, (0, import_kolmafia90.availableAmount)(this.potion));
        (0, import_kolmafia90.use)(quantityToUse, this.potion);
      }
      var remainingDifference = ensureTurns - (0, import_kolmafia90.haveEffect)(effect2);
      if (remainingDifference > 0) {
        var maxPrice = Math.floor(this.maxPricePerTurn * remainingDifference);
        (0, import_kolmafia90.mallPrice)(this.potion) <= maxPrice && ((0, import_kolmafia90.availableAmount)(this.potion) || (0, import_kolmafia90.buy)(1, this.potion, maxPrice)) && (0, import_kolmafia90.use)(1, this.potion);
      }
      return (0, import_kolmafia90.haveEffect)(effect2) >= ensureTurns;
    }
  }]);
}(MoodElement), GenieMoodElement = /* @__PURE__ */ function(_MoodElement3) {
  function GenieMoodElement2(effect2) {
    var _this4;
    return _classCallCheck18(this, GenieMoodElement2), _this4 = _callSuper4(this, GenieMoodElement2), _defineProperty23(_this4, "effect", void 0), _this4.effect = effect2, _this4;
  }
  return _inherits5(GenieMoodElement2, _MoodElement3), _createClass18(GenieMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
      if ((0, import_kolmafia90.haveEffect)(this.effect) >= ensureTurns) return !0;
      var neededWishes = Math.ceil(((0, import_kolmafia90.haveEffect)(this.effect) - ensureTurns) / 20), wishesToBuy = clamp(neededWishes - (0, import_kolmafia90.availableAmount)($item(_templateObject3314 || (_templateObject3314 = _taggedTemplateLiteral83(["pocket wish"])))), 0, 20);
      (0, import_kolmafia90.buy)(wishesToBuy, $item(_templateObject3413 || (_templateObject3413 = _taggedTemplateLiteral83(["pocket wish"]))), 5e4);
      for (var wishesToUse = clamp(neededWishes, 0, (0, import_kolmafia90.availableAmount)($item(_templateObject3512 || (_templateObject3512 = _taggedTemplateLiteral83(["pocket wish"]))))); wishesToUse > 0; wishesToUse--)
        (0, import_kolmafia90.cliExecute)("genie effect ".concat(this.effect.name));
      return (0, import_kolmafia90.haveEffect)(this.effect) >= ensureTurns;
    }
  }]);
  ...
  function CustomMoodElement2(effect2, gainEffect) {
    var _this5;
    return _classCallCheck18(this, CustomMoodElement2), _this5 = _callSuper4(this, CustomMoodElement2), _defineProperty23(_this5, "effect", void 0), _defineProperty23(_this5, "gainEffect", void 0), _this5.effect = effect2, _this5.gainEffect = gainEffect != null ? gainEffect : function() {
      return (0, import_kolmafia90.cliExecute)(effect2.default);
    }, _this5;
  }
  return _inherits5(CustomMoodElement2, _MoodElement4), _createClass18(CustomMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
      for (var currentTurns = (0, import_kolmafia90.haveEffect)(this.effect), lastCurrentTurns = -1; currentTurns < ensureTurns && currentTurns !== lastCurrentTurns; )
        this.gainEffect(), lastCurrentTurns = currentTurns, currentTurns = (0, import_kolmafia90.haveEffect)(this.effect);
      return (0, import_kolmafia90.haveEffect)(this.effect) > ensureTurns;
    }
  }]);
}(MoodElement), AsdonMoodElement = /* @__PURE__ */ function(_MoodElement5) {
  function AsdonMoodElement2(effect2) {
    var _this6, preferInventory = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
    return _classCallCheck18(this, AsdonMoodElement2), _this6 = _callSuper4(this, AsdonMoodElement2), _defineProperty23(_this6, "effect", void 0), _defineProperty23(_this6, "preferInventory", void 0), _this6.effect = effect2, _this6.preferInventory = preferInventory, _this6;
  }
  return _inherits5(AsdonMoodElement2, _MoodElement5), _createClass18(AsdonMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
  ...
  function Mood2() {
    ...
    _classCallCheck18(this, Mood2), _defineProperty23(this, "options", void 0), _defineProperty23(this, "elements", []), this.options = _objectSpread11(_objectSpread11({}, Mood2.defaultOptions), options);
  }
  return _createClass18(Mood2, [{
    ...
    value: function() {
      ...
      }) + Math.max((0, import_kolmafia90.myMp)() - this.options.reserveMp, 0);
    }
  }, {
    key: "moreMp",
    value: function(minimumTarget) {
      if (!((0, import_kolmafia90.myMp)() >= minimumTarget)) {
        var _iterator2 = _createForOfIteratorHelper14(this.options.mpSources), _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
            var mpSource = _step2.value;
            if (mpSource.usesRemaining() > 0 && (mpSource.execute(), (0, import_kolmafia90.myMp)() >= minimumTarget))
              break;
          }
        } catch (err) {
          _iterator2.e(err);
        ...
        this.options.useNativeRestores && (0, import_kolmafia90.restoreMp)(minimumTarget);
      }
    }
    /**
    ...
    value: function(_skill) {
      ...
      return this.elements.push(new SkillMoodElement(_skill, options)), this;
    }
    /**
    ...
    value: function(_effect, gainEffect) {
      var skill = (0, import_kolmafia90.toSkill)(_effect);
      return _toConsumableArray27(aprilShieldEffects.values()).includes(_effect) ? this.skill(skill, {
    ...
    value: (
       ...
       */
      function(options) {
        Mood2.defaultOptions = _objectSpread11(_objectSpread11({}, Mood2.defaultOptions), options);
      }
    )
  }]);
}();
_defineProperty23(Mood, "defaultOptions", {
  songSlots: [],
...
var KolmafiaVersionError = /* @__PURE__ */ function(_Error) {
  function KolmafiaVersionError2(message) {
    var _this;
    return _classCallCheck19(this, KolmafiaVersionError2), _this = _callSuper5(this, KolmafiaVersionError2, [message]), Object.setPrototypeOf(_this, KolmafiaVersionError2.prototype), _this;
  }
  return _inherits6(KolmafiaVersionError2, _Error), _createClass19(KolmafiaVersionError2);
...
function sinceKolmafiaRevision(revision) {
  ...
  var currentRevision = (0, import_kolmafia91.getRevision)();
  if (currentRevision > 0 && currentRevision < revision)
    throw new KolmafiaVersionError("".concat(getScriptName(), " requires revision r").concat(revision, " of kolmafia or higher (current: ").concat((0, import_kolmafia91.getRevision)(), "). Up-to-date builds can be found at https://ci.kolmafia.us/."));
}
function sinceKolmafiaVersion(majorVersion, minorVersion) {
  if (!((0, import_kolmafia91.getRevision)() >= 25720)) {
    ...
    var versionStr = (0, import_kolmafia91.getVersion)(), versionStrMatch = /v(\d+)\.(\d+)/.exec(versionStr);
    if (!versionStrMatch)
...
function fetchUrl(path3) {
  ...
  return (0, import_kolmafia92.visitUrl)(url, method === "POST", !0);
}
function buildUrl(path3) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      var _param = _slicedToArray28(param, 2), _key = _param[0], _value = _param[1];
...
function combineQuery() {
  ...
  for (var result = [], _i = 0, _queries = queries; _i < _queries.length; _i++) {
    ...
    Array.isArray(query) ? result.push.apply(result, _toConsumableArray28(query)) : result.push.apply(result, _toConsumableArray28(Object.entries(query)));
  }
  return result;
}
...
function _toConsumableArray29(r) {
  return _arrayWithoutHoles29(r) || _iterableToArray29(r) || _unsupportedIterableToArray43(r) || _nonIterableSpread29();
}
...
function _defineProperties20(e, r) {
  for (var t = 0; t < r.length; t++) {
    var o = r[t];
    o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey27(o.key), o);
  }
}
...
function _defineProperty24(e, r, t) {
  return (r = _toPropertyKey27(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e;
}
...
var Kmail = /* @__PURE__ */ function() {
  function Kmail2(rawKmail) {
    _classCallCheck20(this, Kmail2), _defineProperty24(this, "id", void 0), _defineProperty24(this, "date", void 0), _defineProperty24(this, "type", void 0), _defineProperty24(this, "senderId", void 0), _defineProperty24(this, "senderName", void 0), _defineProperty24(this, "rawMessage", void 0), _defineProperty24(this, "_parsedMessageParts", void 0), this.id = Number(rawKmail.id), this.date = new Date(Number(rawKmail.azunixtime) * 1e3), this.type = rawKmail.type, this.senderId = Number(rawKmail.fromid), this.senderName = rawKmail.fromname, this.rawMessage = rawKmail.message;
  }
  return _createClass20(Kmail2, [{
    ...
    value: function() {
      ...
      if (this.type === "normal") {
        ...
        var _text$split = text.split("<p>Inside Note:<p>"), _text$split2 = _slicedToArray29(_text$split, 2);
        text = _text$split2[0], insideText = _text$split2[1];
      }
      var split = function(s) {
        var idx = s.indexOf("<");
        return idx === -1 ? [s] : [s.slice(0, idx), s.slice(idx)];
      }, _split = split(text), _split2 = _slicedToArray29(_split, 2), outsideNote = _split2[0], _split2$ = _split2[1], outsideAttachments = _split2$ === void 0 ? null : _split2$, _ref = insideText !== void 0 ? split(insideText) : [], _ref2 = _slicedToArray29(_ref, 2), _ref2$ = _ref2[0], insideNote = _ref2$ === void 0 ? null : _ref2$, _ref2$2 = _ref2[1], insideAttachments = _ref2$2 === void 0 ? null : _ref2$2;
      return {
    ...
    value: function() {
      ...
      return !outsideAttachments && !insideAttachments ? 0 : (0, import_kolmafia93.extractMeat)("".concat(outsideAttachments).concat(insideAttachments));
    }
    /**
     * Reply to kmail
     *
    ...
    value: function() {
      ...
      return JSON.parse((0, import_kolmafia93.visitUrl)("api.php?what=kmail&for=libram&count=".concat(count))).map(Kmail2.parse);
    }
    /**
     * Bulk delete kmails
     *
    ...
    value: function(kmails) {
      var _results$match$, _results$match, results = fetchUrl("messages.php", [["the_action", "delete"], ["box", "Inbox"], ["pwd", EMPTY_VALUE]].concat(_toConsumableArray29(kmails.map(function(k) {
    ...
    value: function(to, message, items, meat, chunkSize, constructUrl, successString) {
      var m = meat, sendableItems = _toConsumableArray29(arrayToCountedMap(items).entries()).filter(function(_ref3) {
        var _ref4 = _slicedToArray29(_ref3, 1), item15 = _ref4[0];
        return (0, import_kolmafia93.isGiftable)(item15);
      ...
      try {
        var _loop = function() {
          ...
          c !== null && c.forEach(function(_ref5, i) {
            var _ref6 = _slicedToArray29(_ref5, 2), item15 = _ref6[0], quantity = _ref6[1];
...
var import_kolmafia94 = require("kolmafia"), logColor = function(color) {
  return function() {
    ...
    color ? (0, import_kolmafia94.print)(output, color) : (0, import_kolmafia94.print)(output);
  };
...
function _defineProperties21(e, r) {
  for (var t = 0; t < r.length; t++) {
    var o = r[t];
    o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey28(o.key), o);
  }
}
function _createClass21(e, r, t) {
  return r && _defineProperties21(e.prototype, r), t && _defineProperties21(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function _defineProperty25(e, r, t) {
  return (r = _toPropertyKey28(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e;
}
...
function _toConsumableArray30(r) {
  return _arrayWithoutHoles30(r) || _iterableToArray30(r) || _unsupportedIterableToArray44(r) || _nonIterableSpread30();
}
...
function mySessionItemsWrapper() {
  ...
  }, itemMappings = new Map([].concat(_toConsumableArray30(foldable($item(_templateObject586 || (_templateObject586 = _taggedTemplateLiteral84(["liar's pants"]))))), _toConsumableArray30(foldable($item(_templateObject2150 || (_templateObject2150 = _taggedTemplateLiteral84(["ice pick"]))))), _toConsumableArray30(manyToOne($item(_templateObject3137 || (_templateObject3137 = _taggedTemplateLiteral84(["Spooky Putty sheet"]))), [$item(_templateObject4120 || (_templateObject4120 = _taggedTemplateLiteral84(["Spooky Putty monster"])))].concat(_toConsumableArray30(getFoldGroup($item(_templateObject587 || (_templateObject587 = _taggedTemplateLiteral84(["Spooky Putty sheet"])))))))), _toConsumableArray30(foldable($item(_templateObject665 || (_templateObject665 = _taggedTemplateLiteral84(["stinky cheese sword"]))))), _toConsumableArray30(foldable($item(_templateObject759 || (_templateObject759 = _taggedTemplateLiteral84(["naughty paper shuriken"]))))), _toConsumableArray30(foldable($item(_templateObject849 || (_templateObject849 = _taggedTemplateLiteral84(["Loathing Legion knife"]))))), _toConsumableArray30(foldable($item(_templateObject939 || (_templateObject939 = _taggedTemplateLiteral84(["deceased crimbo tree"]))))), _toConsumableArray30(foldable($item(_templateObject1033 || (_templateObject1033 = _taggedTemplateLiteral84(["makeshift turban"]))))), _toConsumableArray30(foldable($item(_templateObject1131 || (_templateObject1131 = _taggedTemplateLiteral84(["turtle wax shield"]))))), _toConsumableArray30(foldable($item(_templateObject1230 || (_templateObject1230 = _taggedTemplateLiteral84(["metallic foil bow"]))))), _toConsumableArray30(foldable($item(_templateObject1328 || (_templateObject1328 = _taggedTemplateLiteral84(["ironic moustache"]))))), _toConsumableArray30(foldable($item(_templateObject1426 || (_templateObject1426 = _taggedTemplateLiteral84(["bugged balaclava"]))))), _toConsumableArray30(foldable($item(_templateObject1524 || (_templateObject1524 = _taggedTemplateLiteral84(["toggle switch (Bartend)"]))))), _toConsumableArray30(foldable($item(_templateObject1624 || (_templateObject1624 = _taggedTemplateLiteral84(["mushroom cap"]))))), _toConsumableArray30(manyToOne($item(_templateObject1723 || (_templateObject1723 = _taggedTemplateLiteral84(["can of Rain-Doh"]))), $items(_templateObject1823 || (_templateObject1823 = _taggedTemplateLiteral84(["empty Rain-Doh can"]))))), _toConsumableArray30(manyToOne($item(_templateObject1920 || (_templateObject1920 = _taggedTemplateLiteral84(["meteorite fragment"]))), $items(_templateObject2020 || (_templateObject2020 = _taggedTemplateLiteral84(["meteorite earring, meteorite necklace, meteorite ring"]))))), _toConsumableArray30(manyToOne($item(_templateObject2151 || (_templateObject2151 = _taggedTemplateLiteral84(["Sneaky Pete's leather jacket"]))), $items(_templateObject2222 || (_templateObject2222 = _taggedTemplateLiteral84(["Sneaky Pete's leather jacket (collar popped)"]))))), _toConsumableArray30(manyToOne($item(_templateObject2321 || (_templateObject2321 = _taggedTemplateLiteral84(["Boris's Helm"]))), $items(_templateObject2420 || (_templateObject2420 = _taggedTemplateLiteral84(["Boris's Helm (askew)"]))))), _toConsumableArray30(manyToOne($item(_templateObject2518 || (_templateObject2518 = _taggedTemplateLiteral84(["Jarlsberg's pan"]))), $items(_templateObject2618 || (_templateObject2618 = _taggedTemplateLiteral84(["Jarlsberg's pan (Cosmic portal mode)"]))))), _toConsumableArray30(manyToOne($item(_templateObject2718 || (_templateObject2718 = _taggedTemplateLiteral84(["tiny plastic sword"]))), $items(_templateObject2816 || (_templateObject2816 = _taggedTemplateLiteral84(["grogtini, bodyslam, dirty martini, vesper, cherry bomb, sangria del diablo"]))))), _toConsumableArray30(manyToOne($item(_templateObject2915 || (_templateObject2915 = _taggedTemplateLiteral84(["earthenware muffin tin"]))), $items(_templateObject3015 || (_templateObject3015 = _taggedTemplateLiteral84(["blueberry muffin, bran muffin, chocolate chip muffin"]))))), _toConsumableArray30(manyToOne($item(_templateObject3138 || (_templateObject3138 = _taggedTemplateLiteral84(["ChibiBuddy\u2122 (on)"]))), $items(_templateObject3216 || (_templateObject3216 = _taggedTemplateLiteral84(["ChibiBuddy\u2122 (off)"]))))))), inventory = /* @__PURE__ */ new Map(), invLocations = sessionOnly ? [import_kolmafia95.mySessionItems] : [import_kolmafia95.mySessionItems, import_kolmafia95.getCloset, import_kolmafia95.getDisplay, import_kolmafia95.getStorage];
  if (!sessionOnly)
    for (var _i = 0, _Object$entries = Object.entries((0, import_kolmafia95.getCampground)()); _i < _Object$entries.length; _i++) {
      var _itemMappings$get, _inventory$get, _Object$entries$_i = _slicedToArray30(_Object$entries[_i], 2), itemStr = _Object$entries$_i[0], quantity = _Object$entries$_i[1];
      if (quantity) {
        var item15 = (0, import_kolmafia95.toItem)(itemStr);
        if (item15 !== $item(_templateObject3315 || (_templateObject3315 = _taggedTemplateLiteral84(["big rock"])))) {
  ...
  for (var _i2 = 0, _invLocations = invLocations; _i2 < _invLocations.length; _i2++)
    for (var inventoryFunc = _invLocations[_i2], _i3 = 0, _Object$entries2 = Object.entries(inventoryFunc()); _i3 < _Object$entries2.length; _i3++) {
      var _itemMappings$get2, _inventory$get2, _Object$entries2$_i = _slicedToArray30(_Object$entries2[_i3], 2), _itemStr = _Object$entries2$_i[0], _quantity = _Object$entries2$_i[1];
      if (_quantity) {
        var _item = (0, import_kolmafia95.toItem)(_itemStr), _mappedItem = (_itemMappings$get2 = itemMappings.get(_item)) !== null && _itemMappings$get2 !== void 0 ? _itemMappings$get2 : _item;
...
function inventoryOperation(a, b, op) {
  var difference = /* @__PURE__ */ new Map(), _iterator = _createForOfIteratorHelper17(new Set([].concat(_toConsumableArray30(a.keys()), _toConsumableArray30(b.keys())))), _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
  ...
  var diffEntries = _toConsumableArray30(difference.entries());
  return new Map(diffEntries.filter(function(_ref) {
    var _ref2 = _slicedToArray30(_ref, 2), value = _ref2[1];
    return value !== 0;
  }));
}
var Session = /* @__PURE__ */ function() {
  function Session2(meat, items, totalTurns) {
    _classCallCheck21(this, Session2), _defineProperty25(this, "meat", void 0), _defineProperty25(this, "items", void 0), _defineProperty25(this, "totalTurns", void 0), this.meat = meat, this.items = items, this.totalTurns = totalTurns;
  }
  return _createClass21(Session2, [{
    ...
    value: function(itemValue) {
      var turns2 = this.totalTurns, meat = Math.floor(this.meat), itemDetails = _toConsumableArray30(this.items.entries()).map(function(_ref3) {
        var _ref4 = _slicedToArray30(_ref3, 2), item15 = _ref4[0], quantity = _ref4[1];
        return {
          item: item15,
          quantity: quantity,
    ...
    value: (
      ...
      function(filename) {
        ...
        (0, import_kolmafia95.bufferToFile)(JSON.stringify(val), Session2.getFilepath(filename));
      }
    )
    /**
    ...
    value: function(filename) {
      return filename.endsWith(".json") ? filename : "snapshots/".concat((0, import_kolmafia95.myName)(), "/").concat((0, import_kolmafia95.todayToString)(), "_").concat(filename, ".json");
    }
  }, {
    key: "fromFile",
    value: function(filename) {
      var fileValue = (0, import_kolmafia95.fileToBuffer)(Session2.getFilepath(filename));
      if (fileValue.length > 0) {
        var _val$totalTurns, val = JSON.parse(fileValue), parsedItems = Object.entries(val.items).map(function(_ref5) {
          ...
          return [(0, import_kolmafia95.toItem)(itemStr), quantity];
        });
    ...
    key: "current",
    value: function() {
      var sessionOnly = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, meat = sessionOnly ? [import_kolmafia95.mySessionMeat] : [import_kolmafia95.mySessionMeat, import_kolmafia95.myClosetMeat, import_kolmafia95.myStorageMeat];
      return new Session2(sum(meat, function(f) {
        return f();
      }), mySessionItemsWrapper(sessionOnly), (0, import_kolmafia95.totalTurnsPlayed)());
    }
    /**
