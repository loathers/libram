...
var _templateObject299, _templateObject2100, _templateObject361, _templateObject449, _templateObject536, _templateObject628, _templateObject724, _templateObject824, _templateObject921, _templateObject1020, _templateObject1118, _templateObject1217, _templateObject1316, _templateObject1413;
...
var item8 = $item(_templateObject299 || (_templateObject299 = _taggedTemplateLiteral38(["closed-circuit pay phone"])));
function have39() {
  return have(item8);
}
...
var INGRESS_RIFTS = {
  ...
  cemetery: $location(_templateObject1217 || (_templateObject1217 = _taggedTemplateLiteral38(["Shadow Rift (The Misspelled Cemetary)"]))),
...
var item9 = $item(_templateObject300 || (_templateObject300 = _taggedTemplateLiteral39(["cursed monkey's paw"])));
function have40() {
  return have(item9);
}
function wishes() {
...
var summonSkill2 = $skill(_templateObject309 || (_templateObject309 = _taggedTemplateLiteral41(["Summon Party Favor"])));
function have42() {
...
function expected2() {
  ...
  return /* @__PURE__ */ new Map([[$item(_templateObject2102 || (_templateObject2102 = _taggedTemplateLiteral41(["divine blowout"]))), commonChance2], [$item(_templateObject370 || (_templateObject370 = _taggedTemplateLiteral41(["divine can of silly string"]))), commonChance2], [$item(_templateObject451 || (_templateObject451 = _taggedTemplateLiteral41(["divine noisemaker"]))), commonChance2], [$item(_templateObject538 || (_templateObject538 = _taggedTemplateLiteral41(["divine champagne flute"]))), rareChance2], [$item(_templateObject630 || (_templateObject630 = _taggedTemplateLiteral41(["divine champagne popper"]))), rareChance2], [$item(_templateObject726 || (_templateObject726 = _taggedTemplateLiteral41(["divine cracker"]))), rareChance2]]);
}
...
var _templateObject379, _templateObject2104, _templateObject380;
function _taggedTemplateLiteral43(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill4 = $skill(_templateObject379 || (_templateObject379 = _taggedTemplateLiteral43(["Summon BRICKOs"])));
function have44() {
  return have(summonSkill4);
}
function expected4() {
  var eyeSummons = get("_brickoEyeSummons"), eyeChance = eyeSummons === 3 ? 0 : eyeSummons === 0 ? 0.5 : 1 / 3;
  return /* @__PURE__ */ new Map([[$item(_templateObject2104 || (_templateObject2104 = _taggedTemplateLiteral43(["BRICKO eye brick"]))), eyeChance], [$item(_templateObject380 || (_templateObject380 = _taggedTemplateLiteral43(["BRICKO brick"]))), 3 - eyeChance]]);
}
...
var _templateObject390, _templateObject2107, _templateObject391, _templateObject460, _templateObject545, _templateObject636, _templateObject730, _templateObject826;
function _taggedTemplateLiteral46(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill7 = $skill(_templateObject390 || (_templateObject390 = _taggedTemplateLiteral46(["Summon Taffy"])));
function have47() {
...
function expectedLibramSummon(summonSkill8) {
  switch (summonSkill8) {
    case $skill(_templateObject397 || (_templateObject397 = _taggedTemplateLiteral47(["Summon Candy Heart"]))):
      return expected();
    case $skill(_templateObject2108 || (_templateObject2108 = _taggedTemplateLiteral47(["Summon Party Favor"]))):
      return expected2();
    case $skill(_templateObject398 || (_templateObject398 = _taggedTemplateLiteral47(["Summon Love Song"]))):
      return expected3();
...
function possibleLibramSummons() {
  ...
  return have41() && results.set($skill(_templateObject827 || (_templateObject827 = _taggedTemplateLiteral47(["Summon Candy Heart"]))), expected()), have42() && results.set($skill(_templateObject924 || (_templateObject924 = _taggedTemplateLiteral47(["Summon Party Favor"]))), expected2()), have43() && results.set($skill(_templateObject1022 || (_templateObject1022 = _taggedTemplateLiteral47(["Summon Love Song"]))), expected3()), have44() && results.set($skill(_templateObject1119 || (_templateObject1119 = _taggedTemplateLiteral47(["Summon BRICKOs"]))), expected4()), have45() && results.set($skill(_templateObject1218 || (_templateObject1218 = _taggedTemplateLiteral47(["Summon Dice"]))), expected5()), have46() && results.set($skill(_templateObject1317 || (_templateObject1317 = _taggedTemplateLiteral47(["Summon Resolutions"]))), expected6()), have47() && results.set($skill(_templateObject1414 || (_templateObject1414 = _taggedTemplateLiteral47(["Summon Taffy"]))), expected7()), results;
}
...
// src/ascend.ts
var _templateObject399, _templateObject2109, _templateObject3100, _templateObject466, _templateObject547, _templateObject638;
...
function toMoonId(moon, playerClass) {
  ...
  var offset = function() {
    switch (playerClass.primestat) {
      case $stat(_templateObject399 || (_templateObject399 = _taggedTemplateLiteral48(["Muscle"]))):
        return 0;
...
var _templateObject400, _templateObject2118, _templateObject3101, _templateObject467, _templateObject548, _templateObject639, _templateObject734, _templateObject828, _templateObject925, _templateObject1023, _templateObject1120, _templateObject1219, _templateObject1318, _templateObject1415, _templateObject1513, _templateObject1613, _templateObject1713, _templateObject1813, _templateObject1913, _templateObject2013, _templateObject2119, _templateObject2215, _templateObject2313, _templateObject2412, _templateObject2512, _templateObject2612, _templateObject2712, _templateObject2810, _templateObject2910;
...
function baseWeight() {
  var expWeight = (0, import_kolmafia54.familiarWeight)((0, import_kolmafia54.myFamiliar)()), commaWeight = 0;
  (0, import_kolmafia54.myFamiliar)() === $familiar(_templateObject734 || (_templateObject734 = _taggedTemplateLiteral49(["Comma Chameleon"]))) && get("commaFamiliar") === $familiar(_templateObject828 || (_templateObject828 = _taggedTemplateLiteral49(["Homemade Robot"]))) && (commaWeight = 6 + 11 * get("homemadeRobotUpgrades"));
  var pillWeight = 0;
  return have($effect(_templateObject925 || (_templateObject925 = _taggedTemplateLiteral49(["Fidoxene"])))) && (pillWeight = 20), Math.max(expWeight, commaWeight, pillWeight);
}
...
_defineProperty15(CommunityService, "HP", new CommunityService(1, "HP", "Donate Blood", function() {
  return 60 - Math.floor(((0, import_kolmafia54.myMaxhp)() - (0, import_kolmafia54.myBuffedstat)($stat(_templateObject1023 || (_templateObject1023 = _taggedTemplateLiteral49(["muscle"])))) - 3) / 30);
}, new Requirement(["HP"], {})));
_defineProperty15(CommunityService, "Muscle", new CommunityService(2, "Muscle", "Feed The Children", statCommunityServicePredictor($stat(_templateObject1120 || (_templateObject1120 = _taggedTemplateLiteral49(["Muscle"])))), new Requirement(["Muscle"], {})));
_defineProperty15(CommunityService, "Mysticality", new CommunityService(3, "Mysticality", "Build Playground Mazes", statCommunityServicePredictor($stat(_templateObject1219 || (_templateObject1219 = _taggedTemplateLiteral49(["Mysticality"])))), new Requirement(["Mysticality"], {})));
_defineProperty15(CommunityService, "Moxie", new CommunityService(4, "Moxie", "Feed Conspirators", statCommunityServicePredictor($stat(_templateObject1318 || (_templateObject1318 = _taggedTemplateLiteral49(["Moxie"])))), new Requirement(["Moxie"], {})));
...
_defineProperty15(CommunityService, "WeaponDamage", new CommunityService(6, "Weapon Damage", "Reduce Gazelle Population", function() {
  var weaponPower = (0, import_kolmafia54.getPower)((0, import_kolmafia54.equippedItem)($slot(_templateObject1415 || (_templateObject1415 = _taggedTemplateLiteral49(["weapon"]))))), offhandPower = (0, import_kolmafia54.toSlot)((0, import_kolmafia54.equippedItem)($slot(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral49(["off-hand"]))))) === $slot(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral49(["weapon"]))) ? (0, import_kolmafia54.getPower)((0, import_kolmafia54.equippedItem)($slot(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral49(["off-hand"]))))) : 0, familiarPower = (0, import_kolmafia54.toSlot)((0, import_kolmafia54.equippedItem)($slot(_templateObject1813 || (_templateObject1813 = _taggedTemplateLiteral49(["familiar"]))))) === $slot(_templateObject1913 || (_templateObject1913 = _taggedTemplateLiteral49(["weapon"]))) ? (0, import_kolmafia54.getPower)((0, import_kolmafia54.equippedItem)($slot(_templateObject2013 || (_templateObject2013 = _taggedTemplateLiteral49(["familiar"]))))) : 0, multiplier = have($effect(_templateObject2119 || (_templateObject2119 = _taggedTemplateLiteral49(["Bow-Legged Swagger"])))) ? 2 : 1;
...
_defineProperty15(CommunityService, "SpellDamage", new CommunityService(7, "Spell Damage", "Make Sausage", function() {
  var dragonfishDamage = (0, import_kolmafia54.myFamiliar)() === $familiar(_templateObject2215 || (_templateObject2215 = _taggedTemplateLiteral49(["Magic Dragonfish"]))) ? (0, import_kolmafia54.numericModifier)($familiar(_templateObject2313 || (_templateObject2313 = _taggedTemplateLiteral49(["Magic Dragonfish"]))), "Spell Damage Percent", baseWeight() + (0, import_kolmafia54.weightAdjustment)(), $item.none) : 0;
...
_defineProperty15(CommunityService, "BoozeDrop", new CommunityService(9, "Item Drop", "Make Margaritas", function() {
  ...
  preventEquip: $items(_templateObject2910 || (_templateObject2910 = _taggedTemplateLiteral49(["broken champagne bottle"])))
})));
...
function isMonday() {
  return get2("Muscle Percent", $item(_templateObject401 || (_templateObject401 = _taggedTemplateLiteral50(["Tuesday's ruby"])))) > 0;
}
  ...
  return _createClass14(MenuItem2, [{
    ...
    value: function() {
      return /* @__PURE__ */ new Map([[$item(_templateObject3102 || (_templateObject3102 = _taggedTemplateLiteral50(["distention pill"]))), {
        ...
        size: -1
      }], [$item(_templateObject1024 || (_templateObject1024 = _taggedTemplateLiteral50(["spice melange"]))), {
      ...
      }], [$item(_templateObject1220 || (_templateObject1220 = _taggedTemplateLiteral50(["The Plumber's mushroom stew"]))), {
...
var DietPlanner = /* @__PURE__ */ function() {
  ...
  return _createClass14(DietPlanner2, [{
    ...
    value: function(menuItem, overrideModifiers) {
      ...
      this.seasoning && (0, import_kolmafia56.itemType)(menuItem.item) === "food" && this.mpa * (_expectedAdventures(menuItem.item, _objectSpread6(_objectSpread6({}, defaultModifiers), {}, {
        seasoning: !0
...
var _templateObject408, _templateObject2122, _templateObject3103;
...
var MpSource = /* @__PURE__ */ function() {
  ...
  return _createClass16(OscusSoda2, [{
    key: "available",
    value: function() {
      return have($item(_templateObject409 || (_templateObject409 = _taggedTemplateLiteral52(["Oscus's neverending soda"]))));
    }
  }, {
    key: "usesRemaining",
    value: function() {
...
var MagicalSausages = /* @__PURE__ */ function(_MpSource2) {
  ...
  return _createClass16(MagicalSausages2, [{
    ...
    key: "usesRemaining",
    value: function() {
      var maxSausages = (0, import_kolmafia58.availableAmount)($item(_templateObject470 || (_templateObject470 = _taggedTemplateLiteral52(["magical sausage"])))) + (0, import_kolmafia58.availableAmount)($item(_templateObject550 || (_templateObject550 = _taggedTemplateLiteral52(["magical sausage casing"]))));
...
var MoodElement = /* @__PURE__ */ function() {
  ...
  return _createClass16(GenieMoodElement2, [{
    ...
    value: function(mood, ensureTurns) {
      ...
      for (var wishesToUse = clamp(neededWishes, 0, (0, import_kolmafia58.availableAmount)($item(_templateObject1025 || (_templateObject1025 = _taggedTemplateLiteral52(["pocket wish"]))))); wishesToUse > 0; wishesToUse--)
...
// src/Path.ts
var _templateObject471, _templateObject2124, _templateObject3105, _templateObject477, _templateObject551, _templateObject644, _templateObject737, _templateObject831, _templateObject928, _templateObject1026, _templateObject1122;
...
var Path5 = /* @__PURE__ */ _createClass19(
  ...
  function Path6(name, id) {
    var hasAllPerms = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0, canUseSkillbooks = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, hasCampground = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, hasTerrarium = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !0, stomachSize = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : 15, liverSize = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : 15, spleenSize = arguments.length > 8 && arguments[8] !== void 0 ? arguments[8] : 15, classes = arguments.length > 9 && arguments[9] !== void 0 ? arguments[9] : $classes(_templateObject471 || (_templateObject471 = _taggedTemplateLiteral53(["Seal Clubber, Turtle Tamer, Sauceror, Pastamancer, Disco Bandit, Accordion Thief"])));
  ...
  AvatarofJarlsberg: new Path5("Avatar of Jarlsberg", 12, !1, !1, !0, !1, 10, 10, 15, $classes(_templateObject477 || (_templateObject477 = _taggedTemplateLiteral53(["Avatar of Jarlsberg"])))),
  ...
  PathOfThePlumber: new Path5("Path of the Plumber", 38, !1, !1, !0, !0, 20, 0, 5, $classes(_templateObject1026 || (_templateObject1026 = _taggedTemplateLiteral53(["Plumber"])))),
...
function mySessionItemsWrapper() {
  ...
  }, itemMappings = new Map([].concat(_toConsumableArray18(foldable($item(_templateObject478 || (_templateObject478 = _taggedTemplateLiteral54(["liar's pants"]))))), _toConsumableArray18(foldable($item(_templateObject2125 || (_templateObject2125 = _taggedTemplateLiteral54(["ice pick"]))))), _toConsumableArray18(manyToOne($item(_templateObject3106 || (_templateObject3106 = _taggedTemplateLiteral54(["Spooky Putty sheet"]))), [$item(_templateObject479 || (_templateObject479 = _taggedTemplateLiteral54(["Spooky Putty monster"])))].concat(_toConsumableArray18(getFoldGroup($item(_templateObject556 || (_templateObject556 = _taggedTemplateLiteral54(["Spooky Putty sheet"])))))))), _toConsumableArray18(foldable($item(_templateObject645 || (_templateObject645 = _taggedTemplateLiteral54(["stinky cheese sword"]))))), _toConsumableArray18(foldable($item(_templateObject738 || (_templateObject738 = _taggedTemplateLiteral54(["naughty paper shuriken"]))))), _toConsumableArray18(foldable($item(_templateObject834 || (_templateObject834 = _taggedTemplateLiteral54(["Loathing Legion knife"]))))), _toConsumableArray18(foldable($item(_templateObject929 || (_templateObject929 = _taggedTemplateLiteral54(["deceased crimbo tree"]))))), _toConsumableArray18(foldable($item(_templateObject1027 || (_templateObject1027 = _taggedTemplateLiteral54(["makeshift turban"]))))), _toConsumableArray18(foldable($item(_templateObject1123 || (_templateObject1123 = _taggedTemplateLiteral54(["turtle wax shield"]))))), _toConsumableArray18(foldable($item(_templateObject1221 || (_templateObject1221 = _taggedTemplateLiteral54(["metallic foil bow"]))))), _toConsumableArray18(foldable($item(_templateObject1320 || (_templateObject1320 = _taggedTemplateLiteral54(["ironic moustache"]))))), _toConsumableArray18(foldable($item(_templateObject1417 || (_templateObject1417 = _taggedTemplateLiteral54(["bugged balaclava"]))))), _toConsumableArray18(foldable($item(_templateObject1515 || (_templateObject1515 = _taggedTemplateLiteral54(["toggle switch (Bartend)"]))))), _toConsumableArray18(foldable($item(_templateObject1615 || (_templateObject1615 = _taggedTemplateLiteral54(["mushroom cap"]))))), _toConsumableArray18(manyToOne($item(_templateObject1715 || (_templateObject1715 = _taggedTemplateLiteral54(["can of Rain-Doh"]))), $items(_templateObject1815 || (_templateObject1815 = _taggedTemplateLiteral54(["empty Rain-Doh can"]))))), _toConsumableArray18(manyToOne($item(_templateObject1915 || (_templateObject1915 = _taggedTemplateLiteral54(["meteorite fragment"]))), $items(_templateObject2015 || (_templateObject2015 = _taggedTemplateLiteral54(["meteorite earring, meteorite necklace, meteorite ring"]))))), _toConsumableArray18(manyToOne($item(_templateObject2126 || (_templateObject2126 = _taggedTemplateLiteral54(["Sneaky Pete's leather jacket"]))), $items(_templateObject2217 || (_templateObject2217 = _taggedTemplateLiteral54(["Sneaky Pete's leather jacket (collar popped)"]))))), _toConsumableArray18(manyToOne($item(_templateObject2315 || (_templateObject2315 = _taggedTemplateLiteral54(["Boris's Helm"]))), $items(_templateObject2414 || (_templateObject2414 = _taggedTemplateLiteral54(["Boris's Helm (askew)"]))))), _toConsumableArray18(manyToOne($item(_templateObject2514 || (_templateObject2514 = _taggedTemplateLiteral54(["Jarlsberg's pan"]))), $items(_templateObject2614 || (_templateObject2614 = _taggedTemplateLiteral54(["Jarlsberg's pan (Cosmic portal mode)"]))))), _toConsumableArray18(manyToOne($item(_templateObject2714 || (_templateObject2714 = _taggedTemplateLiteral54(["tiny plastic sword"]))), $items(_templateObject2812 || (_templateObject2812 = _taggedTemplateLiteral54(["grogtini, bodyslam, dirty martini, vesper, cherry bomb, sangria del diablo"]))))), _toConsumableArray18(manyToOne($item(_templateObject2912 || (_templateObject2912 = _taggedTemplateLiteral54(["earthenware muffin tin"]))), $items(_templateObject3011 || (_templateObject3011 = _taggedTemplateLiteral54(["blueberry muffin, bran muffin, chocolate chip muffin"]))))))), inventory = /* @__PURE__ */ new Map(), _i = 0, _Object$entries = Object.entries((0, import_kolmafia62.mySessionItems)()); _i < _Object$entries.length; _i++) {
