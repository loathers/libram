...
const defaultHandlers = {
  ...
  debug: (message: string) => printHtml(`<span style="background: blue; color: white;"><b>[Libram DEBUG]</b> ${message}</span>`),
};
...
class Logger {
  ...
  setHandler(level: "warning" | "info" | "debug", callback: (message: string) => unknown): void;
