  ...
  return _createClass14(DietPlanner2, [{
    ...
    value: function(menuItem, overrideModifiers) {
      ...
      var defaultModifiers = _objectSpread7({
        ...
        refinedPalate: have($effect(_templateObject2216 || (_templateObject2216 = _taggedTemplateLiteral58(["Refined Palate"])))),
        garish: have($effect(_templateObject2315 || (_templateObject2315 = _taggedTemplateLiteral58(["Gar-ish"])))),
        saucemaven: have($skill(_templateObject2413 || (_templateObject2413 = _taggedTemplateLiteral58(["Saucemaven"])))),
        pinkyRing: have($item(_templateObject2513 || (_templateObject2513 = _taggedTemplateLiteral58(["mafia pinky ring"])))) && (0, import_kolmafia64.canEquip)($item(_templateObject2613 || (_templateObject2613 = _taggedTemplateLiteral58(["mafia pinky ring"])))),
        tuxedoShirt: have($item(_templateObject2713 || (_templateObject2713 = _taggedTemplateLiteral58(["tuxedo shirt"])))) && (0, import_kolmafia64.canEquip)($item(_templateObject2811 || (_templateObject2811 = _taggedTemplateLiteral58(["tuxedo shirt"]))))
      }, overrideModifiers);
      this.seasoning && (0, import_kolmafia64.itemType)(menuItem.item) === "food" && this.mpa * (_expectedAdventures(menuItem.item, _objectSpread7(_objectSpread7({}, defaultModifiers), {}, {
        ...
        seasoning: !1
      }))) > (0, import_kolmafia64.mallPrice)($item(_templateObject2911 || (_templateObject2911 = _taggedTemplateLiteral58(["Special Seasoning"])))) && helpers.push(this.seasoning);
...
}(), interactingItems = [[$item(_templateObject3710 || (_templateObject3710 = _taggedTemplateLiteral58(["spice melange"]))), [["food", -3], ["booze", -3]]], [$item(_templateObject3810 || (_templateObject3810 = _taggedTemplateLiteral58(["Ultra Mega Sour Ball"]))), [["food", -3], ["booze", -3]]], [$item(_templateObject3910 || (_templateObject3910 = _taggedTemplateLiteral58(["The Plumber's mushroom stew"]))), [["food", 3], ["booze", -1]]], [$item(_templateObject4010 || (_templateObject4010 = _taggedTemplateLiteral58(["The Mad Liquor"]))), [["food", -1], ["booze", 3]]], [$item(_templateObject4112 || (_templateObject4112 = _taggedTemplateLiteral58(["Doc Clock's thyme cocktail"]))), [["food", -2], ["booze", 4]]], [$item(_templateObject4211 || (_templateObject4211 = _taggedTemplateLiteral58(["Mr. Burnsger"]))), [["food", 4], ["booze", -2]]], [$effect(_templateObject4311 || (_templateObject4311 = _taggedTemplateLiteral58(["Refined Palate"]))), []], [$item(_templateObject4410 || (_templateObject4410 = _taggedTemplateLiteral58(["toasted brie"]))), [["food", 2]]], [$effect(_templateObject4510 || (_templateObject4510 = _taggedTemplateLiteral58(["Gar-ish"]))), []], [$item(_templateObject4610 || (_templateObject4610 = _taggedTemplateLiteral58(["potion of the field gar"]))), []]];
function planDiet(mpa, menu) {
  var organCapacities = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [["food", null], ["booze", null], ["spleen item", null]], resolvedOrganCapacities = organCapacities.map(function(_ref8) {
    ...
    var interacting = interactingItems.find(function(_ref10) {
      ...
      return menuItem.item === itemOrEffect || menuItem.item === $item(_templateObject4710 || (_templateObject4710 = _taggedTemplateLiteral58(["pocket wish"]))) && menuItem.effect === itemOrEffect;
    });
    if (interacting) {
  ...
  if (spleenCapacity) {
    var additionalSpleen = sum(planFoodBooze, function(_ref18) {
      ...
      return items.some(function(menuItem) {
        return $items(_templateObject4810 || (_templateObject4810 = _taggedTemplateLiteral58(["jar of fermented pickle juice, extra-greasy slider"]))).includes(menuItem.item);
      }) ? 5 * number : 0;
...
var DietEntry = /* @__PURE__ */ function() {
    ...
    value: function(diet) {
      {
        ...
        var items = this.menuItems.map(function(m) {
          return m.item;
        }), targetItem = this.menuItems[this.menuItems.length - 1].item, fork = (0, import_kolmafia64.itemType)(targetItem) === "food" && items.includes($item(_templateObject496 || (_templateObject496 = _taggedTemplateLiteral58(["Ol' Scratch's salad fork"])))), mug = (0, import_kolmafia64.itemType)(targetItem) === "booze" && items.includes($item(_templateObject506 || (_templateObject506 = _taggedTemplateLiteral58(["Frosty's frosty mug"]))));
        return this.quantity * _expectedAdventures(this.menuItems[this.menuItems.length - 1].item, {
          forkMug: fork || mug,
          seasoning: items.includes($item(_templateObject5111 || (_templateObject5111 = _taggedTemplateLiteral58(["Special Seasoning"])))),
  ...
  return _createClass14(Diet2, [{
    ...
    get: function() {
      return this.entries.some(function(dietEntry) {
        return dietEntry.menuItems.some(function(trialItem) {
          return trialItem.item === $item(_templateObject5211 || (_templateObject5211 = _taggedTemplateLiteral58(["pocket wish"]))) && trialItem.effect === $effect(_templateObject5310 || (_templateObject5310 = _taggedTemplateLiteral58(["Refined Palate"]))) || trialItem.item === $item(_templateObject5410 || (_templateObject5410 = _taggedTemplateLiteral58(["toasted brie"])));
        });
      });
    }
  }, {
    ...
    get: function() {
      return this.entries.some(function(dietEntry) {
        return dietEntry.menuItems.some(function(trialItem) {
          return trialItem.item === $item(_templateObject557 || (_templateObject557 = _taggedTemplateLiteral58(["pocket wish"]))) && trialItem.effect === $effect(_templateObject565 || (_templateObject565 = _taggedTemplateLiteral58(["Gar-ish"]))) || trialItem.item === $item(_templateObject575 || (_templateObject575 = _taggedTemplateLiteral58(["potion of the field gar"])));
        });
      });
    }
  }, {
    key: "saucemaven",
    get: function() {
      return have($skill(_templateObject585 || (_templateObject585 = _taggedTemplateLiteral58(["Saucemaven"]))));
    }
  }, {
    key: "tuxedoShirt",
    get: function() {
      return have($item(_templateObject594 || (_templateObject594 = _taggedTemplateLiteral58(["tuxedo shirt"])))) && (0, import_kolmafia64.canEquip)($item(_templateObject604 || (_templateObject604 = _taggedTemplateLiteral58(["tuxedo shirt"]))));
    }
  }, {
    key: "pinkyRing",
    get: function() {
      return have($item(_templateObject6110 || (_templateObject6110 = _taggedTemplateLiteral58(["mafia pinky ring"])))) && (0, import_kolmafia64.canEquip)($item(_templateObject6210 || (_templateObject6210 = _taggedTemplateLiteral58(["mafia pinky ring"]))));
    }
  }, {
    key: "expectedAdventures",
    value: function() {
...
var _templateObject498, _templateObject2127, _templateObject3116, _templateObject499, _templateObject558, _templateObject647, _templateObject741, _templateObject836, _templateObject929, _templateObject1025;
  ...
  return _createClass16(MagicalSausages2, [{
    ...
    value: function() {
      ...
      if (!(mpSpaceAvailable < 700)) {
        ...
        (0, import_kolmafia66.retrieveItem)(maxSausages, $item(_templateObject647 || (_templateObject647 = _taggedTemplateLiteral60(["magical sausage"])))), (0, import_kolmafia66.eat)(maxSausages, $item(_templateObject741 || (_templateObject741 = _taggedTemplateLiteral60(["magical sausage"]))));
      }
    }
  }]), MagicalSausages2;
}(MpSource);
...
// src/Path.ts
init_kolmafia_polyfill();
var _templateObject500, _templateObject2128, _templateObject3117, _templateObject4100, _templateObject559, _templateObject648, _templateObject744, _templateObject837, _templateObject930, _templateObject1026, _templateObject1122;
...
var Path5 = /* @__PURE__ */ _createClass19(
  ...
  ActuallyEdTheUndying: new Path5("Actually Ed the Undying", 23, !1, !1, !1, !1, 0, 0, 5, $classes(_templateObject648 || (_templateObject648 = _taggedTemplateLiteral61(["Ed the Undying"])))),
