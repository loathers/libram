...
var ridingFamiliars = [{
  ...
  drops: $items(_templateObject416 || (_templateObject416 = _taggedTemplateLiteral10(["yellow pixel"]))),
  probability: 0.25,
  dropPredicate: function() {
    return get("_yellowPixelDropsCrown") < 25;
  }
  ...
  drops: $items(_templateObject319 || (_templateObject319 = _taggedTemplateLiteral10(["candy cane"]))),
  probability: 1
}, {
  ...
  drops: $items(_templateObject374 || (_templateObject374 = _taggedTemplateLiteral10(["blackberry"]))),
  probability: 1
}, {
  familiar: $familiar(_templateObject384 || (_templateObject384 = _taggedTemplateLiteral10(["Hunchbacked Minion"]))),
  drops: /* @__PURE__ */ new Map([[$item(_templateObject394 || (_templateObject394 = _taggedTemplateLiteral10(["disembodied brain"]))), 0.02], [$item(_templateObject404 || (_templateObject404 = _taggedTemplateLiteral10(["skeleton bone"]))), 0.98]]),
  probability: 1
}, {
  familiar: $familiar(_templateObject417 || (_templateObject417 = _taggedTemplateLiteral10(["Reanimated Reanimator"]))),
  drops: $items(_templateObject425 || (_templateObject425 = _taggedTemplateLiteral10(["hot wing, broken skull"]))),
  probability: 1
}, {
  familiar: $familiar(_templateObject434 || (_templateObject434 = _taggedTemplateLiteral10(["Attention-Deficit Demon"]))),
  drops: $items(_templateObject444 || (_templateObject444 = _taggedTemplateLiteral10(["chorizo brownies, white chocolate and tomato pizza, carob chunk noodles"]))),
  probability: 1
}, {
  familiar: $familiar(_templateObject454 || (_templateObject454 = _taggedTemplateLiteral10(["Piano Cat"]))),
  drops: $items(_templateObject463 || (_templateObject463 = _taggedTemplateLiteral10(["beertini, papaya slung, salty slug, tomato daiquiri"]))),
  probability: 1
}, {
  familiar: $familiar(_templateObject473 || (_templateObject473 = _taggedTemplateLiteral10(["Golden Monkey"]))),
  ...
  drops: $items(_templateObject582 || (_templateObject582 = _taggedTemplateLiteral10(["snailmail bits, turtlemail bits, turtle wax"]))),
  probability: 0.35
}, {
  ...
  return !ridingFamiliars.some(function(_ref) {
    var familiar6 = _ref.familiar;
    return familiar6 === f;
  });
}).map(function(familiar6) {
  return {
    familiar: familiar6,
    drops: 0,
    probability: 1
...
function pickRider(mode) {
  ...
  if (list) {
    var riderToReturn = list.find(function(_ref3) {
      var _dropPredicate, dropPredicate = _ref3.dropPredicate, familiar6 = _ref3.familiar;
      return ((_dropPredicate = dropPredicate == null ? void 0 : dropPredicate()) !== null && _dropPredicate !== void 0 ? _dropPredicate : !0) && (!excludeCurrentFamiliar || (0, import_kolmafia15.myFamiliar)() !== familiar6);
    });
    return riderToReturn != null ? riderToReturn : null;
  }
  return null;
}
function getModifier(modifier, familiar6) {
  return (0, import_kolmafia15.numericModifier)("Throne:".concat(familiar6), modifier);
}
function createModifierValueFunction(modifiers, functions) {
  return function(familiar6) {
    return sum(modifiers, function(modifier) {
      return functions[modifier](getModifier(modifier, familiar6));
    });
  };
}
...
var familiar3 = $familiar(_templateObject100 || (_templateObject100 = _taggedTemplateLiteral11(["Obtuse Angel"])));
function have7() {
...
var box = $item(_templateObject101 || (_templateObject101 = _taggedTemplateLiteral12(["Rain-Doh black box"])));
function have8() {
...
var _templateObject108, _templateObject220, _templateObject320, _templateObject418, _templateObject514, _templateObject611;
function _taggedTemplateLiteral13(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
function have9() {
  return have($familiar(_templateObject108 || (_templateObject108 = _taggedTemplateLiteral13(["Reagnimated Gnome"]))));
}
var bodyParts = {
...
var _templateObject109, _templateObject221, _templateObject321, _templateObject419;
function _taggedTemplateLiteral14(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
function have11() {
  return have($familiar(_templateObject109 || (_templateObject109 = _taggedTemplateLiteral14(["Crimbo Shrub"]))));
}
var Toppers = {
  Muscle: 1,
  Mysticality: 2,
...
var lab = $item(_templateObject110 || (_templateObject110 = _taggedTemplateLiteral15(["Little Geneticist DNA-Splicing Lab"])));
function have12() {
...
init_kolmafia_polyfill();
var _templateObject111, _templateObject228, _templateObject328, _templateObject421;
function _taggedTemplateLiteral16(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
function have13() {
  return haveInCampground($item(_templateObject111 || (_templateObject111 = _taggedTemplateLiteral16(["packet of winter seeds"]))));
}
...
var BARRELS = $items(_templateObject119 || (_templateObject119 = _taggedTemplateLiteral17(["little firkin, normal barrel, big tun, weathered barrel, dusty barrel, disintegrating barrel, moist barrel, rotting barrel, mouldering barrel, barnacled barrel"])));
function have14() {
...
var _templateObject129, _templateObject230, _templateObject330, _templateObject428, _templateObject518, _templateObject616, _templateObject713, _templateObject813, _templateObject912, _templateObject1012;
function _taggedTemplateLiteral20(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var Mayo = {
  nex: $item(_templateObject129 || (_templateObject129 = _taggedTemplateLiteral20(["Mayonex"]))),
...
var _templateObject130, _templateObject231, _templateObject331, _templateObject429, _templateObject519, _templateObject617, _templateObject714, _templateObject814, _templateObject913, _templateObject1013, _templateObject1111, _templateObject1210, _templateObject139, _templateObject148, _templateObject158, _templateObject168, _templateObject178, _templateObject188, _templateObject198, _templateObject208, _templateObject2113, _templateObject2211, _templateObject238, _templateObject248, _templateObject258, _templateObject268, _templateObject278;
...
var item = $item(_templateObject130 || (_templateObject130 = _taggedTemplateLiteral21(["Source terminal"])));
function have19() {
...
var Skills = {
  ...
  Extract: $skill(_templateObject1210 || (_templateObject1210 = _taggedTemplateLiteral21(["Extract"]))),
...
var item2 = $item(_templateObject131 || (_templateObject131 = _taggedTemplateLiteral22(["Witchess Set"])));
function have20() {
...
function crazyHorseStats() {
  return have21() ? (get("_horseryCrazyName") || (0, import_kolmafia30.visitUrl)("place.php?whichplace=town_right&action=town_horsery"), {
...
function currentCostumes() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      matcher && returnValue.set((0, import_kolmafia31.toFamiliar)(matcher[3]), [toModifier(matcher[1]), parseInt(matcher[2])]);
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
var _templateObject140, _templateObject239, _Alignment, _Element, _templateObject337, _templateObject430, _templateObject520, _templateObject618, _templateObject715, _templateObject815, _templateObject914, _LeftSacrifice, _templateObject1014, _templateObject1112, _templateObject1211, _templateObject1310, _templateObject149, _templateObject159, _templateObject169, _templateObject179, _templateObject189, _MiddleSacrifice, _templateObject199, _templateObject209, _templateObject2114, _templateObject2212, _templateObject2310, _templateObject249, _templateObject259, _templateObject269, _templateObject279, _templateObject287, _RightSacrifice;
...
var pantogram = $item(_templateObject140 || (_templateObject140 = _taggedTemplateLiteral23(["portable pantogram"]))), pants = $item(_templateObject239 || (_templateObject239 = _taggedTemplateLiteral23(["pantogram pants"])));
function have22() {
...
function findRequirements(modifiers) {
  ...
  if (leftSac) {
    ...
    sacrifice instanceof import_kolmafia32.Item && returnValue.set(sacrifice, quantity);
  }
  if (rightSac) {
    ...
    _sacrifice instanceof import_kolmafia32.Item && returnValue.set(_sacrifice, _quantity);
  }
  if (middleSac) {
    ...
    _sacrifice2 instanceof import_kolmafia32.Item && returnValue.set(_sacrifice2, _quantity2);
  }
  return returnValue;
}
function sacrificePairToURL(pair) {
  var _pair = _slicedToArray7(pair, 2), rawSacrifice = _pair[0], quantity = _pair[1], sacrifice = rawSacrifice instanceof import_kolmafia32.Item ? rawSacrifice.id : rawSacrifice;
...
function makePants(alignment, element, leftSac, middleSac, rightSac) {
  ...
  return directlyUse(pantogram), (0, import_kolmafia32.visitUrl)(url), have(pants);
}
...
var familiar4 = $familiar(_templateObject141 || (_templateObject141 = _taggedTemplateLiteral24(["Robortender"])));
function have23() {
  return (0, import_kolmafia33.haveFamiliar)(familiar4);
}
var phylumDrops = /* @__PURE__ */ new Map([
  ...
  // bottle of anís
  [$phylum(_templateObject431 || (_templateObject431 = _taggedTemplateLiteral24(["Constellation"]))), import_kolmafia33.Item.get(9348)],
  ...
  [$phylum(_templateObject1113 || (_templateObject1113 = _taggedTemplateLiteral24(["Fish"]))), $item(_templateObject1212 || (_templateObject1212 = _taggedTemplateLiteral24(["bottle of clam juice"])))],
  ...
  [$phylum(_templateObject2311 || (_templateObject2311 = _taggedTemplateLiteral24(["Mer-kin"]))), import_kolmafia33.Item.get(9358)],
...
function dropFrom(target) {
  var _phylumDrops$get, phylum = target instanceof import_kolmafia33.Monster ? target.phylum : target;
...
function currentDrinks() {
  ...
  return pref ? pref.split(",").filter(function(x) {
    ...
    return (0, import_kolmafia33.toItem)(name);
...
function feed(beverage) {
  if (currentDrinks().includes(beverage))
    return !0;
  if (currentDrinks().length >= 5 || !drinks.includes(beverage) || !(0, import_kolmafia33.itemAmount)(beverage) || !have23())
    return !1;
  var priorFamiliar = (0, import_kolmafia33.myFamiliar)();
  return (0, import_kolmafia33.useFamiliar)(familiar4), (0, import_kolmafia33.visitUrl)("inventory.php?action=robooze&which=1&whichitem=".concat(beverage.id)), (0, import_kolmafia33.useFamiliar)(priorFamiliar), currentDrinks().includes(beverage);
}
...
var _templateObject150, _templateObject241, _templateObject340, _templateObject436, _templateObject525;
...
function updateStatus() {
  (0, import_kolmafia34.visitUrl)("place.php?whichplace=spacegate&action=sg_Terminal");
}
function dialled() {
...
function hazardEquipment(hazards2) {
  var hazardEquipment2 = {
    "toxic atmosphere": $item(_templateObject150 || (_templateObject150 = _taggedTemplateLiteral25(["filter helmet"]))),
...
function getHazardEquipment() {
  ...
  return equipment.forEach(function(equip3) {
    ...
    (0, import_kolmafia34.visitUrl)("place.php?whichplace=spacegate&action=sg_requisition"), (0, import_kolmafia34.visitUrl)("choice.php?whichchoice=1233&option=".concat(num));
  }), equipment.forEach(function(equip3) {
    if ((0, import_kolmafia34.availableAmount)(equip3) !== 1)
      return !1;
  }), !0;
}
function getVaccine(choice) {
  ...
  return (0, import_kolmafia34.cliExecute)("spacegate vaccine ".concat(num)), get("_spacegateVaccine");
}
function dial(address) {
  ...
  return (0, import_kolmafia34.cliExecute)("spacegate destination ".concat(address)), dialled() && planetCoords() === address;
}
function dialRandom() {
  return !have24() || dialled() ? !1 : ((0, import_kolmafia34.cliExecute)("spacegate destination random"), dialled());
}
...
var _templateObject151, _templateObject250;
...
function haveLovEnamorang() {
  return have($item(_templateObject151 || (_templateObject151 = _taggedTemplateLiteral26(["LOV Enamorang"]))));
}
...
var INGREDIENTS = {
  ...
  chili: {
    ...
    location: $location(_templateObject1213 || (_templateObject1213 = _taggedTemplateLiteral27(["The Haunted Kitchen"])))
  },
  clove: {
    modifier: {
      "Stench Resistance": 3
...
function fill() {
  ...
  }) ? !1 : (0, import_kolmafia37.cliExecute)("latte refill ".concat(ingredients.join(" ")));
}
...
function currentIngredients() {
  return (0, import_kolmafia37.getProperty)("latteIngredients").split(",");
}
...
var item3 = $item(_templateObject161 || (_templateObject161 = _taggedTemplateLiteral28(["SongBoom\u2122 BoomBox"])));
function have27() {
  return have(item3);
}
var keywords = {
...
function setSong(newSong) {
  if (song() !== newSong) {
    ...
    return (0, import_kolmafia38.cliExecute)("boombox ".concat(newSong ? keywords[newSong] : "none")), !0;
  } else
    return !1;
}
...
var _templateObject170, _templateObject260, _templateObject349, _templateObject439, _templateObject528, _templateObject621, _templateObject718, _templateObject818, _templateObject917, _templateObject1017, _templateObject1115, _templateObject1214, _templateObject1313, _templateObject1412, _templateObject1512, _templateObject1612, _templateObject1712, _templateObject1812, _templateObject1912, _templateObject2012, _templateObject2117;
function _taggedTemplateLiteral29(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
function have28() {
  return have(import_kolmafia39.Item.get("Beach Comb"));
}
function available2() {
  return have28() || have(import_kolmafia39.Item.get("driftwood beach comb"));
}
...
function tideLevel() {
  var day = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, import_kolmafia39.gamedayToInt)(), dayOfMonth = 1 + day % 8;
  ...
  if (!(!available2() || !tiles.length)) {
    for (var _i = 0, _tiles = tiles; _i < _tiles.length; _i++) {
      ...
      if (canComb(tile)) {
        ...
        (0, import_kolmafia39.cliExecute)("beach wander ".concat(minute)), (0, import_kolmafia39.cliExecute)("beach comb ".concat(row, " ").concat(column));
      }
    }
    (0, import_kolmafia39.handlingChoice)() && (0, import_kolmafia39.runChoice)(5);
  }
}
function headAvailable(target) {
  var effect2 = target instanceof import_kolmafia39.Effect ? target : head[target], headNumber = 1 + headBuffs.indexOf(effect2);
  return (0, import_kolmafia39.getProperty)("beachHeadsUnlocked").split(",").includes(headNumber.toString()) && !(0, import_kolmafia39.getProperty)("_beachHeadsUsed").split(",").includes(headNumber.toString());
}
function tryHead(target) {
  var effect2 = target instanceof import_kolmafia39.Effect ? target : head[target];
  return !headBuffs.includes(effect2) || !headAvailable(target) ? !1 : ((0, import_kolmafia39.cliExecute)(effect2.default), have(effect2));
}
...
function gaze() {
  canGaze() && (0, import_kolmafia40.visitUrl)("place.php?whichplace=campaway&action=campaway_sky");
}
function getGazeBuff() {
  var daycountToCheck = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, import_kolmafia40.daycount)(), buffSign = signIdToName((daycountToCheck + (0, import_kolmafia40.myPath)().id) % 9 + 1), effectName = [];
  return buffSign === (0, import_kolmafia40.mySign)() && effectName.push("Big"), effectName.push("Smile of the", buffSign), import_kolmafia40.Effect.get(effectName.join(" "));
}
function blowSmoke(messages) {
  var times = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, smoke = $item(_templateObject171 || (_templateObject171 = _taggedTemplateLiteral30(["campfire smoke"])));
  (0, import_kolmafia40.retrieveItem)(smoke, times);
  for (var i = 0; i < times; i++)
    withChoice(1394, "1&message=".concat(random(messages)), function() {
      (0, import_kolmafia40.use)(smoke);
    });
}
...
var familiar5 = import_kolmafia41.Familiar.get("Red-Nosed Snapper"), phylumItem = /* @__PURE__ */ new Map([[import_kolmafia41.Phylum.get("beast"), import_kolmafia41.Item.get("patch of extra-warm fur")], [import_kolmafia41.Phylum.get("bug"), import_kolmafia41.Item.get("a bug's lymph")], [import_kolmafia41.Phylum.get("constellation"), import_kolmafia41.Item.get("micronova")], [import_kolmafia41.Phylum.get("construct"), import_kolmafia41.Item.get("industrial lubricant")], [import_kolmafia41.Phylum.get("demon"), import_kolmafia41.Item.get("infernal snowball")], [import_kolmafia41.Phylum.get("dude"), import_kolmafia41.Item.get("human musk")], [import_kolmafia41.Phylum.get("elemental"), import_kolmafia41.Item.get("livid energy")], [import_kolmafia41.Phylum.get("elf"), import_kolmafia41.Item.get("peppermint syrup")], [import_kolmafia41.Phylum.get("fish"), import_kolmafia41.Item.get("fish sauce")], [import_kolmafia41.Phylum.get("goblin"), import_kolmafia41.Item.get("guffin")], [import_kolmafia41.Phylum.get("hippy"), import_kolmafia41.Item.get("organic potpourri")], [import_kolmafia41.Phylum.get("hobo"), import_kolmafia41.Item.get("beggin' cologne")], [import_kolmafia41.Phylum.get("horror"), import_kolmafia41.Item.get("powdered madness")], [import_kolmafia41.Phylum.get("humanoid"), import_kolmafia41.Item.get("vial of humanoid growth hormone")], [import_kolmafia41.Phylum.get("mer-kin"), import_kolmafia41.Item.get("Mer-kin eyedrops")], [import_kolmafia41.Phylum.get("orc"), import_kolmafia41.Item.get("boot flask")], [import_kolmafia41.Phylum.get("penguin"), import_kolmafia41.Item.get("envelope full of Meat")], [import_kolmafia41.Phylum.get("pirate"), import_kolmafia41.Item.get("Shantix\u2122")], [import_kolmafia41.Phylum.get("plant"), import_kolmafia41.Item.get("goodberry")], [import_kolmafia41.Phylum.get("slime"), import_kolmafia41.Item.get("extra-strength goo")], [import_kolmafia41.Phylum.get("undead"), import_kolmafia41.Item.get("unfinished pleasure")], [import_kolmafia41.Phylum.get("weird"), import_kolmafia41.Item.get("non-Euclidean angle")]]), itemPhylum = new Map(_toConsumableArray10(phylumItem).map(function(_ref) {
  var _ref2 = _slicedToArray9(_ref, 2), phylum = _ref2[0], item10 = _ref2[1];
  return [item10, phylum];
}));
function have30() {
  return (0, import_kolmafia41.haveFamiliar)(familiar5);
}
function getTrackedPhylum() {
  return get("redSnapperPhylum");
}
function trackPhylum(phylum) {
  var currentFamiliar = (0, import_kolmafia41.myFamiliar)();
  try {
    (0, import_kolmafia41.useFamiliar)(familiar5), (0, import_kolmafia41.cliExecute)("snapper ".concat(phylum));
  } finally {
    (0, import_kolmafia41.useFamiliar)(currentFamiliar);
  }
}
...
var passive = $skill(_templateObject180 || (_templateObject180 = _taggedTemplateLiteral31(["Comprehensive Cartography"])));
function have31() {
  return have(passive);
}
function mapMonster(location, monster) {
  if (!have31() || get("_monstersMapped") >= 3 || !(0, import_kolmafia42.canAdventure)(location) || ((0, import_kolmafia42.useSkill)($skill(_templateObject261 || (_templateObject261 = _taggedTemplateLiteral31(["Map the Monsters"])))), !get("mappingMonsters")))
    return !1;
  for (var turns = (0, import_kolmafia42.myTurncount)(); (0, import_kolmafia42.currentRound)() < 1; ) {
    if ((0, import_kolmafia42.myTurncount)() > turns)
      throw new Error("Map the Monsters unsuccessful?");
    if ((0, import_kolmafia42.visitUrl)((0, import_kolmafia42.toUrl)(location)), (0, import_kolmafia42.handlingChoice)() && (0, import_kolmafia42.lastChoice)() === 1435)
      return (0, import_kolmafia42.runChoice)(1, "heyscriptswhatsupwinkwink=".concat(monster.id)), !0;
    (0, import_kolmafia42.runChoice)(-1, !1);
  }
  return !1;
}
...
var _templateObject181, _templateObject270, _templateObject350, _templateObject440, _templateObject529, _templateObject625, _templateObject719, _templateObject819, _templateObject918, _templateObject1018, _templateObject1116, _templateObject1215, _templateObject1314;
...
function useTabletWithChoice(option) {
  withChoice(1412, option, function() {
    return (0, import_kolmafia43.use)(1, item4);
  });
}
...
function abandon() {
  return canAbandon() ? ((0, import_kolmafia43.visitUrl)("inventory.php?tap=guzzlr", !1), (0, import_kolmafia43.runChoice)(1), (0, import_kolmafia43.runChoice)(5), !0) : !1;
}
...
function getBooze() {
  ...
  return booze === "" ? null : import_kolmafia43.Item.get(booze);
}
...
function havePlatinumBooze() {
  return Cocktails.some(function(cock) {
    return (0, import_kolmafia43.itemAmount)(cock) > 0;
  });
}
function haveBooze() {
  var booze = getBooze();
  switch (booze) {
    case null:
      return !1;
    case $item(_templateObject350 || (_templateObject350 = _taggedTemplateLiteral32(["Guzzlr cocktail set"]))):
      return havePlatinumBooze();
    default:
      return (0, import_kolmafia43.itemAmount)(booze) > 0;
  }
}
var ingredientToPlatinumCocktail = /* @__PURE__ */ new Map([[$item(_templateObject440 || (_templateObject440 = _taggedTemplateLiteral32(["miniature boiler"]))), $item(_templateObject529 || (_templateObject529 = _taggedTemplateLiteral32(["Steamboat"])))], [$item(_templateObject625 || (_templateObject625 = _taggedTemplateLiteral32(["cold wad"]))), $item(_templateObject719 || (_templateObject719 = _taggedTemplateLiteral32(["Ghiaccio Colada"])))], [$item(_templateObject819 || (_templateObject819 = _taggedTemplateLiteral32(["robin's egg"]))), $item(_templateObject918 || (_templateObject918 = _taggedTemplateLiteral32(["Nog-on-the-Cob"])))], [$item(_templateObject1018 || (_templateObject1018 = _taggedTemplateLiteral32(["mangled finger"]))), $item(_templateObject1116 || (_templateObject1116 = _taggedTemplateLiteral32(["Sourfinger"])))], [$item(_templateObject1215 || (_templateObject1215 = _taggedTemplateLiteral32(["Dish of Clarified Butter"]))), $item(_templateObject1314 || (_templateObject1314 = _taggedTemplateLiteral32(["Buttery Boy"])))]]), platinumCocktailToIngredient = invertMap(ingredientToPlatinumCocktail);
...
var _templateObject190, _templateObject271, _templateObject351, _templateObject441, _templateObject530, _templateObject626, _templateObject720, _templateObject820, _templateObject919, _templateObject1019, _templateObject1117, _templateObject1216, _templateObject1315;
...
var Heroes = {
  ...
  Skill: $skill(_templateObject351 || (_templateObject351 = _taggedTemplateLiteral33(["Slay the Dead"])))
}], [["heck", "thrill"], {
  "Mysticality Experience": 3
}], [["heck", "kiss"], {
  Skill: $skill(_templateObject441 || (_templateObject441 = _taggedTemplateLiteral33(["Unleash the Devil's Kiss"])))
}], [["robot", "hold"], {
  Skill: $skill(_templateObject530 || (_templateObject530 = _taggedTemplateLiteral33(["Deploy Robo-Handcuffs"])))
}], [["robot", "thrill"], {
  "Moxie Experience": 3
}], [["robot", "kiss"], {
  Skill: $skill(_templateObject626 || (_templateObject626 = _taggedTemplateLiteral33(["Blow a Robo-Kiss"])))
}], [["robot", "kill"], {
  Skill: $skill(_templateObject720 || (_templateObject720 = _taggedTemplateLiteral33(["Precision Shot"])))
}]]);
function set2(hero, mode) {
  return have33() ? currentHero() === hero && currentMode() === mode ? !0 : ((0, import_kolmafia44.cliExecute)("retrocape ".concat(hero, " ").concat(mode)), currentHero() === hero && currentMode() === mode) : !1;
}
...
var skills = /* @__PURE__ */ new Map([[$skill(_templateObject820 || (_templateObject820 = _taggedTemplateLiteral33(["Smooch of the Daywalker"]))), ["vampire", "kiss"]], [$skill(_templateObject919 || (_templateObject919 = _taggedTemplateLiteral33(["Slay the Dead"]))), ["vampire", "kill"]], [$skill(_templateObject1019 || (_templateObject1019 = _taggedTemplateLiteral33(["Unleash the Devil's Kiss"]))), ["heck", "kiss"]], [$skill(_templateObject1117 || (_templateObject1117 = _taggedTemplateLiteral33(["Deploy Robo-Handcuffs"]))), ["robot", "hold"]], [$skill(_templateObject1216 || (_templateObject1216 = _taggedTemplateLiteral33(["Blow a Robo-Kiss"]))), ["robot", "kiss"]], [$skill(_templateObject1315 || (_templateObject1315 = _taggedTemplateLiteral33(["Precision Shot"]))), ["robot", "kill"]]]);
function tuneToSkill(skill) {
  var setting = skills.get(skill);
  return !setting || !have33() ? !1 : (set2.apply(void 0, _toConsumableArray12(setting)), [currentHero(), currentMode()].every(function(element, index) {
...
var orb = import_kolmafia45.Item.get("miniature crystal ball");
function have34() {
  return (0, import_kolmafia45.availableAmount)(orb) > 0;
}
var parsedProp = function() {
  return get("crystalBallPredictions").split("|").map(function(element) {
    ...
    return [(0, import_kolmafia45.toLocation)(location), (0, import_kolmafia45.toMonster)(monster)];
  });
};
function ponder() {
  return have34() ? (canVisitUrl() ? (logger_default.debug("Now pondering Crystal Ball."), (0, import_kolmafia45.visitUrl)("inventory.php?ponder=1", !1)) : logger_default.debug("Failed to ponder Crystall Ball."), new Map(parsedProp())) : /* @__PURE__ */ new Map();
}
...
function buffCycle() {
  var playerclass = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, import_kolmafia46.myClass)();
  if (playerclass.id <= 0)
    return [];
...
function nextBuff() {
  var currentBuff = (0, import_kolmafia46.toEffect)(get("lastBeardBuff").toFixed(0)), cycle2 = buffCycle(), index = cycle2.indexOf(currentBuff), newIndex = (1 + index) % 11;
...
var item6 = import_kolmafia47.Item.get("autumn-aton");
function available3() {
  return (0, import_kolmafia47.availableAmount)(item6) > 0;
}
function have36() {
  return get("hasAutumnaton") || available3();
}
function checkLocations(html) {
  return (0, import_kolmafia47.xpath)(html, '//select[@name="heythereprogrammer"]//option[position()>1]/text()').map(function(name) {
    return (0, import_kolmafia47.toLocation)(name);
  });
}
...
function sendTo(target) {
  ...
  upgrade2 && (0, import_kolmafia47.availableChoiceOptions)()[1] && (0, import_kolmafia47.runChoice)(1);
  var locationsAvailable = checkLocations(pageHtml), location = target instanceof import_kolmafia47.Location ? target : Array.isArray(target) ? target.find(function(l) {
    return locationsAvailable.includes(l);
  }) : target(locationsAvailable);
  return !location || !locationsAvailable.includes(location) ? null : ((0, import_kolmafia47.handlingChoice)() || directlyUse(item6), (0, import_kolmafia47.runChoice)(2, "heythereprogrammer=".concat(location.id)), (0, import_kolmafia47.handlingChoice)() && (0, import_kolmafia47.visitUrl)("main.php"), location);
}
function upgrade() {
  directlyUse(item6);
  var canUpgrade = (0, import_kolmafia47.availableChoiceOptions)()[1] !== void 0;
  return canUpgrade && (0, import_kolmafia47.runChoice)(1), (0, import_kolmafia47.visitUrl)("main.php"), canUpgrade;
}
function availableLocations() {
  if (!available3())
    return [];
  var pageHtml = directlyUse(item6);
  return (0, import_kolmafia47.visitUrl)("main.php"), checkLocations(pageHtml);
}
...
function turnsLeft() {
  return get("autumnatonQuestTurn") - (0, import_kolmafia47.totalTurnsPlayed)();
}
function legs() {
...
var difficulties = ["low", "mid", "high"], UNIQUES = {
  outdoor: {
    ...
    high: {
      index: 6,
      item: $item(_templateObject359 || (_templateObject359 = _taggedTemplateLiteral35(["autumn leaf pendant"])))
    }
  },
  indoor: {
    low: {
      index: 0,
      item: $item(_templateObject447 || (_templateObject447 = _taggedTemplateLiteral35(["AutumnFest ale"])))
    },
    mid: {
      index: 3,
      item: $item(_templateObject531 || (_templateObject531 = _taggedTemplateLiteral35(["autumn-spice donut"])))
    },
    high: {
      index: 7,
      item: $item(_templateObject627 || (_templateObject627 = _taggedTemplateLiteral35(["autumn breeze"])))
    }
  },
  underground: {
    low: {
      index: 1,
      item: $item(_templateObject721 || (_templateObject721 = _taggedTemplateLiteral35(["autumn sweater-weather sweater"])))
    },
    mid: {
      index: 5,
      item: $item(_templateObject821 || (_templateObject821 = _taggedTemplateLiteral35(["autumn dollar"])))
    },
    high: {
      index: 8,
      item: $item(_templateObject920 || (_templateObject920 = _taggedTemplateLiteral35(["autumn years wisdom"])))
    }
  }
};
...
function availableLocketMonsters() {
  return reminiscesLeft() === 0 ? [] : Object.entries((0, import_kolmafia48.getLocketMonsters)()).filter(function(_ref) {
    var _ref2 = _slicedToArray12(_ref, 2), unused = _ref2[1];
    return unused;
  }).map(function(_ref3) {
    var _ref4 = _slicedToArray12(_ref3, 1), name = _ref4[0];
    return (0, import_kolmafia48.toMonster)(name);
  });
}
function unlockedLocketMonsters() {
  return Object.entries((0, import_kolmafia48.getLocketMonsters)()).map(function(_ref5) {
...
function reminiscesLeft() {
  return have37() ? clamp(3 - parseLocketProperty().length, 0, 3) : 0;
}
function monstersReminisced() {
  return parseLocketProperty().map(function(id) {
    return (0, import_kolmafia48.toMonster)(id);
  });
}
function reminisce(monster) {
  return !have37() || reminiscesLeft() === 0 || !(0, import_kolmafia48.getLocketMonsters)()[monster.name] ? !1 : ((0, import_kolmafia48.cliExecute)("reminisce ".concat(monster)), (0, import_kolmafia48.runCombat)(), monstersReminisced().includes(monster));
}
function findMonster(criteria) {
  var value = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : function() {
    return 1;
  };
  if (!have37() || reminiscesLeft() === 0)
    return null;
...
var goose = $familiar(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral37(["Grey Goose"])));
function have38() {
  return have(goose);
}
function currentExperience() {
  var postAscensionBaseExperience = have($familiar(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral37(["Shorter-Order Cook"])))) && !get("gooseReprocessed") ? 81 + (have($item(_templateObject360 || (_templateObject360 = _taggedTemplateLiteral37(["blue plate"])))) ? 19 : 0) : 0;
...
function expectedExperience() {
  var weight = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : currentWeight();
  return Math.pow(Math.max(weight - 5, 0), (0, import_kolmafia49.myClass)().id === 27 ? 2 : 3);
}
...
function fightsUntil(target) {
  ...
  return diff <= 0 ? 0 : Math.ceil(diff / (1 + bonusExperience + (have($skill(_templateObject448 || (_templateObject448 = _taggedTemplateLiteral37(["Testudinal Teachings"])))) ? 1 / 6 : 0)));
}
...
var cleaver = (0, import_kolmafia50.toItem)("June cleaver");
function have39() {
  return (0, import_kolmafia50.availableAmount)(cleaver) > 0;
}
...
var item7 = $item(_templateObject299 || (_templateObject299 = _taggedTemplateLiteral38(["model train set"])));
function installed4() {
  return (0, import_kolmafia51.getWorkshed)() === item7;
}
function have40() {
...
var trainsetEffects = /* @__PURE__ */ new Map([[Station.TOWER_FIZZY, import_kolmafia51.Effect.get("Carbonated")], [Station.TOWER_FROZEN, import_kolmafia51.Effect.get("Frozen")], [Station.SPOOKY_GRAVEYARD, import_kolmafia51.Effect.get("Shivering Spine")], [Station.TOWER_SEWAGE, import_kolmafia51.Effect.get("Hot Soupy Garbage")], [Station.OIL_BRIDGE, import_kolmafia51.Effect.get("Burningly Oiled")], [Station.OIL_REFINERY, import_kolmafia51.Effect.get("Spookily Greasy")], [Station.WATER_BRIDGE, import_kolmafia51.Effect.get("Troubled Waters")], [Station.PRAWN_SILO, import_kolmafia51.Effect.get("Craving Prawns")]]), trainsetEffectsDoubled = /* @__PURE__ */ new Map([[Station.TOWER_FIZZY, import_kolmafia51.Effect.get("Double Carbonated")], [Station.TOWER_FROZEN, import_kolmafia51.Effect.get("Double Frozen")], [Station.SPOOKY_GRAVEYARD, import_kolmafia51.Effect.get("Doubly Shivering Spine")], [Station.TOWER_SEWAGE, import_kolmafia51.Effect.get("Double Hot Soupy Garbage")], [Station.OIL_BRIDGE, import_kolmafia51.Effect.get("Doubly Burningly Oiled")], [Station.OIL_REFINERY, import_kolmafia51.Effect.get("Doubly Spookily Greasy")], [Station.WATER_BRIDGE, import_kolmafia51.Effect.get("Doubly Troubled Waters")], [Station.PRAWN_SILO, import_kolmafia51.Effect.get("Doubly Craving Prawns")]]);
...
function setConfiguration(configuration) {
  if (!canConfigure())
    return !1;
  (0, import_kolmafia51.visitUrl)("campground.php?action=workshed"), (0, import_kolmafia51.runChoice)(1, "forceoption=0".concat(configuration.map(function(station, index) {
    return "&slot[".concat(index, "]=").concat(stationToInt(station));
  }).join(""))), (0, import_kolmafia51.visitUrl)("main.php");
...
var _templateObject301, _templateObject2101, _templateObject361, _templateObject449, _templateObject536, _templateObject628, _templateObject724;
function _taggedTemplateLiteral40(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var cincho = $item(_templateObject301 || (_templateObject301 = _taggedTemplateLiteral40(["Cincho de Mayo"])));
function have42() {
  return have(cincho);
}
function currentCinch() {
  return have42() ? clamp(100 - get("_cinchUsed"), 0, 100) : 0;
}
function cinchRestoredBy() {
  var currentRests = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : get("_cinchoRests");
  return have42() ? clamp(50 - currentRests * 5, 5, 30) : 0;
}
function totalAvailableCinch() {
  var remainingRests = Math.max(0, (0, import_kolmafia53.totalFreeRests)() - get("timesRested"));
  return have42() ? currentCinch() + sum(new Array(remainingRests).fill(null).map(function(_, i) {
...
var skills2 = {
  SaltAndLime: $skill(_templateObject2101 || (_templateObject2101 = _taggedTemplateLiteral40(["Cincho: Dispense Salt and Lime"]))),
  PartySoundtrack: $skill(_templateObject361 || (_templateObject361 = _taggedTemplateLiteral40(["Cincho: Party Soundtrack"]))),
  FiestaExit: $skill(_templateObject449 || (_templateObject449 = _taggedTemplateLiteral40(["Cincho: Fiesta Exit"]))),
  ProjectilePi\u00F1ata: $skill(_templateObject536 || (_templateObject536 = _taggedTemplateLiteral40(["Cincho: Projectile Pi\xF1ata"]))),
  PartyFoul: $skill(_templateObject628 || (_templateObject628 = _taggedTemplateLiteral40(["Cincho: Party Foul"]))),
  ConfettiExtrava: $skill(_templateObject724 || (_templateObject724 = _taggedTemplateLiteral40(["Cincho: Confetti Extravaganza"])))
};
...
var _templateObject309, _templateObject2102, _templateObject369, _templateObject450, _templateObject537, _templateObject629, _templateObject725, _templateObject824, _templateObject921, _templateObject1020, _templateObject1118, _templateObject1217, _templateObject1316, _templateObject1413;
...
var item8 = $item(_templateObject309 || (_templateObject309 = _taggedTemplateLiteral41(["closed-circuit pay phone"])));
function have43() {
  return have(item8);
}
function rufusTarget() {
  ...
  switch (get("rufusQuestType")) {
    case "entity":
      return import_kolmafia54.Monster.get(target);
    case "artifact":
    case "items":
      return import_kolmafia54.Item.get(target);
    default:
      return null;
  }
}
var INGRESS_RIFTS = {
  desertbeach: $location(_templateObject2102 || (_templateObject2102 = _taggedTemplateLiteral41(["Shadow Rift (Desert Beach)"]))),
  forestvillage: $location(_templateObject369 || (_templateObject369 = _taggedTemplateLiteral41(["Shadow Rift (Forest Village)"]))),
  mclargehuge: $location(_templateObject450 || (_templateObject450 = _taggedTemplateLiteral41(["Shadow Rift (Mt. McLargeHuge)"]))),
  beanstalk: $location(_templateObject537 || (_templateObject537 = _taggedTemplateLiteral41(["Shadow Rift (Somewhere Over the Beanstalk)"]))),
  manor3: $location(_templateObject629 || (_templateObject629 = _taggedTemplateLiteral41(["Shadow Rift (Spookyraven Manor Third Floor)"]))),
  "8bit": $location(_templateObject725 || (_templateObject725 = _taggedTemplateLiteral41(["Shadow Rift (The 8-Bit Realm)"]))),
  pyramid: $location(_templateObject824 || (_templateObject824 = _taggedTemplateLiteral41(["Shadow Rift (The Ancient Buried Pyramid)"]))),
  giantcastle: $location(_templateObject921 || (_templateObject921 = _taggedTemplateLiteral41(["Shadow Rift (The Castle in the Clouds in the Sky)"]))),
  woods: $location(_templateObject1020 || (_templateObject1020 = _taggedTemplateLiteral41(["Shadow Rift (The Distant Woods)"]))),
  hiddencity: $location(_templateObject1118 || (_templateObject1118 = _taggedTemplateLiteral41(["Shadow Rift (The Hidden City)"]))),
  cemetery: $location(_templateObject1217 || (_templateObject1217 = _taggedTemplateLiteral41(["Shadow Rift (The Misspelled Cemetary)"]))),
  plains: $location(_templateObject1316 || (_templateObject1316 = _taggedTemplateLiteral41(["Shadow Rift (The Nearby Plains)"]))),
  town_right: $location(_templateObject1413 || (_templateObject1413 = _taggedTemplateLiteral41(["Shadow Rift (The Right Side of the Tracks)"])))
};
...
function chooseRift(options) {
  var filterFunction = function(l) {
    var _options$monsters, _options$drops, _options$otherFilter, _options$otherFilter2, monsters = (0, import_kolmafia54.getMonsters)(l);
    return options.canAdventure && !(0, import_kolmafia54.canAdventure)(l) || (_options$monsters = options.monsters) !== null && _options$monsters !== void 0 && _options$monsters.some(function(m) {
      ...
      return !monsters.some(function(m) {
        return i.name in (0, import_kolmafia54.itemDrops)(m);
      });
...
function chooseQuest(chooser) {
  return get("questRufus") !== "unstarted" || !have43() ? !1 : (withChoice(1497, "", function() {
    var _get2;
    directlyUse(item8), (0, import_kolmafia54.runChoice)(chooser({
      artifact: (0, import_kolmafia54.toItem)(get("rufusDesiredArtifact")),
      entity: (_get2 = get("rufusDesiredEntity")) !== null && _get2 !== void 0 ? _get2 : $monster.none,
      items: (0, import_kolmafia54.toItem)(get("rufusDesiredItems"))
    }));
...
function submitQuest() {
  return questStep("questRufus") === 1 ? (withChoice(1498, 1, function() {
    return (0, import_kolmafia54.use)(item8);
...
var item9 = $item(_templateObject370 || (_templateObject370 = _taggedTemplateLiteral42(["cursed monkey's paw"])));
function have44() {
  return have(item9);
}
function wishes() {
...
function wishableItems() {
  ...
  return new Set(flat(import_kolmafia55.Location.all().filter(function(l) {
    var _filters$location, _filters$location2;
    return (0, import_kolmafia55.canAdventure)(l) && ((_filters$location = (_filters$location2 = filters.location) === null || _filters$location2 === void 0 ? void 0 : _filters$location2.call(filters, l)) !== null && _filters$location !== void 0 ? _filters$location : !0);
  }).map(function(l) {
    return (0, import_kolmafia55.getMonsters)(l).filter(function(m) {
      ...
      return (0, import_kolmafia55.itemDropsArray)(m).filter(function(_ref) {
...
function unwishableEffects() {
  var names = import_kolmafia55.Effect.all().filter(function(e) {
  ...
  return names.filter(function(_ref3) {
    ...
    var name = _ref5.name;
    return (0, import_kolmafia55.toEffect)(name);
  });
}
...
function isWishable(wish) {
  return wish instanceof import_kolmafia55.Item ? wishableItems().has(wish) : wish.attributes.includes("nohookah") ? !1 : wish.name.match(/[.,']/) ? !getUnwishableEffects().includes(wish) : !0;
}
function wishFor(wish) {
  if (wishes() <= 0)
    return !1;
  if (wish instanceof import_kolmafia55.Effect)
    return (0, import_kolmafia55.monkeyPaw)(wish);
  var locations = import_kolmafia55.Location.all().filter(function(l) {
    return (0, import_kolmafia55.canAdventure)(l) && (0, import_kolmafia55.getMonsters)(l).some(function(m) {
      return m.copyable && (0, import_kolmafia55.itemDropsArray)(m).some(function(_ref6) {
        var drop = _ref6.drop;
        return drop === wish;
      });
    });
  ...
  try {
    locations.length && ((0, import_kolmafia55.cliExecute)("checkpoint"), (0, import_kolmafia55.prepareForAdventure)(locations[0]));
    var result = (0, import_kolmafia55.monkeyPaw)(wish);
    ...
    locations.length && (0, import_kolmafia55.cliExecute)("outfit checkpoint");
  }
}
...
init_kolmafia_polyfill();
var _templateObject371, _templateObject2103, _templateObject378, _templateObject451, _templateObject538, _templateObject630, _templateObject726;
function _taggedTemplateLiteral43(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill = $skill(_templateObject371 || (_templateObject371 = _taggedTemplateLiteral43(["Summon Candy Heart"]))), libramChance = 1 / 6, libramExpected = /* @__PURE__ */ new Map([[$item(_templateObject2103 || (_templateObject2103 = _taggedTemplateLiteral43(["green candy heart"]))), libramChance], [$item(_templateObject378 || (_templateObject378 = _taggedTemplateLiteral43(["lavender candy heart"]))), libramChance], [$item(_templateObject451 || (_templateObject451 = _taggedTemplateLiteral43(["orange candy heart"]))), libramChance], [$item(_templateObject538 || (_templateObject538 = _taggedTemplateLiteral43(["pink candy heart"]))), libramChance], [$item(_templateObject630 || (_templateObject630 = _taggedTemplateLiteral43(["white candy heart"]))), libramChance], [$item(_templateObject726 || (_templateObject726 = _taggedTemplateLiteral43(["yellow candy heart"]))), libramChance]]);
function have45() {
...
init_kolmafia_polyfill();
var _templateObject379, _templateObject2104, _templateObject380, _templateObject457, _templateObject539, _templateObject631, _templateObject727;
function _taggedTemplateLiteral44(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill2 = $skill(_templateObject379 || (_templateObject379 = _taggedTemplateLiteral44(["Summon Party Favor"])));
function have46() {
...
function expected2() {
  ...
  return /* @__PURE__ */ new Map([[$item(_templateObject2104 || (_templateObject2104 = _taggedTemplateLiteral44(["divine blowout"]))), commonChance2], [$item(_templateObject380 || (_templateObject380 = _taggedTemplateLiteral44(["divine can of silly string"]))), commonChance2], [$item(_templateObject457 || (_templateObject457 = _taggedTemplateLiteral44(["divine noisemaker"]))), commonChance2], [$item(_templateObject539 || (_templateObject539 = _taggedTemplateLiteral44(["divine champagne flute"]))), rareChance2], [$item(_templateObject631 || (_templateObject631 = _taggedTemplateLiteral44(["divine champagne popper"]))), rareChance2], [$item(_templateObject727 || (_templateObject727 = _taggedTemplateLiteral44(["divine cracker"]))), rareChance2]]);
}

// src/resources/2009/LoveSongs.ts
init_kolmafia_polyfill();
var _templateObject381, _templateObject2105, _templateObject387, _templateObject458, _templateObject540, _templateObject634, _templateObject728;
function _taggedTemplateLiteral45(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill3 = $skill(_templateObject381 || (_templateObject381 = _taggedTemplateLiteral45(["Summon Love Song"]))), libramChance2 = 1 / 6, libramExpected2 = /* @__PURE__ */ new Map([[$item(_templateObject2105 || (_templateObject2105 = _taggedTemplateLiteral45(["love song of disturbing obsession"]))), libramChance2], [$item(_templateObject387 || (_templateObject387 = _taggedTemplateLiteral45(["love song of icy revenge"]))), libramChance2], [$item(_templateObject458 || (_templateObject458 = _taggedTemplateLiteral45(["love song of naughty innuendo"]))), libramChance2], [$item(_templateObject540 || (_templateObject540 = _taggedTemplateLiteral45(["love song of smoldering passion"]))), libramChance2], [$item(_templateObject634 || (_templateObject634 = _taggedTemplateLiteral45(["love song of sugary cuteness"]))), libramChance2], [$item(_templateObject728 || (_templateObject728 = _taggedTemplateLiteral45(["love song of vague ambiguity"]))), libramChance2]]);
function have47() {
...
init_kolmafia_polyfill();
var _templateObject388, _templateObject2106, _templateObject389;
function _taggedTemplateLiteral46(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill4 = $skill(_templateObject388 || (_templateObject388 = _taggedTemplateLiteral46(["Summon BRICKOs"])));
function have48() {
  return have(summonSkill4);
}
function expected4() {
  var eyeSummons = get("_brickoEyeSummons"), eyeChance = eyeSummons === 3 ? 0 : eyeSummons === 0 ? 0.5 : 1 / 3;
  return /* @__PURE__ */ new Map([[$item(_templateObject2106 || (_templateObject2106 = _taggedTemplateLiteral46(["BRICKO eye brick"]))), eyeChance], [$item(_templateObject389 || (_templateObject389 = _taggedTemplateLiteral46(["BRICKO brick"]))), 3 - eyeChance]]);
}

// src/resources/2011/Gygaxian.ts
init_kolmafia_polyfill();
var _templateObject390, _templateObject2107, _templateObject391, _templateObject459, _templateObject541, _templateObject635, _templateObject729;
function _taggedTemplateLiteral47(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill5 = $skill(_templateObject390 || (_templateObject390 = _taggedTemplateLiteral47(["Summon Dice"]))), libramChance3 = 1 / 6, libramExpected3 = /* @__PURE__ */ new Map([[$item(_templateObject2107 || (_templateObject2107 = _taggedTemplateLiteral47(["d4"]))), libramChance3], [$item(_templateObject391 || (_templateObject391 = _taggedTemplateLiteral47(["d6"]))), libramChance3], [$item(_templateObject459 || (_templateObject459 = _taggedTemplateLiteral47(["d8"]))), libramChance3], [$item(_templateObject541 || (_templateObject541 = _taggedTemplateLiteral47(["d10"]))), libramChance3], [$item(_templateObject635 || (_templateObject635 = _taggedTemplateLiteral47(["d12"]))), libramChance3], [$item(_templateObject729 || (_templateObject729 = _taggedTemplateLiteral47(["d20"]))), libramChance3]]);
function have49() {
...
init_kolmafia_polyfill();
var _templateObject397, _templateObject2108, _templateObject398, _templateObject460, _templateObject545, _templateObject636, _templateObject730, _templateObject825, _templateObject923, _templateObject1021;
function _taggedTemplateLiteral48(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill6 = $skill(_templateObject397 || (_templateObject397 = _taggedTemplateLiteral48(["Summon Resolutions"]))), commonChance = 0.98 / 6, rareChance = 0.02 / 3, libramExpected4 = /* @__PURE__ */ new Map([[$item(_templateObject2108 || (_templateObject2108 = _taggedTemplateLiteral48(["resolution: be feistier"]))), commonChance], [$item(_templateObject398 || (_templateObject398 = _taggedTemplateLiteral48(["resolution: be happier"]))), commonChance], [$item(_templateObject460 || (_templateObject460 = _taggedTemplateLiteral48(["resolution: be sexier"]))), commonChance], [$item(_templateObject545 || (_templateObject545 = _taggedTemplateLiteral48(["resolution: be smarter"]))), commonChance], [$item(_templateObject636 || (_templateObject636 = _taggedTemplateLiteral48(["resolution: be stronger"]))), commonChance], [$item(_templateObject730 || (_templateObject730 = _taggedTemplateLiteral48(["resolution: be wealthier"]))), commonChance], [$item(_templateObject825 || (_templateObject825 = _taggedTemplateLiteral48(["resolution: be kinder"]))), rareChance], [$item(_templateObject923 || (_templateObject923 = _taggedTemplateLiteral48(["resolution: be luckier"]))), rareChance], [$item(_templateObject1021 || (_templateObject1021 = _taggedTemplateLiteral48(["resolution: be more adventurous"]))), rareChance]]);
function have50() {
...
init_kolmafia_polyfill();
var _templateObject399, _templateObject2109, _templateObject3100, _templateObject461, _templateObject546, _templateObject637, _templateObject731, _templateObject826;
function _taggedTemplateLiteral49(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var summonSkill7 = $skill(_templateObject399 || (_templateObject399 = _taggedTemplateLiteral49(["Summon Taffy"])));
function have51() {
...
function expected7() {
  ...
  return /* @__PURE__ */ new Map([[$item(_templateObject2109 || (_templateObject2109 = _taggedTemplateLiteral49(["pulled blue taffy"]))), commonChance2], [$item(_templateObject3100 || (_templateObject3100 = _taggedTemplateLiteral49(["pulled orange taffy"]))), commonChance2], [$item(_templateObject461 || (_templateObject461 = _taggedTemplateLiteral49(["pulled violet taffy"]))), commonChance2], [$item(_templateObject546 || (_templateObject546 = _taggedTemplateLiteral49(["pulled red taffy"]))), commonChance2], [$item(_templateObject637 || (_templateObject637 = _taggedTemplateLiteral49(["pulled indigo taffy"]))), rareChance2], [$item(_templateObject731 || (_templateObject731 = _taggedTemplateLiteral49(["pulled green taffy"]))), rareChance2], [$item(_templateObject826 || (_templateObject826 = _taggedTemplateLiteral49(["pulled yellow taffy"]))), yellowChance]]);
}

// src/resources/LibramSummon.ts
var _templateObject400, _templateObject2118, _templateObject3101, _templateObject466, _templateObject547, _templateObject638, _templateObject734, _templateObject827, _templateObject924, _templateObject1022, _templateObject1119, _templateObject1218, _templateObject1317, _templateObject1414;
...
function expectedLibramSummon(summonSkill8) {
  switch (summonSkill8) {
    case $skill(_templateObject400 || (_templateObject400 = _taggedTemplateLiteral50(["Summon Candy Heart"]))):
      return expected();
    case $skill(_templateObject2118 || (_templateObject2118 = _taggedTemplateLiteral50(["Summon Party Favor"]))):
      return expected2();
    case $skill(_templateObject3101 || (_templateObject3101 = _taggedTemplateLiteral50(["Summon Love Song"]))):
      return expected3();
    case $skill(_templateObject466 || (_templateObject466 = _taggedTemplateLiteral50(["Summon BRICKOs"]))):
      return expected4();
    case $skill(_templateObject547 || (_templateObject547 = _taggedTemplateLiteral50(["Summon Dice"]))):
      return expected5();
    case $skill(_templateObject638 || (_templateObject638 = _taggedTemplateLiteral50(["Summon Resolutions"]))):
      return expected6();
    case $skill(_templateObject734 || (_templateObject734 = _taggedTemplateLiteral50(["Summon Taffy"]))):
      return expected7();
  }
...
function possibleLibramSummons() {
  ...
  return have45() && results.set($skill(_templateObject827 || (_templateObject827 = _taggedTemplateLiteral50(["Summon Candy Heart"]))), expected()), have46() && results.set($skill(_templateObject924 || (_templateObject924 = _taggedTemplateLiteral50(["Summon Party Favor"]))), expected2()), have47() && results.set($skill(_templateObject1022 || (_templateObject1022 = _taggedTemplateLiteral50(["Summon Love Song"]))), expected3()), have48() && results.set($skill(_templateObject1119 || (_templateObject1119 = _taggedTemplateLiteral50(["Summon BRICKOs"]))), expected4()), have49() && results.set($skill(_templateObject1218 || (_templateObject1218 = _taggedTemplateLiteral50(["Summon Dice"]))), expected5()), have50() && results.set($skill(_templateObject1317 || (_templateObject1317 = _taggedTemplateLiteral50(["Summon Resolutions"]))), expected6()), have51() && results.set($skill(_templateObject1414 || (_templateObject1414 = _taggedTemplateLiteral50(["Summon Taffy"]))), expected7()), results;
}
...
// src/ascend.ts
var _templateObject401, _templateObject2119, _templateObject3102, _templateObject467, _templateObject548, _templateObject639;
...
function permedSkills() {
  return new Map(Array.from(Object.entries((0, import_kolmafia56.getPermedSkills)())).map(function(_ref) {
    var _ref2 = _slicedToArray14(_ref, 2), skillName = _ref2[0], isHardcore = _ref2[1];
    return [(0, import_kolmafia56.toSkill)(skillName), isHardcore ? Lifestyle.hardcore : Lifestyle.softcore];
  }));
}
var AscendError = /* @__PURE__ */ function(_Error) {
  ...
  function AscendError2(cause) {
    ...
    else if (cause instanceof import_kolmafia56.Skill) {
      var reason = cause.permable ? (0, import_kolmafia56.haveSkill)(cause) ? "too karmaically expensive" : "not a skill you currently know" : "unpermable";
      _this = _super.call(this, "Skill ".concat(cause, " is ").concat(reason, "!")), _defineProperty13(_assertThisInitialized3(_this), "cause", void 0);
    } else
      cause instanceof import_kolmafia56.Item ? (_this = _super.call(this, "Invalid astral item: ".concat(cause, "!")), _defineProperty13(_assertThisInitialized3(_this), "cause", void 0)) : cause instanceof import_kolmafia56.Class ? (_this = _super.call(this, "Invalid class ".concat(cause, " for this path!")), _defineProperty13(_assertThisInitialized3(_this), "cause", void 0)) : cause instanceof import_kolmafia56.Path ? (_this = _super.call(this, "Invalid path ".concat(cause, "!")), _defineProperty13(_assertThisInitialized3(_this), "cause", void 0)) : (_this = _super.call(this, cause), _defineProperty13(_assertThisInitialized3(_this), "cause", void 0));
...
function inputToMoonId(moon, playerClass) {
  ...
  var offset = function() {
    switch (playerClass.primestat) {
      case $stat(_templateObject401 || (_templateObject401 = _taggedTemplateLiteral51(["Muscle"]))):
        return 0;
      case $stat(_templateObject2119 || (_templateObject2119 = _taggedTemplateLiteral51(["Mysticality"]))):
        return 1;
      case $stat(_templateObject3102 || (_templateObject3102 = _taggedTemplateLiteral51(["Moxie"]))):
        return 2;
      default:
...
function isInValhalla() {
  var charPaneText = (0, import_kolmafia56.visitUrl)("charpane.php"), matches = charPaneText.match(/<img src="[^"]*\/otherimages\/inf_\w+\.gif">/);
  return matches !== null;
}
function ascend(path, playerClass, lifestyle, moon) {
  var consumable = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : $item(_templateObject467 || (_templateObject467 = _taggedTemplateLiteral51(["astral six-pack"]))), pet = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : void 0, permOptions = arguments.length > 6 ? arguments[6] : void 0;
  if (playerClass.path !== (path.avatar ? path : import_kolmafia56.Path.none))
  ...
  if (consumable && !$items(_templateObject548 || (_templateObject548 = _taggedTemplateLiteral51(["astral six-pack, astral hot dog dinner, [10882]carton of astral energy drinks"]))).includes(consumable))
    throw new AscendError(consumable);
  if (pet && !$items(_templateObject639 || (_templateObject639 = _taggedTemplateLiteral51(["astral bludgeon, astral shield, astral chapeau, astral bracer, astral longbow, astral shorts, astral mace, astral trousers, astral ring, astral statuette, astral pistol, astral mask, astral pet sweater, astral shirt, astral belt"]))).includes(pet))
    throw new AscendError(pet);
  var illegalSkill = permOptions ? Array.from(permOptions.permSkills.keys()).find(function(skill2) {
    return !skill2.permable || !(0, import_kolmafia56.haveSkill)(skill2);
  }) : void 0;
  if (illegalSkill)
    throw new AscendError(illegalSkill);
  if (isInValhalla() || (0, import_kolmafia56.visitUrl)("ascend.php?action=ascend&confirm=on&confirm2=on"), !isInValhalla())
    throw new AscendError();
  if ((0, import_kolmafia56.visitUrl)("afterlife.php?action=pearlygates"), consumable && (0, import_kolmafia56.visitUrl)("afterlife.php?action=buydeli&whichitem=".concat(consumable.id)), pet && (0, import_kolmafia56.visitUrl)("afterlife.php?action=buyarmory&whichitem=".concat(pet.id)), permOptions) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        ...
        if (prospectivePermLevel > currentPermLevel) {
          ...
          (0, import_kolmafia56.visitUrl)("afterlife.php?action=".concat(permText, "&whichskill=").concat(skill.id));
        }
      }
    } catch (err) {
      _iterator.e(err);
  ...
  (0, import_kolmafia56.visitUrl)("afterlife.php?action=ascend&confirmascend=1&whichsign=".concat(moonId, "&gender=2&whichclass=").concat(playerClass.id, "&whichpath=").concat(path.id, "&asctype=").concat(lifestyle, "&nopetok=1&noskillsok=1&lamepathok=1&lamesignok=1&pwd"), !0);
}
function prepareAscension() {
  ...
  if (throwOnFail = (_throwOnFail = throwOnFail) !== null && _throwOnFail !== void 0 ? _throwOnFail : !0, garden && !Object.getOwnPropertyNames((0, import_kolmafia56.getCampground)()).includes(garden)) {
    (0, import_kolmafia56.use)(import_kolmafia56.Item.get(garden));
    var gardenName = Object.getOwnPropertyNames((0, import_kolmafia56.getCampground)()).find(isGarden);
    if (gardenName !== garden && throwOnFail)
      throw new AscensionPrepError(garden, gardenName);
  }
  if (eudora && (0, import_kolmafia56.eudoraItem)().name !== eudora) {
    var eudoraNumber = 1 + eudorae.indexOf(eudora);
    if (!(0, import_kolmafia56.xpath)((0, import_kolmafia56.visitUrl)("account.php?tab=correspondence"), '//select[@name="whichpenpal"]/option/@value').includes(eudoraNumber.toString()) && throwOnFail)
      throw new AscensionPrepError("Unable to swap eudora to ".concat(eudora, " because you are not subscribed to it."));
    if ((0, import_kolmafia56.visitUrl)("account.php?actions[]=whichpenpal&whichpenpal=".concat(eudoraNumber, "&action=Update"), !0), (0, import_kolmafia56.eudoraItem)() !== import_kolmafia56.Item.get(eudora) && throwOnFail)
      throw new AscensionPrepError(eudora, (0, import_kolmafia56.eudoraItem)());
  }
...
// src/Clan.ts
init_kolmafia_polyfill();
var import_html_entities = __toESM(require_lib()), import_kolmafia57 = require("kolmafia");
...
var clanIdCache = {}, toPlayerId = function(player) {
  return typeof player == "string" ? (0, import_kolmafia57.getPlayerId)(player) : player;
  ...
  return _createClass11(Clan2, [{
    key: "_check",
    value: function() {
      if (this.id !== (0, import_kolmafia57.getClanId)())
    ...
    key: "check",
    value: function() {
      return (0, import_kolmafia57.visitUrl)("clan_hall.php").includes("<b>".concat(this.name, "</b>"));
    }
    /**
    ...
    value: function() {
      this._check();
      var logs = (0, import_kolmafia57.visitUrl)("clan_log.php"), lastFax = logs.match(LOG_FAX_PATTERN);
      if (!lastFax)
        return null;
      var _lastFax = _slicedToArray15(lastFax, 4), monsterName = _lastFax[3];
      return monsterName ? import_kolmafia57.Monster.get(monsterName) : null;
    }
    /**
    ...
    value: function() {
      this._check();
      var page = (0, import_kolmafia57.visitUrl)("clan_whitelist.php");
      return (0, import_kolmafia57.xpath)(page, '//select[@name="level"]//option').map(function(option) {
        var validHtml = "<select>".concat(option, "</select>"), match = (0, import_kolmafia57.xpath)(validHtml, "//text()")[0].match(WHITELIST_DEGREE_PATTERN), id = (0, import_kolmafia57.xpath)(validHtml, "//@value")[0];
        if (!match || !id)
          return null;
        var _match = _slicedToArray15(match, 3), encodedName = _match[1], degree = _match[2];
        return {
    ...
    value: function(player, rankName) {
      ...
      if (!rank)
        return !1;
      var result = (0, import_kolmafia57.visitUrl)("clan_whitelist.php?action=add&pwd&addwho=".concat(playerId, "&level=").concat(rank.id, "&title=").concat(title));
    ...
    value: function(player) {
      this._check();
      var playerId = toPlayerId(player), result = (0, import_kolmafia57.visitUrl)("clan_whitelist.php?action=updatewl&pwd&who=".concat(playerId, "&remove=Remove"));
    ...
    value: function() {
      this._check();
      var page = (0, import_kolmafia57.visitUrl)("clan_stash.php"), _ref = page.match(/Your <b>Clan Coffer<\/b> contains ([\d,]+) Meat./) || ["0", "0"], _ref2 = _slicedToArray15(_ref, 2), meat = _ref2[1];
    ...
    value: function(amount) {
      this._check();
      var result = (0, import_kolmafia57.visitUrl)("clan_stash.php?pwd&action=contribute&howmuch=".concat(amount));
    ...
    value: function(items) {
      ...
      return map.forEach(function(quantity, item10) {
        var needed = Math.max(0, quantity - (0, import_kolmafia57.availableAmount)(item10));
        if (needed === 0)
          return map.set(item10, 0);
        var foldGroup = getFoldGroup(item10), _iterator = _createForOfIteratorHelper11(foldGroup), _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            for (var foldable = _step.value, quantityToFold = Math.min(needed, (0, import_kolmafia57.availableAmount)(foldable)), _i3 = 0; _i3 < quantityToFold; _i3++)
              (0, import_kolmafia57.cliExecute)("fold ".concat(item10.name)), needed--;
        ...
        (0, import_kolmafia57.refreshStash)();
        for (var _i2 = 0, _arr2 = [item10].concat(_toConsumableArray14(foldGroup)); _i2 < _arr2.length; _i2++) {
          var matchingItem = _arr2[_i2], quantityToTake = Math.min(needed, (0, import_kolmafia57.stashAmount)(matchingItem));
          if (quantityToTake !== 0) {
            if (!(0, import_kolmafia57.takeStash)(quantityToTake, matchingItem))
              return;
            if (matchingItem === item10)
              needed -= quantityToTake;
            else
              for (var i = 0; i < quantityToTake; i++)
                (0, import_kolmafia57.cliExecute)("fold ".concat(matchingItem.name)), needed--;
          }
        }
    ...
    value: function(items) {
      ...
      return map.forEach(function(quantity, item10) {
        (0, import_kolmafia57.retrieveItem)(quantity, item10);
        var returned = Math.min(quantity, (0, import_kolmafia57.availableAmount)(item10));
        (0, import_kolmafia57.putStash)(returned, item10), map.set(item10, quantity - returned);
      }), Array.isArray(items) ? countedMapToArray(map) : map;
    }
    /**
    ...
    key: "_join",
    value: function(id) {
      var result = (0, import_kolmafia57.visitUrl)("showclan.php?recruiter=1&whichclan=".concat(id, "&pwd&whichclan=").concat(id, "&action=joinclan&apply=Apply+to+this+Clan&confirm=on"));
    ...
    value: function(clanIdOrName) {
      ...
      if (typeof clanIdOrName == "string") {
        ...
        if (_clanName === (0, import_kolmafia57.getClanName)().toLowerCase())
          return Clan2.get();
      ...
      } else if (clanId = clanIdOrName, clanId === (0, import_kolmafia57.getClanId)())
        return Clan2.get();
    ...
    key: "get",
    value: function() {
      return new Clan2((0, import_kolmafia57.getClanId)(), (0, import_kolmafia57.getClanName)());
    }
    /**
    ...
    key: "getWhitelisted",
    value: function() {
      var page = (0, import_kolmafia57.visitUrl)("clan_signup.php");
      return (0, import_kolmafia57.xpath)(page, '//select[@name="whichclan"]//option').map(function(option) {
        var validHtml = "<select>".concat(option, "</select>"), id = Number.parseInt((0, import_kolmafia57.xpath)(validHtml, "//@value")[0]), name = (0, import_html_entities.decode)((0, import_kolmafia57.xpath)(validHtml, "//text()")[0]);
...
var _templateObject407, _templateObject2120, _templateObject3103, _templateObject468, _templateObject549, _templateObject640, _templateObject735, _templateObject828, _templateObject925, _templateObject1023, _templateObject1120, _templateObject1219, _templateObject1318, _templateObject1415, _templateObject1513, _templateObject1613, _templateObject1713, _templateObject1813, _templateObject1913, _templateObject2013, _templateObject2121, _templateObject2215, _templateObject2313, _templateObject2412, _templateObject2512, _templateObject2612, _templateObject2712;
...
var thralls = /* @__PURE__ */ new Map([[$stat(_templateObject407 || (_templateObject407 = _taggedTemplateLiteral52(["muscle"]))), $thrall(_templateObject2120 || (_templateObject2120 = _taggedTemplateLiteral52(["Elbow Macaroni"])))], [$stat(_templateObject3103 || (_templateObject3103 = _taggedTemplateLiteral52(["moxie"]))), $thrall(_templateObject468 || (_templateObject468 = _taggedTemplateLiteral52(["Penne Dreadful"])))]]), statCommunityServicePredictor = function(stat) {
  return function() {
    return 60 - Math.floor(1 / 30 * ((0, import_kolmafia58.myBuffedstat)(stat) - (0, import_kolmafia58.myBasestat)(thralls.get(stat) === (0, import_kolmafia58.myThrall)() && !have($effect(_templateObject549 || (_templateObject549 = _taggedTemplateLiteral52(["Expert Oiliness"])))) ? $stat(_templateObject640 || (_templateObject640 = _taggedTemplateLiteral52(["mysticality"]))) : stat)));
  };
}, visitCouncil = function() {
  return (0, import_kolmafia58.visitUrl)("council.php");
}, baseWeight = function() {
  return have($effect(_templateObject735 || (_templateObject735 = _taggedTemplateLiteral52(["Fidoxene"])))) ? 20 : (0, import_kolmafia58.familiarWeight)((0, import_kolmafia58.myFamiliar)());
  ...
  return _createClass12(CommunityService2, [{
    ...
    value: function() {
      ...
      (_this$timer = this.timer) !== null && _this$timer !== void 0 || (this.timer = {
        time: Date.now(),
        turns: (0, import_kolmafia58.myTurncount)()
      });
    }
  }, {
    key: "isDone",
    ...
    value: function() {
      ...
      var councilText = (0, import_kolmafia58.runChoice)(this.choice);
    ...
    value: function(prepare) {
      ...
      try {
        ...
        return (0, import_kolmafia58.print)("".concat(e), "red"), "failed";
      }
      var prediction = this.predictor(), council = visitCouncil(), turnCost = this._actualCost(council);
      return turnCost ? turnCost > Math.min(maxTurns, (0, import_kolmafia58.myAdventures)()) || !this.do() ? "failed" : (CommunityService2.log[this.property] = {
        predictedTurns: prediction + additionalTurns,
        turnCost: (0, import_kolmafia58.myTurncount)() - turns,
    ...
    value: (
      ...
      function() {
        for (var colour = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "blue", logEntries = Object.entries(CommunityService2.log), _i = 0, _logEntries = logEntries; _i < _logEntries.length; _i++) {
          ...
          type === "test" ? ((0, import_kolmafia58.print)("We predicted the ".concat(testName, " test would take ").concat(predictedTurns, " turns, ").concat(predictedTurns === turnCost ? "and" : "but", " it took ").concat(turnCost, " turns."), colour), (0, import_kolmafia58.print)("".concat(testName, " took ").concat(seconds.toFixed(1), " seconds."), colour)) : (predictedTurns === 0 && turnCost === 0 || (0, import_kolmafia58.print)("We predicted the task ".concat(testName, " would take ").concat(predictedTurns, " turns, ").concat(predictedTurns === turnCost ? "and" : "but", " it took ").concat(turnCost, " turns."), colour), (0, import_kolmafia58.print)("The task ".concat(testName, " took ").concat(seconds.toFixed(1), " seconds."), colour));
        }
        ...
        (0, import_kolmafia58.print)("All together, you have spent ".concat(totalTime.toFixed(1), " seconds during this Community Service run"), colour);
      }
    )
...
_defineProperty15(CommunityService, "HP", new CommunityService(1, "HP", "Donate Blood", function() {
  return 60 - Math.floor(((0, import_kolmafia58.myMaxhp)() - (0, import_kolmafia58.myBuffedstat)($stat(_templateObject828 || (_templateObject828 = _taggedTemplateLiteral52(["muscle"])))) - 3) / 30);
}, new Requirement(["HP"], {})));
_defineProperty15(CommunityService, "Muscle", new CommunityService(2, "Muscle", "Feed The Children", statCommunityServicePredictor($stat(_templateObject925 || (_templateObject925 = _taggedTemplateLiteral52(["Muscle"])))), new Requirement(["Muscle"], {})));
_defineProperty15(CommunityService, "Mysticality", new CommunityService(3, "Mysticality", "Build Playground Mazes", statCommunityServicePredictor($stat(_templateObject1023 || (_templateObject1023 = _taggedTemplateLiteral52(["Mysticality"])))), new Requirement(["Mysticality"], {})));
_defineProperty15(CommunityService, "Moxie", new CommunityService(4, "Moxie", "Feed Conspirators", statCommunityServicePredictor($stat(_templateObject1120 || (_templateObject1120 = _taggedTemplateLiteral52(["Moxie"])))), new Requirement(["Moxie"], {})));
_defineProperty15(CommunityService, "FamiliarWeight", new CommunityService(5, "Familiar Weight", "Breed More Collies", function() {
  return 60 - Math.floor((baseWeight() + (0, import_kolmafia58.weightAdjustment)()) / 5);
...
_defineProperty15(CommunityService, "WeaponDamage", new CommunityService(6, "Weapon Damage", "Reduce Gazelle Population", function() {
  var weaponPower = (0, import_kolmafia58.getPower)((0, import_kolmafia58.equippedItem)($slot(_templateObject1219 || (_templateObject1219 = _taggedTemplateLiteral52(["weapon"]))))), offhandPower = (0, import_kolmafia58.toSlot)((0, import_kolmafia58.equippedItem)($slot(_templateObject1318 || (_templateObject1318 = _taggedTemplateLiteral52(["off-hand"]))))) === $slot(_templateObject1415 || (_templateObject1415 = _taggedTemplateLiteral52(["weapon"]))) ? (0, import_kolmafia58.getPower)((0, import_kolmafia58.equippedItem)($slot(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral52(["off-hand"]))))) : 0, familiarPower = (0, import_kolmafia58.toSlot)((0, import_kolmafia58.equippedItem)($slot(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral52(["familiar"]))))) === $slot(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral52(["weapon"]))) ? (0, import_kolmafia58.getPower)((0, import_kolmafia58.equippedItem)($slot(_templateObject1813 || (_templateObject1813 = _taggedTemplateLiteral52(["familiar"]))))) : 0, multiplier = have($effect(_templateObject1913 || (_templateObject1913 = _taggedTemplateLiteral52(["Bow-Legged Swagger"])))) ? 2 : 1;
...
_defineProperty15(CommunityService, "SpellDamage", new CommunityService(7, "Spell Damage", "Make Sausage", function() {
  var dragonfishDamage = (0, import_kolmafia58.myFamiliar)() === $familiar(_templateObject2013 || (_templateObject2013 = _taggedTemplateLiteral52(["Magic Dragonfish"]))) ? (0, import_kolmafia58.numericModifier)($familiar(_templateObject2121 || (_templateObject2121 = _taggedTemplateLiteral52(["Magic Dragonfish"]))), "Spell Damage Percent", baseWeight() + (0, import_kolmafia58.weightAdjustment)(), $item.none) : 0;
...
_defineProperty15(CommunityService, "BoozeDrop", new CommunityService(9, "Item Drop", "Make Margaritas", function() {
  var mummingCostume = MummingTrunk_exports.currentCostumes().get((0, import_kolmafia58.myFamiliar)()), mummingBuff = mummingCostume && mummingCostume[0] === "Item Drop" ? mummingCostume[1] : 0, familiarItemDrop = (0, import_kolmafia58.numericModifier)((0, import_kolmafia58.myFamiliar)(), "Item Drop", baseWeight() + (0, import_kolmafia58.weightAdjustment)(), (0, import_kolmafia58.equippedItem)($slot(_templateObject2215 || (_templateObject2215 = _taggedTemplateLiteral52(["familiar"]))))) + mummingBuff - (0, import_kolmafia58.numericModifier)((0, import_kolmafia58.equippedItem)($slot(_templateObject2313 || (_templateObject2313 = _taggedTemplateLiteral52(["familiar"])))), "Item Drop"), familiarBoozeDrop = (0, import_kolmafia58.numericModifier)((0, import_kolmafia58.myFamiliar)(), "Booze Drop", baseWeight() + (0, import_kolmafia58.weightAdjustment)(), (0, import_kolmafia58.equippedItem)($slot(_templateObject2412 || (_templateObject2412 = _taggedTemplateLiteral52(["familiar"]))))) - (0, import_kolmafia58.numericModifier)((0, import_kolmafia58.equippedItem)($slot(_templateObject2512 || (_templateObject2512 = _taggedTemplateLiteral52(["familiar"])))), "Booze Drop"), multiplier = (0, import_kolmafia58.haveEquipped)($item(_templateObject2612 || (_templateObject2612 = _taggedTemplateLiteral52(["broken champagne bottle"])))) && get("garbageChampagneCharge") > 0 ? 0.5 : 1;
  return 60 - Math.floor(multiplier * (get2("Item Drop") - familiarItemDrop - (0, import_kolmafia58.numericModifier)((0, import_kolmafia58.myThrall)(), "Item Drop")) / 30 + 1e-3) - Math.floor((get2("Booze Drop") - familiarBoozeDrop) / 15 + 1e-3);
}, new Requirement(["Item Drop", "2 Booze Drop"], {
  preventEquip: $items(_templateObject2712 || (_templateObject2712 = _taggedTemplateLiteral52(["broken champagne bottle"])))
})));
...
_defineProperty15(CommunityService, "donate", function() {
  visitCouncil(), (0, import_kolmafia58.visitUrl)("choice.php?whichchoice=1089&option=30");
});
...
function coolingTank() {
  (0, import_kolmafia59.visitUrl)("place.php?whichplace=falloutshelter&action=vault8");
}
function spa() {
  (0, import_kolmafia59.visitUrl)("place.php?whichplace=falloutshelter&action=vault3");
}
function chronoLab() {
  (0, import_kolmafia59.visitUrl)("place.php?whichplace=falloutshelter&action=vault5");
}
...
// src/diet/index.ts
var _templateObject408, _templateObject2122, _templateObject3104, _templateObject469, _templateObject550, _templateObject641, _templateObject736, _templateObject829, _templateObject926, _templateObject1024, _templateObject1121, _templateObject1220, _templateObject1319, _templateObject1416, _templateObject1514, _templateObject1614, _templateObject1714, _templateObject1814, _templateObject1914, _templateObject2014, _templateObject2123, _templateObject2216, _templateObject2314, _templateObject2413, _templateObject2513, _templateObject2613, _templateObject2713, _templateObject2810, _templateObject2910, _templateObject3010, _templateObject3113, _templateObject3212, _templateObject3311, _templateObject3410, _templateObject3510, _templateObject3610, _templateObject3710, _templateObject3810, _templateObject3910, _templateObject409, _templateObject4112, _templateObject4211, _templateObject4310, _templateObject4410, _templateObject4510, _templateObject4610, _templateObject476, _templateObject486, _templateObject496, _templateObject506, _templateObject5111, _templateObject5210, _templateObject5310, _templateObject5410, _templateObject555, _templateObject565, _templateObject575, _templateObject584, _templateObject594;
...
function isMonday() {
  return get2("Muscle Percent", $item(_templateObject408 || (_templateObject408 = _taggedTemplateLiteral53(["Tuesday's ruby"])))) > 0;
}
...
var MenuItem = /* @__PURE__ */ function() {
  function MenuItem2(item10) {
    ...
    var typ = (0, import_kolmafia60.itemType)(this.item);
  ...
  return _createClass14(MenuItem2, [{
    ...
    key: "defaultOptions",
    value: function() {
      return /* @__PURE__ */ new Map([[$item(_templateObject3104 || (_templateObject3104 = _taggedTemplateLiteral53(["distention pill"]))), {
        organ: "food",
        maximum: !have($item(_templateObject469 || (_templateObject469 = _taggedTemplateLiteral53(["distention pill"])))) || get("_distentionPillUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject550 || (_templateObject550 = _taggedTemplateLiteral53(["synthetic dog hair pill"]))), {
        organ: "booze",
        maximum: !have($item(_templateObject641 || (_templateObject641 = _taggedTemplateLiteral53(["synthetic dog hair pill"])))) || get("_syntheticDogHairPillUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject736 || (_templateObject736 = _taggedTemplateLiteral53(["cuppa Voraci tea"]))), {
        organ: "food",
        maximum: get("_voraciTeaUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject829 || (_templateObject829 = _taggedTemplateLiteral53(["cuppa Sobrie tea"]))), {
        organ: "booze",
        maximum: get("_sobrieTeaUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject926 || (_templateObject926 = _taggedTemplateLiteral53(["mojo filter"]))), {
        organ: "spleen item",
        maximum: 3 - get("currentMojoFilters"),
        size: -1
      }], [$item(_templateObject1024 || (_templateObject1024 = _taggedTemplateLiteral53(["spice melange"]))), {
        maximum: get("spiceMelangeUsed") ? 0 : 1
      }], [$item(_templateObject1121 || (_templateObject1121 = _taggedTemplateLiteral53(["Ultra Mega Sour Ball"]))), {
        maximum: get("_ultraMegaSourBallUsed") ? 0 : 1
      }], [$item(_templateObject1220 || (_templateObject1220 = _taggedTemplateLiteral53(["The Plumber's mushroom stew"]))), {
        maximum: get("_plumbersMushroomStewEaten") ? 0 : 1
      }], [$item(_templateObject1319 || (_templateObject1319 = _taggedTemplateLiteral53(["The Mad Liquor"]))), {
        maximum: get("_madLiquorDrunk") ? 0 : 1
      }], [$item(_templateObject1416 || (_templateObject1416 = _taggedTemplateLiteral53(["Doc Clock's thyme cocktail"]))), {
        maximum: get("_docClocksThymeCocktailDrunk") ? 0 : 1
      }], [$item(_templateObject1514 || (_templateObject1514 = _taggedTemplateLiteral53(["Mr. Burnsger"]))), {
...
_defineProperty17(MenuItem, "defaultPriceFunction", function(item10) {
  return (0, import_kolmafia60.npcPrice)(item10) > 0 ? (0, import_kolmafia60.npcPrice)(item10) : (0, import_kolmafia60.mallPrice)(item10);
});
...
var DietPlanner = /* @__PURE__ */ function() {
  function DietPlanner2(mpa, menu) {
    ...
    if (_classCallCheck14(this, DietPlanner2), _defineProperty17(this, "mpa", void 0), _defineProperty17(this, "menu", void 0), _defineProperty17(this, "mayoLookup", void 0), _defineProperty17(this, "fork", void 0), _defineProperty17(this, "mug", void 0), _defineProperty17(this, "seasoning", void 0), _defineProperty17(this, "spleenValue", 0), this.mpa = mpa, this.fork = menu.find(function(item10) {
      return item10.item === $item(_templateObject1614 || (_templateObject1614 = _taggedTemplateLiteral53(["Ol' Scratch's salad fork"])));
    }), this.mug = menu.find(function(item10) {
      return item10.item === $item(_templateObject1714 || (_templateObject1714 = _taggedTemplateLiteral53(["Frosty's frosty mug"])));
    }), this.seasoning = menu.find(function(item10) {
      return item10.item === $item(_templateObject1814 || (_templateObject1814 = _taggedTemplateLiteral53(["Special Seasoning"])));
    ...
    this.menu = menu.filter(function(item10) {
      ...
      return (0, import_kolmafia60.historicalPrice)(item10.item) === 0 || (0, import_kolmafia60.historicalAge)(item10.item) >= 1;
    }).length > 100 && ((0, import_kolmafia60.mallPrices)("food"), (0, import_kolmafia60.mallPrices)("booze"));
    var spleenItems = menu.filter(function(item10) {
      return (0, import_kolmafia60.itemType)(item10.item) === "spleen item";
    });
    if (spleenItems.sort(function(x, y) {
      ...
      var bestMarginalSpleenItem = spleenItems.find(function(spleenItem) {
        return spleenItem.maximum === void 0 || spleenItem.maximum * spleenItem.size >= (0, import_kolmafia60.spleenLimit)() - (0, import_kolmafia60.mySpleenUse)();
      });
  ...
  return _createClass14(DietPlanner2, [{
    ...
    value: function(menuItem, overrideModifiers) {
      ...
      if ((0, import_kolmafia60.itemType)(menuItem.item) === "food" && this.mayoLookup.size) {
      ...
      var defaultModifiers = _objectSpread6({
        ...
        refinedPalate: have($effect(_templateObject1914 || (_templateObject1914 = _taggedTemplateLiteral53(["Refined Palate"])))),
        garish: have($effect(_templateObject2014 || (_templateObject2014 = _taggedTemplateLiteral53(["Gar-ish"])))),
        saucemaven: have($skill(_templateObject2123 || (_templateObject2123 = _taggedTemplateLiteral53(["Saucemaven"])))),
        pinkyRing: have($item(_templateObject2216 || (_templateObject2216 = _taggedTemplateLiteral53(["mafia pinky ring"])))) && (0, import_kolmafia60.canEquip)($item(_templateObject2314 || (_templateObject2314 = _taggedTemplateLiteral53(["mafia pinky ring"])))),
        tuxedoShirt: have($item(_templateObject2413 || (_templateObject2413 = _taggedTemplateLiteral53(["tuxedo shirt"])))) && (0, import_kolmafia60.canEquip)($item(_templateObject2513 || (_templateObject2513 = _taggedTemplateLiteral53(["tuxedo shirt"]))))
      }, overrideModifiers);
      this.seasoning && (0, import_kolmafia60.itemType)(menuItem.item) === "food" && this.mpa * (_expectedAdventures(menuItem.item, _objectSpread6(_objectSpread6({}, defaultModifiers), {}, {
        seasoning: !0
      })) - _expectedAdventures(menuItem.item, _objectSpread6(_objectSpread6({}, defaultModifiers), {}, {
        seasoning: !1
      }))) > (0, import_kolmafia60.mallPrice)($item(_templateObject2613 || (_templateObject2613 = _taggedTemplateLiteral53(["Special Seasoning"])))) && helpers.push(this.seasoning);
      var forkMug = (0, import_kolmafia60.itemType)(menuItem.item) === "food" ? this.fork : (0, import_kolmafia60.itemType)(menuItem.item) === "booze" ? this.mug : null, forkMugPrice = forkMug ? forkMug.price() : 1 / 0, baseCost = menuItem.price() + sum(helpers, function(item10) {
        return item10.price();
      }), valueRaw = _expectedAdventures(menuItem.item, defaultModifiers) * this.mpa - baseCost + ((_menuItem$additionalV = menuItem.additionalValue) !== null && _menuItem$additionalV !== void 0 ? _menuItem$additionalV : 0), valueForkMug = _expectedAdventures(menuItem.item, _objectSpread6(_objectSpread6({}, defaultModifiers), {}, {
        forkMug: !0
      })) * this.mpa - baseCost - forkMugPrice + ((_menuItem$additionalV2 = menuItem.additionalValue) !== null && _menuItem$additionalV2 !== void 0 ? _menuItem$additionalV2 : 0), valueSpleen = $items(_templateObject2713 || (_templateObject2713 = _taggedTemplateLiteral53(["jar of fermented pickle juice, extra-greasy slider"]))).includes(menuItem.item) ? 5 * this.spleenValue : 0;
    ...
    value: function(organ, capacity) {
      ...
      var overrideModifiers = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, submenu = this.menu.filter(function(menuItem) {
        return menuItem.organ === organ && (0, import_kolmafia60.myLevel)() >= menuItem.item.levelreq;
    ...
    value: function(organCapacities, trialItems, overrideModifiers) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          var _step$value = _slicedToArray18(_step.value, 2), organ = _step$value[0], size = _step$value[1], current2 = organCapacitiesWithMap.get(organ);
      ...
      var organCapacitiesWith = _toConsumableArray16(organCapacitiesWithMap), isRefinedPalate = trialItem.item === $item(_templateObject2810 || (_templateObject2810 = _taggedTemplateLiteral53(["pocket wish"]))) && trialItem.effect === $effect(_templateObject2910 || (_templateObject2910 = _taggedTemplateLiteral53(["Refined Palate"]))) || trialItem.item === $item(_templateObject3010 || (_templateObject3010 = _taggedTemplateLiteral53(["toasted brie"]))), isGarish = trialItem.item === $item(_templateObject3113 || (_templateObject3113 = _taggedTemplateLiteral53(["pocket wish"]))) && trialItem.effect === $effect(_templateObject3212 || (_templateObject3212 = _taggedTemplateLiteral53(["Gar-ish"]))) || trialItem.item === $item(_templateObject3311 || (_templateObject3311 = _taggedTemplateLiteral53(["potion of the field gar"]))), _this$planOrgansWithT = this.planOrgansWithTrials(organCapacities, trialItems.slice(1), overrideModifiers), _this$planOrgansWithT2 = _slicedToArray18(_this$planOrgansWithT, 2), valueWithout = _this$planOrgansWithT2[0], planWithout = _this$planOrgansWithT2[1], _this$planOrgansWithT3 = this.planOrgansWithTrials(organCapacitiesWith, trialItems.slice(1), _objectSpread6(_objectSpread6(_objectSpread6({}, overrideModifiers), isRefinedPalate ? {
        refinedPalate: !0
      } : {}), isGarish ? {
        garish: !0
...
}(), interactingItems = [[$item(_templateObject3410 || (_templateObject3410 = _taggedTemplateLiteral53(["spice melange"]))), [["food", -3], ["booze", -3]]], [$item(_templateObject3510 || (_templateObject3510 = _taggedTemplateLiteral53(["Ultra Mega Sour Ball"]))), [["food", -3], ["booze", -3]]], [$item(_templateObject3610 || (_templateObject3610 = _taggedTemplateLiteral53(["The Plumber's mushroom stew"]))), [["food", 3], ["booze", -1]]], [$item(_templateObject3710 || (_templateObject3710 = _taggedTemplateLiteral53(["The Mad Liquor"]))), [["food", -1], ["booze", 3]]], [$item(_templateObject3810 || (_templateObject3810 = _taggedTemplateLiteral53(["Doc Clock's thyme cocktail"]))), [["food", -2], ["booze", 4]]], [$item(_templateObject3910 || (_templateObject3910 = _taggedTemplateLiteral53(["Mr. Burnsger"]))), [["food", 4], ["booze", -2]]], [$effect(_templateObject409 || (_templateObject409 = _taggedTemplateLiteral53(["Refined Palate"]))), []], [$item(_templateObject4112 || (_templateObject4112 = _taggedTemplateLiteral53(["toasted brie"]))), [["food", 2]]], [$effect(_templateObject4211 || (_templateObject4211 = _taggedTemplateLiteral53(["Gar-ish"]))), []], [$item(_templateObject4310 || (_templateObject4310 = _taggedTemplateLiteral53(["potion of the field gar"]))), []]];
function planDiet(mpa, menu) {
  var organCapacities = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [["food", null], ["booze", null], ["spleen item", null]], resolvedOrganCapacities = organCapacities.map(function(_ref8) {
    ...
    return [organ, size != null ? size : organ === "food" ? (0, import_kolmafia60.fullnessLimit)() - (0, import_kolmafia60.myFullness)() : organ === "booze" ? (0, import_kolmafia60.inebrietyLimit)() - (0, import_kolmafia60.myInebriety)() : organ === "spleen item" ? (0, import_kolmafia60.spleenLimit)() - (0, import_kolmafia60.mySpleenUse)() : 0];
    ...
    var interacting = interactingItems.find(function(_ref10) {
      ...
      return menuItem.item === itemOrEffect || menuItem.item === $item(_templateObject4410 || (_templateObject4410 = _taggedTemplateLiteral53(["pocket wish"]))) && menuItem.effect === itemOrEffect;
    });
    if (interacting) {
  ...
  if (spleenCapacity) {
    var additionalSpleen = sum(planFoodBooze, function(_ref18) {
      ...
      return items.some(function(menuItem) {
        return $items(_templateObject4510 || (_templateObject4510 = _taggedTemplateLiteral53(["jar of fermented pickle juice, extra-greasy slider"]))).includes(menuItem.item);
      }) ? 5 * number : 0;
...
var DietEntry = /* @__PURE__ */ function() {
    ...
    value: function(diet) {
      {
        ...
        var items = this.menuItems.map(function(m) {
          return m.item;
        }), targetItem = this.menuItems[this.menuItems.length - 1].item, fork = (0, import_kolmafia60.itemType)(targetItem) === "food" && items.includes($item(_templateObject4610 || (_templateObject4610 = _taggedTemplateLiteral53(["Ol' Scratch's salad fork"])))), mug = (0, import_kolmafia60.itemType)(targetItem) === "booze" && items.includes($item(_templateObject476 || (_templateObject476 = _taggedTemplateLiteral53(["Frosty's frosty mug"]))));
        return this.quantity * _expectedAdventures(this.menuItems[this.menuItems.length - 1].item, {
          forkMug: fork || mug,
          seasoning: items.includes($item(_templateObject486 || (_templateObject486 = _taggedTemplateLiteral53(["Special Seasoning"])))),
  ...
  return _createClass14(Diet2, [{
    ...
    get: function() {
      return this.entries.some(function(dietEntry) {
        return dietEntry.menuItems.some(function(trialItem) {
          return trialItem.item === $item(_templateObject496 || (_templateObject496 = _taggedTemplateLiteral53(["pocket wish"]))) && trialItem.effect === $effect(_templateObject506 || (_templateObject506 = _taggedTemplateLiteral53(["Refined Palate"]))) || trialItem.item === $item(_templateObject5111 || (_templateObject5111 = _taggedTemplateLiteral53(["toasted brie"])));
        });
      });
    }
  }, {
    ...
    get: function() {
      return this.entries.some(function(dietEntry) {
        return dietEntry.menuItems.some(function(trialItem) {
          return trialItem.item === $item(_templateObject5210 || (_templateObject5210 = _taggedTemplateLiteral53(["pocket wish"]))) && trialItem.effect === $effect(_templateObject5310 || (_templateObject5310 = _taggedTemplateLiteral53(["Gar-ish"]))) || trialItem.item === $item(_templateObject5410 || (_templateObject5410 = _taggedTemplateLiteral53(["potion of the field gar"])));
        });
      });
    }
  }, {
    key: "saucemaven",
    get: function() {
      return have($skill(_templateObject555 || (_templateObject555 = _taggedTemplateLiteral53(["Saucemaven"]))));
    }
  }, {
    key: "tuxedoShirt",
    get: function() {
      return have($item(_templateObject565 || (_templateObject565 = _taggedTemplateLiteral53(["tuxedo shirt"])))) && (0, import_kolmafia60.canEquip)($item(_templateObject575 || (_templateObject575 = _taggedTemplateLiteral53(["tuxedo shirt"]))));
    }
  }, {
    key: "pinkyRing",
    get: function() {
      return have($item(_templateObject584 || (_templateObject584 = _taggedTemplateLiteral53(["mafia pinky ring"])))) && (0, import_kolmafia60.canEquip)($item(_templateObject594 || (_templateObject594 = _taggedTemplateLiteral53(["mafia pinky ring"]))));
    }
  }, {
    key: "expectedAdventures",
    value: function() {
...
var _templateObject470, _templateObject2124, _templateObject3105;
...
var Dungeon = /* @__PURE__ */ function() {
  ...
  return _createClass15(Dungeon2, [{
    ...
    value: function(idOrname_) {
      ...
      var itemname_s = (0, import_kolmafia61.xpath)(pageText, "//tr/td[2]/b/text()"), whichLoots = (0, import_kolmafia61.xpath)(pageText, '//form[@action="clan_basement.php"]//input[@type="hidden"][@name_="whichloot"]/@value');
      itemname_s.forEach(function(itemname_, index) {
        lootList.includes((0, import_kolmafia61.toItem)(itemname_)) && ((0, import_kolmafia61.visitUrl)("clan_basement.php?whichloot=".concat(whichLoots[index], "&recipient=").concat(player.id)), distributeAllOfAGivenItem || lootList.splice(lootList.indexOf((0, import_kolmafia61.toItem)(itemname_))));
      });
    }
    /**
     * Close this dungeon
    ...
    key: "close",
    value: function() {
      (0, import_kolmafia61.visitUrl)("clan_basement.php?action=".concat(this.closeAction, "&confirm=true"), !0);
      var pageText = (0, import_kolmafia61.visitUrl)("clan_basement.php");
    ...
    key: "open",
    value: function() {
      var paymentPolicy = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "Difference", pageText = (0, import_kolmafia61.visitUrl)("clan_basement.php");
      ...
      return (0, import_kolmafia61.visitUrl)("clan_basement.php?action=".concat(this.openAction), !0), (0, import_kolmafia61.visitUrl)("clan_basement.php").includes(this.openImage);
    }
    /**
    ...
    key: "findLoot",
    value: function() {
      var result = /* @__PURE__ */ new Map(), pageText = (0, import_kolmafia61.visitUrl)("clan_basement.php"), _iterator = _createForOfIteratorHelper14(this.loot), _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
...
var MpSource = /* @__PURE__ */ function() {
  ...
  return _createClass16(OscusSoda2, [{
    key: "available",
    value: function() {
      return have($item(_templateObject471 || (_templateObject471 = _taggedTemplateLiteral55(["Oscus's neverending soda"]))));
    }
  }, {
    key: "usesRemaining",
    value: function() {
    ...
    key: "execute",
    value: function() {
      (0, import_kolmafia62.use)($item(_templateObject2125 || (_templateObject2125 = _taggedTemplateLiteral55(["Oscus's neverending soda"]))));
    }
  }]), OscusSoda2;
}(MpSource);
...
var MagicalSausages = /* @__PURE__ */ function(_MpSource2) {
  ...
  return _createClass16(MagicalSausages2, [{
    key: "available",
    value: function() {
      return have($item(_templateObject3106 || (_templateObject3106 = _taggedTemplateLiteral55(["Kramco Sausage-o-Matic\u2122"]))));
    }
  }, {
    key: "usesRemaining",
    value: function() {
      var maxSausages = (0, import_kolmafia62.availableAmount)($item(_templateObject477 || (_templateObject477 = _taggedTemplateLiteral55(["magical sausage"])))) + (0, import_kolmafia62.availableAmount)($item(_templateObject551 || (_templateObject551 = _taggedTemplateLiteral55(["magical sausage casing"]))));
      return this.available() ? clamp(23 - get("_sausagesEaten"), 0, maxSausages) : 0;
    }
  }, {
    key: "availableMpMin",
    value: function() {
      return this.available() ? Math.min((0, import_kolmafia62.myMaxmp)(), 999) * this.usesRemaining() : 0;
    }
  }, {
    key: "execute",
    value: function() {
      var mpSpaceAvailable = (0, import_kolmafia62.myMaxmp)() - (0, import_kolmafia62.myMp)();
      if (!(mpSpaceAvailable < 700)) {
        var maxSausages = Math.min(this.usesRemaining(), Math.floor(((0, import_kolmafia62.myMaxmp)() - (0, import_kolmafia62.myMp)()) / Math.min((0, import_kolmafia62.myMaxmp)() - (0, import_kolmafia62.myMp)(), 999)));
        (0, import_kolmafia62.retrieveItem)(maxSausages, $item(_templateObject644 || (_templateObject644 = _taggedTemplateLiteral55(["magical sausage"])))), (0, import_kolmafia62.eat)(maxSausages, $item(_templateObject737 || (_templateObject737 = _taggedTemplateLiteral55(["magical sausage"]))));
      }
    }
  }]), MagicalSausages2;
}(MpSource);
...
var MoodElement = /* @__PURE__ */ function() {
  ...
  return _createClass16(SkillMoodElement2, [{
    key: "mpCostPerTurn",
    value: function() {
      var turns = (0, import_kolmafia62.turnsPerCast)(this.skill);
      return turns > 0 ? (0, import_kolmafia62.mpCost)(this.skill) / turns : 0;
    }
  }, {
    key: "turnIncrement",
    value: function() {
      return (0, import_kolmafia62.turnsPerCast)(this.skill);
    }
  }, {
    key: "execute",
    value: function(mood, ensureTurns) {
      var effect2 = (0, import_kolmafia62.toEffect)(this.skill), initialTurns = (0, import_kolmafia62.haveEffect)(effect2);
      if (!(0, import_kolmafia62.haveSkill)(this.skill))
        return !1;
        ...
        try {
          var _loop = function() {
            ...
            if (!slot || slot.includes(effect2))
              return (0, import_kolmafia62.cliExecute)("shrug ".concat(song2)), "break";
          };
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            var _ret = _loop();
            if (_ret === "break")
      ...
      for (var oldRemainingCasts = -1, remainingCasts = Math.ceil((ensureTurns - (0, import_kolmafia62.haveEffect)(effect2)) / (0, import_kolmafia62.turnsPerCast)(this.skill)); remainingCasts > 0 && oldRemainingCasts !== remainingCasts; ) {
        var maxCasts = void 0;
        if ((0, import_kolmafia62.hpCost)(this.skill) > 0)
          maxCasts = Math.max(0, Math.floor(((0, import_kolmafia62.myHp)() - 1) / (0, import_kolmafia62.hpCost)(this.skill)));
        else {
          var cost = (0, import_kolmafia62.mpCost)(this.skill);
          if (maxCasts = Math.floor(Math.min(mood.availableMp(), (0, import_kolmafia62.myMp)()) / cost), maxCasts < remainingCasts) {
            var bestMp = Math.min(remainingCasts * (0, import_kolmafia62.mpCost)(this.skill), (0, import_kolmafia62.myMaxmp)());
            mood.moreMp(bestMp), maxCasts = Math.floor(Math.min(mood.availableMp(), (0, import_kolmafia62.myMp)()) / cost);
          }
        }
        var casts = clamp(remainingCasts, 0, Math.min(100, maxCasts));
        (0, import_kolmafia62.useSkill)(casts, this.skill), oldRemainingCasts = remainingCasts, remainingCasts = Math.ceil((ensureTurns - (0, import_kolmafia62.haveEffect)(effect2)) / (0, import_kolmafia62.turnsPerCast)(this.skill));
      }
      return (0, import_kolmafia62.haveEffect)(effect2) > ensureTurns;
    }
  }]), SkillMoodElement2;
  ...
  return _createClass16(PotionMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
      var effect2 = (0, import_kolmafia62.effectModifier)(this.potion, "Effect"), effectTurns = (0, import_kolmafia62.haveEffect)(effect2), turnsPerUse = (0, import_kolmafia62.numericModifier)(this.potion, "Effect Duration");
      if ((0, import_kolmafia62.mallPrice)(this.potion) > this.maxPricePerTurn * turnsPerUse)
        return !1;
      if (effectTurns < ensureTurns) {
        var uses = Math.floor((ensureTurns - effectTurns) / turnsPerUse), quantityToBuy = clamp(uses - (0, import_kolmafia62.availableAmount)(this.potion), 0, 100);
        (0, import_kolmafia62.buy)(quantityToBuy, this.potion, Math.floor(this.maxPricePerTurn * turnsPerUse));
        var quantityToUse = clamp(uses, 0, (0, import_kolmafia62.availableAmount)(this.potion));
        (0, import_kolmafia62.use)(quantityToUse, this.potion);
      }
      var remainingDifference = ensureTurns - (0, import_kolmafia62.haveEffect)(effect2);
      if (remainingDifference > 0) {
        var price2 = Math.floor(this.maxPricePerTurn * remainingDifference);
        price2 <= (0, import_kolmafia62.mallPrice)(this.potion) && ((0, import_kolmafia62.availableAmount)(this.potion) || (0, import_kolmafia62.buy)(1, this.potion, price2)) && (0, import_kolmafia62.use)(1, this.potion);
      }
      return (0, import_kolmafia62.haveEffect)(effect2) >= ensureTurns;
    }
  }]), PotionMoodElement2;
  ...
  return _createClass16(GenieMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
      if ((0, import_kolmafia62.haveEffect)(this.effect) >= ensureTurns)
        return !0;
      var neededWishes = Math.ceil(((0, import_kolmafia62.haveEffect)(this.effect) - ensureTurns) / 20), wishesToBuy = clamp(neededWishes - (0, import_kolmafia62.availableAmount)($item(_templateObject830 || (_templateObject830 = _taggedTemplateLiteral55(["pocket wish"])))), 0, 20);
      (0, import_kolmafia62.buy)(wishesToBuy, $item(_templateObject927 || (_templateObject927 = _taggedTemplateLiteral55(["pocket wish"]))), 5e4);
      for (var wishesToUse = clamp(neededWishes, 0, (0, import_kolmafia62.availableAmount)($item(_templateObject1025 || (_templateObject1025 = _taggedTemplateLiteral55(["pocket wish"]))))); wishesToUse > 0; wishesToUse--)
        (0, import_kolmafia62.cliExecute)("genie effect ".concat(this.effect.name));
      return (0, import_kolmafia62.haveEffect)(this.effect) >= ensureTurns;
    }
  }]), GenieMoodElement2;
  ...
  function CustomMoodElement2(effect2, gainEffect) {
    ...
    return _classCallCheck16(this, CustomMoodElement2), _this4 = _super6.call(this), _defineProperty19(_assertThisInitialized4(_this4), "effect", void 0), _defineProperty19(_assertThisInitialized4(_this4), "gainEffect", void 0), _this4.effect = effect2, _this4.gainEffect = gainEffect != null ? gainEffect : function() {
      return (0, import_kolmafia62.cliExecute)(effect2.default);
    }, _this4;
  }
  return _createClass16(CustomMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
      for (var currentTurns = (0, import_kolmafia62.haveEffect)(this.effect), lastCurrentTurns = -1; currentTurns < ensureTurns && currentTurns !== lastCurrentTurns; )
        this.gainEffect(), lastCurrentTurns = currentTurns, currentTurns = (0, import_kolmafia62.haveEffect)(this.effect);
      return (0, import_kolmafia62.haveEffect)(this.effect) > ensureTurns;
    }
  }]), CustomMoodElement2;
  ...
  function Mood2() {
    ...
    _classCallCheck16(this, Mood2), _defineProperty19(this, "options", void 0), _defineProperty19(this, "elements", []), this.options = _objectSpread7(_objectSpread7({}, Mood2.defaultOptions), options);
  }
  return _createClass16(Mood2, [{
    ...
    value: function() {
      ...
      }) + Math.max((0, import_kolmafia62.myMp)() - this.options.reserveMp, 0);
    }
  }, {
    key: "moreMp",
    value: function(minimumTarget) {
      if (!((0, import_kolmafia62.myMp)() >= minimumTarget)) {
        var _iterator2 = _createForOfIteratorHelper15(this.options.mpSources), _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
            var mpSource = _step2.value;
            if (mpSource.usesRemaining() > 0 && (mpSource.execute(), (0, import_kolmafia62.myMp)() >= minimumTarget))
              break;
          }
        } catch (err) {
          _iterator2.e(err);
        ...
        this.options.useNativeRestores && (0, import_kolmafia62.restoreMp)(minimumTarget);
      }
    }
    /**
    ...
    value: function(_effect, gainEffect) {
      var skill = (0, import_kolmafia62.toSkill)(_effect);
...
function sinceKolmafiaRevision(revision) {
  ...
  var currentRevision = (0, import_kolmafia63.getRevision)();
  if (currentRevision > 0 && currentRevision < revision)
    throw new KolmafiaVersionError("".concat(getScriptName(), " requires revision r").concat(revision, " of kolmafia or higher (current: ").concat((0, import_kolmafia63.getRevision)(), "). Up-to-date builds can be found at https://ci.kolmafia.us/."));
}
function sinceKolmafiaVersion(majorVersion, minorVersion) {
  if (!((0, import_kolmafia63.getRevision)() >= 25720)) {
    ...
    var versionStr = (0, import_kolmafia63.getVersion)(), versionStrMatch = /v(\d+)\.(\d+)/.exec(versionStr);
    if (!versionStrMatch)
...
var Kmail = /* @__PURE__ */ function() {
  ...
  return _createClass18(Kmail2, [{
    ...
    key: "items",
    value: function() {
      return new Map(Object.entries((0, import_kolmafia64.extractItems)(this.rawMessage)).map(function(_ref) {
        var _ref2 = _slicedToArray19(_ref, 2), itemName = _ref2[0], quantity = _ref2[1];
        return [import_kolmafia64.Item.get(itemName), quantity];
      }));
    }
    /**
    ...
    key: "meat",
    value: function() {
      return (0, import_kolmafia64.extractMeat)(this.rawMessage);
    }
    /**
     * Reply to kmail
     *
    ...
    value: function() {
      ...
      return JSON.parse((0, import_kolmafia64.visitUrl)("api.php?what=kmail&for=libram&count=".concat(count))).map(Kmail2.parse);
    }
    /**
     * Bulk delete kmails
     *
    ...
    value: function(kmails) {
      var _results$match$, _results$match, results = (0, import_kolmafia64.visitUrl)("messages.php?the_action=delete&box=Inbox&pwd&".concat(kmails.map(function(k) {
    ...
    value: function(to, message, items, meat, chunkSize, constructUrl, successString) {
      var m = meat, sendableItems = _toConsumableArray18(arrayToCountedMap(items).entries()).filter(function(_ref3) {
        ...
        return (0, import_kolmafia64.isGiftable)(item10);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          ...
          }), r = (0, import_kolmafia64.visitUrl)(constructUrl(m, _itemsQuery.join("&"), _itemsQuery.length));
...
// src/Path.ts
init_kolmafia_polyfill();
var _templateObject478, _templateObject2126, _templateObject3107, _templateObject479, _templateObject556, _templateObject645, _templateObject738, _templateObject831, _templateObject928, _templateObject1026, _templateObject1122;
...
var Path5 = /* @__PURE__ */ _createClass19(
  ...
  function Path6(name, id) {
    var hasAllPerms = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0, canUseSkillbooks = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, hasCampground = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, hasTerrarium = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !0, stomachSize = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : 15, liverSize = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : 15, spleenSize = arguments.length > 8 && arguments[8] !== void 0 ? arguments[8] : 15, classes = arguments.length > 9 && arguments[9] !== void 0 ? arguments[9] : $classes(_templateObject478 || (_templateObject478 = _taggedTemplateLiteral56(["Seal Clubber, Turtle Tamer, Sauceror, Pastamancer, Disco Bandit, Accordion Thief"])));
  ...
  AvatarOfBoris: new Path5("Avatar of Boris", 8, !1, !1, !0, !1, 20, 5, 15, $classes(_templateObject2126 || (_templateObject2126 = _taggedTemplateLiteral56(["Avatar of Boris"])))),
  BugbearInvasion: new Path5("Bugbear Invasion", 9),
  ZombieSlayer: new Path5("Zombie Slayer", 10, !1, !1, !0, !0, 15, 5, 15, $classes(_templateObject3107 || (_templateObject3107 = _taggedTemplateLiteral56(["Zombie Master"])))),
  ClassAct: new Path5("Class Act", 11, !1, !1),
  AvatarofJarlsberg: new Path5("Avatar of Jarlsberg", 12, !1, !1, !0, !1, 10, 10, 15, $classes(_templateObject479 || (_templateObject479 = _taggedTemplateLiteral56(["Avatar of Jarlsberg"])))),
  Big: new Path5("BIG!", 14),
  KolHs: new Path5("KOLHS", 15),
  ClassAct2: new Path5("Class Act II: A Class For Pigs", 16, !1),
  AvatarofSneakyPete: new Path5("Avatar of Sneaky Pete", 17, !1, !1, !0, !1, 5, 20, 15, $classes(_templateObject556 || (_templateObject556 = _taggedTemplateLiteral56(["Avatar of Sneaky Pete"])))),
  ...
  ActuallyEdTheUndying: new Path5("Actually Ed the Undying", 23, !1, !1, !1, !1, 0, 0, 5, $classes(_templateObject645 || (_templateObject645 = _taggedTemplateLiteral56(["Ed the Undying"])))),
  OneCrazyRandomSummer: new Path5("One Crazy Random Summer", 24),
  CommunityService: new Path5("Community Service", 25),
  AvatarOfWestOfLoathing: new Path5("Avatar of West of Loathing", 26, !1, !1, !0, !0, 10, 10, 10, $classes(_templateObject738 || (_templateObject738 = _taggedTemplateLiteral56(["Cow Puncher, Snake Oiler, Beanslinger"])))),
  TheSource: new Path5("The Source", 27),
  NuclearAutumn: new Path5("Nuclear Autumn", 28, !1, !1, !1, !0, 3, 3, 3),
  GelatinousNoob: new Path5("Gelatinous Noob", 29, !1, !1, !0, !0, 0, 0, 0, $classes(_templateObject831 || (_templateObject831 = _taggedTemplateLiteral56(["Gelatinous Noob"])))),
  ...
  DarkGyffte: new Path5("Dark Gyffte", 35, !1, !1, !0, !1, 5, 5, 15, $classes(_templateObject928 || (_templateObject928 = _taggedTemplateLiteral56(["Vampyre"])))),
  TwoCrazyRandomSummer: new Path5("Two Crazy Random Summer", 36),
  KingdomOfExploathing: new Path5("Kingdom of Exploathing", 37),
  PathOfThePlumber: new Path5("Path of the Plumber", 38, !1, !1, !0, !0, 20, 0, 5, $classes(_templateObject1026 || (_templateObject1026 = _taggedTemplateLiteral56(["Plumber"])))),
  ...
  GreyYou: new Path5(
    ...
    $classes(_templateObject1122 || (_templateObject1122 = _taggedTemplateLiteral56(["Grey Goo"])))
  ),
...
init_kolmafia_polyfill();
var import_kolmafia65 = require("kolmafia"), logColor = function(color) {
  return function() {
    ...
    color ? (0, import_kolmafia65.print)(output, color) : (0, import_kolmafia65.print)(output);
  };
...
var _templateObject480, _templateObject2127, _templateObject3108, _templateObject481, _templateObject557, _templateObject646, _templateObject739, _templateObject834, _templateObject929, _templateObject1027, _templateObject1123, _templateObject1221, _templateObject1320, _templateObject1417, _templateObject1515, _templateObject1615, _templateObject1715, _templateObject1815, _templateObject1915, _templateObject2015, _templateObject2128, _templateObject2217, _templateObject2315, _templateObject2414, _templateObject2514, _templateObject2614, _templateObject2714, _templateObject2811, _templateObject2911, _templateObject3011, _templateObject3114, _templateObject3213, _templateObject3312;
...
function mySessionItemsWrapper() {
  ...
  }, itemMappings = new Map([].concat(_toConsumableArray19(foldable($item(_templateObject480 || (_templateObject480 = _taggedTemplateLiteral57(["liar's pants"]))))), _toConsumableArray19(foldable($item(_templateObject2127 || (_templateObject2127 = _taggedTemplateLiteral57(["ice pick"]))))), _toConsumableArray19(manyToOne($item(_templateObject3108 || (_templateObject3108 = _taggedTemplateLiteral57(["Spooky Putty sheet"]))), [$item(_templateObject481 || (_templateObject481 = _taggedTemplateLiteral57(["Spooky Putty monster"])))].concat(_toConsumableArray19(getFoldGroup($item(_templateObject557 || (_templateObject557 = _taggedTemplateLiteral57(["Spooky Putty sheet"])))))))), _toConsumableArray19(foldable($item(_templateObject646 || (_templateObject646 = _taggedTemplateLiteral57(["stinky cheese sword"]))))), _toConsumableArray19(foldable($item(_templateObject739 || (_templateObject739 = _taggedTemplateLiteral57(["naughty paper shuriken"]))))), _toConsumableArray19(foldable($item(_templateObject834 || (_templateObject834 = _taggedTemplateLiteral57(["Loathing Legion knife"]))))), _toConsumableArray19(foldable($item(_templateObject929 || (_templateObject929 = _taggedTemplateLiteral57(["deceased crimbo tree"]))))), _toConsumableArray19(foldable($item(_templateObject1027 || (_templateObject1027 = _taggedTemplateLiteral57(["makeshift turban"]))))), _toConsumableArray19(foldable($item(_templateObject1123 || (_templateObject1123 = _taggedTemplateLiteral57(["turtle wax shield"]))))), _toConsumableArray19(foldable($item(_templateObject1221 || (_templateObject1221 = _taggedTemplateLiteral57(["metallic foil bow"]))))), _toConsumableArray19(foldable($item(_templateObject1320 || (_templateObject1320 = _taggedTemplateLiteral57(["ironic moustache"]))))), _toConsumableArray19(foldable($item(_templateObject1417 || (_templateObject1417 = _taggedTemplateLiteral57(["bugged balaclava"]))))), _toConsumableArray19(foldable($item(_templateObject1515 || (_templateObject1515 = _taggedTemplateLiteral57(["toggle switch (Bartend)"]))))), _toConsumableArray19(foldable($item(_templateObject1615 || (_templateObject1615 = _taggedTemplateLiteral57(["mushroom cap"]))))), _toConsumableArray19(manyToOne($item(_templateObject1715 || (_templateObject1715 = _taggedTemplateLiteral57(["can of Rain-Doh"]))), $items(_templateObject1815 || (_templateObject1815 = _taggedTemplateLiteral57(["empty Rain-Doh can"]))))), _toConsumableArray19(manyToOne($item(_templateObject1915 || (_templateObject1915 = _taggedTemplateLiteral57(["meteorite fragment"]))), $items(_templateObject2015 || (_templateObject2015 = _taggedTemplateLiteral57(["meteorite earring, meteorite necklace, meteorite ring"]))))), _toConsumableArray19(manyToOne($item(_templateObject2128 || (_templateObject2128 = _taggedTemplateLiteral57(["Sneaky Pete's leather jacket"]))), $items(_templateObject2217 || (_templateObject2217 = _taggedTemplateLiteral57(["Sneaky Pete's leather jacket (collar popped)"]))))), _toConsumableArray19(manyToOne($item(_templateObject2315 || (_templateObject2315 = _taggedTemplateLiteral57(["Boris's Helm"]))), $items(_templateObject2414 || (_templateObject2414 = _taggedTemplateLiteral57(["Boris's Helm (askew)"]))))), _toConsumableArray19(manyToOne($item(_templateObject2514 || (_templateObject2514 = _taggedTemplateLiteral57(["Jarlsberg's pan"]))), $items(_templateObject2614 || (_templateObject2614 = _taggedTemplateLiteral57(["Jarlsberg's pan (Cosmic portal mode)"]))))), _toConsumableArray19(manyToOne($item(_templateObject2714 || (_templateObject2714 = _taggedTemplateLiteral57(["tiny plastic sword"]))), $items(_templateObject2811 || (_templateObject2811 = _taggedTemplateLiteral57(["grogtini, bodyslam, dirty martini, vesper, cherry bomb, sangria del diablo"]))))), _toConsumableArray19(manyToOne($item(_templateObject2911 || (_templateObject2911 = _taggedTemplateLiteral57(["earthenware muffin tin"]))), $items(_templateObject3011 || (_templateObject3011 = _taggedTemplateLiteral57(["blueberry muffin, bran muffin, chocolate chip muffin"]))))), _toConsumableArray19(manyToOne($item(_templateObject3114 || (_templateObject3114 = _taggedTemplateLiteral57(["ChibiBuddy\u2122 (on)"]))), $items(_templateObject3213 || (_templateObject3213 = _taggedTemplateLiteral57(["ChibiBuddy\u2122 (off)"]))))))), inventory = /* @__PURE__ */ new Map(), _i = 0, _arr = [import_kolmafia66.mySessionItems, import_kolmafia66.getCloset, import_kolmafia66.getDisplay, import_kolmafia66.getStorage]; _i < _arr.length; _i++)
    for (var inventoryFunc = _arr[_i], _i2 = 0, _Object$entries = Object.entries(inventoryFunc()); _i2 < _Object$entries.length; _i2++) {
      var _itemMappings$get, _inventory$get, _Object$entries$_i = _slicedToArray20(_Object$entries[_i2], 2), itemStr = _Object$entries$_i[0], quantity = _Object$entries$_i[1], _item = (0, import_kolmafia66.toItem)(itemStr), mappedItem = (_itemMappings$get = itemMappings.get(_item)) !== null && _itemMappings$get !== void 0 ? _itemMappings$get : _item;
      inventory.set(mappedItem, quantity + ((_inventory$get = inventory.get(mappedItem)) !== null && _inventory$get !== void 0 ? _inventory$get : 0));
    }
  for (var _i3 = 0, _Object$entries2 = Object.entries((0, import_kolmafia66.getCampground)()); _i3 < _Object$entries2.length; _i3++) {
    var _itemMappings$get2, _inventory$get2, _Object$entries2$_i = _slicedToArray20(_Object$entries2[_i3], 2), _itemStr = _Object$entries2$_i[0], _quantity = _Object$entries2$_i[1], _item2 = (0, import_kolmafia66.toItem)(_itemStr);
    if (_item2 !== $item(_templateObject3312 || (_templateObject3312 = _taggedTemplateLiteral57(["big rock"])))) {
  ...
  return _createClass20(Session2, [{
    ...
    value: (
      ...
      function(filename) {
        ...
        (0, import_kolmafia66.bufferToFile)(JSON.stringify(val), Session2.getFilepath(filename));
      }
    )
    /**
    ...
    value: function(filename) {
      return filename.endsWith(".json") ? filename : "snapshots/".concat((0, import_kolmafia66.myName)(), "/").concat((0, import_kolmafia66.todayToString)(), "_").concat(filename, ".json");
    }
  }, {
    key: "fromFile",
    value: function(filename) {
      var fileValue = (0, import_kolmafia66.fileToBuffer)(Session2.getFilepath(filename));
      if (fileValue.length > 0) {
        var val = JSON.parse(fileValue), parsedItems = Object.entries(val.items).map(function(_ref3) {
          ...
          return [(0, import_kolmafia66.toItem)(itemStr), quantity];
        });
    ...
    key: "current",
    value: function() {
      return new Session2(sum([import_kolmafia66.mySessionMeat, import_kolmafia66.myClosetMeat, import_kolmafia66.myStorageMeat], function(f) {
        return f();
