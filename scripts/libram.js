...
function ascend(path, playerClass, lifestyle, moon) {
  ...
  if (playerClass.path !== (path.avatar ? path : import_kolmafia57.Path.none))
  ...
  (0, import_kolmafia57.visitUrl)("afterlife.php?action=ascend&confirmascend=1&whichsign=".concat(moonId, "&gender=2&whichclass=").concat(playerClass.id, "&whichpath=").concat(path.id, "&asctype=").concat(lifestyle, "&nopetok=1&noskillsok=1&lamepathok=1&lamesignok=1&pwd"), !0);
}
...
var _templateObject408, _templateObject2121, _templateObject3103, _templateObject469, _templateObject550, _templateObject641, _templateObject736, _templateObject829, _templateObject925, _templateObject1023, _templateObject1120, _templateObject1219, _templateObject1318, _templateObject1415, _templateObject1513, _templateObject1613, _templateObject1713, _templateObject1813, _templateObject1913, _templateObject2013, _templateObject2122, _templateObject2215, _templateObject2313, _templateObject2412, _templateObject2512, _templateObject2612, _templateObject2712;
...
var thralls = /* @__PURE__ */ new Map([[$stat(_templateObject408 || (_templateObject408 = _taggedTemplateLiteral53(["muscle"]))), $thrall(_templateObject2121 || (_templateObject2121 = _taggedTemplateLiteral53(["Elbow Macaroni"])))], [$stat(_templateObject3103 || (_templateObject3103 = _taggedTemplateLiteral53(["moxie"]))), $thrall(_templateObject469 || (_templateObject469 = _taggedTemplateLiteral53(["Penne Dreadful"])))]]), statCommunityServicePredictor = function(stat) {
  return function() {
    return 60 - Math.floor(1 / 30 * ((0, import_kolmafia59.myBuffedstat)(stat) - (0, import_kolmafia59.myBasestat)(thralls.get(stat) === (0, import_kolmafia59.myThrall)() && !have($effect(_templateObject550 || (_templateObject550 = _taggedTemplateLiteral53(["Expert Oiliness"])))) ? $stat(_templateObject641 || (_templateObject641 = _taggedTemplateLiteral53(["mysticality"]))) : stat)));
  };
}, visitCouncil = function() {
  return (0, import_kolmafia59.visitUrl)("council.php");
}, baseWeight = function() {
  return have($effect(_templateObject736 || (_templateObject736 = _taggedTemplateLiteral53(["Fidoxene"])))) ? 20 : (0, import_kolmafia59.familiarWeight)((0, import_kolmafia59.myFamiliar)());
  ...
  return _createClass12(CommunityService2, [{
    ...
    value: function() {
      ...
      (_this$timer = this.timer) !== null && _this$timer !== void 0 || (this.timer = {
        time: Date.now(),
        turns: (0, import_kolmafia59.myTurncount)()
      });
    }
  }, {
    key: "isDone",
    ...
    value: function() {
      ...
      var councilText = (0, import_kolmafia59.runChoice)(this.choice);
    ...
    value: function(prepare) {
      ...
      try {
        ...
        return (0, import_kolmafia59.print)("".concat(e), "red"), "failed";
      }
      var prediction = this.predictor(), council = visitCouncil(), turnCost = this._actualCost(council);
      return turnCost ? turnCost > Math.min(maxTurns, (0, import_kolmafia59.myAdventures)()) || !this.do() ? "failed" : (CommunityService2.log[this.property] = {
        predictedTurns: prediction + additionalTurns,
        turnCost: (0, import_kolmafia59.myTurncount)() - turns,
    ...
    value: (
      ...
      function() {
        for (var colour = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "blue", logEntries = Object.entries(CommunityService2.log), _i = 0, _logEntries = logEntries; _i < _logEntries.length; _i++) {
          ...
          type === "test" ? ((0, import_kolmafia59.print)("We predicted the ".concat(testName, " test would take ").concat(predictedTurns, " turns, ").concat(predictedTurns === turnCost ? "and" : "but", " it took ").concat(turnCost, " turns."), colour), (0, import_kolmafia59.print)("".concat(testName, " took ").concat(seconds.toFixed(1), " seconds."), colour)) : (predictedTurns === 0 && turnCost === 0 || (0, import_kolmafia59.print)("We predicted the task ".concat(testName, " would take ").concat(predictedTurns, " turns, ").concat(predictedTurns === turnCost ? "and" : "but", " it took ").concat(turnCost, " turns."), colour), (0, import_kolmafia59.print)("The task ".concat(testName, " took ").concat(seconds.toFixed(1), " seconds."), colour));
        }
        ...
        (0, import_kolmafia59.print)("All together, you have spent ".concat(totalTime.toFixed(1), " seconds during this Community Service run"), colour);
      }
    )
...
_defineProperty16(CommunityService, "HP", new CommunityService(1, "HP", "Donate Blood", function() {
  return 60 - Math.floor(((0, import_kolmafia59.myMaxhp)() - (0, import_kolmafia59.myBuffedstat)($stat(_templateObject829 || (_templateObject829 = _taggedTemplateLiteral53(["muscle"])))) - 3) / 30);
}, new Requirement(["HP"], {})));
_defineProperty16(CommunityService, "Muscle", new CommunityService(2, "Muscle", "Feed The Children", statCommunityServicePredictor($stat(_templateObject925 || (_templateObject925 = _taggedTemplateLiteral53(["Muscle"])))), new Requirement(["Muscle"], {})));
_defineProperty16(CommunityService, "Mysticality", new CommunityService(3, "Mysticality", "Build Playground Mazes", statCommunityServicePredictor($stat(_templateObject1023 || (_templateObject1023 = _taggedTemplateLiteral53(["Mysticality"])))), new Requirement(["Mysticality"], {})));
_defineProperty16(CommunityService, "Moxie", new CommunityService(4, "Moxie", "Feed Conspirators", statCommunityServicePredictor($stat(_templateObject1120 || (_templateObject1120 = _taggedTemplateLiteral53(["Moxie"])))), new Requirement(["Moxie"], {})));
_defineProperty16(CommunityService, "FamiliarWeight", new CommunityService(5, "Familiar Weight", "Breed More Collies", function() {
  return 60 - Math.floor((baseWeight() + (0, import_kolmafia59.weightAdjustment)()) / 5);
...
_defineProperty16(CommunityService, "WeaponDamage", new CommunityService(6, "Weapon Damage", "Reduce Gazelle Population", function() {
  var weaponPower = (0, import_kolmafia59.getPower)((0, import_kolmafia59.equippedItem)($slot(_templateObject1219 || (_templateObject1219 = _taggedTemplateLiteral53(["weapon"]))))), offhandPower = (0, import_kolmafia59.toSlot)((0, import_kolmafia59.equippedItem)($slot(_templateObject1318 || (_templateObject1318 = _taggedTemplateLiteral53(["off-hand"]))))) === $slot(_templateObject1415 || (_templateObject1415 = _taggedTemplateLiteral53(["weapon"]))) ? (0, import_kolmafia59.getPower)((0, import_kolmafia59.equippedItem)($slot(_templateObject1513 || (_templateObject1513 = _taggedTemplateLiteral53(["off-hand"]))))) : 0, familiarPower = (0, import_kolmafia59.toSlot)((0, import_kolmafia59.equippedItem)($slot(_templateObject1613 || (_templateObject1613 = _taggedTemplateLiteral53(["familiar"]))))) === $slot(_templateObject1713 || (_templateObject1713 = _taggedTemplateLiteral53(["weapon"]))) ? (0, import_kolmafia59.getPower)((0, import_kolmafia59.equippedItem)($slot(_templateObject1813 || (_templateObject1813 = _taggedTemplateLiteral53(["familiar"]))))) : 0, multiplier = have($effect(_templateObject1913 || (_templateObject1913 = _taggedTemplateLiteral53(["Bow-Legged Swagger"])))) ? 2 : 1;
...
_defineProperty16(CommunityService, "SpellDamage", new CommunityService(7, "Spell Damage", "Make Sausage", function() {
  var dragonfishDamage = (0, import_kolmafia59.myFamiliar)() === $familiar(_templateObject2013 || (_templateObject2013 = _taggedTemplateLiteral53(["Magic Dragonfish"]))) ? (0, import_kolmafia59.numericModifier)($familiar(_templateObject2122 || (_templateObject2122 = _taggedTemplateLiteral53(["Magic Dragonfish"]))), "Spell Damage Percent", baseWeight() + (0, import_kolmafia59.weightAdjustment)(), $item.none) : 0;
...
_defineProperty16(CommunityService, "BoozeDrop", new CommunityService(9, "Item Drop", "Make Margaritas", function() {
  var mummingCostume = MummingTrunk_exports.currentCostumes().get((0, import_kolmafia59.myFamiliar)()), mummingBuff = mummingCostume && mummingCostume[0] === "Item Drop" ? mummingCostume[1] : 0, familiarItemDrop = (0, import_kolmafia59.numericModifier)((0, import_kolmafia59.myFamiliar)(), "Item Drop", baseWeight() + (0, import_kolmafia59.weightAdjustment)(), (0, import_kolmafia59.equippedItem)($slot(_templateObject2215 || (_templateObject2215 = _taggedTemplateLiteral53(["familiar"]))))) + mummingBuff - (0, import_kolmafia59.numericModifier)((0, import_kolmafia59.equippedItem)($slot(_templateObject2313 || (_templateObject2313 = _taggedTemplateLiteral53(["familiar"])))), "Item Drop"), familiarBoozeDrop = (0, import_kolmafia59.numericModifier)((0, import_kolmafia59.myFamiliar)(), "Booze Drop", baseWeight() + (0, import_kolmafia59.weightAdjustment)(), (0, import_kolmafia59.equippedItem)($slot(_templateObject2412 || (_templateObject2412 = _taggedTemplateLiteral53(["familiar"]))))) - (0, import_kolmafia59.numericModifier)((0, import_kolmafia59.equippedItem)($slot(_templateObject2512 || (_templateObject2512 = _taggedTemplateLiteral53(["familiar"])))), "Booze Drop"), multiplier = (0, import_kolmafia59.haveEquipped)($item(_templateObject2612 || (_templateObject2612 = _taggedTemplateLiteral53(["broken champagne bottle"])))) && get("garbageChampagneCharge") > 0 ? 0.5 : 1;
  return 60 - Math.floor(multiplier * (get2("Item Drop") - familiarItemDrop - (0, import_kolmafia59.numericModifier)((0, import_kolmafia59.myThrall)(), "Item Drop")) / 30 + 1e-3) - Math.floor((get2("Booze Drop") - familiarBoozeDrop) / 15 + 1e-3);
}, new Requirement(["Item Drop", "2 Booze Drop"], {
  preventEquip: $items(_templateObject2712 || (_templateObject2712 = _taggedTemplateLiteral53(["broken champagne bottle"])))
})));
...
_defineProperty16(CommunityService, "donate", function() {
  visitCouncil(), (0, import_kolmafia59.visitUrl)("choice.php?whichchoice=1089&option=30");
});
...
function coolingTank() {
  (0, import_kolmafia60.visitUrl)("place.php?whichplace=falloutshelter&action=vault8");
}
function spa() {
  (0, import_kolmafia60.visitUrl)("place.php?whichplace=falloutshelter&action=vault3");
}
function chronoLab() {
  (0, import_kolmafia60.visitUrl)("place.php?whichplace=falloutshelter&action=vault5");
}
...
// src/diet/index.ts
var _templateObject409, _templateObject2123, _templateObject3104, _templateObject470, _templateObject551, _templateObject644, _templateObject737, _templateObject830, _templateObject926, _templateObject1024, _templateObject1121, _templateObject1220, _templateObject1319, _templateObject1416, _templateObject1514, _templateObject1614, _templateObject1714, _templateObject1814, _templateObject1914, _templateObject2014, _templateObject2124, _templateObject2216, _templateObject2314, _templateObject2413, _templateObject2513, _templateObject2613, _templateObject2713, _templateObject2810, _templateObject2910, _templateObject3010, _templateObject3113, _templateObject3212, _templateObject3312, _templateObject3410, _templateObject3510, _templateObject3610, _templateObject3710, _templateObject3810, _templateObject3910, _templateObject4010, _templateObject4112, _templateObject4211, _templateObject4310, _templateObject4410, _templateObject4510, _templateObject4610, _templateObject476, _templateObject486, _templateObject496, _templateObject506, _templateObject5111, _templateObject5210, _templateObject5310, _templateObject5410, _templateObject555, _templateObject565, _templateObject575, _templateObject584, _templateObject594;
...
function isMonday() {
  return get2("Muscle Percent", $item(_templateObject409 || (_templateObject409 = _taggedTemplateLiteral54(["Tuesday's ruby"])))) > 0;
}
...
var MenuItem = /* @__PURE__ */ function() {
  function MenuItem2(item10) {
    ...
    var typ = (0, import_kolmafia61.itemType)(this.item);
  ...
  return _createClass14(MenuItem2, [{
    ...
    key: "defaultOptions",
    value: function() {
      return /* @__PURE__ */ new Map([[$item(_templateObject3104 || (_templateObject3104 = _taggedTemplateLiteral54(["distention pill"]))), {
        organ: "food",
        maximum: !have($item(_templateObject470 || (_templateObject470 = _taggedTemplateLiteral54(["distention pill"])))) || get("_distentionPillUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject551 || (_templateObject551 = _taggedTemplateLiteral54(["synthetic dog hair pill"]))), {
        organ: "booze",
        maximum: !have($item(_templateObject644 || (_templateObject644 = _taggedTemplateLiteral54(["synthetic dog hair pill"])))) || get("_syntheticDogHairPillUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject737 || (_templateObject737 = _taggedTemplateLiteral54(["cuppa Voraci tea"]))), {
        organ: "food",
        maximum: get("_voraciTeaUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject830 || (_templateObject830 = _taggedTemplateLiteral54(["cuppa Sobrie tea"]))), {
        organ: "booze",
        maximum: get("_sobrieTeaUsed") ? 0 : 1,
        size: -1
      }], [$item(_templateObject926 || (_templateObject926 = _taggedTemplateLiteral54(["mojo filter"]))), {
        organ: "spleen item",
        maximum: 3 - get("currentMojoFilters"),
        size: -1
      }], [$item(_templateObject1024 || (_templateObject1024 = _taggedTemplateLiteral54(["spice melange"]))), {
        maximum: get("spiceMelangeUsed") ? 0 : 1
      }], [$item(_templateObject1121 || (_templateObject1121 = _taggedTemplateLiteral54(["Ultra Mega Sour Ball"]))), {
        maximum: get("_ultraMegaSourBallUsed") ? 0 : 1
      }], [$item(_templateObject1220 || (_templateObject1220 = _taggedTemplateLiteral54(["The Plumber's mushroom stew"]))), {
        maximum: get("_plumbersMushroomStewEaten") ? 0 : 1
      }], [$item(_templateObject1319 || (_templateObject1319 = _taggedTemplateLiteral54(["The Mad Liquor"]))), {
        maximum: get("_madLiquorDrunk") ? 0 : 1
      }], [$item(_templateObject1416 || (_templateObject1416 = _taggedTemplateLiteral54(["Doc Clock's thyme cocktail"]))), {
        maximum: get("_docClocksThymeCocktailDrunk") ? 0 : 1
      }], [$item(_templateObject1514 || (_templateObject1514 = _taggedTemplateLiteral54(["Mr. Burnsger"]))), {
...
_defineProperty18(MenuItem, "defaultPriceFunction", function(item10) {
  return (0, import_kolmafia61.npcPrice)(item10) > 0 ? (0, import_kolmafia61.npcPrice)(item10) : (0, import_kolmafia61.mallPrice)(item10);
});
...
var DietPlanner = /* @__PURE__ */ function() {
  function DietPlanner2(mpa, menu) {
    ...
    if (_classCallCheck14(this, DietPlanner2), _defineProperty18(this, "mpa", void 0), _defineProperty18(this, "menu", void 0), _defineProperty18(this, "mayoLookup", void 0), _defineProperty18(this, "fork", void 0), _defineProperty18(this, "mug", void 0), _defineProperty18(this, "seasoning", void 0), _defineProperty18(this, "spleenValue", 0), this.mpa = mpa, this.fork = menu.find(function(item10) {
      return item10.item === $item(_templateObject1614 || (_templateObject1614 = _taggedTemplateLiteral54(["Ol' Scratch's salad fork"])));
    }), this.mug = menu.find(function(item10) {
      return item10.item === $item(_templateObject1714 || (_templateObject1714 = _taggedTemplateLiteral54(["Frosty's frosty mug"])));
    }), this.seasoning = menu.find(function(item10) {
      return item10.item === $item(_templateObject1814 || (_templateObject1814 = _taggedTemplateLiteral54(["Special Seasoning"])));
    ...
    this.menu = menu.filter(function(item10) {
      ...
      return (0, import_kolmafia61.historicalPrice)(item10.item) === 0 || (0, import_kolmafia61.historicalAge)(item10.item) >= 1;
    }).length > 100 && ((0, import_kolmafia61.mallPrices)("food"), (0, import_kolmafia61.mallPrices)("booze"));
    var spleenItems = menu.filter(function(item10) {
      return (0, import_kolmafia61.itemType)(item10.item) === "spleen item";
    });
    if (spleenItems.sort(function(x, y) {
      ...
      var bestMarginalSpleenItem = spleenItems.find(function(spleenItem) {
        return spleenItem.maximum === void 0 || spleenItem.maximum * spleenItem.size >= (0, import_kolmafia61.spleenLimit)() - (0, import_kolmafia61.mySpleenUse)();
      });
  ...
  return _createClass14(DietPlanner2, [{
    ...
    value: function(menuItem, overrideModifiers) {
      ...
      if ((0, import_kolmafia61.itemType)(menuItem.item) === "food" && this.mayoLookup.size) {
      ...
      var defaultModifiers = _objectSpread6({
        ...
        refinedPalate: have($effect(_templateObject1914 || (_templateObject1914 = _taggedTemplateLiteral54(["Refined Palate"])))),
        garish: have($effect(_templateObject2014 || (_templateObject2014 = _taggedTemplateLiteral54(["Gar-ish"])))),
        saucemaven: have($skill(_templateObject2124 || (_templateObject2124 = _taggedTemplateLiteral54(["Saucemaven"])))),
        pinkyRing: have($item(_templateObject2216 || (_templateObject2216 = _taggedTemplateLiteral54(["mafia pinky ring"])))) && (0, import_kolmafia61.canEquip)($item(_templateObject2314 || (_templateObject2314 = _taggedTemplateLiteral54(["mafia pinky ring"])))),
        tuxedoShirt: have($item(_templateObject2413 || (_templateObject2413 = _taggedTemplateLiteral54(["tuxedo shirt"])))) && (0, import_kolmafia61.canEquip)($item(_templateObject2513 || (_templateObject2513 = _taggedTemplateLiteral54(["tuxedo shirt"]))))
      }, overrideModifiers);
      this.seasoning && (0, import_kolmafia61.itemType)(menuItem.item) === "food" && this.mpa * (_expectedAdventures(menuItem.item, _objectSpread6(_objectSpread6({}, defaultModifiers), {}, {
        seasoning: !0
      })) - _expectedAdventures(menuItem.item, _objectSpread6(_objectSpread6({}, defaultModifiers), {}, {
        seasoning: !1
      }))) > (0, import_kolmafia61.mallPrice)($item(_templateObject2613 || (_templateObject2613 = _taggedTemplateLiteral54(["Special Seasoning"])))) && helpers.push(this.seasoning);
      var forkMug = (0, import_kolmafia61.itemType)(menuItem.item) === "food" ? this.fork : (0, import_kolmafia61.itemType)(menuItem.item) === "booze" ? this.mug : null, forkMugPrice = forkMug ? forkMug.price() : 1 / 0, baseCost = menuItem.price() + sum(helpers, function(item10) {
        return item10.price();
    ...
    value: function(organ, capacity) {
      ...
      var overrideModifiers = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, submenu = this.menu.filter(function(menuItem) {
        return menuItem.organ === organ && (0, import_kolmafia61.myLevel)() >= menuItem.item.levelreq;
    ...
    value: function(organCapacities, trialItems, overrideModifiers) {
      ...
      var organCapacitiesWith = _toConsumableArray16(organCapacitiesWithMap), isRefinedPalate = trialItem.item === $item(_templateObject2810 || (_templateObject2810 = _taggedTemplateLiteral54(["pocket wish"]))) && trialItem.effect === $effect(_templateObject2910 || (_templateObject2910 = _taggedTemplateLiteral54(["Refined Palate"]))) || trialItem.item === $item(_templateObject3010 || (_templateObject3010 = _taggedTemplateLiteral54(["toasted brie"]))), isGarish = trialItem.item === $item(_templateObject3113 || (_templateObject3113 = _taggedTemplateLiteral54(["pocket wish"]))) && trialItem.effect === $effect(_templateObject3212 || (_templateObject3212 = _taggedTemplateLiteral54(["Gar-ish"]))) || trialItem.item === $item(_templateObject3312 || (_templateObject3312 = _taggedTemplateLiteral54(["potion of the field gar"]))), _this$planOrgansWithT = this.planOrgansWithTrials(organCapacities, trialItems.slice(1), overrideModifiers), _this$planOrgansWithT2 = _slicedToArray19(_this$planOrgansWithT, 2), valueWithout = _this$planOrgansWithT2[0], planWithout = _this$planOrgansWithT2[1], _this$planOrgansWithT3 = this.planOrgansWithTrials(organCapacitiesWith, trialItems.slice(1), _objectSpread6(_objectSpread6(_objectSpread6({}, overrideModifiers), isRefinedPalate ? {
        refinedPalate: !0
      } : {}), isGarish ? {
        garish: !0
...
}(), interactingItems = [[$item(_templateObject3410 || (_templateObject3410 = _taggedTemplateLiteral54(["spice melange"]))), [["food", -3], ["booze", -3]]], [$item(_templateObject3510 || (_templateObject3510 = _taggedTemplateLiteral54(["Ultra Mega Sour Ball"]))), [["food", -3], ["booze", -3]]], [$item(_templateObject3610 || (_templateObject3610 = _taggedTemplateLiteral54(["The Plumber's mushroom stew"]))), [["food", 3], ["booze", -1]]], [$item(_templateObject3710 || (_templateObject3710 = _taggedTemplateLiteral54(["The Mad Liquor"]))), [["food", -1], ["booze", 3]]], [$item(_templateObject3810 || (_templateObject3810 = _taggedTemplateLiteral54(["Doc Clock's thyme cocktail"]))), [["food", -2], ["booze", 4]]], [$item(_templateObject3910 || (_templateObject3910 = _taggedTemplateLiteral54(["Mr. Burnsger"]))), [["food", 4], ["booze", -2]]], [$effect(_templateObject4010 || (_templateObject4010 = _taggedTemplateLiteral54(["Refined Palate"]))), []], [$item(_templateObject4112 || (_templateObject4112 = _taggedTemplateLiteral54(["toasted brie"]))), [["food", 2]]], [$effect(_templateObject4211 || (_templateObject4211 = _taggedTemplateLiteral54(["Gar-ish"]))), []], [$item(_templateObject4310 || (_templateObject4310 = _taggedTemplateLiteral54(["potion of the field gar"]))), []]];
function planDiet(mpa, menu) {
  var organCapacities = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [["food", null], ["booze", null], ["spleen item", null]], resolvedOrganCapacities = organCapacities.map(function(_ref8) {
    ...
    return [organ, size != null ? size : organ === "food" ? (0, import_kolmafia61.fullnessLimit)() - (0, import_kolmafia61.myFullness)() : organ === "booze" ? (0, import_kolmafia61.inebrietyLimit)() - (0, import_kolmafia61.myInebriety)() : organ === "spleen item" ? (0, import_kolmafia61.spleenLimit)() - (0, import_kolmafia61.mySpleenUse)() : 0];
    ...
    var interacting = interactingItems.find(function(_ref10) {
      ...
      return menuItem.item === itemOrEffect || menuItem.item === $item(_templateObject4410 || (_templateObject4410 = _taggedTemplateLiteral54(["pocket wish"]))) && menuItem.effect === itemOrEffect;
    });
    if (interacting) {
  ...
  if (spleenCapacity) {
    var additionalSpleen = sum(planFoodBooze, function(_ref18) {
      ...
      return items.some(function(menuItem) {
        return $items(_templateObject4510 || (_templateObject4510 = _taggedTemplateLiteral54(["jar of fermented pickle juice, extra-greasy slider"]))).includes(menuItem.item);
      }) ? 5 * number : 0;
...
var DietEntry = /* @__PURE__ */ function() {
    ...
    value: function(diet) {
      {
        ...
        var items = this.menuItems.map(function(m) {
          return m.item;
        }), targetItem = this.menuItems[this.menuItems.length - 1].item, fork = (0, import_kolmafia61.itemType)(targetItem) === "food" && items.includes($item(_templateObject4610 || (_templateObject4610 = _taggedTemplateLiteral54(["Ol' Scratch's salad fork"])))), mug = (0, import_kolmafia61.itemType)(targetItem) === "booze" && items.includes($item(_templateObject476 || (_templateObject476 = _taggedTemplateLiteral54(["Frosty's frosty mug"]))));
        return this.quantity * _expectedAdventures(this.menuItems[this.menuItems.length - 1].item, {
          forkMug: fork || mug,
          seasoning: items.includes($item(_templateObject486 || (_templateObject486 = _taggedTemplateLiteral54(["Special Seasoning"])))),
  ...
  return _createClass14(Diet2, [{
    ...
    get: function() {
      return this.entries.some(function(dietEntry) {
        return dietEntry.menuItems.some(function(trialItem) {
          return trialItem.item === $item(_templateObject496 || (_templateObject496 = _taggedTemplateLiteral54(["pocket wish"]))) && trialItem.effect === $effect(_templateObject506 || (_templateObject506 = _taggedTemplateLiteral54(["Refined Palate"]))) || trialItem.item === $item(_templateObject5111 || (_templateObject5111 = _taggedTemplateLiteral54(["toasted brie"])));
        });
      });
    }
  }, {
    ...
    get: function() {
      return this.entries.some(function(dietEntry) {
        return dietEntry.menuItems.some(function(trialItem) {
          return trialItem.item === $item(_templateObject5210 || (_templateObject5210 = _taggedTemplateLiteral54(["pocket wish"]))) && trialItem.effect === $effect(_templateObject5310 || (_templateObject5310 = _taggedTemplateLiteral54(["Gar-ish"]))) || trialItem.item === $item(_templateObject5410 || (_templateObject5410 = _taggedTemplateLiteral54(["potion of the field gar"])));
        });
      });
    }
  }, {
    key: "saucemaven",
    get: function() {
      return have($skill(_templateObject555 || (_templateObject555 = _taggedTemplateLiteral54(["Saucemaven"]))));
    }
  }, {
    key: "tuxedoShirt",
    get: function() {
      return have($item(_templateObject565 || (_templateObject565 = _taggedTemplateLiteral54(["tuxedo shirt"])))) && (0, import_kolmafia61.canEquip)($item(_templateObject575 || (_templateObject575 = _taggedTemplateLiteral54(["tuxedo shirt"]))));
    }
  }, {
    key: "pinkyRing",
    get: function() {
      return have($item(_templateObject584 || (_templateObject584 = _taggedTemplateLiteral54(["mafia pinky ring"])))) && (0, import_kolmafia61.canEquip)($item(_templateObject594 || (_templateObject594 = _taggedTemplateLiteral54(["mafia pinky ring"]))));
    }
  }, {
    key: "expectedAdventures",
    value: function() {
...
var _templateObject471, _templateObject2125, _templateObject3105;
...
var Dungeon = /* @__PURE__ */ function() {
  ...
  return _createClass15(Dungeon2, [{
    ...
    value: function(idOrname_) {
      ...
      var pageText = (0, import_kolmafia62.visitUrl)("clan_basement.php");
      if (!pageText.match(new RegExp(player.name, "i")))
        throw new Error("".concat(player.name, " cannot be distributed loot from ").concat((0, import_kolmafia62.getClanName)()));
      var itemname_s = (0, import_kolmafia62.xpath)(pageText, "//tr/td[2]/b/text()"), whichLoots = (0, import_kolmafia62.xpath)(pageText, '//form[@action="clan_basement.php"]//input[@type="hidden"][@name_="whichloot"]/@value');
      itemname_s.forEach(function(itemname_, index) {
        lootList.includes((0, import_kolmafia62.toItem)(itemname_)) && ((0, import_kolmafia62.visitUrl)("clan_basement.php?whichloot=".concat(whichLoots[index], "&recipient=").concat(player.id)), distributeAllOfAGivenItem || lootList.splice(lootList.indexOf((0, import_kolmafia62.toItem)(itemname_))));
      });
    }
    /**
     * Close this dungeon
    ...
    key: "close",
    value: function() {
      (0, import_kolmafia62.visitUrl)("clan_basement.php?action=".concat(this.closeAction, "&confirm=true"), !0);
      var pageText = (0, import_kolmafia62.visitUrl)("clan_basement.php");
    ...
    key: "open",
    value: function() {
      var paymentPolicy = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "Difference", pageText = (0, import_kolmafia62.visitUrl)("clan_basement.php");
      ...
      return (0, import_kolmafia62.visitUrl)("clan_basement.php?action=".concat(this.openAction), !0), (0, import_kolmafia62.visitUrl)("clan_basement.php").includes(this.openImage);
    }
    /**
    ...
    key: "findLoot",
    value: function() {
      var result = /* @__PURE__ */ new Map(), pageText = (0, import_kolmafia62.visitUrl)("clan_basement.php"), _iterator = _createForOfIteratorHelper14(this.loot), _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
...
var MpSource = /* @__PURE__ */ function() {
  ...
  return _createClass16(OscusSoda2, [{
    key: "available",
    value: function() {
      return have($item(_templateObject477 || (_templateObject477 = _taggedTemplateLiteral56(["Oscus's neverending soda"]))));
    }
  }, {
    key: "usesRemaining",
    value: function() {
    ...
    key: "execute",
    value: function() {
      (0, import_kolmafia63.use)($item(_templateObject2126 || (_templateObject2126 = _taggedTemplateLiteral56(["Oscus's neverending soda"]))));
    }
  }]), OscusSoda2;
}(MpSource);
...
var MagicalSausages = /* @__PURE__ */ function(_MpSource2) {
  ...
  return _createClass16(MagicalSausages2, [{
    key: "available",
    value: function() {
      return have($item(_templateObject3106 || (_templateObject3106 = _taggedTemplateLiteral56(["Kramco Sausage-o-Matic\u2122"]))));
    }
  }, {
    key: "usesRemaining",
    value: function() {
      var maxSausages = (0, import_kolmafia63.availableAmount)($item(_templateObject478 || (_templateObject478 = _taggedTemplateLiteral56(["magical sausage"])))) + (0, import_kolmafia63.availableAmount)($item(_templateObject556 || (_templateObject556 = _taggedTemplateLiteral56(["magical sausage casing"]))));
      return this.available() ? clamp(23 - get("_sausagesEaten"), 0, maxSausages) : 0;
    }
  }, {
    key: "availableMpMin",
    value: function() {
      return this.available() ? Math.min((0, import_kolmafia63.myMaxmp)(), 999) * this.usesRemaining() : 0;
    }
  }, {
    key: "execute",
    value: function() {
      var mpSpaceAvailable = (0, import_kolmafia63.myMaxmp)() - (0, import_kolmafia63.myMp)();
      if (!(mpSpaceAvailable < 700)) {
        var maxSausages = Math.min(this.usesRemaining(), Math.floor(((0, import_kolmafia63.myMaxmp)() - (0, import_kolmafia63.myMp)()) / Math.min((0, import_kolmafia63.myMaxmp)() - (0, import_kolmafia63.myMp)(), 999)));
        (0, import_kolmafia63.retrieveItem)(maxSausages, $item(_templateObject645 || (_templateObject645 = _taggedTemplateLiteral56(["magical sausage"])))), (0, import_kolmafia63.eat)(maxSausages, $item(_templateObject738 || (_templateObject738 = _taggedTemplateLiteral56(["magical sausage"]))));
      }
    }
  }]), MagicalSausages2;
}(MpSource);
...
var MoodElement = /* @__PURE__ */ function() {
  ...
  return _createClass16(SkillMoodElement2, [{
    key: "mpCostPerTurn",
    value: function() {
      var turns = (0, import_kolmafia63.turnsPerCast)(this.skill);
      return turns > 0 ? (0, import_kolmafia63.mpCost)(this.skill) / turns : 0;
    }
  }, {
    key: "turnIncrement",
    value: function() {
      return (0, import_kolmafia63.turnsPerCast)(this.skill);
    }
  }, {
    key: "execute",
    value: function(mood, ensureTurns) {
      var effect2 = (0, import_kolmafia63.toEffect)(this.skill), initialTurns = (0, import_kolmafia63.haveEffect)(effect2);
      if (!(0, import_kolmafia63.haveSkill)(this.skill))
        return !1;
        ...
        try {
          var _loop = function() {
            ...
            if (!slot || slot.includes(effect2))
              return (0, import_kolmafia63.cliExecute)("shrug ".concat(song2)), "break";
          };
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            var _ret = _loop();
            if (_ret === "break")
      ...
      for (var oldRemainingCasts = -1, remainingCasts = Math.ceil((ensureTurns - (0, import_kolmafia63.haveEffect)(effect2)) / (0, import_kolmafia63.turnsPerCast)(this.skill)); remainingCasts > 0 && oldRemainingCasts !== remainingCasts; ) {
        var maxCasts = void 0;
        if ((0, import_kolmafia63.hpCost)(this.skill) > 0)
          maxCasts = Math.max(0, Math.floor(((0, import_kolmafia63.myHp)() - 1) / (0, import_kolmafia63.hpCost)(this.skill)));
        else {
          var cost = (0, import_kolmafia63.mpCost)(this.skill);
          if (maxCasts = Math.floor(Math.min(mood.availableMp(), (0, import_kolmafia63.myMp)()) / cost), maxCasts < remainingCasts) {
            var bestMp = Math.min(remainingCasts * (0, import_kolmafia63.mpCost)(this.skill), (0, import_kolmafia63.myMaxmp)());
            mood.moreMp(bestMp), maxCasts = Math.floor(Math.min(mood.availableMp(), (0, import_kolmafia63.myMp)()) / cost);
          }
        }
        var casts = clamp(remainingCasts, 0, Math.min(100, maxCasts));
        (0, import_kolmafia63.useSkill)(casts, this.skill), oldRemainingCasts = remainingCasts, remainingCasts = Math.ceil((ensureTurns - (0, import_kolmafia63.haveEffect)(effect2)) / (0, import_kolmafia63.turnsPerCast)(this.skill));
      }
      return (0, import_kolmafia63.haveEffect)(effect2) > ensureTurns;
    }
  }]), SkillMoodElement2;
  ...
  return _createClass16(PotionMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
      var effect2 = (0, import_kolmafia63.effectModifier)(this.potion, "Effect"), effectTurns = (0, import_kolmafia63.haveEffect)(effect2), turnsPerUse = (0, import_kolmafia63.numericModifier)(this.potion, "Effect Duration");
      if ((0, import_kolmafia63.mallPrice)(this.potion) > this.maxPricePerTurn * turnsPerUse)
        return !1;
      if (effectTurns < ensureTurns) {
        var uses = Math.floor((ensureTurns - effectTurns) / turnsPerUse), quantityToBuy = clamp(uses - (0, import_kolmafia63.availableAmount)(this.potion), 0, 100);
        (0, import_kolmafia63.buy)(quantityToBuy, this.potion, Math.floor(this.maxPricePerTurn * turnsPerUse));
        var quantityToUse = clamp(uses, 0, (0, import_kolmafia63.availableAmount)(this.potion));
        (0, import_kolmafia63.use)(quantityToUse, this.potion);
      }
      var remainingDifference = ensureTurns - (0, import_kolmafia63.haveEffect)(effect2);
      if (remainingDifference > 0) {
        var price2 = Math.floor(this.maxPricePerTurn * remainingDifference);
        price2 <= (0, import_kolmafia63.mallPrice)(this.potion) && ((0, import_kolmafia63.availableAmount)(this.potion) || (0, import_kolmafia63.buy)(1, this.potion, price2)) && (0, import_kolmafia63.use)(1, this.potion);
      }
      return (0, import_kolmafia63.haveEffect)(effect2) >= ensureTurns;
    }
  }]), PotionMoodElement2;
  ...
  return _createClass16(GenieMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
      if ((0, import_kolmafia63.haveEffect)(this.effect) >= ensureTurns)
        return !0;
      var neededWishes = Math.ceil(((0, import_kolmafia63.haveEffect)(this.effect) - ensureTurns) / 20), wishesToBuy = clamp(neededWishes - (0, import_kolmafia63.availableAmount)($item(_templateObject831 || (_templateObject831 = _taggedTemplateLiteral56(["pocket wish"])))), 0, 20);
      (0, import_kolmafia63.buy)(wishesToBuy, $item(_templateObject927 || (_templateObject927 = _taggedTemplateLiteral56(["pocket wish"]))), 5e4);
      for (var wishesToUse = clamp(neededWishes, 0, (0, import_kolmafia63.availableAmount)($item(_templateObject1025 || (_templateObject1025 = _taggedTemplateLiteral56(["pocket wish"]))))); wishesToUse > 0; wishesToUse--)
        (0, import_kolmafia63.cliExecute)("genie effect ".concat(this.effect.name));
      return (0, import_kolmafia63.haveEffect)(this.effect) >= ensureTurns;
    }
  }]), GenieMoodElement2;
  ...
  function CustomMoodElement2(effect2, gainEffect) {
    ...
    return _classCallCheck16(this, CustomMoodElement2), _this4 = _super6.call(this), _defineProperty20(_assertThisInitialized4(_this4), "effect", void 0), _defineProperty20(_assertThisInitialized4(_this4), "gainEffect", void 0), _this4.effect = effect2, _this4.gainEffect = gainEffect != null ? gainEffect : function() {
      return (0, import_kolmafia63.cliExecute)(effect2.default);
    }, _this4;
  }
  return _createClass16(CustomMoodElement2, [{
    key: "execute",
    value: function(mood, ensureTurns) {
      for (var currentTurns = (0, import_kolmafia63.haveEffect)(this.effect), lastCurrentTurns = -1; currentTurns < ensureTurns && currentTurns !== lastCurrentTurns; )
        this.gainEffect(), lastCurrentTurns = currentTurns, currentTurns = (0, import_kolmafia63.haveEffect)(this.effect);
      return (0, import_kolmafia63.haveEffect)(this.effect) > ensureTurns;
    }
  }]), CustomMoodElement2;
  ...
  return _createClass16(Mood2, [{
    ...
    value: function() {
      ...
      }) + Math.max((0, import_kolmafia63.myMp)() - this.options.reserveMp, 0);
    }
  }, {
    key: "moreMp",
    value: function(minimumTarget) {
      if (!((0, import_kolmafia63.myMp)() >= minimumTarget)) {
        var _iterator2 = _createForOfIteratorHelper15(this.options.mpSources), _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
            var mpSource = _step2.value;
            if (mpSource.usesRemaining() > 0 && (mpSource.execute(), (0, import_kolmafia63.myMp)() >= minimumTarget))
              break;
          }
        } catch (err) {
          _iterator2.e(err);
        ...
        this.options.useNativeRestores && (0, import_kolmafia63.restoreMp)(minimumTarget);
      }
    }
    /**
    ...
    value: function(_effect, gainEffect) {
      var skill = (0, import_kolmafia63.toSkill)(_effect);
...
function sinceKolmafiaRevision(revision) {
  ...
  var currentRevision = (0, import_kolmafia64.getRevision)();
  if (currentRevision > 0 && currentRevision < revision)
    throw new KolmafiaVersionError("".concat(getScriptName(), " requires revision r").concat(revision, " of kolmafia or higher (current: ").concat((0, import_kolmafia64.getRevision)(), "). Up-to-date builds can be found at https://ci.kolmafia.us/."));
}
function sinceKolmafiaVersion(majorVersion, minorVersion) {
  if (!((0, import_kolmafia64.getRevision)() >= 25720)) {
    ...
    var versionStr = (0, import_kolmafia64.getVersion)(), versionStrMatch = /v(\d+)\.(\d+)/.exec(versionStr);
    if (!versionStrMatch)
...
var Kmail = /* @__PURE__ */ function() {
  ...
  return _createClass18(Kmail2, [{
    ...
    key: "items",
    value: function() {
      return new Map(Object.entries((0, import_kolmafia65.extractItems)(this.rawMessage)).map(function(_ref) {
        var _ref2 = _slicedToArray20(_ref, 2), itemName = _ref2[0], quantity = _ref2[1];
        return [import_kolmafia65.Item.get(itemName), quantity];
      }));
    }
    /**
    ...
    key: "meat",
    value: function() {
      return (0, import_kolmafia65.extractMeat)(this.rawMessage);
    }
    /**
     * Reply to kmail
     *
    ...
    value: function() {
      ...
      return JSON.parse((0, import_kolmafia65.visitUrl)("api.php?what=kmail&for=libram&count=".concat(count))).map(Kmail2.parse);
    }
    /**
     * Bulk delete kmails
     *
    ...
    value: function(kmails) {
      var _results$match$, _results$match, results = (0, import_kolmafia65.visitUrl)("messages.php?the_action=delete&box=Inbox&pwd&".concat(kmails.map(function(k) {
    ...
    value: function(to, message, items, meat, chunkSize, constructUrl, successString) {
      var m = meat, sendableItems = _toConsumableArray18(arrayToCountedMap(items).entries()).filter(function(_ref3) {
        ...
        return (0, import_kolmafia65.isGiftable)(item10);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
          ...
          }), r = (0, import_kolmafia65.visitUrl)(constructUrl(m, _itemsQuery.join("&"), _itemsQuery.length));
...
// src/Path.ts
init_kolmafia_polyfill();
var _templateObject479, _templateObject2127, _templateObject3107, _templateObject480, _templateObject557, _templateObject646, _templateObject739, _templateObject834, _templateObject928, _templateObject1026, _templateObject1122;
...
var Path5 = /* @__PURE__ */ _createClass19(
  ...
  function Path6(name, id) {
    var hasAllPerms = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0, canUseSkillbooks = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, hasCampground = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, hasTerrarium = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : !0, stomachSize = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : 15, liverSize = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : 15, spleenSize = arguments.length > 8 && arguments[8] !== void 0 ? arguments[8] : 15, classes = arguments.length > 9 && arguments[9] !== void 0 ? arguments[9] : $classes(_templateObject479 || (_templateObject479 = _taggedTemplateLiteral57(["Seal Clubber, Turtle Tamer, Sauceror, Pastamancer, Disco Bandit, Accordion Thief"])));
  ...
  AvatarOfBoris: new Path5("Avatar of Boris", 8, !1, !1, !0, !1, 20, 5, 15, $classes(_templateObject2127 || (_templateObject2127 = _taggedTemplateLiteral57(["Avatar of Boris"])))),
  BugbearInvasion: new Path5("Bugbear Invasion", 9),
  ZombieSlayer: new Path5("Zombie Slayer", 10, !1, !1, !0, !0, 15, 5, 15, $classes(_templateObject3107 || (_templateObject3107 = _taggedTemplateLiteral57(["Zombie Master"])))),
  ClassAct: new Path5("Class Act", 11, !1, !1),
  AvatarofJarlsberg: new Path5("Avatar of Jarlsberg", 12, !1, !1, !0, !1, 10, 10, 15, $classes(_templateObject480 || (_templateObject480 = _taggedTemplateLiteral57(["Avatar of Jarlsberg"])))),
  Big: new Path5("BIG!", 14),
  KolHs: new Path5("KOLHS", 15),
  ClassAct2: new Path5("Class Act II: A Class For Pigs", 16, !1),
  AvatarofSneakyPete: new Path5("Avatar of Sneaky Pete", 17, !1, !1, !0, !1, 5, 20, 15, $classes(_templateObject557 || (_templateObject557 = _taggedTemplateLiteral57(["Avatar of Sneaky Pete"])))),
  ...
  ActuallyEdTheUndying: new Path5("Actually Ed the Undying", 23, !1, !1, !1, !1, 0, 0, 5, $classes(_templateObject646 || (_templateObject646 = _taggedTemplateLiteral57(["Ed the Undying"])))),
  OneCrazyRandomSummer: new Path5("One Crazy Random Summer", 24),
  CommunityService: new Path5("Community Service", 25),
  AvatarOfWestOfLoathing: new Path5("Avatar of West of Loathing", 26, !1, !1, !0, !0, 10, 10, 10, $classes(_templateObject739 || (_templateObject739 = _taggedTemplateLiteral57(["Cow Puncher, Snake Oiler, Beanslinger"])))),
  TheSource: new Path5("The Source", 27),
  NuclearAutumn: new Path5("Nuclear Autumn", 28, !1, !1, !1, !0, 3, 3, 3),
  GelatinousNoob: new Path5("Gelatinous Noob", 29, !1, !1, !0, !0, 0, 0, 0, $classes(_templateObject834 || (_templateObject834 = _taggedTemplateLiteral57(["Gelatinous Noob"])))),
  ...
  DarkGyffte: new Path5("Dark Gyffte", 35, !1, !1, !0, !1, 5, 5, 15, $classes(_templateObject928 || (_templateObject928 = _taggedTemplateLiteral57(["Vampyre"])))),
  TwoCrazyRandomSummer: new Path5("Two Crazy Random Summer", 36),
  KingdomOfExploathing: new Path5("Kingdom of Exploathing", 37),
  PathOfThePlumber: new Path5("Path of the Plumber", 38, !1, !1, !0, !0, 20, 0, 5, $classes(_templateObject1026 || (_templateObject1026 = _taggedTemplateLiteral57(["Plumber"])))),
  ...
  GreyYou: new Path5(
    ...
    $classes(_templateObject1122 || (_templateObject1122 = _taggedTemplateLiteral57(["Grey Goo"])))
  ),
...
init_kolmafia_polyfill();
var import_kolmafia66 = require("kolmafia"), logColor = function(color) {
  return function() {
    ...
    color ? (0, import_kolmafia66.print)(output, color) : (0, import_kolmafia66.print)(output);
  };
...
var _templateObject481, _templateObject2128, _templateObject3108, _templateObject487, _templateObject558, _templateObject647, _templateObject740, _templateObject835, _templateObject929, _templateObject1027, _templateObject1123, _templateObject1221, _templateObject1320, _templateObject1417, _templateObject1515, _templateObject1615, _templateObject1715, _templateObject1815, _templateObject1915, _templateObject2015, _templateObject2129, _templateObject2217, _templateObject2315, _templateObject2414, _templateObject2514, _templateObject2614, _templateObject2714, _templateObject2811, _templateObject2911, _templateObject3011, _templateObject3114, _templateObject3213, _templateObject3313;
...
function mySessionItemsWrapper() {
  ...
  }, itemMappings = new Map([].concat(_toConsumableArray19(foldable($item(_templateObject481 || (_templateObject481 = _taggedTemplateLiteral58(["liar's pants"]))))), _toConsumableArray19(foldable($item(_templateObject2128 || (_templateObject2128 = _taggedTemplateLiteral58(["ice pick"]))))), _toConsumableArray19(manyToOne($item(_templateObject3108 || (_templateObject3108 = _taggedTemplateLiteral58(["Spooky Putty sheet"]))), [$item(_templateObject487 || (_templateObject487 = _taggedTemplateLiteral58(["Spooky Putty monster"])))].concat(_toConsumableArray19(getFoldGroup($item(_templateObject558 || (_templateObject558 = _taggedTemplateLiteral58(["Spooky Putty sheet"])))))))), _toConsumableArray19(foldable($item(_templateObject647 || (_templateObject647 = _taggedTemplateLiteral58(["stinky cheese sword"]))))), _toConsumableArray19(foldable($item(_templateObject740 || (_templateObject740 = _taggedTemplateLiteral58(["naughty paper shuriken"]))))), _toConsumableArray19(foldable($item(_templateObject835 || (_templateObject835 = _taggedTemplateLiteral58(["Loathing Legion knife"]))))), _toConsumableArray19(foldable($item(_templateObject929 || (_templateObject929 = _taggedTemplateLiteral58(["deceased crimbo tree"]))))), _toConsumableArray19(foldable($item(_templateObject1027 || (_templateObject1027 = _taggedTemplateLiteral58(["makeshift turban"]))))), _toConsumableArray19(foldable($item(_templateObject1123 || (_templateObject1123 = _taggedTemplateLiteral58(["turtle wax shield"]))))), _toConsumableArray19(foldable($item(_templateObject1221 || (_templateObject1221 = _taggedTemplateLiteral58(["metallic foil bow"]))))), _toConsumableArray19(foldable($item(_templateObject1320 || (_templateObject1320 = _taggedTemplateLiteral58(["ironic moustache"]))))), _toConsumableArray19(foldable($item(_templateObject1417 || (_templateObject1417 = _taggedTemplateLiteral58(["bugged balaclava"]))))), _toConsumableArray19(foldable($item(_templateObject1515 || (_templateObject1515 = _taggedTemplateLiteral58(["toggle switch (Bartend)"]))))), _toConsumableArray19(foldable($item(_templateObject1615 || (_templateObject1615 = _taggedTemplateLiteral58(["mushroom cap"]))))), _toConsumableArray19(manyToOne($item(_templateObject1715 || (_templateObject1715 = _taggedTemplateLiteral58(["can of Rain-Doh"]))), $items(_templateObject1815 || (_templateObject1815 = _taggedTemplateLiteral58(["empty Rain-Doh can"]))))), _toConsumableArray19(manyToOne($item(_templateObject1915 || (_templateObject1915 = _taggedTemplateLiteral58(["meteorite fragment"]))), $items(_templateObject2015 || (_templateObject2015 = _taggedTemplateLiteral58(["meteorite earring, meteorite necklace, meteorite ring"]))))), _toConsumableArray19(manyToOne($item(_templateObject2129 || (_templateObject2129 = _taggedTemplateLiteral58(["Sneaky Pete's leather jacket"]))), $items(_templateObject2217 || (_templateObject2217 = _taggedTemplateLiteral58(["Sneaky Pete's leather jacket (collar popped)"]))))), _toConsumableArray19(manyToOne($item(_templateObject2315 || (_templateObject2315 = _taggedTemplateLiteral58(["Boris's Helm"]))), $items(_templateObject2414 || (_templateObject2414 = _taggedTemplateLiteral58(["Boris's Helm (askew)"]))))), _toConsumableArray19(manyToOne($item(_templateObject2514 || (_templateObject2514 = _taggedTemplateLiteral58(["Jarlsberg's pan"]))), $items(_templateObject2614 || (_templateObject2614 = _taggedTemplateLiteral58(["Jarlsberg's pan (Cosmic portal mode)"]))))), _toConsumableArray19(manyToOne($item(_templateObject2714 || (_templateObject2714 = _taggedTemplateLiteral58(["tiny plastic sword"]))), $items(_templateObject2811 || (_templateObject2811 = _taggedTemplateLiteral58(["grogtini, bodyslam, dirty martini, vesper, cherry bomb, sangria del diablo"]))))), _toConsumableArray19(manyToOne($item(_templateObject2911 || (_templateObject2911 = _taggedTemplateLiteral58(["earthenware muffin tin"]))), $items(_templateObject3011 || (_templateObject3011 = _taggedTemplateLiteral58(["blueberry muffin, bran muffin, chocolate chip muffin"]))))), _toConsumableArray19(manyToOne($item(_templateObject3114 || (_templateObject3114 = _taggedTemplateLiteral58(["ChibiBuddy\u2122 (on)"]))), $items(_templateObject3213 || (_templateObject3213 = _taggedTemplateLiteral58(["ChibiBuddy\u2122 (off)"]))))))), inventory = /* @__PURE__ */ new Map(), invLocations = sessionOnly ? [import_kolmafia67.mySessionItems] : [import_kolmafia67.mySessionItems, import_kolmafia67.getCloset, import_kolmafia67.getDisplay, import_kolmafia67.getStorage], _i = 0, _invLocations = invLocations; _i < _invLocations.length; _i++)
    for (var inventoryFunc = _invLocations[_i], _i2 = 0, _Object$entries = Object.entries(inventoryFunc()); _i2 < _Object$entries.length; _i2++) {
      var _itemMappings$get, _inventory$get, _Object$entries$_i = _slicedToArray21(_Object$entries[_i2], 2), itemStr = _Object$entries$_i[0], quantity = _Object$entries$_i[1], _item = (0, import_kolmafia67.toItem)(itemStr), mappedItem = (_itemMappings$get = itemMappings.get(_item)) !== null && _itemMappings$get !== void 0 ? _itemMappings$get : _item;
      inventory.set(mappedItem, quantity + ((_inventory$get = inventory.get(mappedItem)) !== null && _inventory$get !== void 0 ? _inventory$get : 0));
    }
  for (var _i3 = 0, _Object$entries2 = Object.entries((0, import_kolmafia67.getCampground)()); _i3 < _Object$entries2.length; _i3++) {
    var _itemMappings$get2, _inventory$get2, _Object$entries2$_i = _slicedToArray21(_Object$entries2[_i3], 2), _itemStr = _Object$entries2$_i[0], _quantity = _Object$entries2$_i[1], _item2 = (0, import_kolmafia67.toItem)(_itemStr);
    if (_item2 !== $item(_templateObject3313 || (_templateObject3313 = _taggedTemplateLiteral58(["big rock"])))) {
  ...
  return _createClass20(Session2, [{
    ...
    value: (
      ...
      function(filename) {
        ...
        (0, import_kolmafia67.bufferToFile)(JSON.stringify(val), Session2.getFilepath(filename));
      }
    )
    /**
    ...
    value: function(filename) {
      return filename.endsWith(".json") ? filename : "snapshots/".concat((0, import_kolmafia67.myName)(), "/").concat((0, import_kolmafia67.todayToString)(), "_").concat(filename, ".json");
    }
  }, {
    key: "fromFile",
    value: function(filename) {
      var fileValue = (0, import_kolmafia67.fileToBuffer)(Session2.getFilepath(filename));
      if (fileValue.length > 0) {
        var val = JSON.parse(fileValue), parsedItems = Object.entries(val.items).map(function(_ref3) {
          ...
          return [(0, import_kolmafia67.toItem)(itemStr), quantity];
        });
    ...
    key: "current",
    value: function() {
      var sessionOnly = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, meat = sessionOnly ? [import_kolmafia67.mySessionMeat] : [import_kolmafia67.mySessionMeat, import_kolmafia67.myClosetMeat, import_kolmafia67.myStorageMeat];
